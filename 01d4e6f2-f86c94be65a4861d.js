...
/* harmony export */   t: () => (/* binding */ TextMarkupAnnotation)
/* harmony export */ });
...
var TextMarkupAnnotation = /** @class */ (function () {
    ...
    TextMarkupAnnotation.prototype.createAnnotationSelectElement = function () {
        this.dropDivAnnotationLeft = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + '_droplet_left', className: 'e-pv-drop' });
        this.dropDivAnnotationLeft.style.borderRight = '2px solid';
        this.dropDivAnnotationRight = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + '_droplet_right', className: 'e-pv-drop' });
        this.dropDivAnnotationRight.style.borderLeft = '2px solid';
        this.dropElementLeft = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-droplet', id: this.pdfViewer.element.id + '_dropletspan_left' });
        this.dropElementLeft.style.transform = 'rotate(0deg)';
        this.dropDivAnnotationLeft.appendChild(this.dropElementLeft);
        this.dropElementRight = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-droplet', id: this.pdfViewer.element.id + '_dropletspan_right' });
            ...
            if (annotations_1) {
                for (var i = 0; i < annotations_1.length; i++) {
                    ...
                    if (annotation.TextMarkupAnnotationType) {
                        ...
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotation.TextMarkupContent) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotation.textMarkupContent)) {
                            var markedBounds = annotation.Bounds;
                            var storedData = this.pdfViewerBase.getStoredData(pageNumber, true);
                            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(storedData)) {
                    ...
                    if (type === 'Highlight' && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(highlightCanvasContext)) {
    ...
    TextMarkupAnnotation.prototype.getHighlightCanvasContext = function (isPrintCanvas, pageNumber) {
        ...
        if (!isPrintCanvas) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(canvas)) {
                canvas = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('canvas', { id: this.pdfViewer.element.id + '_print_blendAnnotations_canvas_' + pageNumber });
    ...
    TextMarkupAnnotation.prototype.drawAnnotationSelector = function (newAnnotation, annotation, newcanvas) {
        ...
        for (var i = 0; i < newAnnotation.bounds.length; i++) {
            ...
            nextTop = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newAnnotation.bounds[i + 1]) ? newAnnotation.bounds[i + 1].top ?
            ...
            nextLeft = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newAnnotation.bounds[i + 1]) ? newAnnotation.bounds[i + 1].left ?
            ...
            currentRotation = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newAnnotationBounds.rotation) ? newAnnotationBounds.rotation : pageRotate ? pageRotate : 0;
            ...
            if (rotation180Exists) {
                ...
                var nextRight = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newAnnotation.bounds[i + 1]) ?
                ...
                var nextBottom = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newAnnotation.bounds[i + 1]) ? newAnnotation.bounds[i + 1].bottom ?
    ...
    TextMarkupAnnotation.prototype.drawTextMarkups = function (type, bounds, pageNumber, rect, factor, textContent, startIndex, endIndex, isMultiSelect, targetElement) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(context)) {
            var pageDiv = document.getElementById(this.pdfViewer.element.id + '_pageDiv_' + pageNumber);
        ...
        if (context) {
            ...
            switch (type) {
                case 'Highlight':
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.highlightOpacity)) {
                ...
                case 'Strikethrough':
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.strikethroughOpacity)) {
                ...
                case 'Underline':
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.underlineOpacity)) {
            ...
            if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !this.pdfViewer.enableDesktopMode && this.pdfViewer.enableToolbar &&
    ...
    TextMarkupAnnotation.prototype.printAnnotationsInCanvas = function (textMarkupAnnotations, pageIndex, stampData, shapeData, measureShapeData, stickyData, freeTextData, inkData) {
        var canvas = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('canvas', { id: this.pdfViewer.element.id + '_print_annotation_layer_' + pageIndex });
        canvas.style.width = 816 + 'px';
        canvas.style.height = 1056 + 'px';
        ...
        if (this.currentTextMarkupAnnotation) {
            ...
            if (!isLock) {
                ...
                if (pageAnnotations) {
                    ...
                    else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(deletedAnnotation)) {
    ...
    TextMarkupAnnotation.prototype.modifyOpacityProperty = function (args, isOpacity) {
        if (this.currentTextMarkupAnnotation) {
            ...
            if (!((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isOpacity))) {
            ...
            if (pageAnnotations) {
                this.manageAnnotations(pageAnnotations, this.selectTextMarkupCurrentPage);
                this.pdfViewer.annotationModule.renderAnnotations(this.selectTextMarkupCurrentPage, null, null, null);
                if (!((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isOpacity)) || args.name === 'changed') {
                    this.pdfViewerBase.updateDocumentEditedProperty(true);
                    var annotation = this.currentTextMarkupAnnotation;
                    var multiPageCollection = this.multiPageCollectionList(annotation);
                    if (multiPageCollection.length > 0) {
    ...
    TextMarkupAnnotation.prototype.getAnnotationBounds = function (bounds, pageIndex) {
        var left = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bounds.left) ? bounds.left : bounds.Left;
        var top = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bounds.top) ? bounds.top : bounds.Top;
    ...
    TextMarkupAnnotation.prototype.getRgbCode = function (colorString) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(markupStringArray[1])) {
    ...
    TextMarkupAnnotation.prototype.getIndexNumbers = function (pageNumber, content, parentText) {
        ...
        if (storedData) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parentText)) {
    ...
    TextMarkupAnnotation.prototype.onTextMarkupAnnotationMouseUp = function (event) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pageNumber) && !isNaN(pageNumber)) {
    ...
    TextMarkupAnnotation.prototype.onTextMarkupAnnotationTouchEnd = function (event) {
        ...
        else if (this.selectTextMarkupCurrentPage != null && (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !this.pdfViewer.enableDesktopMode)) {
        ...
        if (this.pdfViewer.toolbarModule && this.pdfViewer.toolbarModule.annotationToolbarModule &&
            ...
            if (this.pdfViewer.toolbarModule.annotationToolbarModule) {
                ...
                if (this.currentTextMarkupAnnotation) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.isTextMarkupAnnotationMode) && !this.isTextMarkupAnnotationMode) {
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isBlazor */ .Z4)()) {
    ...
    TextMarkupAnnotation.prototype.getIsPrintValue = function (type) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPrint)) {
            isPrint = true;
        }
        return isPrint;
    };
...
//# sourceMappingURL=01d4e6f2-f86c94be65a4861d.js.map
