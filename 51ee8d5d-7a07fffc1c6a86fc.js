"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[8736],{
...
/* harmony import */ var _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(41271);
/* harmony import */ var _base_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68198);
/* harmony import */ var _base_constant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16206);
/* harmony import */ var _base_enum__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(88555);
/* harmony import */ var _base_string_literals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(89874);
...
var Selection = /** @class */ (function () {
    ...
    Selection.prototype.fDataUpdate = function (args) {
        if (!this.isMultiSelection && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args.cellIndex) || !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args.rowIndex))) {
            var rowObj = this.getRowObj((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args.rowIndex) ? (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args.cellIndex) ?
    ...
    Selection.prototype.destroy = function () {
        ...
        if (!gridElement || (!gridElement.querySelector('.' + _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .gridHeader */ .iM) && !gridElement.querySelector('.' + _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .gridContent */ .iV))) {
            return;
        }
        this.hidePopUp();
        this.clearSelection();
        ...
        this.unWireEvents();
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.getContent(), 'mousedown', this.mouseDownHandler);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.getHeaderContent(), 'mousedown', this.mouseDownHandler);
    };
    ...
    Selection.prototype.getCurrentBatchRecordChanges = function () {
        ...
        if (gObj.editSettings.mode === 'Batch' && gObj.editModule) {
            var currentRecords = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .iterateExtend */ .pA)(this.parent.getCurrentViewRecords());
            currentRecords = gObj.editSettings.newRowPosition === 'Bottom' ?
                currentRecords.concat(this.parent.editModule.getBatchChanges()[_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .addedRecords */ .V0]) :
                this.parent.editModule.getBatchChanges()[_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .addedRecords */ .V0].concat(currentRecords);
            var deletedRecords = this.parent.editModule.getBatchChanges()[_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .deletedRecords */ .S4];
    ...
    Selection.prototype.selectRow = function (index, isToggle) {
        ...
        if (gObj.enableVirtualization && index > -1) {
            ...
            this.parent.notify(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .selectVirtualRow */ .ghX, e);
        ...
        if (!isToggle) {
            ...
            this.parent.trigger(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowSelecting */ .FeU, this.fDataUpdate(args), this.rowSelectingCallBack(args, isToggle, index, selectData, isRemoved, isRowSelected, can));
        }
        else {
            if (this.selectionSettings.checkboxMode !== 'ResetOnRowClick' && this.selectionSettings.persistSelection) {
                this.rowDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowDeselecting */ .Oi0, [rowObj.index], [rowObj.data], [selectedRow], [rowObj.foreignKeyData], this.actualTarget);
                ...
                this.rowDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowDeselected */ .BK8, [rowObj.index], [rowObj.data], [selectedRow], [rowObj.foreignKeyData], this.actualTarget, undefined, undefined, undefined);
            }
    ...
    Selection.prototype.rowSelectingCallBack = function (args, isToggle, index, selectData, isRemoved, isRowSelected, can) {
        ...
        return function (args) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args) && args["" + can] === true) {
    ...
    Selection.prototype.selectRowCallBack = function () {
        ...
        if (!isToggle) {
            ...
            this.onActionComplete(args, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowSelected */ .CZL);
        }
    ...
    Selection.prototype.selectRows = function (rowIndexes) {
        ...
        this.parent.trigger(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowSelecting */ .FeU, this.fDataUpdate(args), function (args) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args) && args["" + can] === true) {
                _this.disableInteracted();
                return;
            }
                ...
                if (selectableRowIndex.length === _this.totalRecordsCount) {
                    ...
                    if (selectionData.length > 0) {
                        ...
                        for (var i = 0; i < selectionData.length; i++) {
                            ...
                            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(record)) {
            ...
            if (_this.isRowSelected) {
                _this.onActionComplete(args, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowSelected */ .CZL);
            }
    ...
    Selection.prototype.addRowsToSelection = function (rowIndexes) {
        ...
        for (var _i = 0, rowIndexes_1 = rowIndexes; _i < rowIndexes_1.length; _i++) {
            ...
            if (isUnSelected && ((checkboxColumn.length ? true : this.selectionSettings.enableToggle) || this.isMultiCtrlRequest)) {
                ...
                this.rowDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowDeselecting */ .Oi0, [rowIndex], [rowObj.data], [selectedRow], [rowObj.foreignKeyData], target);
                if (this.isCancelDeSelect) {
                    return;
                }
                ...
                this.rowDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowDeselected */ .BK8, [rowIndex], [rowObj.data], [selectedRow], [rowObj.foreignKeyData], target, undefined, undefined, undefined);
                this.isInteracted = false;
                this.isMultiSelection = false;
                this.isAddRowsToSelection = false;
                this.isHdrSelectAllClicked = false;
                ...
                this.parent.trigger(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowSelecting */ .FeU, this.fDataUpdate(args));
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args) && args["" + can] === true) {
    ...
    Selection.prototype.getPkValue = function (pkField, data) {
        return pkField ? (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .isComplexField */ .DL)(pkField) ? (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getObject */ .iM)(pkField, data) : data["" + pkField] : data["" + pkField];
    };
    Selection.prototype.updatePersistCollection = function (selectedRow, chkState) {
        var _this = this;
        if ((this.parent.isPersistSelection || this.parent.selectionSettings.persistSelection &&
            this.parent.getPrimaryKeyFieldNames().length > 0) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(selectedRow)) {
    ...
    Selection.prototype.updateCheckBoxes = function (row, chkState, rowIndex) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(row)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(chkBox)) {
                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .removeAddCboxClasses */ .Cd)(chkBox.nextElementSibling, chkState);
                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .setChecked */ .Go)(chkBox, chkState);
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.checkedTarget) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.checkedTarget)
    ...
    Selection.prototype.clearSelection = function () {
        ...
        if (this.selectionSettings.persistSelection && this.persistSelectedData.length) {
            this.deSelectedData = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .iterateExtend */ .pA)(this.persistSelectedData);
        }
        if (!this.parent.isPersistSelection || (this.parent.isPersistSelection && !this.parent.isEdit) ||
            (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.checkedTarget) && this.checkedTarget.classList.contains('e-checkselectall'))) {
            ...
            this.enableSelectMultiTouch = false;
            if (!(this.selectionSettings.checkboxMode === 'ResetOnRowClick' && this.target && (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.target, 'e-rowcell'))) {
                this.isInteracted = false;
            }
    ...
    Selection.prototype.clearRowSelection = function () {
        ...
        if (this.isRowSelected) {
            ...
            this.rowDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowDeselecting */ .Oi0, rowIndex_1, data_1, row_1, foreignKeyData_1, target_1, null, function () {
                ...
                _this.rowDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowDeselected */ .BK8, rowIndex_1, data_1, row_1, foreignKeyData_1, target_1, null, undefined, null);
                if (_this.clearRowCheck) {
                    _this.clearRowCallBack();
                    _this.clearRowCheck = false;
                    if (_this.selectRowCheck) {
    ...
    foreignKeyData, target, mRow, rowDeselectCallBack, frozenRightRow) {
        ...
        if ((this.selectionSettings.persistSelection && (this.isRowClicked || !this.isRowDeselect || this.checkSelectAllClicked || (this.focus['activeKey'] &&
            ...
            var isHeaderCheckBxClick = this.actualTarget && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(this.actualTarget, 'thead'));
    ...
    Selection.prototype.selectCell = function (cellIndex, isToggle) {
        ...
        isToggle = !isToggle ? isToggle : (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isUndefined */ .b0)(this.prevCIdxs) &&
        ...
        if (!isToggle) {
            ...
            this.parent.trigger(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelecting */ .hJm, this.fDataUpdate(args), this.successCallBack(args, isToggle, cellIndex, selectedCell, selectedData));
    ...
    Selection.prototype.successCallBack = function (cellSelectingArgs, isToggle, cellIndex, selectedCell, selectedData) {
        ...
        return function (cellSelectingArgs) {
            var cncl = 'cancel';
            var currentCell = 'currentCell';
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(cellSelectingArgs) && cellSelectingArgs["" + cncl] === true) {
                return;
            }
            if (!isToggle) {
            ...
            if (!isToggle) {
                ...
                _this.onActionComplete(args, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelected */ .sF6);
            }
        };
    };
    ...
    Selection.prototype.selectCellsByRange = function (startIndex, endIndex) {
        ...
        var gObj = this.parent;
        var selectedCell = this.parent.isSpan ? (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getCellFromRow */ .tA)(this.parent, startIndex.rowIndex, startIndex.cellIndex) :
        ...
        var previousRowCellIndex = 'previousRowCellIndex';
        args["" + previousRowCellIndex] = this.prevECIdxs;
        this.parent.trigger(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelecting */ .hJm, this.fDataUpdate(args), function (cellSelectingArgs) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(cellSelectingArgs) && cellSelectingArgs["" + cncl] === true) {
                return;
            }
            _this.clearCell();
            ...
            for (var i = startIndex.rowIndex; i <= endIndex.rowIndex; i++) {
                ...
                for (var j = min < max ? min : max, len = min > max ? min : max; j <= len; j++) {
                    selectedCell = _this.parent.isSpan ? (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getCellFromRow */ .tA)(gObj, i, j) : gObj.getCellFromIndex(i, j);
                    if (!selectedCell) {
                        continue;
                    }
                    cellIndexes.push(j);
            ...
            if (!_this.isDragged) {
                _this.onActionComplete(cellSelectedArgs, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelected */ .sF6);
    ...
    Selection.prototype.selectCells = function (rowCellIndexes) {
        ...
        this.onActionBegin(cellSelectArgs, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelecting */ .hJm);
        ...
        this.onActionComplete(cellSelectedArgs, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelected */ .sF6);
    };
    /**
        ...
        for (var _i = 0, cellIndexes_1 = cellIndexes; _i < cellIndexes_1.length; _i++) {
            ...
            if (isUnSelected) {
                ...
                if (selectedCellIdx.indexOf(cellIndex.cellIndex) > -1 || (this.selectionSettings.mode === 'Both' &&
                    ...
                    this.cellDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellDeselecting */ .efc, [{ rowIndex: cellIndex.rowIndex, cellIndexes: [cellIndex.cellIndex] }], selectedData, [selectedCell], foreignKeyData);
                    ...
                    this.cellDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellDeselected */ .Lcf, [{ rowIndex: cellIndex.rowIndex, cellIndexes: [cellIndex.cellIndex] }], selectedData, [selectedCell], foreignKeyData);
                }
                else {
                    isUnSelected = false;
                    this.onActionBegin(args, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelecting */ .hJm);
                ...
                this.onActionBegin(args, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelecting */ .hJm);
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args) && args["" + cncl] === true) {
                    return;
                }
    ...
    Selection.prototype.getColIndex = function (rowIndex, index) {
        ...
        var cells = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getCellsByTableName */ .Ax)(this.parent, col, rowIndex);
        if (cells) {
            for (var m = 0; m < cells.length; m++) {
                var colIndex = parseInt(cells[parseInt(m.toString(), 10)].getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
                if (colIndex === index) {
                    return m;
                }
            }
    ...
    Selection.prototype.getLastColIndex = function (rowIndex) {
        ...
        return parseInt(cells[cells.length - 1].getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
    };
    ...
    Selection.prototype.cellDeselect = function (type, cellIndexes, data, cells, foreignKeyData) {
        ...
        if (cells && cells.length > 0) {
            for (var _i = 0, cells_1 = cells; _i < cells_1.length; _i++) {
                var cell = cells_1[_i];
                if (cell && cell.classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .gridChkBox */ .yM)) {
                    this.updateCheckBoxes((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(cell, 'tr'));
                }
            }
        }
        var args = {
    ...
    Selection.prototype.updateCellSelection = function (selectedCell, rowIndex, cellIndex) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(rowIndex)) {
            this.addRowCellIndex({ rowIndex: rowIndex, cellIndex: cellIndex });
        }
        selectedCell.classList.add('e-cellselectionbackground');
        if (selectedCell.classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .gridChkBox */ .yM)) {
            this.updateCheckBoxes((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(selectedCell, 'tr'), true);
        }
        this.addAttribute(selectedCell);
    };
    ...
    Selection.prototype.clearCellSelection = function () {
        if (this.isCellSelected) {
            ...
            this.cellDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellDeselecting */ .efc, rowCell, data, cells, foreignKeyData);
            ...
            if (!this.isDragged && this.cellselected) {
                this.cellDeselect(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellDeselected */ .Lcf, rowCell, data, cells, foreignKeyData);
            }
        }
    };
    ...
    Selection.prototype.mouseMoveHandler = function (e) {
        ...
        var x1 = this.x;
        var y1 = this.y;
        var position = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getPosition */ .E9)(e);
        var x2 = position.x - gBRect.left;
        var y2 = position.y - gBRect.top;
        var tmp;
        var target = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(e.target, 'tr');
        this.isDragged = true;
        if (!this.isCellDrag) {
            if (!target) {
                target = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(document.elementFromPoint(this.parent.element.offsetLeft + 2, e.clientY), 'tr');
            }
            if (x1 > x2) {
                tmp = x2;
                x2 = x1;
        ...
        if (target && !e.ctrlKey && !e.shiftKey) {
            var rowIndex = parseInt(target.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
            if (!this.isCellDrag) {
                this.hideAutoFill();
                ...
                var td = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt);
                if (td) {
                    this.startAFCell = this.startCell;
                    this.endAFCell = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt);
                    if (rowIndex > -1) {
                        this.selectLikeExcel(e, rowIndex, parseInt(td.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1);
                    }
                }
            }
        }
    ...
    Selection.prototype.updateScrollPosition = function (mouseEvent, position, scrollElement) {
        ...
        if (clientRect.left >= position.x - 20 -
            (this.parent.enableRtl && this.parent.height !== 'auto' ? (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getScrollBarWidth */ .F_)() : 0)) {
            ...
            (!this.parent.enableRtl && this.parent.height !== 'auto' ? (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getScrollBarWidth */ .F_)() : 0) < position.x) {
        ...
        if (clientRect.top >= position.y - (this.parent.getRowHeight() * 0.5)) {
            ...
            (scrollElement.firstElementChild.scrollWidth > scrollElement.firstElementChild.offsetWidth ?
                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getScrollBarWidth */ .F_)() : 0) <= position.y) {
    ...
    Selection.prototype.setScrollPosition = function (scrollElement, direction, mouseEvent) {
        ...
        switch (direction) {
            case 'up':
                if (mouseEvent && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(mouseEvent.target, '.e-headercontent')) {
                    return;
                }
            ...
            for (var i = 0; i < fixedCells.length; i++) {
                ...
                if (idx === firstRowIdx &&
                    ((!this.parent.getHeaderContent().querySelector('.e-cellselectionbackground.e-fixedfreeze')
                        && (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(parentEle, 'e-content')) || !(0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(parentEle, 'e-content'))) {
                ...
                if (idx === lastRowIdx &&
                    ((!this.parent.getContent().querySelector('.e-cellselectionbackground.e-fixedfreeze')
                        && (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(parentEle, 'e-headercontent')) || !(0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(parentEle, 'e-headercontent'))) {
    ...
    Selection.prototype.refreshFrozenBorders = function () {
        if (this.bdrElement) {
            ...
            if (this.parent.isFrozenGrid() && this.parent.getFrozenMode() === _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .leftRight */ .U0) {
    ...
    Selection.prototype.isLastRow = function (cell) {
        var rows = [].slice.call((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(cell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .tbody */ .T_).querySelectorAll('.e-row:not(.e-hiddenrow)'));
    ...
    Selection.prototype.setBorders = function (parentEle, border, bdrStr) {
        ...
        if (cells.length) {
            ...
            var rightOffset = ((this.parent.getFrozenMode() === 'Right' && (bdrStr === '1' || bdrStr === '3'))
                || (this.parent.getFrozenMode() === _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .leftRight */ .U0 && (bdrStr === '5' || bdrStr === '6')))
    ...
    Selection.prototype.positionBorders = function () {
        ...
        if (this.parent.isFrozenGrid()) {
            ...
            if (this.parent.getFrozenMode() === _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .leftRight */ .U0) {
    ...
    Selection.prototype.createBorders = function () {
        if (!this.bdrElement) {
            var selectionBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
            ...
            if (this.parent.isFrozenGrid()) {
                var middleContentBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
                ...
                if (this.parent.getFrozenMode() === _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .leftRight */ .U0) {
                    var frozenRightContentBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
            ...
            if (this.parent.frozenRows) {
                var frozenHeaderBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
            ...
            if (this.parent.frozenRows && this.parent.isFrozenGrid()) {
                var middleHeaderBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
                ...
                if (this.parent.getFrozenMode() === _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .leftRight */ .U0) {
                    var frozenRightHeaderBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
    ...
    Selection.prototype.showHideBorders = function (display, freeze) {
        if (this.bdrElement) {
            ...
            if (this.parent.isFrozenGrid()) {
                ...
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)(parentEle.querySelectorAll('.e-xlsel-top-border'), 'e-xlsel-top-border');
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)(parentEle.querySelectorAll('.e-xlsel-left-border'), 'e-xlsel-left-border');
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)(parentEle.querySelectorAll('.e-xlsel-right-border'), 'e-xlsel-right-border');
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)(parentEle.querySelectorAll('.e-xlsel-bottom-border'), 'e-xlsel-bottom-border');
                if (!freeze) {
    ...
    Selection.prototype.positionAFBorders = function () {
        ...
        var firstCellTop = endOff.top - stOff.top >= 0 && ((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.startAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .movableContent */ .S1) ||
            (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.startAFCell, 'e-frozencontent')) && this.isFirstRow(this.startAFCell) ? 1.5 : 0;
        var firstCellLeft = ((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.startAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .movableContent */ .S1) ||
            (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.startAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .movableHeader */ .eW)) && this.isFirstCell(this.startAFCell) ? 1 : 0;
        var rowHeight = this.isLastRow(this.endAFCell) && ((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.endAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .movableContent */ .S1) ||
            (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.endAFCell, 'e-frozencontent')) ? 2 : 0;
        ...
        var totalHeight = this.parent.element.clientHeight - (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getScrollBarWidth */ .F_)();
        ...
        var totalWidth = this.parent.element.clientWidth - (this.parent.height !== 'auto' ? (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getScrollBarWidth */ .F_)() : 0);
        ...
        if (!this.parent.enableRtl) {
            ...
            var scrolloffSet = ((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.startAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .movableContent */ .S1) ||
                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.startAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .movableHeader */ .eW)) ? stOff.right -
            ...
            if (parseInt(this.bdrAFTop.style.left, 10) < 0) {
                ...
                if (this.parent.height !== 'auto' && (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getScrollBarWidth */ .F_)()) {
                    this.bdrAFTop.style.left = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getScrollBarWidth */ .F_)() + 'px';
                    this.bdrAFTop.style.width = (parseInt(this.bdrAFTop.style.width, 10) - (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getScrollBarWidth */ .F_)()) + 'px';
                }
                else {
    ...
    Selection.prototype.createAFBorders = function () {
        if (!this.bdrAFLeft) {
            var leftSelectionBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
            ...
            var rightSelectionBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
            ...
            var bottomSelectionBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
            ...
            var topSelectionBorder = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
    ...
    Selection.prototype.createBeforeAutoFill = function (rowIndex, colIndex, cell) {
        ...
        this.parent.trigger(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .beforeAutoFill */ .mKl, args);
        return args;
    };
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    Selection.prototype.selectLikeAutoFill = function (e, isApply) {
        var startrowIdx = parseInt((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.startAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .row */ .nM).getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
        var startCellIdx = parseInt(this.startAFCell.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
        var endrowIdx = parseInt((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.endAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .row */ .nM).getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
        var endCellIdx = parseInt(this.endAFCell.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
        ...
        switch (true) { //direction
            case !isApply && this.endAFCell.classList.contains('e-cellselectionbackground') &&
                !!(0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt):
            ...
            case this.autoFillRLselection && startCellIdx + colLen < endCellIdx && //right
                ...
                endrowIdx = parseInt((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.endAFCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .row */ .nM).getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
                endCellIdx = parseInt(this.endAFCell.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
                if (!isApply) {
                    this.drawAFBorders();
                }
                else {
                    var cellIdx = parseInt(this.endCell.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
            ...
            case startrowIdx > endrowIdx: //up
                ...
                if (!isApply) {
                    ...
                    var trIdx = parseInt(this.endCell.parentElement.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
                    var r = trIdx;
    ...
    Selection.prototype.mouseUpHandler = function (e) {
        ...
        if (this.element && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.element.parentElement)) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .remove */ .TF)(this.element);
        }
        if (this.isDragged && this.selectedRowCellIndexes.length === 1 && this.selectedRowCellIndexes[0].cellIndexes.length === 1) {
            this.mUPTarget = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt);
        }
        else {
            this.mUPTarget = null;
        }
        var closeRowCell = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(e.target, '.e-rowcell');
        if (this.isDragged && !this.isAutoFillSel && this.selectionSettings.mode === 'Cell' &&
            closeRowCell && closeRowCell.classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt)) {
            var rowIndex = parseInt(closeRowCell.parentElement.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
            var cellIndex = parseInt(closeRowCell.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
        ...
        if (this.isAutoFillSel) {
            this.preventFocus = true;
            var lastCell = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt);
            this.endAFCell = lastCell ? lastCell : this.endCell === this.endAFCell ? this.startAFCell : this.endAFCell;
            this.startAFCell = this.startCell;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.endAFCell) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.startAFCell)) {
                ...
                if (this.parent.aggregates.length > 0) {
                    this.parent.notify(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .refreshFooterRenderer */ .whj, {});
                }
            }
            this.isAutoFillSel = false;
            this.preventFocus = false;
        }
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.getContent(), 'mousemove', this.mouseMoveHandler);
        if (this.parent.frozenRows) {
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.getHeaderContent(), 'mousemove', this.mouseMoveHandler);
        }
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(document, 'mouseup', this.mouseUpHandler);
    };
    ...
    Selection.prototype.updateAutoFillPosition = function () {
        if (this.parent.enableAutoFill && !this.parent.isEdit &&
            ...
            var index = parseInt(this.target.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
            ...
            var isFrozenRight = this.parent.getFrozenMode() === _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .leftRight */ .U0
                && col.getFreezeTableName() === _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .frozenRight */ .Xg;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Lt)('#' + this.parent.element.id + '_autofill', (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .table */ .tp))) {
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Lt)('#' + this.parent.element.id + '_autofill', this.parent.element)) {
                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Lt)('#' + this.parent.element.id + '_autofill', this.parent.element).remove();
                }
                this.autofill = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-autofill', id: this.parent.element.id + '_autofill' });
                this.autofill.style.display = 'none';
    ...
    Selection.prototype.mouseDownHandler = function (e) {
        ...
        var gObj = this.parent;
        var isDrag;
        var gridElement = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, 'e-grid');
        if (gridElement && gridElement.id !== gObj.element.id || (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .headerContent */ .VW) && !this.parent.frozenRows ||
            (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, 'e-editedbatchcell') || (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .editedRow */ .QF)) {
            return;
        }
        if (e.shiftKey || e.ctrlKey) {
            e.preventDefault();
        }
        if ((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt) && !e.shiftKey && !e.ctrlKey) {
            if (gObj.selectionSettings.cellSelectionMode.indexOf('Box') > -1 && !this.isRowType() && !this.isSingleSel()) {
                ...
                this.isRowDragSelected = false;
                if (!this.isRowType() || this.isSingleSel() || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(target, 'td').classList.contains('e-selectionbackground')) {
                    this.isDragged = false;
                    return;
                }
                isDrag = true;
    ...
    Selection.prototype.updateStartEndCells = function () {
        ...
        if (this.startCell) {
            this.startIndex = parseInt(this.startCell.parentElement.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
            this.startCellIndex = parseInt((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(this.startCell, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt).getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
        }
    };
    ...
    Selection.prototype.enableDrag = function (e, isUpdate) {
        ...
        if (isUpdate) {
            ...
            this.startDIndex = parseInt(tr.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
            this.startDCellIndex = parseInt((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt)
                .getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
        }
        document.body.classList.add('e-disableuserselect');
        var gBRect = gObj.element.getBoundingClientRect();
        var postion = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .getPosition */ .E9)(e);
        this.x = postion.x - gBRect.left;
        this.y = postion.y - gBRect.top;
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(gObj.getContent(), 'mousemove', this.mouseMoveHandler, this);
        if (this.parent.frozenRows) {
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(gObj.getHeaderContent(), 'mousemove', this.mouseMoveHandler, this);
        }
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(document, 'mouseup', this.mouseUpHandler, this);
    };
    ...
    Selection.prototype.addEventListener = function () {
        ...
        this.evtHandlers = [{ event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .uiUpdate */ .yPb, handler: this.enableAfterRender },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .initialEnd */ .qOR, handler: this.initializeSelection },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowSelectionComplete */ .m0l, handler: this.onActionComplete },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellSelectionComplete */ .kYU, handler: this.onActionComplete },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .inBoundModelChanged */ .$HR, handler: this.onPropertyChanged },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .cellFocused */ .uJh, handler: this.onCellFocused },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .beforeFragAppend */ .IcQ, handler: this.clearSelAfterRefresh },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .columnPositionChanged */ .QzQ, handler: this.columnPositionChanged },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .contentReady */ .PRb, handler: this.initialEnd },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .rowsRemoved */ .Osn, handler: this.rowsRemoved },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .headerRefreshed */ .CRr, handler: this.refreshHeader },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .destroyAutoFillElements */ .CZS, handler: this.destroyAutoFillElements },
            { event: _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .destroy */ .zrj, handler: this.destroy }];
        (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveEventListener */ .yc)(this.parent, this.evtHandlers, true, this);
        this.actionBeginFunction = this.actionBegin.bind(this);
        this.actionCompleteFunction = this.actionComplete.bind(this);
        this.parent.addEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .actionBegin */ .eYd, this.actionBeginFunction);
        this.parent.addEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .actionComplete */ .wn6, this.actionCompleteFunction);
    ...
    Selection.prototype.removeEventListener = function () {
        ...
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.getContent(), 'mousedown', this.mouseDownHandler);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.getHeaderContent(), 'mousedown', this.mouseDownHandler);
        (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveEventListener */ .yc)(this.parent, this.evtHandlers, false);
        this.parent.removeEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .actionBegin */ .eYd, this.actionBeginFunction);
        this.parent.removeEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .actionComplete */ .wn6, this.actionCompleteFunction);
        this.removeEventListener_checkbox();
        this.parent.off(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .destroyAutoFillElements */ .CZS, this.destroyAutoFillElements);
    };
    Selection.prototype.wireEvents = function () {
        this.isMacOS = navigator.userAgent.indexOf('Mac OS') !== -1;
        if (this.isMacOS) {
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.parent.element, 'keydown', this.keyDownHandler, this);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.parent.element, 'keyup', this.keyUpHandler, this);
        }
        else {
    ...
    Selection.prototype.unWireEvents = function () {
        if (this.isMacOS) {
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.element, 'keydown', this.keyDownHandler);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.element, 'keyup', this.keyUpHandler);
        }
        else {
            if (!this.parent.allowKeyboard) {
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.parent.element, 'keydown', this.keyDownHandler);
    ...
    Selection.prototype.render = function (e) {
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.parent.getContent(), 'mousedown', this.mouseDownHandler, this);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.parent.getHeaderContent(), 'mousedown', this.mouseDownHandler, this);
    };
    Selection.prototype.onPropertyChanged = function (e) {
        ...
        var gObj = this.parent;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(e.properties.type)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(e.properties.mode) ||
            !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(e.properties.cellSelectionMode)) {
            this.clearSelection();
            this.prevRowIndex = undefined;
            this.prevCIdxs = undefined;
            this.prevColIndex = undefined;
    ...
    Selection.prototype.initialEnd = function () {
        if (!this.selectedRowIndexes.length) {
            this.parent.off(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .contentReady */ .PRb, this.initialEnd);
            this.selectRow(this.parent.selectedRowIndex);
        }
    };
    Selection.prototype.checkBoxSelectionChanged = function () {
        var gobj = this.parent;
        gobj.off(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .contentReady */ .PRb, this.checkBoxSelectionChanged);
        ...
        if (checkboxColumn.length > 0) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.totalRecordsCount)) {
    ...
    Selection.prototype.ensureCheckboxFieldSelection = function () {
        ...
        if (!gobj.enableVirtualization && this.chkField
            ...
            this.dataSuccess((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.dataSource) && this.parent.dataSource.result) ||
    ...
    Selection.prototype.dataSuccess = function (res) {
        for (var i = 0; i < res.length; i++) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.selectedRowState["" + pkValue]) && checkedFieldData && typeof checkedFieldData === 'boolean') {
    ...
    Selection.prototype.setRowSelection = function (state) {
        if (!(this.parent.getDataModule().isRemote() || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.dataSource)
            ...
            if (state) {
                ...
                if (!this.isCheckboxReset) {
                    ...
                    for (var _d = 0, rowData_1 = rowData; _d < rowData_1.length; _d++) {
                        ...
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(data[this.primaryKey])) {
    ...
    Selection.prototype.getAvailableSelectedData = function (data) {
        var filteredSearchedSelectedData = new _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__/* .DataManager */ .M(data).executeLocal(this.parent.getDataModule().generateQuery(true));
    ...
    Selection.prototype.refreshPersistSelection = function () {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(rows) && rows.length > 0 && (this.parent.isPersistSelection || this.chkField)) {
            var indexes = [];
            for (var j = 0; j < rows.length; j++) {
                ...
                if (this.selectedRowState["" + pKey] || (this.parent.checkAllRows === 'Check' && this.selectedRowState["" + pKey] &&
                    ...
                    || (this.parent.checkAllRows === 'Intermediate' && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.chkField) && rowObj.data[this.chkField])) {
                    indexes.push(parseInt(rows[parseInt(j.toString(), 10)].getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1);
                    checkState = true;
                }
                else {
                    checkState = false;
                    if (this.checkedTarget !== chkBox && this.parent.isCheckBoxSelection && chkBox) {
                        (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .removeAddCboxClasses */ .Cd)(chkBox.nextElementSibling, checkState);
                    }
                }
    ...
    Selection.prototype.actionBegin = function (e) {
        if (e.requestType === 'save' && this.parent.isPersistSelection) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(editChkBox)) {
                var row = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(editChkBox, '.' + _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .editedRow */ .QF);
                if (row) {
        ...
        if (this.parent.isPersistSelection && this.isPartialSelection) {
            if (e.requestType === 'paging' && (this.parent.getDataModule().isRemote()
                || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.dataSource) && this.parent.dataSource.result))) {
                this.selectedRowIndexes = [];
            }
        }
    };
    Selection.prototype.actionComplete = function (e) {
        ...
        if (e.requestType === 'delete' && this.parent.isPersistSelection) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pkValue)) {
    ...
    Selection.prototype.updatePersistSelectedData = function (checkState) {
        ...
        if (this.parent.isPersistSelection) {
            ...
            if (this.parent.checkAllRows === 'Check' && (this.parent.searchSettings.key.length > 0
                ...
                && !(this.parent.getDataModule().isRemote() || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.dataSource)
    ...
    Selection.prototype.checkSelectAllAction = function (checkState) {
        ...
        this.chkAllCollec = [];
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(editForm)) {
            var editChkBox = editForm.querySelector('.e-edit-checkselect');
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(editChkBox)) {
                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .removeAddCboxClasses */ .Cd)(editChkBox.nextElementSibling, checkState);
            }
        }
    };
    Selection.prototype.checkSelectAll = function (checkBox) {
        ...
        if (stateStr === 'Intermediate') {
            ...
            if (this.parent.isPersistSelection) {
                ...
                else if ((this.parent.getDataModule().isRemote() || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.dataSource)
                    && this.parent.dataSource.result))) {
                    for (var i = 0; i < this.getCurrentBatchRecordChanges().length; i++) {
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.getPkValue(this.primaryKey, this.getCurrentBatchRecordChanges()["" + i]))) {
                            // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    Selection.prototype.getCheckAllStatus = function (ele) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(ele)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.getCheckAllBox())) {
    ...
    Selection.prototype.checkSelect = function (checkBox) {
        var target = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(this.checkedTarget, '.' + _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt);
        var gObj = this.parent;
        this.isMultiCtrlRequest = true;
        var rIndex = 0;
        this.isHeaderCheckboxClicked = false;
        if ((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .isGroupAdaptive */ .Gj)(gObj)) {
            ...
            if (this.parent.enableVirtualization && this.parent.groupSettings.columns.length) {
                rIndex = parseInt(target.parentElement.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3), 10) - 1;
            }
            else {
        ...
        if (this.parent.isPersistSelection && this.parent.element.getElementsByClassName(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .addedRow */ .jm).length > 0 &&
            this.parent.editSettings.newRowPosition === 'Top' && !this.parent.editSettings.showAddNewRow) {
            ++rIndex;
        }
        this.rowCellSelectionHandler(rIndex, parseInt(target.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1);
        this.moveIntoUncheckCollection((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(target, '.' + _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .row */ .nM));
        this.setCheckAllState();
        this.isMultiCtrlRequest = false;
    ...
    Selection.prototype.triggerChkChangeEvent = function (checkBox, checkState) {
        this.parent.trigger(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .checkBoxChange */ .OK6, {
    ...
    Selection.prototype.updateSelectedRowIndexes = function () {
        if (this.parent.isCheckBoxSelection && (this.parent.enableVirtualization || this.parent.enableInfiniteScrolling) &&
            this.isPartialSelection && !(this.parent.getDataModule().isRemote() || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.dataSource)
            && this.parent.dataSource.result))
    ...
    Selection.prototype.setCheckAllState = function (index, isInteraction) {
        if (this.parent.isCheckBoxSelection || this.parent.selectionSettings.checkboxMode === 'ResetOnRowClick') {
            ...
            if (input) {
                ...
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)([spanEle], ['e-check', 'e-stop', 'e-uncheck']);
                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .setChecked */ .Go)(input, false);
                ...
                if ((checkToSelectAll && isFiltered && (this.parent.getDataModule().isRemote() ||
                    ...
                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .addClass */ .iQ)([spanEle], ['e-check']);
                    (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .setChecked */ .Go)(input, true);
                    if (isInteraction) {
                    ...
                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .addClass */ .iQ)([spanEle], ['e-uncheck']);
                    if (isInteraction) {
                    ...
                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .addClass */ .iQ)([spanEle], ['e-stop']);
                    this.parent.checkAllRows = 'Intermediate';
                    input.indeterminate = true;
                }
                if (checkedLen === 0 && this.getCurrentBatchRecordChanges().length === 0) {
                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .addClass */ .iQ)([spanEle.parentElement], ['e-checkbox-disabled']);
                }
                else {
                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)([spanEle.parentElement], ['e-checkbox-disabled']);
                }
                if (this.isPartialSelection) {
    ...
    Selection.prototype.checkVirtualCheckBox = function () {
        return this.parent.enableVirtualization && !(this.parent.getDataModule().isRemote() || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.dataSource)
    ...
    Selection.prototype.isSelectAllRowCount = function (count) {
        ...
        if (this.parent.selectionSettings.persistSelection && (this.parent.enableVirtualization || this.parent.enableInfiniteScrolling)) {
            var dataLen = (this.parent.getDataModule().isRemote() || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.dataSource)
                && this.parent.dataSource.result)) ?
    ...
    Selection.prototype.keyDownHandler = function (e) {
        ...
        if ((_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.info.name === 'opera' && e.keyCode === 17) || (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.info.name === 'mozilla' && e.keyCode === 224) ||
            (((_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.info.name === 'safari') || (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.info.name === 'chrome')) && (e.keyCode === 91 || e.keyCode === 93))) {
            this.cmdKeyPressed = true;
        }
        var targetHeadCell = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.target, 'e-headercell');
        var targetRowCell = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt);
    ...
    Selection.prototype.clickHandler = function (e) {
        ...
        if ((0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .row */ .nM) || (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, 'e-headerchkcelldiv') ||
        ...
        this.preventFocus = true;
        var checkBox;
        var checkWrap = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, 'e-checkbox-wrapper');
        this.checkSelectAllClicked = checkWrap && checkWrap.getElementsByClassName('e-checkselectall') ||
            (this.selectionSettings.persistSelection && (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .row */ .nM)) ? true : false;
        if (this.selectionSettings.persistSelection && this.isPartialSelection && (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, 'e-headerchkcelldiv')
        ...
        this.drawBorders();
        this.updateAutoFillPosition();
        target = (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(target, _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt);
        ...
        if (this.isRowDragSelected && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(target) && this.parent.allowRowDragAndDrop &&
            this.selectionSettings.persistSelection && this.checkSelectAllClicked) {
            this.isRowDragSelected = false;
        }
        if (((target && target.parentElement.classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .row */ .nM) && !this.parent.selectionSettings.checkboxOnly) || chkSelect)
            && !this.isRowDragSelected) {
            if (this.parent.isCheckBoxSelection) {
                this.isMultiCtrlRequest = true;
            }
            this.target = target;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBox)) {
                ...
                if (this.parent.isPersistSelection && !this.parent.editSettings.showAddNewRow
                    && this.parent.element.getElementsByClassName(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .addedRow */ .jm).length > 0) {
                    ++rIndex;
                }
            ...
            if (!this.parent.isCheckBoxSelection && _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !this.isSingleSel()) {
                this.showPopup(e);
            }
        }
        ...
        this.isMultiCtrlRequestCell = this.isMultiCtrlRequest;
        this.isMultiShiftRequest = false;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(e.target, '.e-unboundcell'))) {
            this.preventFocus = false;
        }
    };
    Selection.prototype.popUpClickHandler = function (e) {
        var target = e.target;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(target, '.e-headercell') || e.target.classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt) ||
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(target, '.e-gridpopup')) {
    ...
    Selection.prototype.showPopup = function (e) {
        if (!this.selectionSettings.enableSimpleMultiRowSelection) {
            (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .setCssInGridPopUp */ .TJ)(this.parent.element.querySelector('.e-gridpopup'), e, 'e-rowselect e-icons e-icon-rowselect' +
    ...
    Selection.prototype.rowCellSelectionHandler = function (rowIndex, cellIndex) {
        if ((!this.isMultiCtrlRequest && !this.isMultiShiftRequest) || this.isSingleSel()) {
            ...
            var isChkBox = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(this.target, '.' + _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt).classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .gridChkBox */ .yM);
            if (this.parent.isCheckBoxSelection || (!this.parent.isCheckBoxSelection && !isChkBox)
                ...
                this.selectRowsByRange((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isUndefined */ .b0)(this.prevRowIndex) ? rowIndex : this.prevRowIndex, rowIndex);
            }
            else {
                this.addRowsToSelection([rowIndex]);
            }
            this.selectCellsByRange((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isUndefined */ .b0)(this.prevCIdxs) ? { rowIndex: rowIndex, cellIndex: cellIndex } : this.prevCIdxs, { rowIndex: rowIndex, cellIndex: cellIndex });
            this.updateAutoFillPosition();
            this.drawBorders();
        }
        else {
    ...
    Selection.prototype.onCellFocused = function (e) {
        if (this.parent.frozenRows && e.container.isHeader && e.byKey) {
            if (e.keyArgs.action === 'upArrow') {
                ...
                if (e.keyArgs.action === 'downArrow') {
                    var rIdx = Number(e.element.parentElement.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaRowIndex */ .E3)) - 1;
        ...
        var headerAction = (e.container.isHeader && e.element.tagName !== 'TD' && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(e.element, '.' + _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt))
        ...
        if (this.parent.frozenRows) {
            if (e.container.isHeader && (e.element.tagName === 'TD' || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(e.element, '.' + _base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt))) {
                ...
                rowIndex -= hdrLength;
                prev.rowIndex = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(prev.rowIndex) ? prev.rowIndex - hdrLength : null;
            }
            else {
                rowIndex += this.parent.frozenRows;
                prev.rowIndex = prev.rowIndex === 0 || !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(prev.rowIndex) ? prev.rowIndex + this.parent.frozenRows : null;
            }
        }
    ...
    Selection.prototype.getKeyColIndex = function (e) {
        ...
        if (this.selectionSettings.allowColumnSelection && (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .parentsUntil */ .oC)(e.element, 'e-columnheader')) {
            ...
            if (stackedHeader) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(e.element.querySelector('.e-headercelldiv'))) {
    ...
    Selection.prototype.applyUpDown = function (rowIndex) {
        ...
        var cIndex = parseInt(this.target.getAttribute(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .ariaColIndex */ .ql), 10) - 1;
        var row = this.contentRenderer.getRowByIndex(rowIndex);
        if (row) {
            this.target = row.getElementsByClassName(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt)[parseInt(cIndex.toString(), 10)];
        }
    ...
    Selection.prototype.shiftDownKey = function (rowIndex, cellIndex) {
        ...
        if (this.isRowType() && !this.isSingleSel()) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isUndefined */ .b0)(this.prevRowIndex)) {
    ...
    Selection.prototype.addRemoveClassesForRow = function (row, isAdd, clearAll) {
        ...
        if (row) {
            var cells = [].slice.call(row.getElementsByClassName(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .rowCell */ .Jt));
            ...
            _base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveActiveClasses */ .yR.apply(void 0, [cells, isAdd].concat(args));
        }
    ...
    Selection.prototype.getRenderer = function () {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.contentRenderer)) {
            this.contentRenderer = this.factory.getRenderer(_base_enum__WEBPACK_IMPORTED_MODULE_5__/* .RenderType */ .nJ.Content);
        }
    ...
    Selection.prototype.selectColumn = function (index) {
        var gObj = this.parent;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(gObj.getColumns()[parseInt(index.toString(), 10)])) {
            return;
        }
        ...
        if (!this.selectionSettings.enableToggle || isMultiColumns || !isColSelected) {
            ...
            this.onActionBegin(args, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .columnSelecting */ .fvJ);
            if (args.cancel) {
                this.disableInteracted();
                return;
            }
            ...
            this.onActionComplete(selectedArgs, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .columnSelected */ .Q0g);
        }
    ...
    Selection.prototype.selectColumnsByRange = function (startIndex, endIndex) {
        var gObj = this.parent;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(gObj.getColumns()[parseInt(startIndex.toString(), 10)])) {
            return;
        }
        var indexes = [];
        if (gObj.selectionSettings.type === 'Single' || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(endIndex)) {
    ...
    Selection.prototype.selectColumns = function (columnIndexes) {
        ...
        this.onActionBegin(selectingArgs, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .columnSelecting */ .fvJ);
    ...
    Selection.prototype.clearColumnSelection = function (clearIndex) {
        if (this.isColumnSelected) {
            var gObj = this.parent;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(clearIndex) && this.selectedColumnsIndexes.indexOf(clearIndex) === -1) {
                return;
            }
            var index = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(clearIndex) ? clearIndex :
            ...
            var isCanceled = this.columnDeselect(deselectedArgs, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .columnDeselecting */ .MLr);
            if (isCanceled) {
                this.disableInteracted();
                return;
            }
            var selectedHeader = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(clearIndex) ? [selectedCol] :
            ...
            for (var i = 0, len = selectedHeader.length; i < len; i++) {
                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveActiveClasses */ .yR)([selectedHeader[parseInt(i.toString(), 10)]], false, 'e-columnselection');
            }
            for (var i = 0, len = selectedCells.length; i < len; i++) {
                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveActiveClasses */ .yR)([selectedCells[parseInt(i.toString(), 10)]], false, 'e-columnselection');
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(clearIndex)) {
                ...
                this.columnDeselect(deselectedArgs, _base_constant__WEBPACK_IMPORTED_MODULE_3__/* .columnDeselected */ .zTL);
                this.selectedColumnsIndexes = [];
    ...
    Selection.prototype.getSelectedColumnCells = function (clearIndex) {
        var gObj = this.parent;
        var isRowTemplate = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.rowTemplate);
        var rows = isRowTemplate ? gObj.getRows() : gObj.getDataRows();
        var seletedcells = [];
        var selectionString = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(clearIndex) ? '[aria-colindex="' + (clearIndex + 1) + '"]' : '.e-columnselection';
        for (var i = 0, len = rows.length; i < len; i++) {
    ...
    Selection.prototype.updateColSelection = function (selectedCol, startIndex) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.getColumns()[parseInt(startIndex.toString(), 10)])) {
            return;
        }
        var isRowTemplate = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.rowTemplate);
        ...
        (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveActiveClasses */ .yR)([selectedCol], true, 'e-columnselection');
        for (var j = 0, len = rows.length; j < len; j++) {
            if (rows[parseInt(j.toString(), 10)].classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .row */ .nM)) {
                if ((rows[parseInt(j.toString(), 10)].classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .editedRow */ .QF)
                    || rows[parseInt(j.toString(), 10)].classList.contains(_base_string_literals__WEBPACK_IMPORTED_MODULE_1__/* .addedRow */ .jm))
                    && this.parent.editSettings.mode === 'Normal'
                    && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(rows[parseInt(j.toString(), 10)].querySelector('tr').childNodes[parseInt(startIndex.toString(), 10)])) {
                    (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveActiveClasses */ .yR)([rows[parseInt(j.toString(), 10)].querySelector('tr').childNodes[parseInt(startIndex.toString(), 10)]], true, 'e-columnselection');
                }
                else {
                    if (this.parent.isSpan && this.parent.isFrozenGrid()) {
                        ...
                        for (var i = 0; i < cells.length; i++) {
                            if (cells[parseInt(i.toString(), 10)].getAttribute('aria-colindex') === selectedCol.getAttribute('aria-colindex')) {
                                (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveActiveClasses */ .yR)([cells[parseInt(i.toString(), 10)]], true, 'e-columnselection');
                            }
                        }
                    }
                    else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(rows[parseInt(j.toString(), 10)].childNodes[parseInt(startIndex.toString(), 10)])) {
                        (0,_base_util__WEBPACK_IMPORTED_MODULE_2__/* .addRemoveActiveClasses */ .yR)([rows[parseInt(j.toString(), 10)].childNodes[parseInt(startIndex.toString(), 10)]], true, 'e-columnselection');
                    }
                }
            }
        }
    ...
    Selection.prototype.headerSelectionHandler = function (colIndex) {
        if ((!this.isMultiCtrlRequest && !this.isMultiShiftRequest) || this.isSingleSel()) {
            ...
            this.selectColumnsByRange((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isUndefined */ .b0)(this.prevColIndex) ? colIndex : this.prevColIndex, colIndex);
        }
        else {
    ...
    Selection.prototype.addEventListener_checkbox = function () {
        var _this = this;
        this.parent.on(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .dataReady */ .yUO, this.dataReady, this);
        this.onDataBoundFunction = this.onDataBound.bind(this);
        this.parent.addEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .dataBound */ .BPR, this.onDataBoundFunction);
        this.parent.on(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .refreshInfinitePersistSelection */ .UqJ, this.onDataBoundFunction);
        this.parent.on(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .contentReady */ .PRb, this.checkBoxSelectionChanged, this);
        this.parent.on(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .beforeRefreshOnDataChange */ .eAe, this.initPerisistSelection, this);
        this.parent.on(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .onEmpty */ .DjW, this.setCheckAllForEmptyGrid, this);
        this.actionCompleteFunc = this.actionCompleteHandler.bind(this);
        this.parent.addEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .actionComplete */ .wn6, this.actionCompleteFunc);
        this.parent.on(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .click */ .jMr, this.clickHandler, this);
        this.resizeEndFn = function () {
            _this.updateAutoFillPosition();
            _this.drawBorders();
        };
        this.resizeEndFn.bind(this);
        this.parent.addEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .resizeStop */ .D5n, this.resizeEndFn);
    };
    // eslint-disable-next-line camelcase
    Selection.prototype.removeEventListener_checkbox = function () {
        this.parent.off(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .dataReady */ .yUO, this.dataReady);
        this.parent.removeEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .dataBound */ .BPR, this.onDataBoundFunction);
        this.parent.removeEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .actionComplete */ .wn6, this.actionCompleteFunc);
        this.parent.off(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .refreshInfinitePersistSelection */ .UqJ, this.onDataBoundFunction);
        this.parent.off(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .onEmpty */ .DjW, this.setCheckAllForEmptyGrid);
        this.parent.off(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .click */ .jMr, this.clickHandler);
        this.parent.removeEventListener(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .resizeStop */ .D5n, this.resizeEndFn);
        this.parent.off(_base_constant__WEBPACK_IMPORTED_MODULE_3__/* .beforeRefreshOnDataChange */ .eAe, this.initPerisistSelection);
    };
    ...
    Selection.prototype.selectRowIndex = function (index) {
        ...
        if (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.parent.selectedRowIndex) || this.parent.selectedRowIndex === -1) || !this.parent.enablePersistence) {
...
//# sourceMappingURL=51ee8d5d-7a07fffc1c6a86fc.js.map