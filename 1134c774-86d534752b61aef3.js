"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[7171],{

/***/ 84996:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   g: () => (/* binding */ FormDesigner)
/* harmony export */ });
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(63037);
/* harmony import */ var _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(75443);
/* harmony import */ var _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(50699);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(28696);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(99320);
/* harmony import */ var _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(6720);
/* harmony import */ var _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(14629);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(34794);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(34286);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(90158);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(31376);
/* harmony import */ var _syncfusion_ej2_dropdowns__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(73941);
/* harmony import */ var _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(57266);
/* harmony import */ var _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(1716);
/* harmony import */ var _base_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(50474);
/* harmony import */ var _drawing_drawing_util__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(38819);
/* harmony import */ var _syncfusion_ej2_pdf__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(23436);
/* harmony import */ var _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28929);
...
var FormDesigner = /** @class */ (function () {
    ...
    FormDesigner.prototype.drawHTMLContent = function (formFieldAnnotationType, element, drawingObject, pageIndex, commandHandler, fieldId, isAddedProgrammatically, action) {
        ...
        if (formFieldElement === null && element !== null && canvasElement !== null && textLayer) {
            ...
            if (formFieldAnnotationType === 'Checkbox' && (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice)) {
                ...
                var outerDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', outerDivAttribute);
            ...
            var point = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(element).topLeft;
            if (formFieldAnnotationType === 'Checkbox' && (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice)) {
            ...
            if (formFieldAnnotationType === 'SignatureField' || formFieldAnnotationType === 'InitialField') {
                if (drawingObject.value && action !== 'Addition') {
                    ...
                    var value = void 0;
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.nameTable["" + elementId])) {
                    ...
                    if (radiobutton.radiobuttonItem && currentData.FormField.radiobuttonItem) {
                        for (var m = 0; m < currentData.FormField.radiobuttonItem.length; m++) {
                            if (currentData.FormField.radiobuttonItem[parseInt(m.toString(), 10)].id === radiobutton.id) {
                                ...
                                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewerBase.formFieldCollection[parseInt(i.toString(), 10)])) {
    ...
    FormDesigner.prototype.getRgbCode = function (colorString) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(stringArray[1])) {
    ...
    FormDesigner.prototype.rgbToHsv = function (r, g, b, opacity) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(opacity)) {
            hsv.push(opacity);
        }
        return hsv;
    };
    ...
    FormDesigner.prototype.rgbToHex = function (rgb) {
        return rgb.length ? ('#' + this.hex(rgb[0]) + this.hex(rgb[1]) + this.hex(rgb[2]) +
            (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(rgb[3]) ? (rgb[3] !== 0 ? (Math.round(rgb[3] * 255) + 0x10000).toString(16).substr(-2) : '00') : '')) : '';
    };
    /**
    ...
    FormDesigner.prototype.updateCanvas = function (pageNumber, canvas) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(canvas)) {
                                ...
                                if (currentData.formFieldAnnotationType === 'RadioButton') {
                                    ...
                                    if (currentData.formFieldAnnotationType === 'SignatureField' || currentData.formFieldAnnotationType === 'InitialField') {
                                        ...
                                        formFieldsData.filter(function (item) {
                                            if (item.FormField.name === currentData.name && item.FormField.id !== currentData.id && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(proxy_1.pdfViewer.nameTable[item.FormField.id]) && proxy_1.pdfViewer.nameTable[item.FormField.id].value !== '') {
                                        ...
                                        if (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(proxy_1.pdfViewer.nameTable[currentData.id])
                                    ...
                                    if (currentData.signatureBound) {
                                        ...
                                        if ((currentData.formFieldAnnotationType === 'SignatureField' || currentData.formFieldAnnotationType === 'InitialField') && currentData.signatureType === 'Image' && signatureValueRender) {
                                            setTimeout(function () {
                                                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.pdfViewer.nameTable[element_1.id.split('_')[0] + '_content'])) {
                                                    _this.pdfViewer.nameTable[element_1.id.split('_')[0] + '_content'].signatureBound = currentData.signatureBound;
                                                }
                                            }, 10);
                                        }
                                        else {
                                            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this_1.pdfViewer.nameTable[element_1.id.split('_')[0] + '_content'])) {
    ...
    FormDesigner.prototype.renderFormFieldsInZooming = function (element, currentData, signatureField, zoomValue) {
        if (element) {
            ...
            var point = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(signatureField.wrapper.children[0]).topLeft;
            if (currentData.formFieldAnnotationType === 'Checkbox' && (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice)) {
    ...
    */
    ...
    FormDesigner.prototype.updateHTMLElement = function (actualObject) {
        ...
        if (element) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(htmlElement)) {
                var point = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(actualObject.wrapper.children[0]).topLeft;
                htmlElement.style.cssText = "height: " + element.actualSize.height * zoomValue + "px;\n                width: " + element.actualSize.width * zoomValue + "px;left: " + point.x * zoomValue + "px;top: " + point.y * zoomValue + "px;\n                position: absolute;transform: rotate(" + (element.rotateAngle + element.parentTransform) + "deg);\n                pointer-events: " + (this.pdfViewer.designerMode ? 'none' : 'all') + ";visibility: " + (element.visible ? 'visible' : 'hidden') + ";\n                opacity: " + element.style.opacity + ";";
                var data = this.pdfViewerBase.getItemFromSessionStorage('_formDesigner');
    ...
    FormDesigner.prototype.createSignatureDialog = function (commandHandler, signatureField, bounds, isPrint) {
        this.isInitialField = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureField.isInitialField) ? false : signatureField.isInitialField;
        this.pdfViewerBase.isInitialField = this.isInitialField;
        this.pdfViewerBase.isInitialField = signatureField.isInitialField;
        var element = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div');
        ...
        var divElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div');
        divElement.style.width = '100%';
        divElement.style.height = '100%';
        divElement.style.position = 'absolute';
        divElement.style.backgroundColor = 'transparent';
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureField.thickness)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureField.value) && signatureField.value !== '') {
            divElement.className = 'e-pdfviewer-signatureformfields-signature';
        ...
        if (!signatureFieldSettings.signatureDialogSettings) {
            signatureFieldSettings.signatureDialogSettings =
                { displayMode: _base_types__WEBPACK_IMPORTED_MODULE_2__/* .DisplayMode */ .q5.Draw | _base_types__WEBPACK_IMPORTED_MODULE_2__/* .DisplayMode */ .q5.Text | _base_types__WEBPACK_IMPORTED_MODULE_2__/* .DisplayMode */ .q5.Upload, hideSaveSignature: false };
        }
        ...
        var spanElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span');
        if (!initialFieldSettings.initialIndicatorSettings) {
            initialFieldSettings.initialIndicatorSettings = { opacity: 1, backgroundColor: 'orange', width: 19, height: 10, fontSize: 10, text: null, color: 'black' };
        }
        if (!initialFieldSettings.initialDialogSettings) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureField.tooltip) && signatureField.tooltip !== '') {
    ...
    FormDesigner.prototype.updateSignatureandInitialIndicator = function (formFieldObject, options, htmlElement) {
        if (htmlElement !== null) {
            ...
            if (indicatorSettings && objIndicatorSettings) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(indicatorSettings.opacity)) {
                    spanElement.style.opacity = indicatorSettings.opacity;
    ...
    FormDesigner.prototype.createDropDownList = function (dropdownElement, drawingObject, isPrint) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(drawingObject.selectedIndex) || drawingObject.selectedIndex.length === 0) {
            select.selectedIndex = -1;
        }
        else {
            select.selectedIndex = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(drawingObject.selectedIndex) ? drawingObject.selectedIndex : 0;
        }
        element.appendChild(select);
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(drawingObject.tooltip) && drawingObject.tooltip !== '') {
    ...
    FormDesigner.prototype.createListBox = function (listBoxElement, drawingObject, isPrint) {
        ...
        for (var j = 0; j < dropDownChildren.length; j++) {
            ...
            option.value = dropDownChildren[parseInt(j.toString(), 10)].itemValue;
            option.text = dropDownChildren[parseInt(j.toString(), 10)].itemName;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(drawingObject.selectedIndex)) {
    ...
    FormDesigner.prototype.createInputElement = function (formFieldAnnotationType, drawingObject, formFieldBounds, isPrint) {
        ...
        var checkboxDiv;
        var innerSpan;
        var inputElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input');
        var textArea = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('textarea');
        ...
        if (formFieldAnnotationType === 'Textbox') {
            ...
            labelElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('label', { className: 'e-pv-checkbox-container' });
            ...
            checkboxDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-checkbox-div' });
            ...
            if (drawingObject.isChecked) {
                innerSpan = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { className: 'e-pv-checkbox-span e-pv-cb-checked' });
            }
            else {
                innerSpan = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { className: 'e-pv-checkbox-span e-pv-cb-unchecked' });
            }
            ...
            */
            ...
            var bounds = this.getCheckboxRadioButtonBounds(drawingObject, formFieldBounds, isPrint);
            element.style.display = bounds.display;
            labelElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('label', { className: 'e-pv-radiobtn-container' });
            ...
            innerSpan = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { className: 'e-pv-radiobtn-span' });
            innerSpan.id = drawingObject.id + '_input_span';
            ...
            if (formFieldsData[parseInt(i.toString(), 10)].Key.split('_')[0] === event.target.id.split('_')[0] ||
                ...
                if (this_6.pdfViewer.enableHtmlSanitizer) {
                    formFieldsData[parseInt(i.toString(), 10)].FormField.value =
                        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(formFieldsData[parseInt(i.toString(), 10)].FormField.value);
                }
    ...
    FormDesigner.prototype.updateFormFieldSessions = function (field) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(formFieldsDatas) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(field)) {
    ...
    FormDesigner.prototype.setTextBoxFontStyle = function (fontStyle) {
        return { isBold: (fontStyle & _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Bold) === _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Bold,
            isItalic: (fontStyle & _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Italic) === _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Italic,
            isStrikeout: (fontStyle & _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Strikethrough) === _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Strikethrough,
            isUnderline: (fontStyle & _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Underline) === _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Underline };
    };
    /**
    ...
    FormDesigner.prototype.addField = function (formFieldType, options, isCollection, id, isAddedProgrammatically) {
        var obj = {
            ...
            fontFamily: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontFamily) ? options.fontFamily : 'Helvetica', fontSize: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontSize) ? options.fontSize : 10,
            color: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.color) ? options.color : 'black', backgroundColor: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.backgroundColor) ? options.backgroundColor : '#daeaf7ff',
            alignment: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.alignment) ? options.alignment : 'left', isReadonly: options.isReadOnly ? options.isReadOnly : false, rotateAngle: options.rotateAngle ? options.rotateAngle : options.rotationAngle, isTransparent: options.isTransparent, insertSpaces: options.insertSpaces, isChecked: options.isChecked, isMultiline: options.isMultiline, isSelected: options.isSelected, options: options.options, selectedIndex: options.selectedIndex, signatureIndicatorSettings: options.signatureIndicatorSettings, signatureType: options.signatureType, zIndex: options.zIndex
        };
        obj.customData = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.customData) ? options.customData : '';
        obj.fontStyle = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontStyle) ? options.fontStyle : 'None';
        obj.visibility = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.visibility) ? options.visibility : 'visible';
        obj.value = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.value) ? options.value : '';
        obj.isRequired = options.isRequired ? options.isRequired : false;
        obj.isPrint = options.isPrint ? options.isPrint : true;
        obj.pageNumber = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.pageNumber) ? options.pageNumber : this.pdfViewerBase.currentPageNumber;
        obj.pageIndex = obj.pageNumber - 1;
        obj.font = options.font;
        obj.id = id;
        if (isCollection || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isCollection)) {
        ...
        switch (formFieldType) {
            case 'Textbox':
                ...
                obj.name = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) ? options.name : 'Textbox' + this.formFieldIndex;
                obj.insertSpaces = options.insertSpaces;
                obj.maxLength = options.maxLength;
                obj.thickness = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.thickness) ? options.thickness : 1;
                obj.borderColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.borderColor) ? options.borderColor : '#303030';
                if (options.font) {
                    obj.font = options.font;
                }
            ...
            case 'Password':
                ...
                obj.name = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) ? options.name : 'Password' + this.formFieldIndex;
                obj.maxLength = options.maxLength;
                obj.thickness = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.thickness) ?
                    options.thickness : 1;
                obj.borderColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.borderColor) ? options.borderColor : '#303030';
                break;
            case 'DropDown':
                obj.formFieldAnnotationType = 'DropdownList';
                obj.name = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) ? options.name : 'Dropdown' + this.formFieldIndex;
                ...
                obj.selectedIndex = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.selectedIndex) ? options.selectedIndex : [0];
                obj.thickness = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.thickness) ?
                    options.thickness : 1;
                obj.borderColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.borderColor) ? options.borderColor : '#303030';
                if (options.font) {
            ...
            case 'ListBox':
                obj.formFieldAnnotationType = formFieldType;
                obj.name = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) ? options.name : 'List Box' + this.formFieldIndex;
                obj.options = options.options ? options.options : [];
                for (var i = 0; i < this.pdfViewer.formFieldCollection.length; i++) {
                    var formField = this.pdfViewer.formFieldCollection[parseInt(i.toString(), 10)];
            ...
            case 'CheckBox':
                ...
                obj.backgroundColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.backgroundColor) ? options.backgroundColor : '#daeaf7ff';
                obj.isReadonly = options.isReadOnly ? options.isReadOnly : false;
                obj.name = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) ? options.name : 'Check Box' + this.formFieldIndex;
            ...
            case 'RadioButton':
                ...
                obj.backgroundColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.backgroundColor) ? options.backgroundColor : '#daeaf7ff';
                obj.isReadonly = options.isReadOnly ? options.isReadOnly : false;
                obj.name = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) ? options.name : 'Radio Button' + this.formFieldIndex;
            ...
            case 'SignatureField': {
                ...
                obj.backgroundColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.backgroundColor) ?
                    _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.setTransparencyToHex(this.colorNametoHashValue(options.backgroundColor)) : obj.isReadonly ? 'trasnparent' : '#daeaf7ff';
                obj.borderColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.borderColor) ?
                    options.borderColor : '#303030';
                obj.fontSize = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontSize) ?
                    options.fontSize : 10;
                obj.fontStyle = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontStyle) ? options.fontStyle : 'None';
                obj.name = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) ? options.name : 'Signature' + this.formFieldIndex;
                obj.isRequired = options.isRequired ? options.isRequired : false;
                obj.thickness = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.thickness) ? options.thickness : 1;
            ...
            case 'InitialField': {
                ...
                obj.backgroundColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.backgroundColor) ?
                    _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.setTransparencyToHex(this.colorNametoHashValue(options.backgroundColor)) : obj.isReadonly ? 'trasnparent' :
                    '#daeaf7ff';
                obj.borderColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.borderColor) ?
                    options.borderColor : '#303030';
                obj.fontSize = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontSize) ?
                ...
                obj.thickness = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.thickness) ? options.thickness : 1;
                obj.fontStyle = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontStyle) ? options.fontStyle : 'None';
                obj.name = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) ? options.name : 'Initial' + this.formFieldIndex;
                obj.isRequired = options.isRequired ? options.isRequired : false;
        ...
        obj.tooltip = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.tooltip) ? options.tooltip : '';
        this.setFormFieldIndex();
    ...
    FormDesigner.prototype.addFieldCollection = function (node) {
        var formField = {
            id: (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .randomId */ .zE)(), name: node.name, value: node.value,
    ...
    FormDesigner.prototype.setFormFieldMode = function (formFieldType, options) {
        if (this.pdfViewer.selectedItems && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.selectedItems.annotations) &&
            this.pdfViewer.selectedItems.annotations.length > 0 && this.pdfViewerBase.activeElements &&
            !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewerBase.activeElements.activePageID)) {
    ...
    FormDesigner.prototype.updateFormField = function (formFieldId, options) {
        ...
        if (formField) {
            if (!formField.isReadonly || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isReadOnly) && !options.isReadOnly)) {
                switch (formField.formFieldAnnotationType) {
                    case 'Textbox':
                    case 'PasswordField':
                    case 'DropdownList':
    ...
    FormDesigner.prototype.updateDesignerSession = function (formFieldId, options) {
        ...
        var isEdited = false;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.customData) && actualObject.customData !== options.customData) {
            actualObject.customData = options.customData;
            isEdited = true;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) && actualObject.name !== options.name) {
            actualObject.name = options.name;
            isEdited = true;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.borderColor) && actualObject.borderColor !== options.borderColor) {
            actualObject.borderColor = options.borderColor;
            isEdited = true;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.backgroundColor) && actualObject.backgroundColor !== options.backgroundColor) {
            actualObject.backgroundColor = options.backgroundColor;
            isEdited = true;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.value) && actualObject.value !== options.value) {
            actualObject.value = options.value;
            isEdited = true;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.bounds) && actualObject.bounds.properties !== options.bounds) {
    ...
    FormDesigner.prototype.updateFormFieldsInFieldsSession = function (formFieldId, options) {
        ...
        var isEdited = false;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fieldsData)) {
            var data = JSON.parse(fieldsData);
            for (var x = 0; x < data.length; x++) {
                if (data["" + x].FieldName === formFieldId.name) {
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.customData) && data["" + x].CustomData !== options.customData) {
                        data["" + x].CustomData = options.customData;
                        isEdited = true;
                    }
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.backgroundColor) && data["" + x].BackColor !== options.backgroundColor) {
                        data["" + x].BackColor = this.getRgbCode(options.backgroundColor);
                        isEdited = true;
                    }
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.borderColor) && data["" + x].BorderColor !== options.borderColor) {
                        data["" + x].BorderColor = this.getRgbCode(options.borderColor);
                        isEdited = true;
                    }
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.name) && data["" + x].Name !== options.name) {
                        data["" + x].Name = options.name;
                        isEdited = true;
                    }
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.value) && data["" + x].Value !== options.value) {
                        data["" + x].Value = options.value;
                        isEdited = true;
                    }
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.bounds)) {
                        var lineBounds = {
                        ...
                        if (JSON.stringify(lineBounds) !== JSON.stringify(options.bounds)) {
                            var newLineBounds = {
                                X: _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.convertPixelToPoint(options.bounds.X),
                                Y: _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.convertPixelToPoint(options.bounds.Y),
                                Width: _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.convertPixelToPoint(options.bounds.Width),
                                Height: _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.convertPixelToPoint(options.bounds.Height)
                            };
    ...
    FormDesigner.prototype.updateFormFieldData = function (currentData, options) {
        ...
        if (options.backgroundColor) {
            ...
            if (currentData.backgroundColor !== backColor) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.nameTable["" + id])) {
                    this.pdfViewer.nameTable["" + id].backgroundColor = backColor;
                }
            }
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.customData) && currentData.customData !== options.customData) {
            currentData.customData = options.customData;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isReadOnly) && currentData.isReadonly !== options.isReadOnly) {
            currentData.isReadOnly = options.isReadOnly;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isRequired) && currentData.isRequired !== options.isRequired) {
            currentData.isRequired = options.isRequired;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isPrint) && currentData.isPrint !== options.isPrint) {
        ...
        if (currentData.type === 'Checkbox' && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isChecked) && currentData.isChecked === options.isChecked)) {
            currentData.isChecked = options.isChecked;
        }
        if (currentData.type === 'RadioButton' && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isSelected) && currentData.isSelected === options.isSelected)) {
    ...
    FormDesigner.prototype.formFieldPropertyChange = function (formFieldObject, options, htmlElement, selectedItem) {
        ...
        if (formFieldObject.formFieldAnnotationType) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.thickness)) {
        ...
        if (options.backgroundColor) {
            ...
            backColor = formFieldObject.formFieldAnnotationType === 'SignatureField' || formFieldObject.formFieldAnnotationType ===
                'InitialField' ? _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.setTransparencyToHex(backColor) : _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.removeAlphaValueFromHex(backColor);
        ...
        if (options.bounds) {
            ...
            formField_1.wrapper.bounds = new _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_4__/* .Rect */ .r(options.bounds.X, options.bounds.Y, options.bounds.Width, options.bounds.Height);
            ...
            var point = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(formField_1.wrapper.children[0]).topLeft;
            var hEment = document.getElementById(element.id + '_html_element');
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(hEment)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isRequired)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isPrint)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.tooltip)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.customData)) {
        ...
        if ((formFieldObject.formFieldAnnotationType === 'Checkbox') && ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isChecked)) || options.isChecked || options.value)) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isChecked) && formFieldObject.isChecked !==
        ...
        if (formFieldObject.formFieldAnnotationType === 'RadioButton' && ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isSelected)) || options.isSelected || options.value)) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isSelected) && formFieldObject.isSelected !==
                options.isSelected) {
                isValueChanged = true;
        ...
        if (formFieldObject.formFieldAnnotationType === 'Textbox' || formFieldObject.formFieldAnnotationType === 'SignatureField' || formFieldObject.formFieldAnnotationType === 'InitialField' ||
            ...
            if (options.value || options.isMultiline) {
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.value) && formFieldObject.value !==
                    options.value) {
                    isValueChanged = true;
                    oldValue = formFieldObject.value;
                    newValue = options.value;
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isMultiline) && formFieldObject.isMultiline !==
                    options.isMultiline) {
                    isValueChanged = true;
                    formFieldObject.isMultiline = options.isMultiline;
                }
                if (!(formFieldObject.formFieldAnnotationType === 'DropdownList' || formFieldObject.formFieldAnnotationType === 'ListBox') && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.value)) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.selectedIndex) && formFieldObject.selectedIndex !==
            ...
            else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options) &&
                !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isMultiline) && !options.isMultiline) {
            ...
            if (formFieldObject.formFieldAnnotationType !== 'PasswordField') {
                ...
                var oldFontStyle = '';
                var newFontStyle = '';
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontStyle)) {
                    ...
                    if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.fontStyle)) && (options.fontStyle === _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.None)) {
                        ...
                        if ((options.fontStyle & _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Bold) !== 0) {
                        ...
                        if ((options.fontStyle & _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Italic) !== 0) {
                        ...
                        if ((options.fontStyle & _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Strikethrough) !== 0) {
                        ...
                        if ((options.fontStyle & _base_types__WEBPACK_IMPORTED_MODULE_2__/* .FontStyle */ .zz.Underline) !== 0) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(options.isReadOnly)) {
    ...
    FormDesigner.prototype.deleteFormField = function (formFieldId, addAction) {
        ...
        var formField = this.getFormField(formFieldId);
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(formField) && formFieldId) {
        ...
        if (formField) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.toolbar) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.toolbar.formDesignerToolbarModule)) {
    ...
    FormDesigner.prototype.clearSelection = function (formFieldId) {
        ...
        if (formField && (this.pdfViewer.selectedItems && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.selectedItems.
            ...
            var pageId = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewerBase.activeElements.activePageID) ?
    ...
    FormDesigner.prototype.removeFieldsFromAnnotationCollections = function (annotationId, fieldName) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(sessiondata)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(sessionformFields)) {
    ...
    FormDesigner.prototype.activateSignatureBoxElement = function (formFieldType) {
        ...
        switch (formFieldType) {
            case 'SignatureField':
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.signatureFieldSettings.signatureIndicatorSettings)) {
                    propertyValues = this.pdfViewer.signatureFieldSettings.signatureIndicatorSettings;
                }
                break;
            case 'InitialField':
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.initialFieldSettings.initialIndicatorSettings)) {
    ...
    FormDesigner.prototype.updateTextboxProperties = function (obj, inputElement, isPrint) {
        ...
        inputElement.style.borderWidth = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj.thickness) ? obj.thickness + 'px' : '1px';
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj.maxLength)) {
    ...
    FormDesigner.prototype.updateRadioButtonProperties = function (obj, inputElement, labelElement) {
        ...
        inputElement.style.borderColor = obj.borderColor ? obj.borderColor : '#303030';
        inputElement.style.visibility = obj.visibility ? obj.visibility : 'visible';
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(labelElement)) {
    ...
    FormDesigner.prototype.updateSignatureFieldProperties = function (obj, inputElement, isPrint) {
        ...
        background = _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.setTransparencyToHex(background);
        if (obj.isTransparent && obj.borderColor === '#ffffffff') {
            inputElement.style.backgroundColor = 'transparent';
            inputElement.style.borderColor = 'transparent';
        ...
        inputElement.style.pointerEvents = obj.isReadonly ? 'none' : 'default';
        if (obj.isReadonly) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(inputElement.firstElementChild)) {
    ...
    FormDesigner.prototype.createHtmlElement = function (elementType, attribute) {
        var element = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)(elementType);
    ...
    FormDesigner.prototype.downloadFormDesigner = function () {
        ...
        if (data || (this.pdfViewer.formDesignerModule && this.pdfViewer.formFieldCollections.length > 0)) {
            var formFieldsData = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(data) ? JSON.parse(data) : [];
            // Get Formfields present in non rendered pages
            this.updateMissingFormFields(formFieldsData);
            var _loop_8 = function (i) {
                var currentData = formFieldsData[parseInt(i.toString(), 10)].FormField;
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData)) {
                    if ((currentData.formFieldAnnotationType === 'SignatureField' || currentData.formFieldAnnotationType === 'InitialField') && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData.signatureBound))) {
                        var filteredField = this_8.pdfViewer.formFieldCollections.filter(function (field) {
                            return field.id === currentData.id.split('_')[0];
                        });
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData.signatureType) && currentData.signatureType === '') {
                            currentData.signatureType = filteredField[0].signatureType;
                        }
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData.value) && currentData.value === '') {
                            currentData.value = filteredField[0].value;
                        }
                        if (currentData.signatureType === 'Image') {
                            var imageUrl = (currentData.value.toString()).split(',')[1];
                            var image = new _syncfusion_ej2_pdf__WEBPACK_IMPORTED_MODULE_5__/* .PdfBitmap */ .e(imageUrl);
                            var boundsObjects = {
                            ...
                            if (this_8.pdfViewer.signatureFitMode === 'Default') {
                                ...
                                currentData.LineBounds = { X: _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.convertPixelToPoint(currentData.lineBound.X),
                                    Y: _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.convertPixelToPoint(currentData.lineBound.Y),
                                    Width: _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.convertPixelToPoint(currentData.lineBound.Width),
                                    Height: _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_3__/* .PdfViewerUtils */ .A9.convertPixelToPoint(currentData.lineBound.Height) };
                            ...
                            currentData.signatureBound = boundsObjects;
                            var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__/* .processPathData */ .lW)(filteredField[0].value);
                            var csData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__/* .splitArrayCollection */ .yo)(collectionData);
                ...
                if (currentData.isRequired) {
                    if (currentData.formFieldAnnotationType === 'Textbox' || currentData.formFieldAnnotationType === 'PasswordField' || currentData.Multiline) {
                        ...
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData.selectedIndex) || currentData.selectedIndex.length === 0) {
                            this_8.pdfViewerBase.validateForm = true;
    ...
    FormDesigner.prototype.getTextToImage = function (currentData) {
        var signTypeCanvas = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('canvas');
    ...
    FormDesigner.prototype.loadedFormFieldValue = function (currentData) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.data)) {
            ...
            if ((currentData.type === 'DropdownList' || currentData.type === 'ListBox')) {
                ...
                if (dropListData.length > 0) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropListData[0].selectedIndex)) {
                ...
                if (signData_1.length > 0) {
                    ...
                    for (var i = 0; i < boundsData.length; i++) {
                        if ((signData_1[0].FieldName !== boundsData[parseInt(i.toString(), 10)].FieldName)) {
                            ...
                            if (signType === 'Path') {
                                var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__/* .processPathData */ .lW)(boundsData[parseInt(i.toString(), 10)].Value);
                                var csData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__/* .splitArrayCollection */ .yo)(collectionData);
    ...
    FormDesigner.prototype.createAnnotationLayer = function (pageDiv, pageWidth, pageHeight, pageNumber, displayMode) {
        ...
        if (canvas) {
            ...
            var annotationCanvas = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('canvas', { id: this.pdfViewer.element.id + '_annotationCanvas_' + pageNumber, className: 'e-pv-annotation-canvas' });
    ...
    FormDesigner.prototype.createPropertiesWindow = function () {
        ...
        var dialogDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: elementID + '_properties_window', className: 'e-pv-properties-form-field-window' });
        ...
        this.propertiesDialog = new _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_7__/* .Dialog */ .lG({
        ...
        var propertySpliterBottom = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div');
    ...
    FormDesigner.prototype.onOkClicked = function (args) {
        var selectedItem = this.pdfViewer.selectedItems.formFields[0];
        var clonedItem = (0,_drawing_drawing_util__WEBPACK_IMPORTED_MODULE_8__/* .cloneObject */ .h2)(selectedItem);
        this.isAddFormFieldProgrammatically = false;
        if (selectedItem) {
            switch (selectedItem.formFieldAnnotationType) {
                ...
                case 'PasswordField': {
                    ...
                    this.multilineCheckboxCheckedState = false;
                    var point = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(selectedItem.wrapper.children[0]).topLeft;
                ...
                case 'Checkbox': {
                    ...
                    var point1 = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(selectedItem.wrapper.children[0]).topLeft;
                ...
                case 'RadioButton': {
                    ...
                    var point2 = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(selectedItem.wrapper.children[0]).topLeft;
                ...
                case 'InitialField': {
                    ...
                    var point3 = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(selectedItem.wrapper.children[0]).topLeft;
                ...
                case 'DropdownList': {
                    ...
                    var point4 = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(selectedItem.wrapper.children[0]).topLeft;
                ...
                case 'ListBox': {
                    ...
                    var point5 = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(selectedItem.wrapper.children[0]).topLeft;
            ...
            var cloneChangedNode = (0,_drawing_drawing_util__WEBPACK_IMPORTED_MODULE_8__/* .cloneObject */ .h2)(selectedItem);
    ...
    FormDesigner.prototype.updateFormFieldCollections = function (formFieldObject) {
        var formField = {
            ...
            pageIndex: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(formFieldObject.pageNumber) ? formFieldObject.pageNumber - 1 : formFieldObject.pageIndex,
            insertSpaces: formFieldObject.insertSpaces,
            isTransparent: formFieldObject.isTransparent ?
            ...
            rotateAngle: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(formFieldObject.rotateAngle) ?
    ...
    FormDesigner.prototype.updateDropdownFormDesignerProperties = function (selectedItem, isUndoRedo) {
        ...
        if (this.pdfViewer.designerMode || isUndoRedo) {
            ...
            if (index_1 > -1) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(selectedItem.options) && selectedItem.options.length > 0) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.formFieldBorderWidth) || isUndoRedo) {
    ...
    FormDesigner.prototype.updateCheckboxFormDesignerProperties = function (selectedItem, updateValue, isUndoRedo) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.checkboxCheckedState) || isUndoRedo) {
    ...
    FormDesigner.prototype.updateRadioButtonDesignerProperties = function (selectedItem, updateValue, isUndoRedo) {
        ...
        if ((this.pdfViewer.designerMode && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.formFieldBorderWidth)) || isUndoRedo) {
        ...
        if (isUndoRedo) {
            ...
            var point2 = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .cornersPointsBeforeRotation */ .Vz)(formField.wrapper.children[0]).topLeft;
    ...
    FormDesigner.prototype.updateTextboxFormDesignerProperties = function (selectedItem, isUndoRedo) {
        ...
        if (this.pdfViewer.designerMode || isUndoRedo || this.isAddFormFieldProgrammatically) {
            ...
            if (this.maxLengthItem || isUndoRedo) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.maxLengthItem)) {
    ...
    FormDesigner.prototype.updateBorderColorPropertyChange = function (selectedItem, element, isUndoRedo, index, formFieldsData) {
        ...
        if (this.pdfViewer.enableHtmlSanitizer && this.borderColorValue) {
            this.borderColorValue = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(this.borderColorValue);
        }
        if (isUndoRedo) {
    ...
    FormDesigner.prototype.updateBackgroundColorPropertyChange = function (selectedItem, element, isUndoRedo, index, formFieldsData) {
        ...
        if (this.pdfViewer.enableHtmlSanitizer && this.backgroundColorValue) {
            this.backgroundColorValue = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(this.backgroundColorValue);
        }
        if (isUndoRedo) {
            if (selectedItem.formFieldAnnotationType === 'RadioButton') {
    ...
    FormDesigner.prototype.updateColorPropertyChange = function (selectedItem, element, isUndoRedo, index, formFieldsData) {
        ...
        if (this.pdfViewer.enableHtmlSanitizer && this.fontColorValue) {
            this.fontColorValue = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(this.fontColorValue);
        }
        if (isUndoRedo) {
    ...
    FormDesigner.prototype.updateFontFamilyPropertyChange = function (selectedItem, element, isUndoRedo, index, formFieldsData) {
        ...
        var oldValue;
        var newValue;
        var fontFamily = this.pdfViewer.enableHtmlSanitizer ? _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(this.formFieldFontFamily ? this.formFieldFontFamily.value.toString() : '') : (this.formFieldFontFamily ? this.formFieldFontFamily.value.toString() : '');
    ...
    FormDesigner.prototype.showSignatureValue = function (selectedItem, oldValue, annotation, index, formFieldsData) {
        if (annotation.shapeAnnotationType === 'SignatureText') {
            ...
            var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__/* .processPathData */ .lW)(annotation.data);
            var csData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__/* .splitArrayCollection */ .yo)(collectionData);
    ...
    FormDesigner.prototype.updateTooltipPropertyChange = function (selectedItem, element, isUndoRedo, index, formFieldsData) {
        ...
        if (this.pdfViewer.enableHtmlSanitizer && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.formFieldTooltip) && this.formFieldTooltip.value) {
            this.formFieldTooltip.value = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(this.formFieldTooltip.value);
        }
        if (isUndoRedo) {
            this.formFieldTooltip = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .TextBox */ .f();
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.formFieldTooltip.value) && this.formFieldTooltip.value !== '') {
    ...
    FormDesigner.prototype.updateNamePropertyChange = function (selectedItem, element, isUndoRedo, index, formFieldsData) {
        ...
        var zoomValue = this.pdfViewerBase.getZoomFactor();
        if (this.pdfViewer.enableHtmlSanitizer && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.formFieldName) && this.formFieldName.value) {
            this.formFieldName.value = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(this.formFieldName.value);
        }
        designerName.style.fontSize = this.defaultFontSize + 'px';
        if (isUndoRedo) {
    ...
    FormDesigner.prototype.updateIsReadOnlyPropertyChange = function (selectedItem, element, isUndoRedo, index, formFieldsData) {
        ...
        if (isUndoRedo) {
            this.formFieldReadOnly = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__/* .CheckBox */ .o();
    ...
    FormDesigner.prototype.updateIsRequiredPropertyChange = function (selectedItem, element, isUndoRedo, index, formFieldsData) {
        ...
        if (isUndoRedo) {
            this.formFieldRequired = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__/* .CheckBox */ .o();
    ...
    FormDesigner.prototype.updateIsPrintPropertyChange = function (selectedItem, isUndoRedo, index, formFieldsData) {
        ...
        if (isUndoRedo) {
            this.formFieldPrinting = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__/* .CheckBox */ .o();
    ...
    FormDesigner.prototype.createAppearanceTab = function () {
        var elementID = this.pdfViewer.element.id;
        var appearanceDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: elementID + '_properties_appearance' });
        if (this.pdfViewer.selectedItems.formFields[0].formFieldAnnotationType !== 'DropdownList' && this.pdfViewer.selectedItems.formFields[0].formFieldAnnotationType !== 'ListBox') {
        ...
        var propertySpliter = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div');
        propertySpliter.className = 'e-pv-properties-header-spliter';
        appearanceDiv.appendChild(propertySpliter);
        var tabContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-tab-style-prop' });
        ...
        if (this.pdfViewer.selectedItems && (this.pdfViewer.selectedItems.formFields[0].formFieldAnnotationType === 'ListBox' || this.pdfViewer.selectedItems.formFields[0].formFieldAnnotationType === 'DropdownList')) {
            this.tabControl = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_11__/* .Tab */ .oz({
                items: [
                    {
    ...
    FormDesigner.prototype.createGeneralProperties = function () {
        ...
        var elementID = this.pdfViewer.element.id;
        var generalPropertiesDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: elementID + '_general_prop_appearance' });
        var textStyleContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-text-edit-prop' });
        generalPropertiesDiv.appendChild(textStyleContainer);
        var formFieldNameMainDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-name-main-div' });
        var formFieldNameDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-name-edit-prop' });
        var formFieldNameContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-name-edit-input e-input' });
        formFieldNameDiv.appendChild(formFieldNameContainer);
        formFieldNameMainDiv.appendChild(formFieldNameDiv);
        this.formFieldName = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .TextBox */ .f({ type: 'text', floatLabelType: 'Always', placeholder: this.pdfViewer.localeObj.getConstant('Name'), value: selectedItem.name, cssClass: 'e-pv-properties-formfield-name' }, formFieldNameContainer);
        textStyleContainer.appendChild(formFieldNameMainDiv);
        var formFieldTooltipMainDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-tooltip-main-div' });
        var formFieldTooltipDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-tooltip-edit-prop' });
        var formFieldTooltipContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-tooltip-prop-input e-input' });
        formFieldTooltipDiv.appendChild(formFieldTooltipContainer);
        formFieldTooltipMainDiv.appendChild(formFieldTooltipDiv);
        this.formFieldTooltip = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .TextBox */ .f({ type: 'text', floatLabelType: 'Always', placeholder: this.pdfViewer.localeObj.getConstant('Tooltip'), value: selectedItem.tooltip, cssClass: 'e-pv-properties-formfield-tooltip' }, formFieldTooltipContainer);
        textStyleContainer.appendChild(formFieldTooltipMainDiv);
        var visibilityContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-visibility-style-prop' });
        generalPropertiesDiv.appendChild(visibilityContainer);
        var formFieldValueMainDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-value-main-div' });
        var formFieldValueDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-value-edit-prop' });
        var formFieldValueContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-value-input e-input' });
        ...
        if (this.pdfViewer.selectedItems.formFields[0].formFieldAnnotationType === 'PasswordField') {
            this.formFieldValue = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .TextBox */ .f({ type: 'password', floatLabelType: 'Always', placeholder: this.pdfViewer.localeObj.getConstant('Value'), value: selectedItem.value, cssClass: 'e-pv-properties-formfield-value' }, formFieldValueContainer);
        }
        else {
            this.formFieldValue = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .TextBox */ .f({ type: 'text', floatLabelType: 'Always', placeholder: this.pdfViewer.localeObj.getConstant('Value'), value: selectedItem.value, cssClass: 'e-pv-properties-formfield-value' }, formFieldValueContainer);
        }
        ...
        var formFieldVisibilityMainDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-visibility-main-div' });
        var formFieldVisibilityDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-visibility-edit-prop' });
        var formFieldVisibilityContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-formfield-visibility' });
        ...
        this.formFieldVisibility = new _syncfusion_ej2_dropdowns__WEBPACK_IMPORTED_MODULE_12__/* .DropDownList */ .O({ dataSource: visibilityItems, floatLabelType: 'Always', index: selectedIndex, value: selectedItem.visibility, placeholder: this.pdfViewer.localeObj.getConstant('Form Field Visibility'), cssClass: 'e-pv-properties-formfield-visibility' }, formFieldVisibilityContainer);
        visibilityContainer.appendChild(formFieldVisibilityMainDiv);
        var checkboxMainDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-checkbox-main-div-prop' });
        var readOnly = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-checkbox-readonly-input e-input' });
        checkboxMainDiv.appendChild(readOnly);
        this.formFieldReadOnly = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__/* .CheckBox */ .o({ label: this.pdfViewer.localeObj.getConstant('Read Only'), checked: selectedItem.isReadonly, cssClass: 'e-pv-properties-form-field-checkbox' }, readOnly);
        if (this.pdfViewer.selectedItems.formFields[0].formFieldAnnotationType === 'Checkbox' || this.pdfViewer.selectedItems.formFields[0].formFieldAnnotationType === 'RadioButton') {
            var checkedState = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-checkbox-checked-input e-input' });
            checkboxMainDiv.appendChild(checkedState);
            this.formFieldChecked = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__/* .CheckBox */ .o({ label: this.pdfViewer.localeObj.getConstant('Checked'), cssClass: 'e-pv-properties-form-field-checkbox', checked: selectedItem.isChecked || selectedItem.isSelected, change: this.checkBoxChange.bind(this) }, checkedState);
        }
        var required = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-checkbox-required-input e-input' });
        checkboxMainDiv.appendChild(required);
        this.formFieldRequired = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__/* .CheckBox */ .o({ label: this.pdfViewer.localeObj.getConstant('Required'), checked: selectedItem.isRequired, cssClass: 'e-pv-properties-form-field-checkbox' }, required);
        var showPrinting = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-checkbox-printing-input e-input' });
        checkboxMainDiv.appendChild(showPrinting);
        this.formFieldPrinting = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__/* .CheckBox */ .o({ label: this.pdfViewer.localeObj.getConstant('Show Printing'), checked: selectedItem.isPrint, cssClass: 'e-pv-properties-form-field-checkbox' }, showPrinting);
        if (selectedItem.formFieldAnnotationType === 'Textbox') {
            var multilineTextbox = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-checkbox-multiline-input e-input' });
            checkboxMainDiv.appendChild(multilineTextbox);
            this.formFieldMultiline = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_10__/* .CheckBox */ .o({ label: this.pdfViewer.localeObj.getConstant('Multiline'), checked: selectedItem.isMultiline, cssClass: 'e-pv-properties-form-field-checkbox', change: this.multilineCheckboxChange.bind(this) }, multilineTextbox);
        }
    ...
    FormDesigner.prototype.setToolTip = function (tooltipContent, targetElement) {
        ...
        var tooltip = new _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_13__/* .Tooltip */ .m({
            content: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .initializeCSPTemplate */ .dG)(function () { return tooltipContent; })
        });
    ...
    FormDesigner.prototype.tooltipBeforeOpen = function (args) {
        var currentFormField = this.pdfViewer.nameTable[args.target.id.split('_')[0] !== '' ? args.target.id.split('_')[0] : !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args.target.firstElementChild) ? args.target.firstElementChild.id.split('_')[0] : ''];
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentFormField)) {
    ...
    FormDesigner.prototype.createAppearanceProperties = function () {
        ...
        var elementID = this.pdfViewer.element.id;
        var appearancePropertiesDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: elementID + '_formatting_text_prop_appearance' });
        var formatTextStyleContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-format-text-style-prop' });
        ...
        var fontItemsContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-font-items-container' });
        var fontFamilyDropdownContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-font-family-container' });
        var formatdropdownContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-format-font-family-prop' });
        ...
        if (!isDefaultFont && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFont) && Object.keys(textFont).length > 0) {
        ...
        this.formFieldFontFamily = new _syncfusion_ej2_dropdowns__WEBPACK_IMPORTED_MODULE_12__/* .DropDownList */ .O({ dataSource: fontFamilyItems, value: fontFamily || 'Helvetica', cssClass: 'e-pv-properties-formfield-fontfamily' }, formatdropdownContainer);
        this.setToolTip(this.pdfViewer.localeObj.getConstant('Font family'), fontFamilyDropdownContainer);
        var fontSizeContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-font-size-container' });
        var fontSizeDropdownContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-format-font-family-prop' });
        fontSizeContainer.appendChild(fontSizeDropdownContainer);
        fontItemsContainer.appendChild(fontSizeContainer);
        this.formFieldFontSize = new _syncfusion_ej2_dropdowns__WEBPACK_IMPORTED_MODULE_12__/* .DropDownList */ .O({ dataSource: fontSizeItems, value: selectedItem.fontSize + 'px', cssClass: 'e-pv-properties-formfield-fontsize' }, fontSizeDropdownContainer);
        this.setToolTip(this.pdfViewer.localeObj.getConstant('Font size'), fontSizeContainer);
        var fontStyleContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-font-style' });
        ...
        var fontColorContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-font-color-container' });
        var fontAlignContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-font-align' });
        ...
        this.fontColorElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-formfield-textcolor-icon', id: this.pdfViewer.element.id + 'formField_textColor' });
        ...
        var maxLengthGroup = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-formfield-maxlength-group', id: this.pdfViewer.element.id + 'formField_maxlength_group' });
        var maxLengthContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-formfield-maxlength-icon', id: this.pdfViewer.element.id + 'formField_maxlength' });
        ...
        var maxLengthDropdownContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-formfield-maxlength', id: this.pdfViewer.element.id + 'formField_maxlength_container' });
        var maxLengthItemDropdown = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-formfield-maxlength-input e-input' });
        ...
        this.maxLengthItem = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_14__/* .NumericTextBox */ .u({ format: 'n', value: selectedItem.maxLength !== 0 ? selectedItem.maxLength : 0, min: 0 }, maxLengthItemDropdown);
        ...
        var colorContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-color-container-style-prop' });
        var backgroundColorContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-fill-color-style-prop' });
        ...
        this.colorDropDownElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-formfield-fontcolor-icon', id: this.pdfViewer.element.id + 'formField_fontColor' });
        ...
        var strokeColorContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-stroke-color-style-prop' });
        ...
        this.strokeDropDownElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-formfield-strokecolor-icon', id: this.pdfViewer.element.id + 'formField_strokeColor' });
        ...
        var strokeThicknessContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-stroke-thickness-style-prop' });
        ...
        this.thicknessElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-formfield-strokethickness-icon', id: this.pdfViewer.element.id + 'formField_strokethickness' });
    ...
    FormDesigner.prototype.createOptionProperties = function () {
        var _this = this;
        var elementID = this.pdfViewer.element.id;
        var optionPropertiesDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: elementID + '_option_prop_appearance' });
        var listItemAddContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-list-add-div' });
        var formFieldListItemMainDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-list-item-main-div' });
        ...
        var formFieldListItemDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-list-item-edit-prop' });
        var formFieldListItemContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-list-item-input e-input' });
        ...
        this.formFieldListItem = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .TextBox */ .f({ type: 'text', cssClass: 'e-pv-properties-formfield-listitem' }, formFieldListItemContainer);
        listItemAddContainer.appendChild(formFieldListItemMainDiv);
        optionPropertiesDiv.appendChild(listItemAddContainer);
        var buttonDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-list-btn-div' });
        var buttonAddInput = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('button', { className: 'e-btn' });
        buttonAddInput.addEventListener('click', this.addListItemOnClick.bind(this));
        buttonDiv.appendChild(buttonAddInput);
        this.formFieldAddButton = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_15__/* .Button */ .$n({ content: this.pdfViewer.localeObj.getConstant('Add'), disabled: true, cssClass: 'e-pv-properties-dropdown-btn' }, buttonAddInput);
        listItemAddContainer.appendChild(buttonDiv);
        var exportValueContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-export-value-div' });
        var formFieldexportValueMainDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-export-value-main-div' });
        ...
        var formFieldExportItemDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-export-value-edit-prop' });
        var formFieldExportItemContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { className: 'e-pv-properties-export-value-input e-input' });
        ...
        this.formFieldListItem = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .TextBox */ .f({ type: 'text', cssClass: 'e-pv-properties-formfield-exportvalue' }, formFieldExportItemContainer);
        exportValueContainer.appendChild(formFieldexportValueMainDiv);
        optionPropertiesDiv.appendChild(exportValueContainer);
        var dropdownListItemContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-option-dropdown-list-div' });
        var formFieldDropdownListMainDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-option-dropdown-list-item-div' });
        ...
        var btnTextAreaContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-btn-textarea-container' });
        var textAreaContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-formfield-textarea', styles: 'width:300px;height:123px;border:1px solid #E0E0E0;margin-right:15px;overflow:auto' });
        var listElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('ul', { id: this.pdfViewer.element.id + '_ul_list_item', className: 'e-pv-form-designer-ul-list-items' });
        ...
        var buttonGroup = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-group-btn-div' });
        var deleteButtonDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-delete-btn-div' });
        var buttonDeleteInput = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('button', { className: 'e-btn' });
        buttonDeleteInput.addEventListener('click', this.deleteListItem.bind(this));
        deleteButtonDiv.appendChild(buttonDeleteInput);
        this.formFieldDeleteButton = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_15__/* .Button */ .$n({ content: this.pdfViewer.localeObj.getConstant('Delete Item'), disabled: listCount > 0 ? false : true, cssClass: 'e-pv-properties-dropdown-btn' }, buttonDeleteInput);
        buttonGroup.appendChild(deleteButtonDiv);
        var upButtonDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-up-btn-div' });
        var buttonUpInput = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('button', { className: 'e-btn' });
        buttonUpInput.addEventListener('click', this.moveUpListItem.bind(this));
        upButtonDiv.appendChild(buttonUpInput);
        this.formFieldUpButton = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_15__/* .Button */ .$n({ content: this.pdfViewer.localeObj.getConstant('Up'), disabled: listCount > 1 ? false : true, cssClass: 'e-pv-properties-dropdown-btn' }, buttonUpInput);
        buttonGroup.appendChild(upButtonDiv);
        var downButtonDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-properties-form-field-down-btn-div' });
        var buttonDownInput = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('button', { className: 'e-btn' });
        buttonDownInput.addEventListener('click', this.moveDownListItem.bind(this));
        downButtonDiv.appendChild(buttonDownInput);
        this.formFieldDownButton = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_15__/* .Button */ .$n({ content: this.pdfViewer.localeObj.getConstant('Down'), disabled: true, cssClass: 'e-pv-properties-dropdown-btn' }, buttonDownInput);
    ...
    FormDesigner.prototype.addListItemOnClick = function () {
        ...
        var createLiElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('li', { className: 'e-pv-formfield-li-element' });
    ...
    FormDesigner.prototype.createThicknessSlider = function (idString) {
        var outerContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-pv-annotation-thickness-popup-container' });
        document.body.appendChild(outerContainer);
        var label = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { id: idString + '_label', className: 'e-pv-annotation-thickness-label' });
        ...
        this.thicknessSlider = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_16__/* .Slider */ .Ap({ type: 'MinRange', cssClass: 'e-pv-annotation-thickness-slider', max: 12, min: 0 });
        this.thicknessIndicator = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: idString + '_thickness_indicator', className: 'e-pv-annotation-thickness-indicator' });
    ...
    FormDesigner.prototype.createColorPicker = function (idString, color) {
        var inputElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { id: idString + '_target' });
        document.body.appendChild(inputElement);
        var colorPicker = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_17__/* .ColorPicker */ .s({
    ...
    FormDesigner.prototype.createDropDownButton = function (element, iconClass, target) {
        ...
        var dropDownButton = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_18__/* .DropDownButton */ .Q({ iconCss: iconClass + ' e-pv-icon', target: target });
        if (this.pdfViewer.enableRtl) {
    ...
    FormDesigner.prototype.addClassFontItem = function (idString, className, isSelectedStyle) {
        var element = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + idString + '_div' });
        element.classList.add(className + '-div');
        var spanElement = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { id: this.pdfViewer.element.id + idString + '_span' });
    ...
    FormDesigner.prototype.createLabelElement = function (labelText, parentElement, isLabelNeeded, className, idString) {
        var container = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: idString + '_container', className: className + '-container' });
        var label = null;
        if (isLabelNeeded) {
            label = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: idString + '_label', className: className });
    ...
    FormDesigner.prototype.setReadOnlyToElement = function (selectedItem, inputElement, isReadOnly) {
        ...
        if (isReadOnly) {
            if (selectedItem.formFieldAnnotationType === 'RadioButton') {
                ...
                var thickness = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(selectedItem.thickness) ? 1 : selectedItem.thickness;
        ...
        if (selectedItem.formFieldAnnotationType === 'RadioButton') {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(selectedItem) && selectedItem.value === '') {
    ...
    FormDesigner.prototype.updateTextFieldSettingProperties = function (drawingObject, isFormDesignerToolbarVisible, isSetFormFieldMode) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.isReadOnly) && this.textFieldPropertyChanged.isReadOnlyChanged &&
            textFieldSettings.isReadOnly !== false) {
            drawingObject.isReadonly = textFieldSettings.isReadOnly;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.isRequired) && this.textFieldPropertyChanged.isRequiredChanged &&
        ...
        if (textFieldSettings.value && this.textFieldPropertyChanged.isValueChanged) {
            drawingObject.value = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(textFieldSettings.value) : textFieldSettings.value;
        }
        if ((textFieldSettings.backgroundColor && textFieldSettings.backgroundColor !== 'white') && this.textFieldPropertyChanged.isBackgroundColorChanged) {
            drawingObject.backgroundColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(textFieldSettings.backgroundColor) : textFieldSettings.backgroundColor;
        }
        if ((textFieldSettings.borderColor && textFieldSettings.borderColor !== 'black') && this.textFieldPropertyChanged.isBorderColorChanged) {
            drawingObject.borderColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(textFieldSettings.borderColor) : textFieldSettings.borderColor;
        }
        ...
        if ((textFieldSettings.color && textFieldSettings.color !== 'black') &&
            ...
            drawingObject.color = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(textFieldSettings.color) : textFieldSettings.color;
        }
        if ((textFieldSettings.fontFamily && textFieldSettings.fontFamily !== 'Helvetica') && this.textFieldPropertyChanged.isFontFamilyChanged) {
            drawingObject.fontFamily = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(textFieldSettings.fontFamily) : textFieldSettings.fontFamily;
        }
        ...
        if (textFieldSettings.name && this.textFieldPropertyChanged.isNameChanged) {
            drawingObject.name = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(textFieldSettings.name) : textFieldSettings.name;
        }
        if (textFieldSettings.tooltip && this.textFieldPropertyChanged.isToolTipChanged) {
            drawingObject.tooltip = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(textFieldSettings.tooltip) : textFieldSettings.tooltip;
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.isPrint) && this.textFieldPropertyChanged.isPrintChanged) {
            drawingObject.isPrint = textFieldSettings.isPrint;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.isMultiline) && this.textFieldPropertyChanged.isMultilineChanged &&
            textFieldSettings.isMultiline !== false) {
            drawingObject.isMultiline = textFieldSettings.isMultiline;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.customData) && this.textFieldPropertyChanged.isCustomDataChanged &&
    ...
    FormDesigner.prototype.updatePasswordFieldSettingProperties = function (drawingObject, isFormDesignerToolbarVisible, isSetFormFieldMode) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.isReadOnly) && this.passwordFieldPropertyChanged.isReadOnlyChanged &&
            passwordFieldSettings.isReadOnly !== false) {
            drawingObject.isReadonly = passwordFieldSettings.isReadOnly;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.isRequired) && this.passwordFieldPropertyChanged.isRequiredChanged &&
        ...
        if ((passwordFieldSettings.backgroundColor && passwordFieldSettings.backgroundColor !== 'white') && this.passwordFieldPropertyChanged.isBackgroundColorChanged) {
            drawingObject.backgroundColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(passwordFieldSettings.backgroundColor) : passwordFieldSettings.backgroundColor;
        }
        if ((passwordFieldSettings.borderColor && passwordFieldSettings.borderColor !== 'black') && this.passwordFieldPropertyChanged.isBorderColorChanged) {
            drawingObject.borderColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(passwordFieldSettings.borderColor) : passwordFieldSettings.borderColor;
        }
        ...
        if ((passwordFieldSettings.color && passwordFieldSettings.color !== 'black') && this.passwordFieldPropertyChanged.isColorChanged) {
            drawingObject.color = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(passwordFieldSettings.color) : passwordFieldSettings.color;
        }
        if ((passwordFieldSettings.fontFamily && passwordFieldSettings.fontFamily !== 'Helvetica') && this.passwordFieldPropertyChanged.isFontFamilyChanged) {
            drawingObject.fontFamily = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(passwordFieldSettings.fontFamily) : passwordFieldSettings.fontFamily;
        }
        ...
        if (passwordFieldSettings.name && this.passwordFieldPropertyChanged.isNameChanged) {
            drawingObject.name = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(passwordFieldSettings.name) : passwordFieldSettings.name;
        }
        if (passwordFieldSettings.tooltip && this.passwordFieldPropertyChanged.isToolTipChanged) {
            drawingObject.tooltip = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(passwordFieldSettings.tooltip) : passwordFieldSettings.tooltip;
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.isPrint) && this.passwordFieldPropertyChanged.isPrintChanged) {
            drawingObject.isPrint = passwordFieldSettings.isPrint;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.customData) && this.passwordFieldPropertyChanged.isCustomDataChanged &&
    ...
    FormDesigner.prototype.updateCheckBoxFieldSettingsProperties = function (drawingObject, isFormDesignerToolbarVisible, isSetFormFieldMode) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.isReadOnly) && this.checkBoxFieldPropertyChanged.isReadOnlyChanged &&
            checkBoxFieldSettings.isReadOnly !== false) {
            drawingObject.isReadonly = checkBoxFieldSettings.isReadOnly;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.isRequired) && this.checkBoxFieldPropertyChanged.isRequiredChanged &&
        ...
        if ((checkBoxFieldSettings.backgroundColor && checkBoxFieldSettings.backgroundColor !== 'white') && this.checkBoxFieldPropertyChanged.isBackgroundColorChanged) {
            drawingObject.backgroundColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(checkBoxFieldSettings.backgroundColor) : checkBoxFieldSettings.backgroundColor;
        }
        if ((checkBoxFieldSettings.borderColor && checkBoxFieldSettings.borderColor !== 'black') && this.checkBoxFieldPropertyChanged.isBorderColorChanged) {
            drawingObject.borderColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(checkBoxFieldSettings.borderColor) : checkBoxFieldSettings.borderColor;
        }
        if (checkBoxFieldSettings.name && this.checkBoxFieldPropertyChanged.isNameChanged) {
            drawingObject.name = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(checkBoxFieldSettings.name);
        }
        if (checkBoxFieldSettings.tooltip && this.checkBoxFieldPropertyChanged.isToolTipChanged) {
            drawingObject.tooltip = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(checkBoxFieldSettings.tooltip) : checkBoxFieldSettings.tooltip;
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.isPrint) && this.checkBoxFieldPropertyChanged.isPrintChanged) {
            drawingObject.isPrint = checkBoxFieldSettings.isPrint;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.isChecked) && this.checkBoxFieldPropertyChanged.isCheckedChanged &&
            checkBoxFieldSettings.isChecked !== false) {
            drawingObject.isChecked = checkBoxFieldSettings.isChecked;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.customData) && this.checkBoxFieldPropertyChanged.isCustomDataChanged &&
    ...
    FormDesigner.prototype.updateRadioButtonFieldSettingProperties = function (drawingObject, isFormDesignerToolbarVisible, isSetFormFieldMode) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.isReadOnly) && this.radioButtonFieldPropertyChanged.isReadOnlyChanged &&
            radioButtonFieldSettings.isReadOnly !== false) {
            drawingObject.isReadonly = radioButtonFieldSettings.isReadOnly;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.isRequired) && this.radioButtonFieldPropertyChanged.isRequiredChanged &&
        ...
        if ((radioButtonFieldSettings.backgroundColor && radioButtonFieldSettings.backgroundColor !== 'white') &&
            ...
            drawingObject.backgroundColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(radioButtonFieldSettings.backgroundColor) : radioButtonFieldSettings.backgroundColor;
        }
        if ((radioButtonFieldSettings.borderColor && radioButtonFieldSettings.borderColor !== 'black') &&
            ...
            drawingObject.borderColor = this.pdfViewer.enableHtmlSanitizer ? _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.
        ...
        if (radioButtonFieldSettings.name && this.radioButtonFieldPropertyChanged.isNameChanged) {
            drawingObject.name = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(radioButtonFieldSettings.name) : radioButtonFieldSettings.name;
        }
        if (radioButtonFieldSettings.tooltip && this.radioButtonFieldPropertyChanged.isToolTipChanged) {
            drawingObject.tooltip = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(radioButtonFieldSettings.tooltip) : radioButtonFieldSettings.tooltip;
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.isPrint) && this.radioButtonFieldPropertyChanged.isPrintChanged) {
            drawingObject.isPrint = radioButtonFieldSettings.isPrint;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.isSelected) && this.radioButtonFieldPropertyChanged.isSelectedChanged &&
            radioButtonFieldSettings.isSelected !== false) {
            drawingObject.isSelected = radioButtonFieldSettings.isSelected;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.customData) && this.radioButtonFieldPropertyChanged.isCustomDataChanged &&
    ...
    FormDesigner.prototype.updateDropdownFieldSettingsProperties = function (drawingObject, isFormDesignerToolbarVisible, isSetFormFieldMode) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.isReadOnly) && this.dropdownFieldPropertyChanged.isReadOnlyChanged &&
            dropdownFieldSettings.isReadOnly !== false) {
            drawingObject.isReadonly = dropdownFieldSettings.isReadOnly;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.isRequired) && this.dropdownFieldPropertyChanged.isRequiredChanged &&
        ...
        if ((dropdownFieldSettings.backgroundColor && dropdownFieldSettings.backgroundColor !== 'white') && this.dropdownFieldPropertyChanged.isBackgroundColorChanged) {
            drawingObject.backgroundColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(dropdownFieldSettings.backgroundColor) : dropdownFieldSettings.backgroundColor;
        }
        if ((dropdownFieldSettings.borderColor && dropdownFieldSettings.borderColor !== 'black') && this.dropdownFieldPropertyChanged.isBorderColorChanged) {
            drawingObject.borderColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(dropdownFieldSettings.borderColor) : dropdownFieldSettings.borderColor;
        }
        ...
        if ((dropdownFieldSettings.color && dropdownFieldSettings.color !== 'black') && this.dropdownFieldPropertyChanged.isColorChanged) {
            drawingObject.color = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(dropdownFieldSettings.color) : dropdownFieldSettings.color;
        }
        if ((dropdownFieldSettings.fontFamily && dropdownFieldSettings.fontFamily !== 'Helvetica') && this.dropdownFieldPropertyChanged.isFontFamilyChanged) {
            drawingObject.fontFamily = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(dropdownFieldSettings.fontFamily);
        }
        ...
        if (dropdownFieldSettings.name && this.dropdownFieldPropertyChanged.isNameChanged) {
            drawingObject.name = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(dropdownFieldSettings.name) : dropdownFieldSettings.name;
        }
        if (dropdownFieldSettings.tooltip && this.dropdownFieldPropertyChanged.isToolTipChanged) {
            drawingObject.tooltip = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(dropdownFieldSettings.tooltip) : dropdownFieldSettings.tooltip;
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.isPrint) && this.dropdownFieldPropertyChanged.isPrintChanged) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.customData) && this.dropdownFieldPropertyChanged.isCustomDataChanged &&
    ...
    FormDesigner.prototype.updatelistBoxFieldSettingsProperties = function (drawingObject, isFormDesignerToolbarVisible, isSetFormFieldMode) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.isReadOnly) && this.listBoxFieldPropertyChanged.isReadOnlyChanged &&
            listBoxFieldSettings.isReadOnly !== false) {
            drawingObject.isReadonly = listBoxFieldSettings.isReadOnly;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.isRequired) && this.listBoxFieldPropertyChanged.isRequiredChanged &&
        ...
        if ((listBoxFieldSettings.backgroundColor && listBoxFieldSettings.backgroundColor !== 'white') && this.listBoxFieldPropertyChanged.isBackgroundColorChanged) {
            drawingObject.backgroundColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(listBoxFieldSettings.backgroundColor) : listBoxFieldSettings.backgroundColor;
        }
        if ((listBoxFieldSettings.borderColor && listBoxFieldSettings.borderColor !== 'black') && this.listBoxFieldPropertyChanged.isBorderColorChanged) {
            drawingObject.borderColor = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(listBoxFieldSettings.borderColor) : listBoxFieldSettings.borderColor;
        }
        ...
        if ((listBoxFieldSettings.color && listBoxFieldSettings.color !== 'black') && this.listBoxFieldPropertyChanged.isColorChanged) {
            drawingObject.color = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(listBoxFieldSettings.color) : listBoxFieldSettings.color;
        }
        if ((listBoxFieldSettings.fontFamily && listBoxFieldSettings.fontFamily !== 'Helvetica') && this.listBoxFieldPropertyChanged.isFontFamilyChanged) {
            drawingObject.fontFamily = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(listBoxFieldSettings.fontFamily) : listBoxFieldSettings.fontFamily;
        }
        ...
        if (listBoxFieldSettings.name && this.listBoxFieldPropertyChanged.isNameChanged) {
            drawingObject.name = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(listBoxFieldSettings.name) : listBoxFieldSettings.name;
        }
        if (listBoxFieldSettings.tooltip && this.listBoxFieldPropertyChanged.isToolTipChanged) {
            drawingObject.tooltip = this.pdfViewer.enableHtmlSanitizer ?
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(listBoxFieldSettings.tooltip) : listBoxFieldSettings.tooltip;
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.isPrint) && this.listBoxFieldPropertyChanged.isPrintChanged) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.customData) && this.listBoxFieldPropertyChanged.isCustomDataChanged &&
    ...
    FormDesigner.prototype.updateSignInitialFieldProperties = function (signatureField, isInitialField, isFormDesignerToolbarVisible, isSetFormFieldMode) {
        ...
        var signatureFieldSettings = this.pdfViewer.signatureFieldSettings;
        if (isInitialField) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(initialFieldSettings.isReadOnly) && this.initialFieldPropertyChanged.isReadOnlyChanged &&
                initialFieldSettings.isReadOnly !== false) {
                signatureField.isReadonly = initialFieldSettings.isReadOnly;
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(initialFieldSettings.isRequired) &&
            ...
            if (initialFieldSettings.tooltip && this.initialFieldPropertyChanged.isTooltipChanged &&
                ...
                signatureField.tooltip = this.pdfViewer.enableHtmlSanitizer ?
                    _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(initialFieldSettings.tooltip) : initialFieldSettings.tooltip;
            }
            if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(initialFieldSettings.thickness) && isSetFormFieldMode === true) &&
            ...
            if (initialFieldSettings.name && this.initialFieldPropertyChanged.isNameChanged &&
                ...
                signatureField.name = this.pdfViewer.enableHtmlSanitizer ?
                    _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(initialFieldSettings.name) : initialFieldSettings.name;
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(initialFieldSettings.isPrint) &&
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(initialFieldSettings.customData) && this.initialFieldPropertyChanged.isCustomDataChanged &&
                initialFieldSettings.customData !== '') {
                signatureField.customData = initialFieldSettings.customData;
            }
        }
        else {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureFieldSettings.isReadOnly) && this.signatureFieldPropertyChanged.isReadOnlyChanged &&
                signatureFieldSettings.isReadOnly !== false) {
                signatureField.isReadonly = signatureFieldSettings.isReadOnly;
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureFieldSettings.isRequired) &&
            ...
            if (signatureFieldSettings.tooltip && this.signatureFieldPropertyChanged.isTooltipChanged &&
                !this.pdfViewer.magnificationModule.isFormFieldPageZoomed) {
                signatureField.tooltip = this.pdfViewer.enableHtmlSanitizer ?
                    _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(signatureFieldSettings.tooltip) : signatureFieldSettings.tooltip;
            }
            if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureFieldSettings.thickness) && isSetFormFieldMode === true) &&
            ...
            if (signatureFieldSettings.name && this.signatureFieldPropertyChanged.isNameChanged &&
                !this.pdfViewer.magnificationModule.isFormFieldPageZoomed) {
                signatureField.name = this.pdfViewer.enableHtmlSanitizer ?
                    _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(signatureFieldSettings.name) : signatureFieldSettings.name;
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureFieldSettings.isPrint) && this.signatureFieldPropertyChanged.isPrintChanged &&
                !this.pdfViewer.magnificationModule.isFormFieldPageZoomed) {
                signatureField.isPrint = signatureFieldSettings.isPrint;
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureFieldSettings.customData) && this.signatureFieldPropertyChanged.isCustomDataChanged &&
    ...
    FormDesigner.prototype.updateSignatureSettings = function (newSignatureFieldSettings, isInitialField) {
        isInitialField = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isInitialField) ? isInitialField : false;
        if (isInitialField) {
            this.initialFieldPropertyChanged.isReadOnlyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.isReadOnly);
            this.initialFieldPropertyChanged.isRequiredChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.isRequired);
            this.initialFieldPropertyChanged.isVisibilityChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.visibility);
            this.initialFieldPropertyChanged.isTooltipChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.tooltip);
            this.initialFieldPropertyChanged.isNameChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.name);
            this.initialFieldPropertyChanged.isPrintChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.isPrint);
            this.initialFieldPropertyChanged.isThicknessChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.thickness);
            this.initialFieldPropertyChanged.isCustomDataChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.customData);
        }
        else {
            this.signatureFieldPropertyChanged.isReadOnlyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.isReadOnly);
            this.signatureFieldPropertyChanged.isRequiredChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.isRequired);
            this.signatureFieldPropertyChanged.isVisibilityChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.visibility);
            this.signatureFieldPropertyChanged.isTooltipChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.tooltip);
            this.signatureFieldPropertyChanged.isNameChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.name);
            this.signatureFieldPropertyChanged.isPrintChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.isPrint);
            this.signatureFieldPropertyChanged.isThicknessChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.thickness);
            this.signatureFieldPropertyChanged.isCustomDataChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(newSignatureFieldSettings.customData);
        }
    };
    /**
    ...
    FormDesigner.prototype.updateTextFieldSettings = function (textFieldSettings) {
        this.textFieldPropertyChanged.isReadOnlyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.isReadOnly);
        this.textFieldPropertyChanged.isRequiredChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.isRequired);
        this.textFieldPropertyChanged.isValueChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.value);
        this.textFieldPropertyChanged.isBackgroundColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.backgroundColor);
        this.textFieldPropertyChanged.isBorderColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.borderColor);
        this.textFieldPropertyChanged.isAlignmentChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.alignment);
        this.textFieldPropertyChanged.isColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.color);
        this.textFieldPropertyChanged.isFontFamilyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.fontFamily);
        this.textFieldPropertyChanged.isFontSizeChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.fontSize);
        this.textFieldPropertyChanged.isFontStyleChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.fontStyle);
        this.textFieldPropertyChanged.isNameChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.name);
        this.textFieldPropertyChanged.isToolTipChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.tooltip);
        this.textFieldPropertyChanged.isThicknessChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.thickness);
        this.textFieldPropertyChanged.isMaxLengthChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.maxLength);
        this.textFieldPropertyChanged.isVisibilityChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.visibility);
        this.textFieldPropertyChanged.isPrintChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.isPrint);
        this.textFieldPropertyChanged.isMultilineChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.isMultiline);
        this.textFieldPropertyChanged.isCustomDataChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textFieldSettings.customData);
    };
    /**
    ...
    FormDesigner.prototype.updatePasswordFieldSettings = function (passwordFieldSettings) {
        this.passwordFieldPropertyChanged.isReadOnlyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.isReadOnly);
        this.passwordFieldPropertyChanged.isRequiredChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.isRequired);
        this.passwordFieldPropertyChanged.isValueChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.value);
        this.passwordFieldPropertyChanged.isBackgroundColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.backgroundColor);
        this.passwordFieldPropertyChanged.isBorderColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.borderColor);
        this.passwordFieldPropertyChanged.isAlignmentChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.alignment);
        this.passwordFieldPropertyChanged.isColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.color);
        this.passwordFieldPropertyChanged.isFontFamilyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.fontFamily);
        this.passwordFieldPropertyChanged.isFontSizeChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.fontSize);
        this.passwordFieldPropertyChanged.isFontStyleChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.fontStyle);
        this.passwordFieldPropertyChanged.isNameChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.name);
        this.passwordFieldPropertyChanged.isToolTipChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.tooltip);
        this.passwordFieldPropertyChanged.isThicknessChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.thickness);
        this.passwordFieldPropertyChanged.isMaxLengthChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.maxLength);
        this.passwordFieldPropertyChanged.isVisibilityChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.visibility);
        this.passwordFieldPropertyChanged.isPrintChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.isPrint);
        this.passwordFieldPropertyChanged.isCustomDataChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(passwordFieldSettings.customData);
    };
    /**
    ...
    FormDesigner.prototype.updateCheckBoxFieldSettings = function (checkBoxFieldSettings) {
        this.checkBoxFieldPropertyChanged.isReadOnlyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.isReadOnly);
        this.checkBoxFieldPropertyChanged.isRequiredChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.isRequired);
        this.checkBoxFieldPropertyChanged.isBackgroundColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.backgroundColor);
        this.checkBoxFieldPropertyChanged.isBorderColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.borderColor);
        this.checkBoxFieldPropertyChanged.isNameChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.name);
        this.checkBoxFieldPropertyChanged.isValueChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.value);
        this.checkBoxFieldPropertyChanged.isToolTipChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.tooltip);
        this.checkBoxFieldPropertyChanged.isThicknessChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.thickness);
        this.checkBoxFieldPropertyChanged.isVisibilityChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.visibility);
        this.checkBoxFieldPropertyChanged.isPrintChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.isPrint);
        this.checkBoxFieldPropertyChanged.isCheckedChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.isChecked);
        this.checkBoxFieldPropertyChanged.isCustomDataChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(checkBoxFieldSettings.customData);
    };
    /**
    ...
    FormDesigner.prototype.updateRadioButtonFieldSettings = function (radioButtonFieldSettings) {
        this.radioButtonFieldPropertyChanged.isReadOnlyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.isReadOnly);
        this.radioButtonFieldPropertyChanged.isRequiredChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.isRequired);
        this.radioButtonFieldPropertyChanged.isBackgroundColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.backgroundColor);
        this.radioButtonFieldPropertyChanged.isBorderColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.borderColor);
        this.radioButtonFieldPropertyChanged.isNameChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.name);
        this.radioButtonFieldPropertyChanged.isValueChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.value);
        this.radioButtonFieldPropertyChanged.isToolTipChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.tooltip);
        this.radioButtonFieldPropertyChanged.isThicknessChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.thickness);
        this.radioButtonFieldPropertyChanged.isVisibilityChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.visibility);
        this.radioButtonFieldPropertyChanged.isPrintChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.isPrint);
        this.radioButtonFieldPropertyChanged.isSelectedChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.isSelected);
        this.radioButtonFieldPropertyChanged.isCustomDataChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(radioButtonFieldSettings.customData);
    };
    /**
    ...
    FormDesigner.prototype.updateDropDownFieldSettings = function (dropdownFieldSettings) {
        this.dropdownFieldPropertyChanged.isReadOnlyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.isReadOnly);
        this.dropdownFieldPropertyChanged.isRequiredChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.isRequired);
        this.dropdownFieldPropertyChanged.isValueChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.value);
        this.dropdownFieldPropertyChanged.isBackgroundColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.backgroundColor);
        this.dropdownFieldPropertyChanged.isBorderColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.borderColor);
        this.dropdownFieldPropertyChanged.isAlignmentChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.alignment);
        this.dropdownFieldPropertyChanged.isColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.color);
        this.dropdownFieldPropertyChanged.isFontFamilyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.fontFamily);
        this.dropdownFieldPropertyChanged.isFontSizeChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.fontSize);
        this.dropdownFieldPropertyChanged.isFontStyleChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.fontStyle);
        this.dropdownFieldPropertyChanged.isNameChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.name);
        this.dropdownFieldPropertyChanged.isToolTipChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.tooltip);
        this.dropdownFieldPropertyChanged.isThicknessChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.thickness);
        this.dropdownFieldPropertyChanged.isVisibilityChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.visibility);
        this.dropdownFieldPropertyChanged.isPrintChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.isPrint);
        this.dropdownFieldPropertyChanged.isOptionChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.options);
        this.dropdownFieldPropertyChanged.isCustomDataChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dropdownFieldSettings.customData);
    };
    /**
    ...
    FormDesigner.prototype.updateListBoxFieldSettings = function (listBoxFieldSettings) {
        this.listBoxFieldPropertyChanged.isReadOnlyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.isReadOnly);
        this.listBoxFieldPropertyChanged.isRequiredChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.isRequired);
        this.listBoxFieldPropertyChanged.isBackgroundColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.backgroundColor);
        this.listBoxFieldPropertyChanged.isBorderColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.borderColor);
        this.listBoxFieldPropertyChanged.isAlignmentChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.alignment);
        this.listBoxFieldPropertyChanged.isColorChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.color);
        this.listBoxFieldPropertyChanged.isFontFamilyChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.fontFamily);
        this.listBoxFieldPropertyChanged.isFontSizeChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.fontSize);
        this.listBoxFieldPropertyChanged.isFontStyleChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.fontStyle);
        this.listBoxFieldPropertyChanged.isNameChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.name);
        this.listBoxFieldPropertyChanged.isToolTipChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.tooltip);
        this.listBoxFieldPropertyChanged.isThicknessChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.thickness);
        this.listBoxFieldPropertyChanged.isVisibilityChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.visibility);
        this.listBoxFieldPropertyChanged.isPrintChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.isPrint);
        this.listBoxFieldPropertyChanged.isOptionChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.options);
        this.listBoxFieldPropertyChanged.isCustomDataChanged = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listBoxFieldSettings.customData);
    };
...
//# sourceMappingURL=1134c774-86d534752b61aef3.js.map