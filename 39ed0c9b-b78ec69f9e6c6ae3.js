"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[3978],{

/***/ 20371:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   v: () => (/* binding */ RulerHelper)
/* harmony export */ });
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _ruler_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(51932);
/* harmony import */ var _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74023);
/* harmony import */ var _format_paragraph_format__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(33077);
/* harmony import */ var _size__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(76029);
...
var RulerHelper = /** @class */ (function () {
    ...
    RulerHelper.prototype.onHRulerMouseEnter = function () {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.currentTabStopElement)) {
    ...
    RulerHelper.prototype.onHRulerMouseDown = function (e) {
        ...
        var leftMargin = this.documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin
            * this.documentEditor.zoomFactor;
        var rightMargin = (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(divRect.width) -
            this.documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.rightMargin * this.documentEditor.zoomFactor);
        var pixelValue = Math.round(e.clientX - divRect.left);
        var mouseXRelativeToDiv = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(pixelValue);
        ...
        if (this.resizerEnabled && !this.documentEditor.isTableMarkerDragging) {
            ...
            this.renderInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(Math.round(e.clientX - divRect.left));
            ...
            this.initialRightMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(rightIndent.style.left);
        ...
        if (divRect.y + (divRect.height / 2) <= e.clientY) {
            ...
            if (this.documentEditor.layoutType === 'Pages') {
                this.mouseDownTabValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(this.mouseDownTabValue - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(this.documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin) *
                    this.documentEditor.zoomFactor);
                if (this.position.paragraph.paragraphFormat.bidi) {
                    var paraWidth = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.position.paragraph['absoluteXPosition']) ? parseFloat(this.position.paragraph['absoluteXPosition']['width'].toString()) : this.position.paragraph.width;
                    paraWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(paraWidth * this.documentEditor.zoomFactor);
                    this.mouseDownTabValue = paraWidth - this.mouseDownTabValue;
                }
            }
            else if (this.documentEditor.layoutType === 'Continuous') {
                if (this.position.paragraph.paragraphFormat.bidi) {
                    this.mouseDownTabValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint((this.mouseDownTabValue) - 20);
                    var paraWidth = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.position.paragraph['absoluteXPosition']) ? parseFloat(this.position.paragraph['absoluteXPosition']['width'].toString()) : this.position.paragraph.width;
                    paraWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(paraWidth * this.documentEditor.zoomFactor);
                    this.mouseDownTabValue = paraWidth - this.mouseDownTabValue;
                }
    ...
    RulerHelper.prototype.onHRulerMouseUp = function (e) {
        ...
        if (divRect.y + (divRect.height / 2) <= e.clientY) {
            ...
            if (this.documentEditor.layoutType === 'Pages') {
                this.mouseUpTabValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(this.mouseUpTabValue -
                    _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(this.documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin)
                        * this.documentEditor.zoomFactor);
                if (this.position.paragraph.paragraphFormat.bidi) {
                    var paraWidth = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.position.paragraph['absoluteXPosition']) ? parseFloat(this.position.paragraph['absoluteXPosition']['width'].toString()) : this.position.paragraph.width;
                    paraWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(paraWidth * this.documentEditor.zoomFactor);
                ...
                if (this.position.paragraph.paragraphFormat.bidi) {
                    this.mouseUpTabValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint((this.mouseUpTabValue) - 20);
                    var paraWidth = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.position.paragraph['absoluteXPosition']) ? parseFloat(this.position.paragraph['absoluteXPosition']['width'].toString()) : this.position.paragraph.width;
                    paraWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(paraWidth * this.documentEditor.zoomFactor);
                    this.mouseUpTabValue = paraWidth - this.mouseUpTabValue;
                }
            ...
            var rightIndent = document.getElementById(this.documentEditor.element.id + '_rightIndent');
            var rightIndentValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(rightIndent.style.left);
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(container)) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(visibleElement)) {
                        ...
                        if (dataNameValue === 'LeftTab' || dataNameValue === 'CenterTab'
                            ...
                            var tabStop = new _format_paragraph_format__WEBPACK_IMPORTED_MODULE_2__/* .WTabStop */ .$();
        ...
        if (this.isDraggingRender && !this.documentEditor.isTableMarkerDragging && !this.isDraggingVertical) {
            ...
            if (this.isLeftMultiColumn || this.isRightMultiColumn) {
                ...
                var columnSpace = this.isLeftMultiColumn ? (secFormat.columns[0].space +
                    ((_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(finalvalue))))
                    : (secFormat.columns[0].space - ((_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(finalvalue))));
                for (var i = 0; i < secFormat.columns.length; i++) {
                    var col = secFormat.columns[parseInt(i.toString(), 10)];
                    if (columnSpace >= 0 && col.width >= 36) {
                        var widthCal = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((pageWidth - (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(columnSpace) * (secFormat.numberOfColumns - 1))) / (secFormat.numberOfColumns));
                        col.width = widthCal;
                ...
                var rightMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(this.rulerGeometry.width) - (mouseXRelativeToDiv / this.documentEditor.zoomFactor);
    ...
    RulerHelper.prototype.onVMouseMove = function (e) {
        ...
        var topMargin = this.documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.topMargin
            * this.documentEditor.zoomFactor;
        var bottomMargin = (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(divRect.height) - this.documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.bottomMargin
            * this.documentEditor.zoomFactor);
        var mouseXRelativeToDiv = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(Math.round(e.clientY - divRect.top));
        ...
        if (this.isDraggingRender) {
            var mouseXRelativeToDiv_1 = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(Math.round(e.clientY - divRect.top));
            var rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.topMargin)
                * this.documentEditor.zoomFactor;
            ...
            if (this.isTopRulerMargin) {
                ...
                var topMaxLimit = rulerZeroPoint + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(pageHeight - bottomMarginValue - minimumValue) * this.documentEditor.zoomFactor);
                if (pixelValue + rulerZeroPoint > topMaxLimit) {
                    pixelValue = topMaxLimit - rulerZeroPoint;
                    mouseXRelativeToDiv_1 = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(pixelValue);
                }
                ...
                var bottomMinLimit = rulerZeroPoint + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(topMarginValue + minimumValue) * this.documentEditor.zoomFactor);
                var bottomMaxLimit = rulerZeroPoint + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(pageHeight) * this.documentEditor.zoomFactor);
            ...
            var currentBottomMargin = (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(divRect.height) -
    ...
    RulerHelper.prototype.onVMouseDown = function (e) {
        if (this.resizerEnabled) {
            ...
            var divRect = this.vRuler.getBoundingClientRect();
            this.initialYValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(Math.round(e.clientY - divRect.top));
    ...
    RulerHelper.prototype.onVMouseUp = function (e) {
        if (this.isDraggingRender) {
            ...
            if (this.isTopRulerMargin) {
                ...
                var bottomtMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(this.rulerGeometry.height) - (mouseXRelativeToDiv / this.documentEditor.zoomFactor);
    ...
    RulerHelper.prototype.onFirstLineIndentMouseDown = function (e) {
        ...
        this.indentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.firstLineIndent.style.left);
        var rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin) * this.documentEditor.zoomFactor;
        if (this.documentEditor.selectionModule.paragraphFormat.bidi) {
            rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin -
                ...
                if (this.documentEditor.selectionModule.paragraphFormat.bidi) {
                    rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin -
                        (this.documentEditor.selectionModule.sectionFormat.pageWidth -
                            this.documentEditor.selectionModule.sectionFormat.leftMargin -
                            this.documentEditor.selectionModule.sectionFormat.rightMargin)) * this.documentEditor.zoomFactor;
                    maxValue = rulerZeroPoint - 6 + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(this.documentEditor.selectionModule.sectionFormat.pageWidth) * this.documentEditor.zoomFactor);
                    minValue = rightIndentValue + _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(42) * this.documentEditor.zoomFactor;
                }
                else {
                    rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin)
                        * this.documentEditor.zoomFactor;
                    minValue = rulerZeroPoint - 6;
                    maxValue = rightIndentValue - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(42) * this.documentEditor.zoomFactor;
                }
            }
            else if (this.documentEditor.layoutType === 'Continuous') {
                if (this.position.paragraph.paragraphFormat.bidi) {
    ...
    RulerHelper.prototype.onIndentMouseUp = function (e) {
        if (this.isDraggingIndents1) {
            this.isDraggingIndents1 = false;
            var finalValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.firstLineIndent.style.left);
    ...
    RulerHelper.prototype.onHangIndentMouseDown = function (e) {
        ...
        this.hangingIndentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.hangingIndent.style.left);
        var rightIndent = document.getElementById(this.documentEditor.element.id + '_rightIndent');
        var rightPosition = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(rightIndent.style.left);
        var rulerZeroPoint;
        if (this.documentEditor.layoutType === 'Pages') {
            if (this.documentEditor.selectionModule.paragraphFormat.bidi) {
                rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin -
                    (this.documentEditor.selectionModule.sectionFormat.pageWidth -
                        this.documentEditor.selectionModule.sectionFormat.leftMargin -
                        this.documentEditor.selectionModule.sectionFormat.rightMargin)) * this.documentEditor.zoomFactor;
                this.minLimit1 = rightPosition + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(42) * this.documentEditor.zoomFactor);
                this.maxLimit1 = rulerZeroPoint - 6 + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(this.documentEditor.selectionModule.sectionFormat.pageWidth) * this.documentEditor.zoomFactor);
            }
            else {
                rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin) * this.documentEditor.zoomFactor;
                this.minLimit1 = rulerZeroPoint - 6;
                this.maxLimit1 = (rightPosition - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(42) * this.documentEditor.zoomFactor);
            }
        }
        else if (this.documentEditor.layoutType === 'Continuous') {
            if (this.position.paragraph.paragraphFormat.bidi) {
    ...
    RulerHelper.prototype.onHangIndentMouseUp = function (e) {
        if (this.isDraggingIndents2) {
            this.isDraggingIndents2 = false;
            var finalValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.hangingIndent.style.left);
    ...
    RulerHelper.prototype.onLeftIndentMouseDown = function (e) {
        ...
        this.indentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.leftIndent.style.left);
        this.firstIndentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.firstLineIndent.style.left);
            ...
            if (this.documentEditor.selectionModule.paragraphFormat.bidi) {
                rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin -
                    (this.documentEditor.selectionModule.sectionFormat.pageWidth -
                        this.documentEditor.selectionModule.sectionFormat.leftMargin -
                        this.documentEditor.selectionModule.sectionFormat.rightMargin)) * this.documentEditor.zoomFactor;
                this.minLimit2 = (rightPosition + _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(42) * this.documentEditor.zoomFactor);
                this.maxLimit2 = rulerZeroPoint - 6 + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(this.documentEditor.selectionModule.sectionFormat.pageWidth) * this.documentEditor.zoomFactor);
                this.isHangingIndent = (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.hangingIndent.style.left) - rightPosition)
                    <= (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.firstLineIndent.style.left) - rightPosition);
            }
            else {
                rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin) * this.documentEditor.zoomFactor;
                this.minLimit2 = rulerZeroPoint - 6;
                this.maxLimit2 = (rightPosition - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(42) * this.documentEditor.zoomFactor);
                this.isHangingIndent = (rightPosition - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.hangingIndent.style.left))
                    <= (rightPosition - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.firstLineIndent.style.left));
            }
        }
        else if (this.documentEditor.layoutType === 'Continuous') {
            if (this.position.paragraph.paragraphFormat.bidi) {
    ...
    RulerHelper.prototype.onLeftIndentMouseUp = function (e) {
        if (this.isDraggingIndents3) {
            this.isDraggingIndents3 = false;
            var finalValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.leftIndent.style.left);
    ...
    RulerHelper.prototype.onRightIndentMouseDown = function (e) {
        ...
        this.indentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.rightIndent.style.left);
        var rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin) * this.documentEditor.zoomFactor;
        if (this.documentEditor.selectionModule.paragraphFormat.bidi) {
            rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin -
    ...
    RulerHelper.prototype.onRightIndentMouseMove = function (e) {
        if (this.isDraggingIndents4) {
            ...
            if (this.documentEditor.selectionModule.paragraphFormat.bidi) {
                ...
                var nearestElement = (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(leftIndent.style.left) - value) <= (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(firstLineIndent.style.left) - value) ? leftIndent : firstLineIndent;
                var indentValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(nearestElement.style.left);
                maxValue = indentValue - (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(42) * this.documentEditor.zoomFactor);
                minValue = rulerZeroPoint - 6;
            }
            else {
                if (this.documentEditor.layoutType === 'Pages') {
                ...
                value = rulerZeroPoint + e.clientX - this.rightLineOffset - this.hRuler.getBoundingClientRect().left;
                var nearestElement = (value - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(leftIndent.style.left))
                    <= (value - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(firstLineIndent.style.left)) ? leftIndent : firstLineIndent;
                var indentValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(nearestElement.style.left);
                ...
                minValue = indentValue + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(42) * this.documentEditor.zoomFactor);
            }
            if (value < minValue) {
                value = minValue;
            }
    ...
    RulerHelper.prototype.onRightIndentMouseUp = function (e) {
        if (this.isDraggingIndents4) {
            this.isDraggingIndents4 = false;
            var finalValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.rightIndent.style.left);
            if (this.documentEditor.selectionModule.paragraphFormat.bidi) {
    ...
    RulerHelper.prototype.onTabStopMouseDown = function (e) {
        ...
        this.tabInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.tabStopElement.style.left);
        ...
        var rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - this.documentEditor.selectionModule.sectionFormat.leftMargin)
            * this.documentEditor.zoomFactor;
        if (this.documentEditor.layoutType === 'Continuous') {
            rulerZeroPoint = (this.documentEditor.hRuler.zeroPosition * this.documentEditor.zoomFactor) - 20;
            if (this.position.paragraph.paragraphFormat.bidi) {
        ...
        if (this.isDraggingForTab) {
            ...
            if (this.documentEditor.layoutType === 'Continuous') {
                ...
                if (this.position.paragraph.bidi) {
                    rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 + this.documentEditor.selectionModule.sectionFormat.rightMargin
            ...
            var maxValue = rightIndentValue;
            var leftIndent = document.getElementById(this.documentEditor.element.id + '_leftIndent');
            var leftIndentValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(leftIndent.style.left);
    ...
    RulerHelper.prototype.onRenderTabStopMouseUp = function (e) {
        if (this.isDraggingForTab && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.currentTabStop)) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.currentTabStopElement) && this.currentTabStopElement.style.display === 'none') {
                ...
                var finalValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.tabStopElement.style.left);
                this.tabInitialValue = finalValue;
                this.documentEditor.editorModule.removeTabStops([this.currrentParagraph], [this.currentTabStop]);
                finalValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(finalValue / this.documentEditor.zoomFactor) - 1584;
    ...
    RulerHelper.prototype.createHtmlElement = function (elementType, attribute) {
        var element = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)(elementType, attribute);
    ...
    RulerHelper.prototype.renderRulerMarkerIndicatorElement = function (documentEditor) {
        ...
        var locale = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .L10n */ .Wo('documenteditor', documentEditor.defaultLocale);
        ...
        for (var i = 0; i < 5; i++) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(element_1)) {
    ...
    RulerHelper.prototype.renderRuler = function (documentEditor, isHorizontal) {
        ...
        var ruler = new _ruler_index__WEBPACK_IMPORTED_MODULE_3__/* .Ruler */ .b(this.rulerDiv, this);
        ...
        if (rulerObj) {
            ...
            if (isHorizontal) {
                rulerObj.scrollLeft = ruler.zeroPosition -
                    _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin);
            }
            else {
                rulerObj.scrollTop = ruler.zeroPosition -
                    _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.topMargin);
            }
        }
        this.locale = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .L10n */ .Wo('documenteditor', documentEditor.defaultLocale);
        if (isHorizontal) {
    ...
    RulerHelper.prototype.onHorizontalRulerMouseMoved = function (e) {
        ...
        if (this.isDraggingRender) {
            ...
            if (this.isLeftRulerMargin) {
                var leftMaxLimit = rulerZeroPoint + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(pageWidth - rightMarginValue -
                    rightIndentValue - minimumValue - firstLineIndent - leftIndent) * this.documentEditor.zoomFactor);
                var leftMinLimit = rulerZeroPoint;
                if (pixelValue + rulerZeroPoint > leftMaxLimit) {
                    pixelValue = leftMaxLimit - rulerZeroPoint;
                    mouseXRelativeToDiv = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(pixelValue);
                }
                else if (pixelValue + rulerZeroPoint < leftMinLimit) {
                    pixelValue = leftMinLimit - rulerZeroPoint;
                    mouseXRelativeToDiv = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(pixelValue);
                ...
                var rightMinLimit = rulerZeroPoint + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(leftMarginValue + leftIndent + firstLineIndent + minimumValue + rightIndentValue) * this.documentEditor.zoomFactor);
                var rightMaxLimit = rulerZeroPoint + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(pageWidth) * this.documentEditor.zoomFactor);
                if (pixelValue + rulerZeroPoint > rightMaxLimit) {
                    pixelValue = rightMaxLimit - rulerZeroPoint;
                    mouseXRelativeToDiv = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(pixelValue);
                }
            ...
            this.finalmouseXRelativeToDiv = mouseXRelativeToDiv;
            var currentRightMargin = (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(divRect.width)
                - (this.documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.rightMargin
                    * this.documentEditor.zoomFactor));
            ...
            if (this.isLeftRulerMargin) {
                ...
                rightIndent.style.left = (this.initialRightMargin - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(difference)) + 'px';
            }
            else {
                var difference = mouseXRelativeToDiv - this.renderInitialValue;
                rightIndent.style.left = (this.initialRightMargin + _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(difference)) + 'px';
    ...
    RulerHelper.prototype.updateRulerPosition = function (documentEditor, isHorizontal) {
        ...
        if (rulerObj) {
            // Set the scrollLeft property to the desired value (e.g., 100 pixels)
            rulerObj.scrollLeft = 2112 - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin);
        }
    };
    ...
    RulerHelper.prototype.updateIndentMarkers = function (documentEditor) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(documentEditor) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(documentEditor.element)
            || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(documentEditor.element.id) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(documentEditor.hRuler)
            || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(documentEditor.hRuler.zeroPosition)) {
            return;
        }
        var indent = undefined;
        var ownerId = documentEditor.element.id;
        var rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - documentEditor.selectionModule.sectionFormat.leftMargin);
        ...
        if (this.position.paragraph.paragraphFormat.bidi || (this.position.paragraph.isInsideTable
            ...
            var rulerMarginDivWidth = ((rulerGeometry.width / documentEditor.zoomFactor) -
                (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((this.position.paragraph.bodyWidget.sectionFormat.rightMargin)
                    + (this.position.paragraph.bodyWidget.sectionFormat.leftMargin))));
            rulerZeroPoint -= rulerMarginDivWidth;
        }
        var paraStart = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.position.paragraph['absoluteXPosition']) ? parseFloat(this.position.paragraph['absoluteXPosition']['x'].toString()) : this.position.paragraph.x;
        var paraWidth = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.position.paragraph['absoluteXPosition']) ? parseFloat(this.position.paragraph['absoluteXPosition']['width'].toString()) : this.position.paragraph.width;
        var finalValueTemp;
        if (this.position.paragraph.paragraphFormat.bidi) {
            rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - documentEditor.selectionModule.sectionFormat.leftMargin -
        ...
        if (documentEditor.layoutType === 'Pages') {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(indent)) {
                if (this.position.paragraph.paragraphFormat.bidi) {
                    indent.style.left = (((finalValueTemp - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(firstLineIndent)) * documentEditor.zoomFactor) - 6) + 'px';
                }
                else {
                    indent.style.left = (((finalValueTemp + _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(firstLineIndent)) * documentEditor.zoomFactor) - 6) + 'px';
                }
            ...
            if (this.position.paragraph.paragraphFormat.bidi) {
                rulerZeroPoint = (documentEditor.hRuler.zeroPosition * documentEditor.zoomFactor) -
                    20 - documentEditor.viewer.clientArea.width;
                finalValueTemp = rulerZeroPoint + paraStart + paraWidth - (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(firstLineIndent) * documentEditor.zoomFactor);
            }
            else {
                rulerZeroPoint = (documentEditor.hRuler.zeroPosition * documentEditor.zoomFactor) - 20;
                finalValueTemp = rulerZeroPoint + ((paraStart + _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(firstLineIndent)) * documentEditor.zoomFactor);
            }
            indent.style.left = finalValueTemp + 'px';
        }
        indent = document.getElementById(ownerId + '_rightIndent');
    ...
    RulerHelper.prototype.updateTabStopMarkers = function (documentEditor) {
        ...
        var rulerSize = this.getRulerSize(documentEditor);
        var RenderedTabElement = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertNodeListToArray(document.querySelectorAll('.e-de-ruler-tab'));
        for (var i = 0; i < tabs.length; i++) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(tabMarker)) {
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(RenderedTabElement) && RenderedTabElement.length > 0) {
                    RenderedTabElement.splice(RenderedTabElement.indexOf(tabMarker), 1);
                }
                var value = this.position.paragraph.paragraphFormat.bidi ?
                    (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - tabStop.position))
                    : (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 + tabStop.position));
                ...
                if (justification !== 'List' && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(justification)) {
                    this.renderTab(documentEditor, rulerSize, tabStop, justification, i, locale);
                }
            }
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(RenderedTabElement)) {
            for (var i = 0; i < RenderedTabElement.length; i++) {
                var elementToRemove = RenderedTabElement[parseInt(i.toString(), 10)];
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(elementToRemove)) {
    ...
    RulerHelper.prototype.updateRulerMargins = function (documentEditor) {
        ...
        var rulerMarginDivHeight = rulerGeometry.height - (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.bottomMargin
    ...
    RulerHelper.prototype.updateHorizontalRulerMargin = function (documentEditor) {
        ...
        var tableBidi = false;
        var currnLefttMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin - 72);
        var currentRightMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.rightMargin - 72);
        ...
        var rulerMarginDivWidth = (this.getRulerGeometry(documentEditor).width -
            (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.rightMargin
    ...
    RulerHelper.prototype.resizeVRulerMargins = function (isRulerTopMargin, currentTopMargin, currentScrollTop, currentBottomMargin, ruler, mousePosition, documentEditor) {
        ...
        var rulerGeometry = this.getRulerGeometry(documentEditor);
        if (isRulerTopMargin) {
            rulerMarginDiv.style.height = (rulerGeometry.height - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.bottomMargin * documentEditor.zoomFactor) + mousePosition)).toString() + 'px';
            if (currentTopMargin < mousePosition) {
                ruler.scrollTop = currentScrollTop - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(mousePosition - currentTopMargin);
            }
            else {
                ruler.scrollTop = currentScrollTop + _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(currentTopMargin - mousePosition);
            }
        }
        else {
            var bottomMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(rulerGeometry.height) - mousePosition;
            rulerMarginDiv.style.height = (rulerGeometry.height - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.topMargin * documentEditor.zoomFactor) + (bottomMargin))).toString() + 'px';
    ...
    RulerHelper.prototype.resizeRulerMargins = function (isRulerLeftMargin, currentLeftMargin, currentScrollLeft, currentRightMargin, ruler, mousePosition, isHorizontal, documentEditor) {
        ...
        var rulerGeometry = this.getRulerGeometry(documentEditor);
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isRulerLeftMargin) && isRulerLeftMargin) {
            rulerMarginDiv.style.width = (rulerGeometry.width - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.rightMargin * documentEditor.zoomFactor) + mousePosition)).toString() + 'px';
            if (currentLeftMargin < mousePosition) {
                ruler.scrollLeft = currentScrollLeft - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(mousePosition - currentLeftMargin);
            }
            else {
                ruler.scrollLeft = currentScrollLeft + _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(currentLeftMargin - mousePosition);
            }
        }
        else {
            var rightMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(rulerGeometry.width) - mousePosition;
            rulerMarginDiv.style.width = (rulerGeometry.width - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin * documentEditor.zoomFactor) + (rightMargin))).toString() + 'px';
    ...
    RulerHelper.prototype.getRulerOrigin = function () {
        var range = 1584;
        var pixelValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584);
    ...
    RulerHelper.prototype.renderIndents = function (documentEditor, isHorizontal, rulerSize, rulerGeometry, locale) {
        ...
        if (!this.firstLineIndent) {
            var margin = ('left:' + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin) - 6) * documentEditor.zoomFactor + 'px;');
            ...
            this.isDraggingIndents1 = false;
            this.indentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.firstLineIndent.style.left); // for mouse up event
            var indentsInitialValue2 = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.firstLineIndent.style.left); // for mouse move event
        ...
        if (!this.hangingIndent) {
            var margin = ('left:' + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin) - 6) + 'px;');
            ...
            this.hangingIndentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.hangingIndent.style.left); // for mouse up event
            var initialValue2 = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.hangingIndent.style.left); // for mouse move event
        ...
        if (!this.leftIndent) {
            ...
            this.indentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.leftIndent.style.left); // for mouse down event
            var initialValue2 = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.leftIndent.style.left); // for mouse move event
        ...
        if (!this.rightIndent) {
            var margin = ('left:' + (documentEditor.selectionModule.end.paragraph.bodyWidget.page.boundingRectangle.width - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.rightMargin) - 6) + 'px;');
            ...
            this.indentInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.rightIndent.style.left); // for mouse down event
            var initialValue2 = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.rightIndent.style.left); // for mouse move event
    ...
    RulerHelper.prototype.updateRuler = function (documentEditor, rerenderRuler) {
        ...
        var hOffset = 0;
        // const vOffset: number = - documentEditor.scroller.verticalOffset;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(documentEditor.hRuler) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(documentEditor.vRuler)) {
            return;
        }
        if (documentEditor.selectionModule.isForward) {
            this.position = documentEditor.selectionModule.start;
    ...
    RulerHelper.prototype.removeTableMarkers = function (documentEditor, ruler) {
        var renderedTableMarkers = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertNodeListToArray(document.querySelectorAll('.e-de-ruler-table-marker'));
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(renderedTableMarkers)) {
    ...
    RulerHelper.prototype.renderTableMarkers = function (documentEditor, ruler) {
        ...
        var _loop_1 = function (i) {
            ...
            tableMarker.addEventListener('mousedown', function (e) {
                ...
                documentEditor.startXPosition = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(e.clientX);
                documentEditor.isTableMarkerDragging = true;
                var cursorPoint = new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .Point */ .bR(e.clientX, e.clientY);
                ...
                var rulerZeroPoint = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(1584 - documentEditor.selectionModule.sectionFormat.leftMargin) * documentEditor.zoomFactor;
            ...
            document.addEventListener('mousemove', function (e) {
                ...
                if (documentEditor.isTableMarkerDragging) {
                    ...
                    if (documentEditor.selectionModule.end.paragraph.associatedCell.ownerTable.tableFormat.bidi) {
                        ...
                        var rulerMarginDivWidth = (rulerGeometry.width - (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel((documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.rightMargin * documentEditor.zoomFactor)
            ...
            document.addEventListener('mouseup', function (e) {
                ...
                if (documentEditor.isTableMarkerDragging) {
                    ...
                    var dragValue = _this.position.paragraph.associatedCell.ownerTable.tableFormat.bidi ?
                        (documentEditor.startXPosition - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(e.clientX))
                        : (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(e.clientX) - documentEditor.startXPosition);
        ...
        if (isHorizontal) {
            if (documentEditor.layoutType === 'Pages') {
                ...
                if (paraBidi || tableBidi) {
                    ...
                    rulerObj.scrollLeft = (ruler.zeroPosition - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.leftMargin)) * documentEditor.zoomFactor;
                }
            }
            else {
                var paraBidi = this.position.paragraph.paragraphFormat.bidi;
            ...
            rulerObj.scrollTop = (ruler.zeroPosition - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPointToPixel(documentEditor.selectionModule.end.paragraph.bodyWidget.sectionFormat.topMargin)) * documentEditor.zoomFactor;
        }
    };
    /**
    ...
    RulerHelper.prototype.getRulerGeometry = function (documentEditor) {
        ...
        var width = (documentEditor.selectionModule.end.paragraph.bodyWidget.page.boundingRectangle.width
            * documentEditor.zoomFactor);
        return new _size__WEBPACK_IMPORTED_MODULE_4__/* .Size */ .o(width, height);
    };
    RulerHelper.prototype.getVerticalHeight = function (documentEditor) {
        var pageheight = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.convertPixelToPoint(documentEditor.selectionModule.end.paragraph.bodyWidget.page.boundingRectangle.height);
    ...
    RulerHelper.prototype.renderTab = function (documentEditor, rulerSize, tabStop, tabJustification, i, locale) {
        ...
        switch (tabJustification) {
            case 'Left': {
                ...
                if (!this.leftTab) {
                    var style = '';
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(tabStop)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(tabStop)) {
            ...
            this.tabInitialValue = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.tabStopElement.style.left); // for mouse up event
            var initialValue2 = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_1__/* .HelperMethods */ .LD.getNumberFromString(this.tabStopElement.style.left); // for mouse move event
    ...
    RulerHelper.prototype.getRulerSize = function (documentEditor) {
        ...
        left = 15;
        //}
        return new _size__WEBPACK_IMPORTED_MODULE_4__/* .Size */ .o(left, top);
    };
...
//# sourceMappingURL=39ed0c9b-b78ec69f9e6c6ae3.js.map