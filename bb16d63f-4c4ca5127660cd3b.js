...
/* harmony export */   C: () => (/* binding */ FormFields)
/* harmony export */ });
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(50699);
/* harmony import */ var _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(63037);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(99320);
...
var FormFields = /** @class */ (function () {
        ...
        if (this.data) {
            ...
            if (this.formFieldsData !== null && canvasElement !== null && textLayer !== null) {
                ...
                for (var i = 0; i < this.formFieldsData.length; i++) {
                    ...
                    if (!flag && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(formField.ActualFieldName) && formField.PageIndex === pageIndex) {
                    ...
                    if (currentData.FieldName !== '') {
                        ...
                        if (this_1.pdfViewer.formDesigner) {
                            if (parseFloat(currentData['PageIndex']) === pageIndex) {
                                ...
                                var fontSize = void 0;
                                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) && font.Height) {
                                    if (font.Italic) {
                                        fontStyle = 'Italic';
                                    }
                                    if (font.Bold) {
                                ...
                                var fieldProperties = {
                                    ...
                                    font: { isItalic: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) ? font.Italic : false, isBold: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) ?
                                            font.Bold : false, isStrikeout: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) ? font.Strikeout : false,
                                        isUnderline: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) ? font.Underline : false },
                                    isTransparent: currentData.IsTransparent,
                                    customData: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData['CustomData']) ? typeof currentData['CustomData'] === 'object'
                                ...
                                if (!currentData.id && this_1.pdfViewer.formFieldCollections[parseInt(i.toString(), 10)] && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData['ActualFieldName'])) {
                                ...
                                if (currentData.Name !== 'SignatureText' || currentData.Name !== 'SignatureImage') {
                                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this_1.getFormFieldType(currentData))) {
                            ...
                            if (parseFloat(currentData['PageIndex']) === pageIndex) {
                                ...
                                if (inputField) {
                                    ...
                                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData.Value)) {
    ...
    FormFields.prototype.setToolTip = function (tooltipContent, targetElement) {
        ...
        var tooltip = new _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .Tooltip */ .m({
    ...
    FormFields.prototype.getListValues = function (currentData) {
        ...
        if (this.getFormFieldType(currentData) === 'DropDown') {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listItem)) {
                ...
                if (this_2.pdfViewer.formDesignerModule) {
                    if (currentData.Name !== 'ink' && currentData.Name !== 'SignatureImage' && currentData.Name !== 'SignatureText') {
                        ...
                        if (index >= 0) {
                            ...
                            if (currentData.Name === 'ink') {
                                var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__/* .processPathData */ .lW)(value);
                                var csData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__/* .splitArrayCollection */ .yo)(collectionData);
                    ...
                    if (currentData.Name !== 'ink') {
                        ...
                        if (currentData.LineBounds) {
                            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData.Bounds)) {
    ...
    FormFields.prototype.retreiveFormFieldsData = function (currentData, isCollection, data) {
        ...
        if (currentData.FieldName !== '') {
            ...
            var fieldProperties = {
                ...
                maxLength: currentData.MaxLength, visibility: currentData.Visible === 1 ? 'hidden' : 'visible',
                font: { isItalic: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) ? font.Italic : false, isBold: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) ? font.Bold : false,
                    isStrikeout: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) ? font.Strikeout : false, isUnderline: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(font) ?
    ...
    FormFields.prototype.updateFormFieldsCollection = function (formField) {
        ...
        if (formField.LineBounds) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(formField.Bounds)) {
                ...
                if (currentData.Name === 'Textbox' || currentData.Name === 'Password' || currentData.Multiline) {
                    ...
                    if (currentCheckBoxIndex && currentData.Selected) {
                        fieldDatas = { isSelected: currentCheckBoxIndex, isReadOnly: currentData.IsReadonly,
                            fieldValue: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData.Value) ? currentData.Value : '' };
                        datas[currentData.GroupName] = fieldDatas;
                    }
                    ...
                    if (currentData.Value && currentData.Value !== '') {
                        ...
                        if (fontFamily) {
                            ...
                            var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__/* .processPathData */ .lW)(currentData.Value);
                            csData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__/* .splitArrayCollection */ .yo)(collectionData);
                        }
                    }
                    if (isRequired && (currentData.Value === null || currentData.Value === '')) {
                        this.pdfViewerBase.validateForm = true;
    ...
    FormFields.prototype.drawSignature = function (signatureType, value, target, fontname, signBounds) {
        ...
        var _loop_3 = function (i) {
            ...
            if (this_3.pdfViewer.formDesigner ? fieldName === targetName : fieldName === targetName &&
                (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(formFieldsData[parseInt(i.toString(), 10)].ActualFieldName))) {
                ...
                this_3.pdfViewer.annotations.filter(function (item) {
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentField_1) && item.id === target.id + '_content') {
                        signatureAdd_1 = false;
                    }
                });
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentField_1)) {
                    ...
                    if (signatureType === 'Path' && !this_3.pdfViewer.drawing.isPasted && !this_3.pdfViewer.annotation.isUndoAction) {
                        if (value && this_3.pdfViewerBase.signatureModule.outputString === '' && (typeof value === 'string' && value.trim().startsWith('['))) {
                            ...
                            var newArray = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__/* .splitArrayCollection */ .yo)(parsenew);
                            currentValue_1 = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__/* .getPathString */ .nv)(newArray);
                        }
                    }
                    ...
                    if (this_3.pdfViewerBase.drawSignatureWithTool && signatureField_1 && signatureType !== 'Image') {
                        ...
                        if (signatureField_1.wrapper.children[1] && obj.wrapper.id === signatureField_1.wrapper.children[1].id) {
                            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureField_1.wrapper.children[1]) && signatureField_1.wrapper.children[1].relativeMode === 'Point') {
    ...
    FormFields.prototype.imageOnLoad = function (bounds, image, currentValue, currentPage, rotateAngle, currentField, signatureField, signString, signatureFontFamily, signatureFontSize, target) {
        ...
        if (this.pdfViewerBase.drawSignatureWithTool && signatureField) {
            ...
            if (signatureField.wrapper.children[1] && obj.wrapper.id === signatureField.wrapper.children[1].id) {
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureField.wrapper.children[1]) && signatureField.wrapper.children[1].relativeMode === 'Point') {
            ...
            var _loop_4 = function (i) {
                if (formFieldsData[parseInt(i.toString(), 10)].Key === key) {
                    ...
                    if (annot.shapeAnnotationType === 'Path') {
                        var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__/* .processPathData */ .lW)(annot.data);
                        var csData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_2__/* .splitArrayCollection */ .yo)(collectionData);
    ...
    FormFields.prototype.updateDataInSession = function (target, signaturePath, signatureBounds, signatureFontFamily, signatureFontSize, isUpdateSameField) {
                ...
                if (currentData.uniqueID === target.id || fieldsByName === currentData.FieldName) {
                    if (target && target.type === 'text' || target.type === 'password' || target.type === 'textarea') {
                        ...
                        if (signField.classList.contains('e-pdfviewer-signatureformfields') || signField.classList.contains('e-pdfviewer-signatureformfields-signature')) {
                            ...
                            if (signatureBounds) {
                                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentData.uniqueID) && fieldsByName === currentData.FieldName
                            ...
                            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(target.multiline)) {
        ...
        if (this.pdfViewer.formDesignerModule && target && target.id) {
            ...
            if (selectedItem && selectedItem.wrapper && selectedItem.wrapper.children[0]) {
                ...
                var point = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_3__/* .cornersPointsBeforeRotation */ .Vz)(selectedItem.wrapper.children[0]).topLeft;
    ...
    FormFields.prototype.removeExistingFormFields = function () {
        var data = this.pdfViewerBase.getItemFromSessionStorage('_formDesigner');
        var formFieldsData = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(data) ? JSON.parse(data) : null;
        if (formFieldsData) {
            for (var i = 0; i < formFieldsData.length; i++) {
    ...
    FormFields.prototype.createSignatureField = function (data, pageIndex, index, printContainer, count) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textLayer)) {
    ...
    FormFields.prototype.renderExistingAnnnot = function (data, index, printContainer, isFieldRotated) {
        if (!printContainer) {
            ...
            if ((data.Name === 'SignatureField' || data.Name === 'InitialField') && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(data.id)) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureFieldElement) && this.isSignatureField) {
                ...
                else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(signatureFieldElement) && data.Value) {
                    var inputField = signatureFieldElement.children[0].children[0];
                    inputField.style.pointerEvents = 'none';
                    inputField.className = 'e-pdfviewer-signatureformfields-signature';
                    inputField.parentElement.style.pointerEvents = 'none';
...
//# sourceMappingURL=bb16d63f-4c4ca5127660cd3b.js.map