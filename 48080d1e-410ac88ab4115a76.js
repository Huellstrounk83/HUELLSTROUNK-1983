"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[4625],{

/***/ 57177:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   q: () => (/* binding */ BasicFormulas)
/* harmony export */ });
/* harmony import */ var _common_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(62569);
/* harmony import */ var _base_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65277);
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6841);
/* harmony import */ var _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(28132);
...
var BasicFormulas = /** @class */ (function () {
    ...
    BasicFormulas.prototype.init = function () {
        ...
        for (var i = 0; i < this.formulas.length; i++) {
            fn = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .getValue */ ._W)('Compute' + this.formulas[i].formulaName, this).bind(this);
    ...
    BasicFormulas.prototype.ComputeSUM = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || (args.length === 1 && args[0] === '')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        var sum = 0;
        var val;
        var orgValue;
        var maxDecimalLength = 0;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args)) {
            var argArr = args;
            ...
            for (var i = 0; i < argArr.length; i++) {
                ...
                if (argValue.indexOf(':') > -1 && this.parent.isCellReference(argValue)) {
                    ...
                    for (var j = 0; j < cellCollection.length; j++) {
                        ...
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(val[0]) || isNaN(this.parent.parseFloat(val))) {
                            continue;
                        }
                    ...
                    if (argArr[i].indexOf(this.parent.tic) > -1) {
                        if (isNaN(this.parent.parseFloat(argArr[i].split(this.parent.tic).join(''))) ||
                            ...
                            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
                        }
                    }
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(orgValue) || isNaN(this.parent.parseFloat(orgValue))) {
                        continue;
                    }
    ...
    BasicFormulas.prototype.ComputeINT = function () {
        ...
        if (args[0] === '' && args.length === 1) {
            ...
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
        ...
        if (!this.parent.isCellReference(args[0])) {
            ...
            if (argsValue.trim() === '') {
                return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
            }
        }
    ...
    BasicFormulas.prototype.ComputeTODAY = function () {
        ...
        if (args.length !== 1 || args[0] !== '') {
            str = this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        else {
    ...
    BasicFormulas.prototype.ComputeWEEKDAY = function () {
        ...
        if ((args[0] === '' && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args[1])) || args.length > 2) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        if ((args[0] === '' && args[1] === '') || args[1] === '') {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Num].toString();
        }
        if (args.length === 1) {
            args.push('1');
        }
        ...
        switch (value) {
            ...
            case 16:
                ...
                break;
            default:
                day = this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Num].toString();
                break;
        }
        return day;
    };
    ...
    BasicFormulas.prototype.ComputePROPER = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || (args[0].trim() === '' && args.length === 1)) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        else if (args.length > 1) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
    ...
    BasicFormulas.prototype.ComputeSUMPRODUCT = function () {
        ...
        for (var i = 0; i < ranges.length; i++) {
            ...
            if (cells[0] === '#REF!') {
                return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
            }
    ...
    BasicFormulas.prototype.ComputeROUNDUP = function () {
        ...
        var num;
        var len = args.length;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) && len > 2) {
            str = this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        if (len === 1 && args[0] !== '') {
            ...
            if (digits > 0) {
                ...
                if (isNaN(num)) {
                    if (digits.toString().indexOf('"') > -1) {
                        str = this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
                    }
                    else {
                        str = this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
                    }
                }
            }
            else {
                ...
                str = num.toString();
                if (isNaN(num)) {
                    str = (digits.toString().indexOf('"') > -1) ? this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value] :
                        str = this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
                }
            }
        }
        else {
            str = index > -1 ? this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value] :
                this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        return str;
    };
    /**
    ...
    BasicFormulas.prototype.ComputeROUNDDOWN = function () {
        ...
        var len = args.length;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) && len > 2) {
            result = this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        if (len === 1 && args[0] !== '') {
            index = args[0].indexOf('"');
            arg1 = args[0].indexOf('"') > -1 ? args[0].replace('"', '') : args[0];
            ...
            if (digits > 0) {
                ...
                if (isNaN(num)) {
                    if (digits.toString().indexOf('"') > -1) {
                        result = this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
                    }
                    else {
                        result = this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
                    }
                }
            }
            else {
                ...
                result = num.toString();
                if (isNaN(num)) {
                    result = (digits.toString().indexOf('"') > -1) ? this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value] :
                        result = this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
                }
            }
        }
        else {
            result = index > -1 ? this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value] :
                this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        return result;
    };
    ...
    BasicFormulas.prototype.ComputeDATE = function () {
        ...
        for (var idx = 0; idx < argArr.length; idx++) {
            ...
            if (this.parent.getErrorStrings().indexOf(argsValue) > -1) {
                ...
                return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value].toString();
            }
        }
        ...
        if (date.toString() !== 'Invalid Date') {
            ...
            if (!nestedFormula) {
                return new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .Internationalization */ .DL(this.parent.parentObject.locale || 'en-US').formatDate(date, { type: 'date', skeleton: 'yMd' });
            }
        }
    ...
    BasicFormulas.prototype.ComputeFLOOR = function () {
        ...
        for (var i = 0; i < argArr.length; i++) {
            ...
            if ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isCellReference */ .irp)(argArr[i])) {
        ...
        if (fnum > 0 && significance < 0) {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Num];
        }
        if ((fnum > 0 || fnum < 0) && significance === 0) {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.DivZero];
        }
        if (isNaN(fnum)) {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
        }
    ...
    BasicFormulas.prototype.ComputeDAY = function () {
        ...
        if (errCollection.indexOf(dateVal) > -1) {
            ...
            return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Num];
        }
    ...
    BasicFormulas.prototype.ComputeIF = function () {
        ...
        if (argArr.length > 3 || argArr.length === 1) {
            ...
            if (condUpper === this.parent.trueValue || (parsedVal < 0 || parsedVal > 0)) {
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr[2])) {
                ...
                return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.Requires3Args];
            }
        }
        ...
        else if (skipTick && !(0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(result) && indexOfTic === -1 && result !== this.parent.trueValue &&
    ...
    BasicFormulas.prototype.ComputePRODUCT = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(range) || (range.length === 1 && range[0] === '')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        var product = 1;
        var val;
        ...
        var argsHit = true;
        var parseVal;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(range)) {
            var argArr = range;
            for (var i = 0; i < argArr.length; i++) {
                ...
                if (rangevalue.indexOf(':') > -1 && this.parent.isCellReference(rangevalue)) {
                    ...
                    for (var j = 0; j < cellCollection.length; j++) {
                        ...
                        if (!(0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(val)) {
                            continue;
                        }
                        if (this.parent.getErrorStrings().indexOf(val) > -1) {
                            return val;
                    ...
                    if (!(0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(orgValue)) {
                        continue;
                    }
                    if (this.parent.getErrorStrings().indexOf(orgValue) > -1) {
                        return orgValue;
    ...
    BasicFormulas.prototype.ComputeDAYS = function () {
        ...
        var processArgs = function (actuaValue) {
            ...
            _this.parent.parentObject.notify(_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .checkDateFormat */ .sJt, dateCheck);
    ...
    BasicFormulas.prototype.ComputeUNIQUE = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr) || (argArr[0] === '' && argArr.length === 1)) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        else if (argArr.length > 3) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        ...
        var processArgs = function (actualValue) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(actualValue)) {
            ...
            if (value.toUpperCase() === _this.parent.trueValue || value.toUpperCase() === _this.parent.falseValue) {
                ...
                return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
            }
        };
        ...
        if (argArr[0].indexOf(':') > -1) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr[0].match(/[0-9]/))) {
                var splitArray = argArr[0].split(':');
                argArr[0] = splitArray[0] + '1' + ':' + splitArray[1] + (this.parent.spreadSheetUsedRange[0] + 1);
            }
            else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr[0].toUpperCase().match(/[A-Z]/))) {
                var splitArray = argArr[0].split(':');
                argArr[0] = 'A' + splitArray[0] + ':' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(this.parent.spreadSheetUsedRange[1] + 1) + splitArray[1];
            }
            ...
            if (this.parent.isCellReference(rangeSplit[0]) && this.parent.isCellReference(rangeSplit[1])) {
                ...
                argArr[0] = sheetIndex + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(colIdx) + rowIdx + ':' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(endColIdx) + endRowIdx;
                ...
                if (exactlyOne === this.parent.trueValue) {
                    ...
                    tmp = exactOne;
                    if (tmp.length === 0) {
                        return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Calc];
                    }
                }
                if (isComputeExp) {
                ...
                if (this.parent.dependencyLevel === 0) {
                        ...
                        for (var i = actRowIdx, diff = tmp.length + actRowIdx; i < diff; i++) {
                            ...
                            for (var j_2 = actColIdx, diff2 = splitValue.length + actColIdx; j_2 < diff2; j_2++) {
                                if (i === diff - 1 && j_2 === diff2 - 1 &&
                                    this.parent.uniqueRange.indexOf(uniqueActCell + ':' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(j_2) + i) === -1) {
                                    this.parent.uniqueRange.push(uniqueActCell + ':' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(j_2) + i);
                                }
                        ...
                        for (var i = actColIdx, diff = tmp.length + actColIdx; i < diff; i++) {
                            ...
                            for (var j_3 = actRowIdx, diff2 = splitValue.length + actRowIdx; j_3 < diff2; j_3++) {
                                if (i === diff - 1 && j_3 === diff2 - 1 &&
                                    this.parent.uniqueRange.indexOf(this.parent.actCell + ':' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(i) + j_3) === -1) {
                                    this.parent.uniqueRange.push(this.parent.actCell + ':' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(i) + j_3);
                                }
                    ...
                    if (isSpill) {
                        return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.Spill];
                    }
                }
                else if (this.parent.dependencyLevel > 0 &&
                    this.parent.getValueFromArg((0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(actColIdx) + actRowIdx, true).indexOf('#SPILL!') > -1) {
                    return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.Spill];
                }
                if (byColumn === this.parent.falseValue) {
                    ...
                    for (var i = 0; i < tmp.length; i++) {
                        ...
                        for (var j_4 = 0; j_4 < splitValue.length; j_4++) {
                            ...
                            if (i > 0 || j_4 > 0) {
                                this.parent.refresh(token + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(actColIdx) + actRowIdx.toString(), cellTxt);
                            }
                            if (splitValue[j_4 + 1]) {
                                actColIdx++;
                            }
    ...
    BasicFormulas.prototype.checkSpill = function (i, j) {
        var spill = false;
        var value = this.parent.getValueFromArg((0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(i) + j, true);
        var formulaAddress = '!' + this.parent.getSheetID(this.parent.grid) + '!' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(i) + j;
        var formulaString;
        ...
        if (value && (value.toUpperCase().indexOf('UNIQUE') < 0 ||
            ...
            value !== this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments]) {
            spill = true;
        }
        return spill;
    };
            ...
            for (var j_5 = actColIdx; j_5 <= colDiff; j_5++) {
                if (this.parent.dependencyLevel > 0 || formulaText.indexOf('UNIQUE') > -1) {
                    if (this.parent.getValueFromArg('!' + this.parent.getSheetID(this.parent.grid) + '!' +
                        (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(actColIdx) + actRowIdx, true).indexOf('#SPILL!') > -1) {
                        return;
                    }
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    this.parent.parentObject.setValueRowCol(this.parent.getSheetID(this.parent.grid) + 1, '', i, j_5);
                    this.parent.refresh('!' + this.parent.getSheetID(this.parent.grid) + '!' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(j_5) + i, actCell);
    ...
    BasicFormulas.prototype.ComputeT = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || (args.length === 1 && args[0].trim() === '')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        else if (args.length > 1) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
    ...
    BasicFormulas.prototype.ComputeHOUR = function () {
        ...
        if (args.length !== 1 || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args[0] === '') {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        ...
        if (this.parent.isNumber(cellVal)) {
            ...
            this.parent.parentObject.notify(_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .checkDateFormat */ .sJt, dateCheck);
            if (dateCheck.isDate || dateCheck.isTime) {
    ...
    BasicFormulas.prototype.ComputeMINUTE = function () {
        ...
        if (argArr.length !== 1 || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr) || argArr[0] === '') {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
    ...
    BasicFormulas.prototype.ComputeNOW = function () {
        ...
        var intl = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .Internationalization */ .DL();
    ...
    BasicFormulas.prototype.ComputeMOD = function () {
        ...
        var value;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args.length !== 2) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        if (args[1] === '' && !args[0].includes('"')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.Div];
        }
        ...
        for (var i = 0; i < args.length; i++) {
            ...
            if ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isCellReference */ .irp)(args[i])) {
    ...
    BasicFormulas.prototype.ComputeODD = function () {
        ...
        var val;
        if ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isCellReference */ .irp)(args[0])) {
    ...
    BasicFormulas.prototype.ComputeMEDIAN = function () {
        ...
        var value1;
        var num = [];
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args[0] === '' && args.length === 1) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        for (var i = 0; i < args.length; i++) {
    ...
    BasicFormulas.prototype.ComputeEDATE = function () {
        ...
        if (args.length !== 2 || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args)) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        if (args[0] === '' || args[1] === '') {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.NA];
        }
        ...
        if (isNaN(mValue) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(this.parent.isDate(date)) || date.getFullYear() > 9999) {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
        }
    ...
    BasicFormulas.prototype.ComputeEOMONTH = function () {
        ...
        if (isNaN(monthValue) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(this.parent.isDate(date)) || date.getFullYear() > 9999) {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
        }
    ...
    BasicFormulas.prototype.ComputeDATEVALUE = function () {
        ...
        if (!(!(this.parent.isNumber(dValue)) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(this.parent.isDate(dValue)))) {
        ...
        else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(date) || date.toString() === 'Invalid Date' ||
    ...
    BasicFormulas.prototype.ComputeCOUNTBLANK = function () {
        ...
        var result = 0;
        if (args.length !== 1 || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || !this.parent.isCellReference(args[0])) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        else if (args[0] === '') {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
    ...
    BasicFormulas.prototype.ComputeDECIMAL = function () {
        ...
        return isNaN(value) ? this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Num] : value;
    };
    /**
     * @hidden
     * @param {string} args - specify the args.
    ...
    BasicFormulas.prototype.ComputeADDRESS = function () {
        ...
        var value;
        var errCollection = this.parent.getErrorStrings();
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr) || (argArr.length === 1 && argArr[0].trim() === '')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        ...
        var absIndex;
        var refStyle;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr[2]) || argArr[2].trim() === '') {
            absIndex = '1';
        }
        else {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr[3]) || argArr[3].trim() === '') {
            refStyle = '1';
        }
        else {
        ...
        if (refStyle === '1') {
            if (absIndex === '1') {
                value = '$' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(parseInt(colIndex, 10)) + '$' + parseInt(rowIndex, 10);
            }
            else if (absIndex === '2') {
                value = (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(parseInt(colIndex, 10)) + '$' + parseInt(rowIndex, 10);
            }
        ...
        var val;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr[4]) && argArr[4] !== '') {
            val = this.parent.getValueFromArg(argArr[4]).split(this.parent.tic).join('');
            if (errCollection.indexOf(val) > 0) {
                return val;
            }
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(val)) {
            value = val + '!' + value;
        }
        return value;
    };
    ...
    BasicFormulas.prototype.ComputeTIME = function () {
        ...
        var result;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args.length !== 3) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        ...
        this.parent.parentObject.notify(_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .checkDateFormat */ .sJt, timeCheck);
        if (timeCheck.isTime) {
    ...
    BasicFormulas.prototype.ComputeCHAR = function () {
        ...
        var value;
        var errCollection = this.parent.getErrorStrings();
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args[0] === '') {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        else if (args.length !== 1) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
    ...
    BasicFormulas.prototype.ComputeDOLLAR = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args.length !== 2 || isEmpty) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        for (var i = 0; i < args.length; i++) {
        ...
        if (val.toUpperCase().match(/^[-]?[0-9.]+$/) && val2.toUpperCase().match(/^[-]?[0-9.]+$/)) {
            ...
            if (!isNaN(roundedNumber)) {
                ...
                value = this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
            }
        }
        else {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
    ...
    BasicFormulas.prototype.ComputeSMALL = function () {
        ...
        var valueCollection = [];
        var numArr = [];
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args[0])) {
            ...
            if (numArr.length === 0) {
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(valueCollection[0]) || args[0].indexOf(this.parent.tic) > -1) {
                    return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
                }
            }
        }
        ...
        var smallIndex;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args[1])) {
            if (this.parent.isCellReference(args[1])) {
            ...
            if (errCollection.indexOf(smallIndex) > -1) {
                ...
                return args[1].length > 0 ? errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value] : errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Num];
            }
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(numArr[finalIndex - 1]) && !isNaN(Number(finalIndex))) {
            return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Num];
        }
        else {
    ...
    BasicFormulas.prototype.ComputeCHOOSE = function () {
        ...
        if (getIndexValue < 1 || isNaN(getIndexValue) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args[getIndexValue])) {
            return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
        }
    ...
    BasicFormulas.prototype.ComputeSUMIF = function () {
        ...
        if (argArr[0].indexOf(':') < 0 && !this.parent.isCellReference(argArr[0]) ||
            ...
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.ImproperFormula];
        }
            ...
            if (this.parent.isCellReference(val)) {
                if (val.indexOf(':') > -1) {
                    ...
                    if (argsList.length === 1 && argsList[0].indexOf(this.parent.tic) < 0 &&
                        !(0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isValidCellReference */ .sa1)(argsList[0])) {
                        return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
                    }
                    else {
                ...
                if (val.startsWith(this.parent.tic) && val.endsWith(this.parent.tic) && val.indexOf('""') > -1) {
                    ...
                    if (!(!(this.parent.isNumber(tempStr)) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(this.parent.isDate(tempStr))) || val.startsWith(' n')) {
    ...
    BasicFormulas.prototype.ComputeAND = function () {
        ...
        var argArr = args;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || (argArr.length === 1 && argArr[0] === '')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
    ...
    BasicFormulas.prototype.ComputeFIND = function () {
        ...
        var errCollection = this.parent.getErrorStrings();
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args.length === 1) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        ...
        var startNum = 1;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args[2])) {
    ...
    BasicFormulas.prototype.ComputeINDEX = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr) || (argArr.length === 1 && argArr[0] === '')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
            ...
            return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Ref];
        }
        var row;
        var col;
        var processArgs = function (actualValue) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(actualValue) || actualValue === '') {
                return 1;
            }
            var value = _this.parent.getValueFromArg(actualValue);
            if (errCollection.indexOf(value) > -1) {
    ...
    BasicFormulas.prototype.ComputeIFS = function () {
        ...
        var argArr = range;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(range) || (argArr.length === 1 && argArr[0] === '') || argArr.length % 2 !== 0) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
        var condition = '';
        var result = '';
            ...
            if (this.parent.isCellReference(argArrs[k])) {
                if (argArrs[k].indexOf(':') > -1) {
                    ...
                    for (var j = 0; j < cellCol.length; j++) {
                        ...
                        else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(cellValue) || cellValue === '') {
                            continue;
                        }
    ...
    BasicFormulas.prototype.ComputeSORT = function () {
        ...
        var result;
        var values = [];
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args[0] === '' || argArr.length > 4) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
            ...
            if (this.parent.isCellReference(rangeSplit[0]) && this.parent.isCellReference(rangeSplit[1])) {
                ...
                if (this.parent.isCellReference(argArr[3])) {
                    ...
                    if (argArr[3] !== this.parent.trueValue && argArr[3] !== this.parent.falseValue) {
                        if ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(argArr[3])) {
                    ...
                    argArr[3] = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(argArr[3]) ? (Number(argArr[3]) === 0 ? this.parent.falseValue : this.parent.trueValue) :
                        argArr[3].split(this.parent.tic).join('').toUpperCase();
                    if (argArr[3] !== this.parent.trueValue && argArr[3] !== this.parent.falseValue) {
                        return this.parent.getErrorStrings()[isStringVal ? _common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value : _common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
                    }
                }
                ...
                argArr[2] = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(argArr[2]) ? Math.floor(Number(argArr[2])).toString() : argArr[2];
                if (argArr[2] !== '1' && argArr[2] !== '-1') {
                    return this.parent.getErrorStrings().indexOf(argArr[2]) > -1 ? this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name] :
                        this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
                }
                var order = argArr[2] === '1' ? 'Ascending' : 'Descending';
                if (this.parent.isCellReference(argArr[1])) {
                    argArr[1] = this.parent.getValueFromArg(argArr[1]);
                    argArr[1] = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(argArr[1]) ? Math.floor(Number(argArr[1])).toString() : (argArr[1] === this.parent.trueValue ? '1'
                    ...
                    argArr[1] = this.parent.getValueFromArg(argArr[1]);
                    argArr[1] = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(argArr[1]) ? Math.floor(Number(argArr[1])).toString() : (argArr[1] === this.parent.trueValue ?
                ...
                argArr[0] = sheetIdx + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(colIdx) + rowIdx + ':' + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(eColIdx) + eRowIdx;
                ...
                var sortedNumColl = numColl_1.length > 0 ? _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__/* .DataUtil */ .$.sort(numColl_1, null, _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__/* .DataUtil */ .$.fnSort(order)) : [];
                var sortedStrColl = strColl_1.length > 0 ? _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__/* .DataUtil */ .$.sort(strColl_1, null, _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__/* .DataUtil */ .$.fnSort(order)) : [];
                var sortedBooleanColl = booleanColl_1.length > 0 ? _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__/* .DataUtil */ .$.sort(booleanColl_1, null, _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_4__/* .DataUtil */ .$.fnSort(order)) : [];
                ...
                if (argArr[3] === 'TRUE') {
                    for (var startRow = rowIdx, rowInc = 0; startRow <= eRowIdx; startRow++, rowInc++) {
                        for (var a = 0, colInc = 0; a < id.length; a++, colInc++) {
                            var cellValue = this.parent.getValueFromArg(sheetIdx + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(id[a] + colIdx) + startRow);
                    ...
                    result = this.parent.getValueFromArg(sheetIdx + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(id[0] + colIdx) + rowIdx);
                }
                if (argArr[3] === 'FALSE') {
                    for (var a = 0, rowInc = 0; a < id.length; a++, rowInc++) {
                        for (var startCol = colIdx, colInc = 0; startCol <= eColIdx; startCol++, colInc++) {
                            var value = this.parent.getValueFromArg(sheetIdx + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(startCol) + (id[a] + rowIdx));
                    ...
                    result = this.parent.getValueFromArg(sheetIdx + (0,_base_index__WEBPACK_IMPORTED_MODULE_1__/* .getAlphalabel */ .Xl)(colIdx) + (id[0] + rowIdx));
                }
            }
        }
        if (nestedFormula) {
    ...
    BasicFormulas.prototype.ComputeCOUNTIF = function () {
        ...
        var argArr = args;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(args) || args[0] === '' || argArr.length !== 2) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
        if (argArr[0].indexOf(':') < 0 && !this.parent.isCellReference(argArr[0])) {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Name];
    ...
    BasicFormulas.prototype.calculateIFS = function (ranges, isAvgIfs) {
        var _this = this;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(ranges) || ranges[0] === '' || ranges.length < 2 || ranges.length > 127) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
    ...
    BasicFormulas.prototype.ComputeTEXT = function () {
        ...
        if ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(s1.split(this.parent.tic).join(''))) {
        ...
        if (!isNaN(d) || !isNaN(dTime)) {
            if (s2.length > 0 && s2.indexOf('#') === -1 && (s2.toUpperCase().indexOf('M') > -1 || s2.toUpperCase().indexOf('D') > -1
                ...
                var getSkeleton = (0,_common_index__WEBPACK_IMPORTED_MODULE_0__/* .getSkeletonVal */ .tp)(s2);
                if (getSkeleton === '') {
                    var date = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .dateToInt */ .pcB)(dt);
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    BasicFormulas.prototype.ComputeMATCH = function () {
        ...
        if (argArr[0] === '') {
            return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.NA];
        }
        ...
        else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argArr[1]) && argArr[1].includes(this.parent.tic + this.parent.tic)) {
        ...
        return index ? index : errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.NA];
    };
    /**
     * @hidden
     * @param {string[]} range - specify the range.
    ...
    BasicFormulas.prototype.ComputeSUBTOTAL = function () {
        ...
        switch (value) {
            ...
            case 111:
                ...
                break;
            default:
                value = errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.Value];
                break;
        }
        return value;
    };
    ...
    BasicFormulas.prototype.ComputeRADIANS = function () {
        ...
        var value;
        var errCollection = this.parent.getErrorStrings();
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argValue) || (argValue[0] === '' && argValue.length === 1) ||
    ...
    BasicFormulas.prototype.ComputeSLOPE = function () {
        ...
        var errCollection = this.parent.getErrorStrings();
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(argValue) || (argValue.length === 1 && argValue[0].trim() === '')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(yPoints) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(xPoints) || (yPoints.length < 2 && xPoints.length < 2)) {
            return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.DivZero];
        }
    ...
    BasicFormulas.prototype.ComputeINTERCEPT = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(yValues) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(xValues) || (yValues.length < 2 && xValues.length < 2)) {
            return errCollection[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.DivZero];
        }
    ...
    BasicFormulas.prototype.ComputeLN = function () {
        ...
        var cellvalue;
        var errCollection = this.parent.getErrorStrings();
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(logValue) || (logValue[0] === '' && logValue.length === 1)) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
    ...
    BasicFormulas.prototype.ComputeSQRT = function () {
        ...
        if (this.parent.parseFloat(sqrtValue) < 0) {
            ...
            this.parent.parentObject.notify(_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .checkDateFormat */ .sJt, dateTimeCheck);
    ...
    BasicFormulas.prototype.ComputeLOG = function () {
        ...
        var orgBaseValue;
        var errCollection = this.parent.getErrorStrings();
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(logValue) || (logValue.length === 1 && logValue[0] === '')) {
            return this.parent.formulaErrorStrings[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .FormulasErrorsStrings */ .lO.InvalidArguments];
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(logValue[0])) {
        ...
        orgBaseValue = 10;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_2__/* .isNullOrUndefined */ .hX)(logValue[1])) {
    ...
    BasicFormulas.prototype.ComputeRSQ = function () {
        ...
        if ((argArr[0].indexOf(':') === -1 && (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isCellReference */ .irp)(argArr[0])) && (argArr[1].indexOf(':') === -1 && (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isCellReference */ .irp)(argArr[1]))) {
            return this.parent.getErrorStrings()[_common_index__WEBPACK_IMPORTED_MODULE_0__/* .CommonErrors */ .fw.DivZero];
        }
        ...
        for (var i = 0; i < xValues.length; i++) {
            ...
            if ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(xValue) && (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(yValue)) {
                validCount++;
            }
        }
        if (validCount <= 1) {
    ...
    BasicFormulas.prototype.getCorrelation = function (xValues, yValues, meanX, meanY) {
        ...
        var diffX;
        for (var i = 0; i < xValues.length; i++) {
            if ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(xValues[i]) && (0,_workbook_index__WEBPACK_IMPORTED_MODULE_3__/* .isNumber */ .EtT)(yValues[i])) {
...
//# sourceMappingURL=48080d1e-410ac88ab4115a76.js.map