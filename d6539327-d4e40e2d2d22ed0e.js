"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[5516],{

/***/ 87534:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   x: () => (/* binding */ StampAnnotation)
/* harmony export */ });
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(50474);
/* harmony import */ var _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(50699);
...
var StampAnnotation = /** @class */ (function () {
        ...
        return new Promise(function (resolve) {
            ...
            if (stampAnnotations && (!isStampAdded || isAnnotOrderAction)) {
                ...
                var _loop_1 = function (s) {
                    ...
                    if (stampName && annotation['IconName'] && annotation['IconName'] !== 'Draft' && !isImageStamp && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotation.template) || annotation.template === '')) {
                    ...
                    else if (annotation['IconName'] && !isImageStamp && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotation.template) || annotation.template === '')) {
    ...
    StampAnnotation.prototype.moveStampElement = function (X, Y, pageIndex) {
        ...
        X = X / zoomFactor;
        Y = Y / zoomFactor;
        var author = (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.annotationSettings.author) && this.pdfViewer.annotationSettings.author !== 'Guest') ? this.pdfViewer.annotationSettings.author : this.pdfViewer.stampSettings.author ? this.pdfViewer.stampSettings.author : 'Guest';
    ...
    StampAnnotation.prototype.calculateImagePosition = function (position, flags) {
        ...
        var x = parseFloat(!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(position.x) ? position.x : position.X);
        var y = parseFloat(!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(position.y) ? position.y : position.Y);
    ...
    StampAnnotation.prototype.renderStamp = function (X, Y, width, height, pageIndex, opacity, rotation, canvass, existingAnnotation, isDynamic) {
        ...
        if (annotation) {
            if (width !== null && height !== null) {
                ...
                var isPrint = true;
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(existingAnnotation.IsPrint)) {
                    isPrint = existingAnnotation.IsPrint;
                }
                else {
                    isPrint = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(existingAnnotation.IsPrint) ?
            ...
            var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .processPathData */ .lW)(annotation.pathdata);
            var csData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .splitArrayCollection */ .yo)(collectionData);
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(canvass)) {
    ...
    StampAnnotation.prototype.updateDeleteItems = function (pageNumber, annotation, opacity) {
        ...
        if (annotation.shapeAnnotationType === 'Image') {
            ...
            annotation.Subject = (this.pdfViewer.annotationSettings.subject !== '' && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.annotationSettings.subject)) ? this.pdfViewer.annotationSettings.subject : this.pdfViewer.customStampSettings.subject ? this.pdfViewer.customStampSettings.subject : '';
        ...
        if (opacity) {
            if (annotation.shapeAnnotationType !== 'Image') {
                var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .processPathData */ .lW)(annotation.data);
                var csData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .splitArrayCollection */ .yo)(collectionData);
                annotationObject.stampAnnotationPath = csData;
            }
            annotation.creationDate = new Date().toLocaleDateString();
            if (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && annotation.wrapper) {
    ...
    StampAnnotation.prototype.renderCustomImage = function (position, pageIndex, image, currentDate, modifiedDate, RotationAngle, opacity, canvas, isExistingStamp, annotation, annotName, isNeedToReorderCollection, orderNumber, isNeedToRender) {
        ...
        var allowedInteractions = this.pdfViewer.stampSettings.allowedInteractions ?
            this.pdfViewer.stampSettings.allowedInteractions : this.pdfViewer.annotationSettings.allowedInteractions;
        var isTemplate = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotation) && annotation.template ? true : false;
        if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
            this.pdfViewerBase.customStampCount += 1;
        }
        if (isExistingStamp) {
            ...
            if (subject === null) {
                subject = (this.pdfViewer.annotationSettings.subject !== '' && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.annotationSettings.subject)) ? this.pdfViewer.annotationSettings.subject : this.pdfViewer.customStampSettings.subject ? this.pdfViewer.customStampSettings.subject : '';
            }
            if (annotation.IsLocked) {
        ...
        var annotationSelectorSettings;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotation) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotation.AnnotationSelectorSettings)) {
        ...
        if (isExistingStamp || isCustomStamp) {
            ...
            this.pdfViewer.add(annot);
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(orderNumber)) {
    ...
    StampAnnotation.prototype.adjustZIndexOrder = function (annot, orderNumber) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.zIndexTable[annot.pageIndex])) {
                ...
                if (pageAnnotationObject) {
                    for (var z = 0; pageAnnotationObject.annotations.length > z; z++) {
                        ...
                        if (!this.pdfViewerBase.clientSideRendering && pageAnnotationObject.annotations[parseInt(z.toString(), 10)].icon) {
                            ...
                            iconSize = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isAndroid ? iconSize - 11 : iconSize - 5;
                        ...
                        pageAnnotationObject.annotations[parseInt(z.toString(), 10)].author = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(author) ? author : 'Guest';
                    }
    ...
    StampAnnotation.prototype.storeStampInSession = function (pageNumber, annotation, isNeedToReorderCollection, orderNumber) {
        ...
        if ((sessionSize + currentAnnotation) > 4500) {
            ...
            if (!(this.pdfViewerBase.isFormStorageExceed) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.formFieldsModule)) {
    ...
    StampAnnotation.prototype.saveImportedStampAnnotations = function (annotation, pageNumber) {
        ...
        if (annotation.IconName && stampName) {
            ...
            if (annotation.IconName === 'Accepted' || annotation.IconName === 'Rejected') {
                var collectionData = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .processPathData */ .lW)(stampAnnotation.pathdata);
                stampAnnotation.pathdata = (0,_syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_1__/* .splitArrayCollection */ .yo)(collectionData);
                isDynamic = true;
            }
        }
        if (stampAnnotation) {
    ...
    StampAnnotation.prototype.modifyInCollection = function (property, pageNumber, annotationBase, toolMoved) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationBase.formFieldAnnotationType) && annotationBase.formFieldAnnotationType !== '') {
    ...
    StampAnnotation.prototype.updateAddAnnotationDetails = function (annotationObject, offset, pageNumber, dynamicStampItem, signStampItem, standardBusinessStampItem) {
        ...
        if (!dynamicStampItem && !signStampItem && !standardBusinessStampItem) {
            dynamicStampItem = _index__WEBPACK_IMPORTED_MODULE_2__/* .DynamicStampItem */ .iB.Approved;
        }
        ...
        if (annotationObject.customStamps && annotationObject.customStamps[0].customStampName) {
            ...
            if (signStampItem === _index__WEBPACK_IMPORTED_MODULE_2__/* .SignStampItem */ .Ix.Accepted || signStampItem === _index__WEBPACK_IMPORTED_MODULE_2__/* .SignStampItem */ .Ix.Rejected) {
            ...
            else if (signStampItem === _index__WEBPACK_IMPORTED_MODULE_2__/* .SignStampItem */ .Ix.SignHere) {
            ...
            else if (signStampItem === _index__WEBPACK_IMPORTED_MODULE_2__/* .SignStampItem */ .Ix.Witness) {
                annotationObject.width = annotationObject.width ? annotationObject.width : 130;
                annotationObject.height = annotationObject.height ? annotationObject.height : 30;
            }
            else if (signStampItem === _index__WEBPACK_IMPORTED_MODULE_2__/* .SignStampItem */ .Ix.InitialHere) {
            ...
            if (standardBusinessStampItem === _index__WEBPACK_IMPORTED_MODULE_2__/* .StandardBusinessStampItem */ .Q6.Final ||
                standardBusinessStampItem === _index__WEBPACK_IMPORTED_MODULE_2__/* .StandardBusinessStampItem */ .Q6.Draft) {
                annotationObject.width = annotationObject.width ? annotationObject.width : 110;
                annotationObject.height = annotationObject.height ? annotationObject.height : 30;
            }
            else if (standardBusinessStampItem === _index__WEBPACK_IMPORTED_MODULE_2__/* .StandardBusinessStampItem */ .Q6.Void) {
                annotationObject.width = annotationObject.width ? annotationObject.width : 100;
                annotationObject.height = annotationObject.height ? annotationObject.height : 30;
            }
            else {
    ...
    StampAnnotation.prototype.updateStampSelectorSettings = function (annotationSelectorSettings) {
        if (this.pdfViewer.stampSettings.annotationSelectorSettings && this.pdfViewer.stampSettings.annotationSelectorSettings.resizerFillColor !== '#FF4081') {
            ...
            annotationSelectorSettings.resizerFillColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.resizerFillColor) ? annotationSelectorSettings.resizerFillColor : '#FF4081';
        }
        if (this.pdfViewer.stampSettings.annotationSelectorSettings && this.pdfViewer.stampSettings.annotationSelectorSettings.resizerBorderColor !== 'black') {
            ...
            annotationSelectorSettings.resizerBorderColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.resizerBorderColor) ? annotationSelectorSettings.resizerBorderColor : 'black';
        }
        if (this.pdfViewer.stampSettings.annotationSelectorSettings && this.pdfViewer.stampSettings.annotationSelectorSettings.selectionBorderColor !== '') {
            ...
            annotationSelectorSettings.selectionBorderColor = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.selectionBorderColor) ? annotationSelectorSettings.selectionBorderColor : '';
        }
        if (this.pdfViewer.stampSettings.annotationSelectorSettings &&
            ...
            annotationSelectorSettings.resizerSize =
                !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.resizerSize) ? annotationSelectorSettings.resizerSize : 8;
        }
        if (this.pdfViewer.stampSettings.annotationSelectorSettings && this.pdfViewer.stampSettings.annotationSelectorSettings.resizerShape !== 'Square') {
            ...
            annotationSelectorSettings.resizerShape = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.resizerShape) ? annotationSelectorSettings.resizerShape : 'Square';
        }
        if (this.pdfViewer.stampSettings.annotationSelectorSettings &&
            ...
            annotationSelectorSettings.resizerCursorType =
                !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.resizerCursorType) ? annotationSelectorSettings.resizerCursorType : null;
        }
        if (this.pdfViewer.stampSettings.annotationSelectorSettings &&
            ...
            annotationSelectorSettings.selectionBorderThickness = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.selectionBorderThickness) ?
        ...
        if (this.pdfViewer.stampSettings.annotationSelectorSettings &&
            ...
            annotationSelectorSettings.selectorLineDashArray = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.selectorLineDashArray) ?
                annotationSelectorSettings.selectorLineDashArray : [];
        }
        if (this.pdfViewer.stampSettings.annotationSelectorSettings &&
            ...
            annotationSelectorSettings.resizerLocation =
                !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(annotationSelectorSettings.resizerLocation) ? annotationSelectorSettings.resizerLocation : 3;
        }
    };
...
//# sourceMappingURL=d6539327-d4e40e2d2d22ed0e.js.map