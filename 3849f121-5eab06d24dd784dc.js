"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[7319],{
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(63514);
...
var Selection = /** @class */ (function () {
    function Selection(parent) {
        ...
        this.arrowShape = [_index__WEBPACK_IMPORTED_MODULE_1__/* .ArrowheadType */ .W8.None, _index__WEBPACK_IMPORTED_MODULE_1__/* .ArrowheadType */ .W8.SolidArrow];
    ...
    Selection.prototype.setCursor = function (x, y) {
        ...
        if (parent.cursor === 'default' || parent.cursor === 'grab') {
            ...
            var tempShapeColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.shapeColl, [], true);
            ...
            while (highestOrder > 0) {
                ...
                for (var i = tempShapeColl.length - 1; i >= 0; i--) {
                    if (tempShapeColl[i].order === highestOrder) {
                        ...
                        if (tempShapeColl[i].id && tempShapeColl[i].id.indexOf('pen') > -1) {
                            if (parent.pointColl[0] && (parent.cursor !== 'grab' || !isCropSelection)
                                ...
                                var points = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.points, [], true);
                                if (!isCropSelection) {
                            ...
                            parent.objColl = [];
                            parent.objColl.push((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, tempShapeColl[i], null, true));
                    ...
                    else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(tempShapeColl[i].order)) {
                        isShape = true;
                    }
                }
                if (parent.cursor !== 'default' && parent.cursor !== 'grab') {
    ...
    Selection.prototype.setCursorForActObj = function (splitWords, isCropSelection, x, y) {
        ...
        if (parent.activeObj.horTopLine !== undefined) {
            ...
            else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.rotatedAngle) && actObj.rotatedAngle !== 0) {
    ...
    Selection.prototype.setCursorForPath = function (actObj, x, y, upperCanvas) {
        ...
        if (parent.cursor === 'default') {
            var obj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, actObj, null, true);
            var isMove = false;
            for (var i = 1, len = actObj.pointColl.length; i < len; i++) {
                ...
                for (var j = 0, jLen = obj.pointColl.length; j < jLen; j++) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(point.x - (radius * 2)) &&
                        !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(point.x + (radius * 2)) &&
                        !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(point.y - (radius * 2)) &&
                        !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(point.y + (radius * 2)) &&
                        x >= (point.x - (radius * 2)) &&
                        x <= (point.x + (radius * 2)) &&
                        y >= (point.y - (radius * 2)) &&
    ...
    Selection.prototype.setCursorForLineArrow = function (actObj, x, y, upperCanvas) {
        var index;
        var radius = actObj.topLeftCircle.radius;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.pointColl)) {
            return index;
        }
    ...
    Selection.prototype.setCursorForFreehandDrawing = function (x, y, upperCanvas, id) {
        ...
        for (var n = 0; n < parent.freehandCounter; n++) {
            ...
            sPoints = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], obj['selPointColl'][n].points, []);
            parent.points = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl[n].points, []);
            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
    ...
    Selection.prototype.setCursorFromObj = function (x, y, obj, upperCanvas, isCropSelection) {
        ...
        for (var i = 0, len = obj.length; i < len; i++) {
            ...
            var actObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj[i], {}, true);
    ...
    Selection.prototype.updateActivePoint = function (x, y, isCropSelection) {
        ...
        switch (this.dragElement.toLowerCase()) {
            ...
            case 'grabbing':
                ...
                break;
            case 'pathdrag':
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pathAdjustedIndex)) {
    ...
    Selection.prototype.triggerShapeChange = function (shapeResizingArgs, shapeMovingArgs, type) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.shapeResizingArgs) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.shapeMovingArgs)) {
        ...
        if (this.previousPoint.x !== 0 && this.previousPoint.y !== 0) {
            if (this.currentDrawingShape === 'text') {
                ...
                if (parent.activeObj.textSettings.fontSize === 0) {
                    ...
                    actPoint.width = actPoint.endX - actPoint.startX;
                    actPoint.height = actPoint.endY - actPoint.startY;
                    tempActiveObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, null, true);
            ...
            if ((actPoint.width < 10 || actPoint.height < 10) ||
                ...
                parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, tempActiveObj, null, true);
            }
        }
    ...
    Selection.prototype.updateCursorStyles = function (x, y, type) {
        ...
        var actObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.topLeftCircle)) {
            return;
        }
        var degree;
        if (actObj.shapeDegree === 0) {
    ...
    Selection.prototype.setActivePoint = function (startX, startY) {
        var parent = this.parent;
        var activePoint = parent.activeObj.activePoint;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(activePoint)) {
            return;
        }
        if (parent.currObjType.isText) {
            ...
            if (parent.activeObj.horTopLine !== undefined) {
                parent.activeObj.activePoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, activePoint, {}, true);
            }
    ...
    Selection.prototype.clickEvent = function (imageEditorClickEventArgs, e) {
        ...
        if (parent.isResize) {
            ...
            this.initialPrevObj.objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
            this.initialPrevObj.pointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
            this.initialPrevObj.afterCropActions = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.afterCropActions, [], true);
            var selPointCollObj = { selPointColl: null };
            parent.notify('freehand-draw', { prop: 'getSelPointColl', onPropertyChange: false,
                value: { obj: selPointCollObj } });
            this.initialPrevObj.selPointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], selPointCollObj['selPointColl'], [], true);
            ...
            this.tempActiveObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
            return;
        }
        ...
        var activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, null, true);
        ...
        if (this.dragCanvas && this.isPan && (parent.cursor === 'grab' || this.isTouch)
            ...
            if (this.isFhdPoint || (this.isFhdCustomized && !parent.togglePen)) {
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(indexObj['freehandSelectedIndex']) &&
                ...
                parent.notify('freehand-draw', { prop: 'getFreehandSelectedIndex', onPropertyChange: false, value: { obj: indexObj } });
                var objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj['index']) && obj['index'] > -1) {
                ...
                if (this.isFhdEditing) {
                    ...
                    var shapeSettings = { id: 'pen_' + (indexObj['freehandSelectedIndex'] + 1), type: _index__WEBPACK_IMPORTED_MODULE_1__/* .ShapeType */ .IO.FreehandDraw,
                ...
                if (parent.cursor === 'crosshair' || (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && parent.togglePen)) {
                    if (parent.togglePen) {
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.strokeSettings)) {
                        ...
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj_2['penStrokeWidth'])) {
        ...
        if (e.type === 'touchmove' && e.touches.length === 2) {
            if (this.isFirstMove) {
                ...
                if (this.currMousePoint.x !== center.x && this.currMousePoint.y !== center.y) {
                    var type = '';
                    if (e.type === 'touchmove' && (parent.zoomSettings.zoomTrigger & _index__WEBPACK_IMPORTED_MODULE_1__/* .ZoomTrigger */ ._7.Pinch) === _index__WEBPACK_IMPORTED_MODULE_1__/* .ZoomTrigger */ ._7.Pinch) {
                        this.zoomType = 'Pinch';
        ...
        if (parent.currObjType.isActiveObj && (parent.activeObj.activePoint !== undefined || parent.objColl.length > 0) &&
            ...
            if (this.dragElement === '') {
                ...
                if ((parent.activeObj.activePoint &&
                    (parent.activeObj.activePoint.width === 0 || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.currIndex) &&
    ...
    Selection.prototype.mouseUpEventHandler = function (e) {
        ...
        this.isMouseUp = true;
        if (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && ((parent.element.querySelector('#' + id + '_contextualToolbar') &&
        ...
        if (this.mouseDown === 'canvas' || this.isSliderActive ||
            ...
            if (e.currentTarget === parent.upperCanvas && !parent.isResize) {
                ...
                if (this.currentDrawingShape !== '') {
                    if (this.currentDrawingShape === 'text') {
                        var prevCropObj_1 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.cropObj, {}, true);
                        parent.notify('undo-redo', { prop: 'updateUndoRedoColl', onPropertyChange: false,
                ...
                if (!parent.togglePen && !isCropSelection) {
                    if (this.tempObjColl && parent.activeObj.activePoint.width !== 0) {
                        ...
                        var tempObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[parent.objColl.length - 1], {}, true);
                        parent.objColl.pop();
            ...
            if (parent.togglePen && e.currentTarget === parent.upperCanvas && !obj['freehandDrawSelectedId']) {
                ...
                if (parent.togglePen && !parent.isMaskImage && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) ||
                    (parent.toolbar && parent.toolbar.length > 0) || !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbarTemplate))) {
                    parent.okBtn();
                    parent.freeHandDraw(true);
                }
            }
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.drawingShape) && activeObjShape && currentDrawingShape !== '') {
    ...
    Selection.prototype.isShapeClick = function (e, isCropSelection) {
        ...
        if (parent.activeObj.shape && parent.activeObj.shape === 'text' && this.isShapeInserted) {
            ...
            if (isTextArea) {
                ...
                else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.currIndex)) {
                    parent.objColl.pop();
                }
            }
        }
    ...
    Selection.prototype.isShapeTouch = function (e, isCropSelection) {
        ...
        if (e.type === 'touchstart' && !parent.togglePen) {
            ...
            if (isTextArea) {
                ...
                var index = this.getCurrentIndex();
                if (!isCropSelection) {
                    if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(index) && JSON.stringify(parent.activeObj.activePoint) ===
    ...
    Selection.prototype.applyCurrShape = function (isShapeClick) {
        ...
        var obj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, null, true);
        ...
        if (parent.textArea.style.display === 'block' || parent.textArea.style.display === 'inline-block') {
            ...
            parent.notify('shape', { prop: 'redrawActObj', onPropertyChange: false,
                value: { x: null, y: null, isMouseDown: null } });
            obj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[parent.objColl.length - 1], null, true);
            parent.objColl.pop();
    ...
    Selection.prototype.canvasMouseDownHandler = function (e) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(tempPanMoveObj['tempPanMove'])) {
    ...
    Selection.prototype.touchStartHandler = function (e) {
        ...
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(parent.lowerCanvas, 'touchend', this.mouseUpEventHandler, this);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(parent.lowerCanvas, 'touchmove', this.mouseMoveEventHandler, this);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(parent.upperCanvas, 'touchend', this.mouseUpEventHandler, this);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(parent.upperCanvas, 'touchmove', this.mouseMoveEventHandler, this);
    };
    Selection.prototype.unwireEvent = function () {
        var parent = this.parent;
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(parent.lowerCanvas, 'touchend', this.mouseUpEventHandler);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(parent.lowerCanvas, 'touchmove', this.mouseMoveEventHandler);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(parent.upperCanvas, 'touchend', this.mouseUpEventHandler);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(parent.upperCanvas, 'touchmove', this.mouseMoveEventHandler);
    };
    Selection.prototype.keyDownEventHandler = function (e) {
        ...
        switch (e.key) {
            ...
            case (e.ctrlKey && 'y'):
                ...
                break;
            case (e.ctrlKey && '+'):
                if ((parent.zoomSettings.zoomTrigger & _index__WEBPACK_IMPORTED_MODULE_1__/* .ZoomTrigger */ ._7.Commands) === _index__WEBPACK_IMPORTED_MODULE_1__/* .ZoomTrigger */ ._7.Commands) {
            ...
            case 'Tab':
                ...
                break;
            default:
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && (parent.textArea.style.display === 'block' || parent.textArea.style.display === 'inline-block')) {
    ...
    Selection.prototype.performEnterAction = function (e) {
        ...
        if (parent.isResize) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(aspectRatioElement)) {
                if (aspectRatioHeight) {
                    var elem = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox');
                ...
                if (aspectRatioWidth) {
                    var elem = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox');
    ...
    Selection.prototype.handleScroll = function (e) {
        ...
        if (e.ctrlKey === true && isInsideCanvas) {
            ...
            var type = '';
            if (e.type === 'mousewheel' && (parent.zoomSettings.zoomTrigger & _index__WEBPACK_IMPORTED_MODULE_1__/* .ZoomTrigger */ ._7.MouseWheel) === _index__WEBPACK_IMPORTED_MODULE_1__/* .ZoomTrigger */ ._7.MouseWheel) {
    ...
    Selection.prototype.findTargetObj = function (x, y, isCrop) {
        ...
        if (parent.objColl.length !== 0 && !parent.currObjType.isCustomCrop && !isCrop) {
            ...
            for (var index = 0; index < parent.objColl.length; index++) {
                var cursor = parent.upperCanvas.style.cursor;
                this.setCursor(x, y);
                var actObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[index], {}, true);
                var radius = actObj.topLeftCircle.radius;
                if (actObj.shape === 'line' || actObj.shape === 'arrow') {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(i)) {
                parent.notify('shape', { prop: 'refreshActiveObj', onPropertyChange: false });
                isShape = false;
            }
            else {
                this.tempObjColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
                parent.currObjType.isCustomCrop = false;
                parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[i], {}, true);
                var temp = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[i], {}, true);
                ...
                if (parent.transform.degree === 0) {
                    ...
                    parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, temp_1, {}, true);
                ...
                parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, temp, {}, true);
                this.setActivePoint();
                parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, temp, {}, true);
                var tempStrokeSettings = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj.strokeSettings, {}, true);
                parent.notify('draw', { prop: 'setTempStrokeSettings', onPropertyChange: false,
                    value: { tempStrokeSettings: tempStrokeSettings } });
                var tempTextSettings = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj.textSettings, {}, true);
    ...
    Selection.prototype.shapeEvent = function (shapeChangingArgs) {
        ...
        if (parent.activeObj.activePoint) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj['prevActObj'])) {
        ...
        for (var i = 0, len = parent.objColl.length; i < len; i++) {
            if (JSON.stringify(obj) === JSON.stringify(parent.objColl[i])) {
                ...
                if (obj.shape && parent.textArea.style.display === 'none') {
                    var actObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj, {}, true);
                    parent.notify('shape', { prop: 'refreshActiveObj', onPropertyChange: false });
                    this.lowerContext.clearRect(0, 0, parent.lowerCanvas.width, parent.lowerCanvas.height);
    ...
    Selection.prototype.applyCurrActObj = function (x, y) {
        ...
        var isInside = false;
        var actObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.activePoint)) {
            return;
        }
        ...
        if (!isInside) {
            ...
            if (parent.activeObj.horTopLine !== undefined && parent.activeObj.horTopLine.startX !== 0 && parent.activeObj.horTopLine.endX
                ...
                if (parent.objColl.length > 0 &&
                    ...
                    parent.objColl.push((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true));
                }
            }
    ...
    Selection.prototype.deleteItem = function () {
        ...
        if (this.isFhdEditing) {
            ...
            if (object['isNewPath']) {
                ...
                parent.notify('toolbar', { prop: 'refresh-main-toolbar', onPropertyChange: false });
                parent.notify('draw', { prop: 'render-image', value: { isMouseWheel: null } });
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(prevObj.objColl[prevObj.objColl.length - 1].currIndex)) {
                    parent.notify('undo-redo', { prop: 'updateUndoRedoColl', onPropertyChange: false,
    ...
    Selection.prototype.updateFreehandDrawColorChange = function () {
        ...
        var indexObj = { freehandSelectedIndex: null };
        parent.notify('freehand-draw', { prop: 'getFreehandSelectedIndex', onPropertyChange: false, value: { obj: indexObj } });
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(indexObj['freehandSelectedIndex']) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.pointColl[indexObj['freehandSelectedIndex']])
    ...
    Selection.prototype.updatePrevShapeSettings = function (obj) {
        ...
        var shapeSettingsObj = {
            id: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currIndex) ? currIndex : null,
...
//# sourceMappingURL=3849f121-5eab06d24dd784dc.js.map