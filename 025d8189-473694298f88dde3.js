"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[8866],{

/***/ 1952:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   X: () => (/* binding */ Draw)
/* harmony export */ });
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(63514);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68576);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28696);
...
var Draw = /** @class */ (function () {
    ...
    Draw.prototype.draw = function (args) {
        ...
        switch (args.prop) {
            ...
            case 'getArrowDimension':
                args.value['obj']['arrowDimension'] = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, this.arrowDimension, {}, true);
                break;
            ...
            case 'setTempDestForStraighten':
                this.tempStraightenDestPoints = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, this.straightenDestPoints, {}, true);
                break;
            ...
            case 'updateTempObjColl':
                this.tempObjColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], this.parent.objColl, [], true);
                break;
            case 'resetTempObjColl':
                this.tempObjColl = null;
                break;
            case 'updateTempPointColl':
                this.tempPointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, this.parent.pointColl, {}, true);
                break;
    ...
    Draw.prototype.updatePrivateVariables = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.tempZoomFactor)) {
    ...
    Draw.prototype.drawObject = function (canvas, obj, isCropRatio, points, isPreventDrag, saveContext, isPreventSelection) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.strokeSettings)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.strokeSettings.strokeWidth)) {
            actObj.strokeSettings.strokeWidth = 2;
        }
        if (obj) {
            parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj, {}, true);
        }
        ...
        actObj = parent.activeObj;
        actPoint = parent.activeObj.activePoint;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actPoint.startX) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actPoint.startY)) {
            return;
        }
        ...
        if (canvas !== 'original') {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPreventSelection) && (canvasDraw === this.lowerContext || canvasDraw === this.upperContext)) {
    ...
    Draw.prototype.drawCropRatio = function () {
        ...
        this.straightenActObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
    ...
    Draw.prototype.enlargeToImg = function () {
        ...
        if (parent.transform.degree % 90 === 0 && parent.transform.degree % 180 !== 0) {
            var actPoint = parent.activeObj.activePoint;
            var tempActPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, actPoint, {}, true);
            var count = 0;
            while (true) {
                ...
                if (object['arr'][0] || object['arr'][1] || object['arr'][2] || object['arr'][3] ||
                    ...
                    actPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, tempActPoint, {}, true);
                ...
                tempActPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, actPoint, {}, true);
            }
        }
    };
    Draw.prototype.updateActiveObject = function (actPoint, obj, isMouseMove, x, y) {
        var parent = this.parent;
        actPoint = actPoint ? actPoint : (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj.activePoint, {}, true);
        obj = obj ? obj : (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
        actPoint.width = actPoint.endX - actPoint.startX;
        actPoint.height = actPoint.endY - actPoint.startY;
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isMouseMove)) {
            parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj, {}, true);
        }
    };
    Draw.prototype.drawOuterSelection = function (canvasDraw, isCropCircle) {
        ...
        var tempObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, actObj, {}, true);
        if (actObj.shape) {
            splitWords = actObj.shape.split('-');
        }
        ...
        parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, tempObj, {}, true);
    };
    ...
    Draw.prototype.drawShapeObj = function (canvas, shape, saveContext, isPreventSelection) {
        ...
        switch (parent.currObjType.shape.toLowerCase()) {
            case 'rectangle':
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPreventSelection) && canvasDraw === this.upperContext) {
                    this.drawOuterSelection(canvasDraw);
                }
                break;
            case 'redact':
            ...
            case 'arrow':
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.triangleDirection)) {
                    actObj.triangleDirection = 'right';
                }
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.start)) {
                    actObj.start = 'none';
                }
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.end)) {
                ...
                break;
            case 'path':
                activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
                if (activeObj.pointColl.length > 1) {
                    var obj = { shape: null };
                    parent.notify('selection', { prop: 'getCurrentDrawingShape', value: { obj: obj } });
                    if (obj['shape'] === 'path' && parent.isShapeDrawing) {
                        ...
                        for (var i = 0, len = activeObj.pointColl.length; i < len; i++) {
                            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(activeObj.pointColl[i + 1])) {
    ...
    Draw.prototype.drawRotationArcLine = function (canvasDraw) {
        var parent = this.parent;
        var actObj = parent.activeObj;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(actObj.rotationCircleLine)) {
    ...
    Draw.prototype.rotateImage = function (canvasDraw) {
        ...
        var degree;
        var actObj = parent.activeObj;
        var tempActiveObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, null, true);
        if (actObj.shapeDegree === 0) {
            degree = parent.transform.degree;
        }
        else {
    ...
    Draw.prototype.updateCurrTransState = function (type, isPreventDestination, isRotatePan, isStraighten) {
        ...
        if (type === 'initial') {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPreventDestination)) {
                this.setDestPoints();
            }
        }
        if (parent.isCircleCrop || (parent.currSelectionPoint && parent.currSelectionPoint.shape === 'crop-circle')) {
            ...
            if (parent.transform.degree === 0 && parent.transform.currFlipState === '' && parent.transform.straighten === 0 &&
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isStraighten)) {
                parent.img.destLeft = destLeft;
                parent.img.destTop = destTop;
            }
            if (isRotatePan) {
    ...
    Draw.prototype.currTransState = function (type, isPreventDimension, context, isPreventCircleCrop) {
        ...
        if (type === 'initial') {
            ...
            if (parent.isCircleCrop || (parent.currSelectionPoint && parent.currSelectionPoint.shape === 'crop-circle'
                && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPreventCircleCrop))) {
    ...
    Draw.prototype.setTransform = function (context, value, isReverse) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isReverse)) {
    ...
    Draw.prototype.renderImage = function (isMouseWheel, isPreventClearRect, isFrame, isStraighten) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPreventClearRect)) {
    ...
    Draw.prototype.imageOnLoad = function (src) {
        ...
        parent.baseImg.onload = function () {
            ...
            (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .hideSpinner */ .W$)(parent.element);
            ...
            if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                ...
                var eventargs = { isApplyBtn: false, isDevice: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice, isOkBtn: null,
            ...
            if (_this.fileType === 'Bmp') {
                _this.fileType = _index__WEBPACK_IMPORTED_MODULE_2__/* .FileType */ .pt.Png;
            }
    ...
    Draw.prototype.updateCanvas = function (isCropped, isSameDimension) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.initZoomValue)) {
    ...
    Draw.prototype.resetFrameZoom = function (isOk) {
        var parent = this.parent;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.tempFrameZoomLevel)) {
            ...
            if (isOk && obj) {
                obj.previousObj.frameObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.frameObj, null, true);
                obj.currentObj.frameObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.frameObj, null, true);
    ...
    Draw.prototype.performCancel = function (isContextualToolbar, isUndoRedo, isFinalCancel) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isUndoRedo) && JSON.stringify(parent.frameObj) !== JSON.stringify(parent.tempFrameObj)) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)(parent.frameObj, parent.tempFrameObj);
        ...
        if (obj['bool']) {
        ...
        else if ((!parent.activeObj.shape || parent.activeObj.shape !== 'redact') && (((!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice || (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !straightenObj['bool'])) &&
            ...
            parent.notify('filter', { prop: 'setAdjustmentLevel', onPropertyChange: false,
                value: { adjustmentLevel: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj_3['tempAdjustmentLevel'], {}, true) } });
            ...
            if ((!parent.activeObj.shape || parent.activeObj.shape !== 'redact') && isContextualToolbar && (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice || (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !straightenObj['bool']))) {
                var eventargs = { type: 'main', isApplyBtn: null, isCropping: null, isZooming: null };
                parent.notify('toolbar', { prop: 'refresh-toolbar', onPropertyChange: false, value: eventargs });
            }
            else {
    ...
    Draw.prototype.cancelItems = function (editCompleteArgs) {
        ...
        if (parent.isResize) {
            ...
            if (ascpectIcon || nonAspectIcon || parent.currentToolbar === 'resize-toolbar') {
                ...
                if (point && point.x && point.y && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.aspectWidth)) {
                ...
                if (obj1['prevCropObj'] && obj2['prevObj']) {
                    ...
                    parent.cropObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj1['prevCropObj'], {}, true);
                    ...
                    var currObj = parent.currSelectionPoint ?
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.currSelectionPoint, {}, true) : null;
                    parent.notify('transform', { prop: 'zoomAction', onPropertyChange: false,
    ...
    Draw.prototype.cancelPen = function () {
        ...
        var tempPointsColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
        parent.pointColl = {};
        ...
        parent.objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], this.tempObjColl, [], true);
        parent.pointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], this.tempPointColl, [], true);
        parent.freehandCounter = parent.pointColl.length;
        this.tempPointColl = {};
        this.renderImage();
    ...
    Draw.prototype.cancelShape = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.currIndex)) {
            ...
            if (object['appliedUndoRedoColl'][(undoRedoObj['undoRedoStep'] - 1)]) {
                parent.objColl =
                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], object['appliedUndoRedoColl'][(undoRedoObj['undoRedoStep'] - 1)].currentObjColl, [], true);
            }
            else {
                parent.objColl = [];
            }
    ...
    Draw.prototype.cancelSelection = function () {
        ...
        if (parent.cancelCropSelection) {
            ...
            if (this.tempStraightenDestPoints && JSON.stringify(this.tempStraightenDestPoints) !== JSON.stringify(this.straightenDestPoints)) {
                this.straightenDestPoints = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, this.tempStraightenDestPoints, {}, true);
            }
        }
    };
    Draw.prototype.updateCropSelObj = function () {
        var parent = this.parent;
        if (parent.cancelCropSelection) {
            parent.cropObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.cancelCropSelection.previousCropObj, {}, true);
            ...
            parent.currSelectionPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.cancelCropSelection.previousCropObj.activeObj, true);
            if (parent.currSelectionPoint && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.currSelectionPoint.shape)) {
                parent.currSelectionPoint = null;
            }
            this.clearOuterCanvas(this.lowerContext);
            if (parent.isCircleCrop || (parent.currSelectionPoint && parent.currSelectionPoint.shape === 'crop-circle')) {
    ...
    Draw.prototype.updateCropSelection = function () {
        ...
        currentObj.objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
        currentObj.pointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
        currentObj.afterCropActions = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.afterCropActions, [], true);
        var selPointCollObj = { selPointColl: null };
        parent.notify('freehand-draw', { prop: 'getSelPointColl', onPropertyChange: false,
            value: { obj: selPointCollObj } });
        currentObj.selPointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], selPointCollObj['selPointColl'], [], true);
        parent.cancelCropSelection = { operation: 'cropTransform', previousObj: currentObj, currentObj: currentObj,
            ...
            previousCropObj: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.cropObj, {}, true),
            currentCropObj: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.cropObj, {}, true),
    ...
    Draw.prototype.select = function (type, startX, startY, width, height) {
        ...
        if (!parent.disabled && parent.isImageLoaded) {
            ...
            previousObj.objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
            previousObj.pointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
            previousObj.afterCropActions = parent.afterCropActions;
            var selPointCollObj = { selPointColl: null };
            parent.notify('freehand-draw', { prop: 'getSelPointColl', onPropertyChange: false,
                value: { obj: selPointCollObj } });
            previousObj.selPointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], selPointCollObj['selPointColl'], [], true);
            ...
            if (parent.transform.zoomFactor > 0 && parent.activeObj.shape &&
                parent.activeObj.shape.split('-')[0] === 'crop' && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.currSelPoint)) {
                this.currSelPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
            }
            var isPrevent = false;
            var splitWords = void 0;
            if (parent.activeObj.shape !== undefined) {
            ...
            if (parent.currSelectionPoint || parent.transform.defaultZoomFactor !== 0 ||
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.cropObj.activeObj.shape)) {
    ...
    Draw.prototype.drawCustomSelection = function (cropShape, startX, startY, width, height) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(startX) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(startY) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(width) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(height)) {
            actPoint.startX = startX;
            actPoint.startY = startY;
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.transform.zoomFactor) || parent.transform.zoomFactor === 0) {
    ...
    Draw.prototype.callUpdateCurrTransState = function () {
        var parent = this.parent;
        var tempObjColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
    ...
    Draw.prototype.setClientTransDim = function (isPreventDimension) {
        ...
        if (parent.transform.degree % 90 === 0 && parent.transform.degree % 180 !== 0) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPreventDimension)) {
    ...
    Draw.prototype.redrawImgWithObj = function () {
        ...
        if (parent.rotateFlipColl.length !== 0) {
            var totalPannedInternalPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.panPoint.totalPannedInternalPoint, {}, true);
    ...
    Draw.prototype.setCurrentObj = function (obj, isUndoRedo, isCircleCropped) {
        ...
        parent.panPoint.totalPannedPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj.totalPannedPoint, {}, true);
        parent.panPoint.totalPannedClientPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj.totalPannedClientPoint, {}, true);
        parent.panPoint.totalPannedInternalPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj.totalPannedInternalPoint, {}, true);
        var point = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj.tempFlipPanPoint, {}, true);
        parent.notify('crop', { prop: 'setTempFlipPanPoint', onPropertyChange: false, value: { point: point } });
        parent.rotateFlipColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], obj.rotateFlipColl, [], true);
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.currSelectionPoint)) {
            currSelectionPoint = null;
        }
        else {
            currSelectionPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.currSelectionPoint, {}, true);
            parent.currSelectionPoint = null;
        }
        parent.isCircleCrop = false;
        if (isCircleCropped) {
        ...
        parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj.activeObj, {}, true);
        this.upperContext.clearRect(0, 0, parent.upperCanvas.width, parent.upperCanvas.height);
        if (parent.activeObj.activePoint.width !== 0 && parent.activeObj.activePoint.height !== 0) {
            this.drawObject('duplicate', null, null, null, true);
        }
        var activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, obj.activeObj, {}, true);
        ...
        var afterCropActions = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.afterCropActions, [], true);
        if (!isObj && afterCropActions.length > 0) {
            ...
            for (var i = 0, len = afterCropActions.length; i < len; i++) {
                if (afterCropActions[i] === 'horizontalflip' || afterCropActions[i] === 'verticalflip') {
                    parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, currSelectionPoint, {}, true);
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currSelectionPoint)) {
            parent.currSelectionPoint = null;
        }
        else {
            parent.currSelectionPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, currSelectionPoint, {}, true);
            if (parent.currSelectionPoint && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.currSelectionPoint.shape)) {
                parent.currSelectionPoint = null;
            }
        }
    ...
    Draw.prototype.panToPoint = function (x, y, ratioX, ratioY) {
        ...
        if (parent.transform.zoomFactor > 0) {
            ...
            if (parent.transform.degree === 0) {
                ...
                var pointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
    ...
    Draw.prototype.openNewImage = function () {
        ...
        var id = parent.element.id;
        var inMemoryContext = parent.inMemoryCanvas.getContext('2d');
        (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .showSpinner */ .xc)(parent.element);
        ...
        if (obj['defToolbarItems'] && obj['defToolbarItems'].length === 0 &&
            ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(document.getElementById(id + '_toolbar'))) &&
    ...
    Draw.prototype.applyDialogOption = function () {
        ...
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(document.getElementById(parent.element.id + '_dialog'), 'dialog').destroy();
        this.isImageEdited = false;
    };
    Draw.prototype.showDialogPopup = function () {
        ...
        var dialog = new _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_3__/* .Dialog */ .lG({
    ...
    Draw.prototype.checkToolbarTemplate = function (inputElement, url) {
        var parent = this.parent;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbarTemplate)) {
            parent.reset();
            parent.update();
        }
    ...
    Draw.prototype.moveToSelectionRange = function (type, activeObj) {
        ...
        if (parent.activeObj.shape) {
            ...
            if (isRotated) {
                        ...
                        if (currObj.activePoint.width < activeObj.activePoint.height) {
                            for (var i = 2; i < parent.zoomSettings.maxZoomFactor; i++) {
                                if (currObj.activePoint.width >= activeObj.activePoint.height ||
                                    ...
                                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(zoomFactor)) {
                                        parent.notify('transform', { prop: 'zoomAction', onPropertyChange: false,
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.shape)) {
                    parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, activeObj, {}, true);
                }
                if (parent.transform.degree === 0) {
                    parent.img.destLeft += panX;
                    parent.img.destTop += panY;
                ...
                parent.notify('transform', { prop: 'setTempPanMove', onPropertyChange: false,
                    value: { point: null } });
                parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[parent.objColl.length - 1]);
                parent.objColl.pop();
        ...
        if (isImgAnnotation || (parent.allowDownScale && !parent.isCropTab && !parent.isCropToolbar && img.width !== 0 && img.height !== 0
            ...
            if (isImgAnnotation) {
                ...
                if (isHFlip && isVFlip) {
                    ...
                    if (isHFlip) {
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.isHorImageFlip) || !parent.activeObj.isHorImageFlip) {
                        ...
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.isVerImageFlip) || !parent.activeObj.isVerImageFlip) {
            ...
            if (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isImgAnnotation) || !isImgAnnotation) && parent.baseImgCanvas.width !== 0 &&
    ...
    Draw.prototype.drawImgToCtx = function (ctx, preventImg) {
        var parent = this.parent;
        if (ctx.canvas.id !== parent.element.id + '_tempCanvas' && ctx !== this.upperContext && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(preventImg)) {
    ...
    Draw.prototype.applyFrame = function (ctx, frame, preventImg) {
        ...
        else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(preventImg)) {
    ...
    Draw.prototype.zoomToSel = function (activeObj, isToolbar) {
        ...
        if (this.straightenActObj && JSON.stringify(this.straightenActObj.activePoint) === JSON.stringify(activeObj.activePoint)) {
            parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, this.straightenActObj, null, true);
            ...
            if (parent.transform.straighten === 0) {
                ...
                while (true) {
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.straightenInitZoom) &&
                ...
                parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, activeObj, null, true);
                parent.transform.zoomFactor += 0.001;
                this.calcStraightenedPoints(isToolbar);
            }
        }
        else {
            this.straightenActObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, activeObj, null, true);
            parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, this.straightenActObj, null, true);
            this.straightenInitZoom = parent.transform.zoomFactor;
            this.calcStraightenedPoints(isToolbar);
        }
    ...
    Draw.prototype.calcStraightenedPoints = function (isToolbar) {
        ...
        var destWidth = parent.img.destWidth;
        var destHeight = parent.img.destHeight;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.transform.zoomFactor)) {
            parent.transform.zoomFactor += 0.025;
        }
        this.updateImgCanvasPoints();
        var _loop_1 = function () {
            if (this_1.isLinesIntersect() || this_1.isSelOutsideImg() || (isToolbar && this_1.isDestPointSmall())) {
                parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, this_1.straightenActObj, null, true);
    ...
    Draw.prototype.setDestForStraighten = function () {
        var parent = this.parent;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.straightenDestPoints)) {
            var _a = parent.img, destLeft = _a.destLeft, destTop = _a.destTop, destWidth = _a.destWidth, destHeight = _a.destHeight;
            // If straightening performed, then destination points are set in non-straightened state
            parent.notify('shape', { prop: 'straightenShapes', onPropertyChange: false });
            this.straightenDestPoints = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.img, {}, true);
            parent.img.destLeft = destLeft;
            parent.img.destTop = destTop;
...
//# sourceMappingURL=025d8189-473694298f88dde3.js.map