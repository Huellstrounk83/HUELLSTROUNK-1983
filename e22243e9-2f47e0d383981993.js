"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[8923],{

/***/ 62614:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LG: () => (/* binding */ PdfField),
/* harmony export */   Nj: () => (/* binding */ PdfSignatureField),
/* harmony export */   PX: () => (/* binding */ PdfTextBoxField),
/* harmony export */   WT: () => (/* binding */ PdfComboBoxField),
/* harmony export */   ZL: () => (/* binding */ PdfButtonField),
/* harmony export */   i5: () => (/* binding */ PdfListBoxField),
/* harmony export */   mO: () => (/* binding */ PdfCheckBoxField),
/* harmony export */   pt: () => (/* binding */ PdfListField),
/* harmony export */   tv: () => (/* binding */ _PdfDefaultAppearance),
/* harmony export */   uC: () => (/* binding */ PdfRadioButtonListField)
/* harmony export */ });
/* harmony import */ var _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(81628);
/* harmony import */ var _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(81421);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14291);
/* harmony import */ var _enumerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8398);
/* harmony import */ var _base_stream__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(96969);
/* harmony import */ var _graphics_pdf_template__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(91008);
/* harmony import */ var _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7680);
/* harmony import */ var _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(74221);
/* harmony import */ var _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78174);
/* harmony import */ var _graphics_pdf_path__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(79457);
/* harmony import */ var _annotations_annotation_collection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21480);
/* harmony import */ var _pdf_action__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(58592);
...
var PdfField = /** @class */ (function () {
    function PdfField() {
        ...
        this._defaultFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.helvetica, 8);
        this._appearanceFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.helvetica, 10, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular);
        this._defaultItemFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.timesRoman, 12);
        this._flatten = false;
    ...
    Object.defineProperty(PdfField.prototype, "name", {
        ...
        get: function () {
            if (typeof this._name === 'undefined') {
                var names = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getInheritableProperty */ .m8)(this._dictionary, 'T', false, false, 'Parent');
    ...
    Object.defineProperty(PdfField.prototype, "visibility", {
        ...
        get: function () {
            var value;
            if (this._isLoaded) {
                value = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.visible;
                var widget = this.itemAt(this._defaultIndex);
                var flag = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.default;
                if (widget && widget._hasFlags) {
                    ...
                    return _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.visibleNotPrintable;
                }
                var flagValue = 3;
                if ((flag & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.hidden) === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.hidden) {
                    flagValue = 0;
                }
                if ((flag & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.noView) === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.noView) {
                    flagValue = 1;
                }
                if ((flag & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.print) !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.print) {
                    flagValue &= 2;
                }
                switch (flagValue) {
                    case 0:
                        value = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.hidden;
                        break;
                    case 1:
                        value = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.hiddenPrintable;
                        break;
                    case 2:
                        value = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.visibleNotPrintable;
                        break;
                    case 3:
                        value = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.visible;
                        break;
                ...
                if (typeof this._visibility === 'undefined') {
                    this._visibility = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.visible;
                }
        ...
        set: function (value) {
            ...
            if (this._isLoaded) {
                if (widget && (!widget._hasFlags || this.visibility !== value)) {
                    (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._updateVisibility */ .Iw)(widget._dictionary, value);
                    this._dictionary._updated = true;
                }
                else if (!this._dictionary.has('F') || this.visibility !== value) {
                    (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._updateVisibility */ .Iw)(this._dictionary, value);
                    this._dictionary._updated = true;
                }
            }
            else {
                if (this.visibility !== value) {
                    ...
                    switch (value) {
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.hidden:
                            widget.flags = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.hidden;
                            break;
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.hiddenPrintable:
                            widget.flags = (_enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.noView | _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.print);
                            break;
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.visible:
                            widget.flags = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.print;
                            break;
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldVisibility */ .pw.visibleNotPrintable:
                            widget.flags = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.default;
                            break;
                    }
                }
            }
    ...
    Object.defineProperty(PdfField.prototype, "bounds", {
        ...
        get: function () {
            ...
            if (widget && widget.bounds) {
                ...
                value = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._calculateBounds */ .lN)(this._dictionary, this.page);
            }
        ...
        set: function (value) {
            ...
            if (this._isLoaded) {
                if (typeof widget === 'undefined' || this._dictionary.has('Rect')) {
                    this._dictionary.update('Rect', (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getUpdatedBounds */ .yG)([value.x, value.y, value.width, value.height], this.page));
                }
                else {
                    widget._page = this.page;
                    widget.bounds = value;
    ...
    Object.defineProperty(PdfField.prototype, "color", {
        ...
        set: function (value) {
            var widget = this.itemAt(this._defaultIndex);
            if (widget && widget.color && (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._isNullOrUndefined */ .i$)(value)) {
                widget.color = value;
            }
            else {
                var isNew = false;
    ...
    Object.defineProperty(PdfField.prototype, "readOnly", {
         ...
         */
        get: function () {
            return (this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.readOnly) !== 0;
        },
        /**
        ...
        set: function (value) {
            if (value) {
                this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.readOnly;
            }
            else {
                if (this._fieldFlags === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.readOnly) {
                    this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.default;
                }
                this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.readOnly;
            }
        },
    ...
    Object.defineProperty(PdfField.prototype, "required", {
         ...
         */
        get: function () {
            return (this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.required) !== 0;
        },
        /**
        ...
        set: function (value) {
            if (value) {
                this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.required;
            }
            else {
                this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.required;
            }
    ...
    Object.defineProperty(PdfField.prototype, "visible", {
        ...
        get: function () {
            if (this._isLoaded) {
                ...
                return flag !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.hidden;
            }
            else {
        ...
        set: function (value) {
            if (!this._isLoaded && this._visible !== value && !value) {
                this._visible = value;
                this.itemAt(this._defaultIndex).flags = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfAnnotationFlag */ .gK.hidden;
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(PdfField.prototype, "border", {
        ...
        get: function () {
            ...
            if (widget && widget._dictionary.has('BS')) {
                ...
                value = new _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfInteractiveBorder */ .RI();
                        ...
                        if (border.has('S')) {
                            ...
                            if (borderStyle) {
                                switch (borderStyle.name) {
                                    case 'D':
                                        value._style = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.dashed;
                                        break;
                                    case 'B':
                                        value._style = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.beveled;
                                        break;
                                    case 'I':
                                        value._style = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.inset;
                                        break;
                                    case 'U':
                                        value._style = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.underline;
                                        break;
                                    default:
                                        value._style = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.solid;
                                        break;
                                }
                            }
                        }
            ...
            if (mkDictionary && mkDictionary.has('R')) {
                ...
                if (rotationValue !== undefined) {
                    switch (rotationValue) {
                        case 90:
                            return _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle90;
                        case 180:
                            return _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle180;
                        case 270:
                            return _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle270;
                        default:
                            return _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle0;
                    }
                }
            }
            if (!widget) {
    ...
    Object.defineProperty(PdfField.prototype, "export", {
         ...
         */
        get: function () {
            return !((this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.noExport) !== 0);
        },
        /**
        ...
        set: function (value) {
            if (value) {
                this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.noExport;
            }
            else {
                this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.noExport;
            }
    ...
    Object.defineProperty(PdfField.prototype, "tabIndex", {
        ...
        set: function (value) {
            ...
            if (this._isLoaded) {
                var page = this.page;
                if (page &&
                    (page.tabOrder === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldsTabOrder */ .ni.manual ||
                        (this.form && this.form._tabOrder === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFormFieldsTabOrder */ .ni.manual))) {
                    if (page._pageDictionary.has('Annots')) {
                        var annots = page._pageDictionary.get('Annots');
                        var annotationCollection = new _annotations_annotation_collection__WEBPACK_IMPORTED_MODULE_4__/* .PdfAnnotationCollection */ .u(annots, this._crossReference, page);
        ...
        get: function () {
            if (!this._page) {
                ...
                if (!page && document_1) {
                    ...
                    if (!page && widgetRef) {
                        page = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._findPage */ .cs)(document_1, widgetRef);
                    }
                    if (!page && this._kids && this._kids.length > 0) {
                        for (var i = 0; i < this._kids.length; i++) {
                            page = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._findPage */ .cs)(document_1, this._kids[i]);
                            if (page) {
                                break;
                            }
                        }
    ...
    Object.defineProperty(PdfField.prototype, "_grayBrush", {
        get: function () {
            if (!this._gray) {
                this._gray = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc([128, 128, 128]);
            }
            return this._gray;
        },
        enumerable: true,
    ...
    Object.defineProperty(PdfField.prototype, "_silverBrush", {
        get: function () {
            if (!this._silver) {
                this._silver = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc([198, 198, 198]);
            }
            return this._silver;
        },
        enumerable: true,
    ...
    Object.defineProperty(PdfField.prototype, "_whiteBrush", {
        get: function () {
            if (!this._white) {
                this._white = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc([255, 255, 255]);
            }
            return this._white;
        },
        enumerable: true,
    ...
    Object.defineProperty(PdfField.prototype, "_blackBrush", {
        get: function () {
            if (!this._black) {
                this._black = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc([0, 0, 0]);
            }
            return this._black;
        },
        enumerable: true,
        ...
        if ((!hasTransparency) || ((this._isLoaded && this._hasBackColor) || (!this._isLoaded && !this._isTransparentBackColor))) {
            ...
            if (widget && widget.backColor) {
                ...
                if (mkDict && mkDict.has('BG')) {
                    ...
                    if (bgArray) {
                        value = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._parseColor */ .Y3)(bgArray);
                    }
                }
            }
            if (typeof value === 'undefined' || value === null) {
    ...
    PdfField.prototype._updateBackColor = function (value, hasTransparency) {
        ...
        if (hasTransparency && (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._isNullOrUndefined */ .i$)(value) && value.length === 4 && value[3] !== 255) {
            ...
            if (widget && widget.backColor !== value) {
                ...
                if (typeof mkDictionary === 'undefined') {
                    var dictionary = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
                ...
                else if (!mkDictionary.has('BG') || (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._parseColor */ .Y3)(mkDictionary.getArray('BG')) !== value) {
    ...
    PdfField.prototype._updateBorderColor = function (value, hasTransparency) {
        ...
        if (hasTransparency && value.length === 4 && value[3] !== 255) {
            ...
            if (widget && widget.borderColor !== value) {
                ...
                else if (!mkDictionary.has('BC') || (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._parseColor */ .Y3)(mkDictionary.getArray('BC')) !== value) {
    ...
    PdfField.prototype.itemAt = function (index) {
        ...
        if (index >= 0 && index < this._kidsCount) {
            if (this._parsedItems.has(index)) {
                ...
                if (reference && reference instanceof _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfReference */ .BG) {
                    dictionary = this._crossReference._fetch(reference);
                }
                if (dictionary) {
                    item = _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfWidgetAnnotation */ .Qf._load(dictionary, this._crossReference);
                    item._ref = reference;
    ...
    PdfField.prototype.getValue = function (name) {
        ...
        if (this._dictionary && this._dictionary.has(name)) {
            ...
            if (element !== null && typeof element !== 'undefined' && element instanceof _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG) {
                value = element.name;
            }
    ...
    Object.defineProperty(PdfField.prototype, "_fieldFlags", {
        get: function () {
            if (typeof this._flags === 'undefined') {
                this._flags = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getInheritableProperty */ .m8)(this._dictionary, 'Ff', false, true, 'Parent');
                if (typeof this._flags === 'undefined') {
                    this._flags = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.default;
                }
            }
            return this._flags;
        },
    ...
    Object.defineProperty(PdfField.prototype, "_defaultAppearance", {
        get: function () {
            if (typeof this._da === 'undefined') {
                var da = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getInheritableProperty */ .m8)(this._dictionary, 'DA', false, true, 'Parent');
                if (da && da !== '') {
    ...
    PdfField.prototype._updateBorder = function (dictionary, value) {
        ...
        if (dictionary && dictionary.has('BS')) {
            ...
            bs = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
        ...
        if (typeof value.style !== 'undefined') {
            bs.update('S', (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._mapBorderStyle */ .rW)(value.style));
            dictionary._updated = true;
        }
        else if (isNew) {
            bs.update('S', (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._mapBorderStyle */ .rW)(_enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.solid));
        }
    ...
    PdfField.prototype._initializeFont = function (font) {
        ...
        if (document) {
            if (document.form._dictionary.has('DR')) {
                ...
                resource = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
            }
        }
        var fontDict;
        ...
        if (resource && resource.has('Font')) {
            ...
            if (obj && obj instanceof _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfReference */ .BG) {
                isReference = true;
                fontDict = this._crossReference._fetch(obj);
            }
            else if (obj instanceof _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP) {
                fontDict = obj;
            }
        }
        if (!fontDict) {
            fontDict = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
        ...
        if (this._font && (this._font._key !== null && typeof this._font._key !== 'undefined') && this._font._reference) {
            keyName = _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get(this._font._key);
            reference = this._font._reference;
            hasFont = true;
        }
        else {
            keyName = _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get((0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getNewGuidString */ .kB)());
    ...
    PdfField.prototype._drawRectangularControl = function (g, parameter) {
        ...
        switch (parameter.borderStyle) {
            case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.inset:
                ...
                break;
            case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.beveled:
    ...
    PdfField.prototype._drawBorder = function (g, bounds, borderPen, style, borderWidth) {
        if (borderPen && borderWidth > 0) {
            if (style === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.underline) {
    ...
    PdfField.prototype._drawLeftTopShadow = function (g, bounds, width, brush) {
        var path = new _graphics_pdf_path__WEBPACK_IMPORTED_MODULE_7__/* .PdfPath */ .Q();
        var points = [];
    ...
    PdfField.prototype._drawRadioButton = function (graphics, parameter, checkSymbol, state) {
        if (checkSymbol === 'l') {
            ...
            switch (state) {
                case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked:
                case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.unchecked:
                    graphics.drawEllipse(bounds[0], bounds[1], diameter, bounds[3], parameter.backBrush);
                    break;
                case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedChecked:
                case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedUnchecked:
                    if ((parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.beveled) || (parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.underline)) {
            ...
            if (state === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked || state === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedChecked) {
            ...
            switch (parameter.borderStyle) {
                case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.beveled:
                    switch (state) {
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedChecked:
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedUnchecked:
                            leftTop = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj(shadowColor, borderWidth);
                            rightBottom = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj([255, 255, 255], borderWidth);
                            break;
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked:
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.unchecked:
                            leftTop = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj([255, 255, 255], borderWidth);
                            rightBottom = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj(shadowColor, borderWidth);
                            break;
                    }
                    break;
                case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.inset:
                    switch (state) {
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedChecked:
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedUnchecked:
                            leftTop = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj([0, 0, 0], borderWidth);
                            rightBottom = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj([0, 0, 0], borderWidth);
                            break;
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked:
                        case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.unchecked:
                            leftTop = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj([128, 128, 128], borderWidth);
                            rightBottom = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj([192, 192, 192], borderWidth);
                            break;
                    }
                    break;
            }
    ...
    PdfField.prototype._drawCheckBox = function (graphics, parameter, checkSymbol, state, font) {
        switch (state) {
            ...
            case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedChecked:
            case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedUnchecked:
                if ((parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.beveled || parameter.backBrush) ||
                    (parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.underline)) {
                    if (parameter.borderPen || parameter.backBrush) {
                        graphics.drawRectangle(parameter.bounds[0], parameter.bounds[1], parameter.bounds[2], parameter.bounds[3], parameter.backBrush);
                    }
                }
        ...
        if ((state === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedChecked) || (state === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedUnchecked)) {
            switch (parameter.borderStyle) {
                case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.inset:
        ...
        switch (state) {
            ...
            case _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked:
                if (!font) {
                    var extraBorder = parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.beveled ||
                        parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.inset;
                    var borderWidth = parameter.borderWidth;
                    if (extraBorder) {
                        borderWidth *= 2;
                    }
                    ...
                    font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.zapfDingbats, fontSize);
                    if (parameter.bounds[2] > parameter.bounds[3]) {
                        yOffset = ((parameter.bounds[3] - font._metrics._getHeight()) / 2);
                    }
                }
                else {
                    font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.zapfDingbats, font._size);
                }
                if (size === 0) {
                    size = parameter.bounds[3];
                }
                if (parameter.pageRotationAngle !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle0 || parameter.rotationAngle > 0) {
                    var state_1 = graphics.save();
                    var size_1 = graphics._size;
                    if (parameter.pageRotationAngle !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle0) {
                        if (parameter.pageRotationAngle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle90) {
                        ...
                        else if (parameter.pageRotationAngle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle180) {
                        ...
                        else if (parameter.pageRotationAngle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle270) {
                    ...
                    if (parameter.rotationAngle > 0) {
                        ...
                        graphics.drawString(checkSymbol, font, [rectangle[0], rectangle[1] - yOffset, rectangle[2], rectangle[3]], null, parameter.foreBrush, new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(_enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.center, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle));
    ...
    PdfField.prototype._drawTemplate = function (template, page, bounds) {
        if (template && page) {
            ...
            graphics.save();
            if (page.rotation === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle90) {
                graphics.translateTransform(graphics._size[1], 0);
                graphics.rotateTransform(90);
            }
            else if (page.rotation === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle180) {
                graphics.translateTransform(graphics._size[0], graphics._size[1]);
                graphics.rotateTransform(-180);
            }
            else if (page.rotation === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle270) {
                graphics.translateTransform(0, graphics._size[0]);
                graphics.rotateTransform(270);
            }
            graphics._sw._setTextRenderingMode(_graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* ._TextRenderingMode */ .ET.fill);
    ...
    PdfField.prototype._addAppearance = function (dictionary, template, key) {
        var appearance = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP();
        if (dictionary && dictionary.has('AP')) {
            appearance = dictionary.get('AP');
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeDuplicateReference */ .i0)(dictionary.get('AP'), this._crossReference, key);
        }
        else {
            appearance = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
    ...
    PdfField.prototype._rotateTextBox = function (rect, size, angle) {
        ...
        if (angle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle180) {
            rectangle = [size[0] - (rect[0] + rect[2]), size[1] - (rect[1] + rect[3]), rect[2], rect[3]];
        }
        else if (angle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle270) {
            rectangle = [rect[1], size[0] - (rect[0] + rect[2]), rect[3], rect[2]];
        }
        else if (angle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle90) {
        ...
        if (this._textAlignment === null || typeof this._textAlignment === 'undefined') {
            if (this._isLoaded) {
                ...
                if (widget && widget._dictionary && widget._dictionary.has('Q')) {
                    ...
                    this._textAlignment = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.left;
                }
            }
            else {
                this._textAlignment = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.left;
    ...
    PdfField.prototype._setTextAlignment = function (value) {
        ...
        this._stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(value, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
    };
...
var PdfTextBoxField = /** @class */ (function (_super) {
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "text", {
        ...
        get: function () {
            if (typeof this._text === 'undefined') {
                if (this._isLoaded) {
                    var text = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getInheritableProperty */ .m8)(this._dictionary, 'V', false, true, 'Parent');
                    if (text) {
                        this._text = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._stringToPdfString */ .FM)(text);
                    }
                    else {
                        var widget = this.itemAt(this._defaultIndex);
                        if (widget) {
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "defaultValue", {
        ...
        get: function () {
            if (typeof this._defaultValue === 'undefined') {
                var text = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getInheritableProperty */ .m8)(this._dictionary, 'DV', false, true, 'Parent');
                if (text) {
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "multiLine", {
         ...
         */
        get: function () {
            return (this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.multiLine) !== 0;
        },
        /**
        ...
        set: function (value) {
            if (value) {
                this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.multiLine;
            }
            else {
                this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.multiLine;
            }
            if (this._stringFormat) {
                this._stringFormat.lineAlignment = value ? _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.top : _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle;
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "password", {
         ...
         */
        get: function () {
            return (this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.password) !== 0;
        },
        /**
        ...
        set: function (value) {
            if (value) {
                this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.password;
            }
            else {
                this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.password;
            }
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "scrollable", {
         ...
         */
        get: function () {
            return !((this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.doNotScroll) !== 0);
        },
        /**
        ...
        set: function (value) {
            if (value) {
                this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.doNotScroll;
            }
            else {
                this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.doNotScroll;
            }
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "spellCheck", {
         ...
         */
        get: function () {
            return !((this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.doNotSpellCheck) !== 0);
        },
        /**
        ...
        set: function (value) {
            if (value) {
                this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.doNotSpellCheck;
            }
            else {
                this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.doNotSpellCheck;
            }
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "insertSpaces", {
        ...
        get: function () {
            ...
            return ((_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.comb & flags) !== 0) &&
                ((flags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.multiLine) === 0) &&
                ((flags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.password) === 0) &&
                ((flags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.fileSelect) === 0);
        },
        /**
         * Meaningful only if the MaxLength property is set and the Multiline, Password properties are false.
         * If set, the field is automatically divided into as many equally spaced positions, or combs,
        ...
        set: function (value) {
            if (value) {
                this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.comb;
            }
            else {
                this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.comb;
            }
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "highlightMode", {
        ...
        get: function () {
            ...
            if (widget && typeof widget.highlightMode !== 'undefined') {
                ...
                mode = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._mapHighlightMode */ .jm)(name_4.name);
            }
            return (typeof mode !== 'undefined') ? mode : _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfHighlightMode */ .iu.noHighlighting;
        },
        /**
        ...
        set: function (value) {
            ...
            else if (!this._dictionary.has('H') || (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._mapHighlightMode */ .jm)(this._dictionary.get('H')) !== value) {
                this._dictionary.update('H', (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._reverseMapHighlightMode */ .Fg)(value));
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "maxLength", {
        ...
        get: function () {
            if (typeof this._maxLength === 'undefined') {
                var length_1 = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getInheritableProperty */ .m8)(this._dictionary, 'MaxLen', false, true, 'Parent');
    ...
    Object.defineProperty(PdfTextBoxField.prototype, "font", {
        ...
        get: function () {
            if (this._font) {
                ...
                var widget = this.itemAt(this._defaultIndex);
                this._font = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._obtainFontDetails */ .W0)(this._form, widget, this);
            }
            return this._font;
        },
        /**
    ...
    PdfTextBoxField.prototype._initialize = function (page, name, bounds) {
        ...
        this._dictionary = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
        ...
        this._dictionary.update('FT', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get('Tx'));
    ...
    PdfTextBoxField.prototype._createItem = function (bounds) {
        var widget = new _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfWidgetAnnotation */ .Qf();
        widget._create(this._page, bounds, this);
        widget.textAlignment = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.left;
        this._stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(widget.textAlignment, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
        widget._dictionary.update('MK', new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference));
    ...
    PdfTextBoxField.prototype._postProcess = function (isFlatten, widget) {
        ...
        if ((widget !== null && typeof widget !== 'undefined' && widget._setAppearance && widget._enableGrouping) || this._form._setAppearance || this._setAppearance || (isFlatten && !source._dictionary.has('AP'))) {
            ...
            if (dictionary && dictionary.has('N')) {
                ...
                if (appearanceStream) {
                    template = new _graphics_pdf_template__WEBPACK_IMPORTED_MODULE_9__/* .PdfTemplate */ .T(appearanceStream, this._crossReference);
                }
            }
        }
        if (template) {
            if (isFlatten) {
                var page = source instanceof _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfWidgetAnnotation */ .Qf ? source._getPage() : source.page;
                if (page) {
                    var graphics = page.graphics;
                    graphics.save();
                    if (page.rotation === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle90) {
    ...
    PdfTextBoxField.prototype._createAppearance = function (isFlatten, widget) {
        ...
        var template = new _graphics_pdf_template__WEBPACK_IMPORTED_MODULE_9__/* .PdfTemplate */ .T([0, 0, bounds.width, bounds.height], this._crossReference);
        (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._setMatrix */ .nI)(template, null);
        template._writeTransformation = false;
        var graphics = template.graphics;
        var parameter = new _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* ._PaintParameter */ .Bw();
        parameter.bounds = [0, 0, bounds.width, bounds.height];
        var backcolor = widget.backColor;
        if (backcolor) {
            parameter.backBrush = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc(backcolor);
        }
        parameter.foreBrush = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc(widget.color);
        var border = widget.border;
        if (widget.borderColor) {
            if (border.width === 0) {
                widget.borderColor = [255, 255, 255];
            }
            parameter.borderPen = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj(widget.borderColor, border.width);
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._updateDashedBorderStyle */ .xu)(border, parameter);
        }
        ...
        if (backcolor) {
            ...
            parameter.shadowBrush = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc(color);
        }
        ...
        if (widget !== null && typeof widget !== 'undefined' && widget instanceof _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfWidgetAnnotation */ .Qf && widget._enableGrouping) {
            enableGrouping = true;
        }
        ...
        if (enableGrouping && widget.textAlignment !== null && typeof widget.textAlignment !== 'undefined') {
            stringFormat = stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(widget.textAlignment, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
        }
            ...
            if (typeof this.textAlignment === 'undefined' || this.textAlignment === null) {
                this._stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(this.textAlignment, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
            }
            else {
                this._stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(_enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.left, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
            }
        }
        if ((0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._isRightToLeftCharacters */ .Cc)(text)) {
            this._stringFormat.textDirection = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextDirection */ .p$.rightToLeft;
        }
        if (enableGrouping) {
    ...
    PdfTextBoxField.prototype._drawTextBox = function (g, parameter, text, font, format, multiline, scroll, maxLength) {
        if (typeof maxLength !== 'undefined') {
            if (parameter.insertSpaces) {
                ...
                if (typeof maxLength !== 'undefined' && maxLength > 0 && this.borderColor) {
                    ...
                    for (var i = 0; i < maxLength; i++) {
                        if (format.alignment === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.right) {
                            ...
                            if (format.alignment === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.center && current.length < maxLength) {
                        ...
                        var stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(_enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.center, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
            ...
            if (parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.beveled || parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.inset) {
            ...
            if ((g._page &&
                ...
                g._page.rotation !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle0) ||
                parameter.rotationAngle > 0) {
                var state = g.save();
                if (typeof parameter.pageRotationAngle !== 'undefined' && parameter.pageRotationAngle !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle0) {
                    if (parameter.pageRotationAngle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle90) {
                ...
                if (parameter.rotationAngle) {
                    if (parameter.rotationAngle === 90) {
                        if (parameter.pageRotationAngle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle90) {
                            ...
                            var y = rectangle[0];
                            rectangle = [x, y, rectangle[3], rectangle[2]];
                            parameter.stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(_enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.center, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
                        }
                        else {
                            if (rectangle[2] > rectangle[3]) {
                                g.translateTransform(0, g._size[1]);
...
var PdfButtonField = /** @class */ (function (_super) {
    ...
    Object.defineProperty(PdfButtonField.prototype, "actions", {
        ...
        get: function () {
            if (!this._actions) {
                this._actions = new _pdf_action__WEBPACK_IMPORTED_MODULE_10__/* .PdfFieldActions */ .oi(this);
            }
    ...
    Object.defineProperty(PdfButtonField.prototype, "text", {
        ...
        get: function () {
            if (this._isLoaded) {
                ...
                if (typeof this._text === 'undefined') {
                    var value = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getInheritableProperty */ .m8)(this._dictionary, 'V', false, true, 'Parent');
                    if (value) {
                        this._text = value;
                    }
                }
    ...
    Object.defineProperty(PdfButtonField.prototype, "highlightMode", {
        ...
        get: function () {
            ...
            if (widget && typeof widget.highlightMode !== 'undefined') {
                ...
                mode = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._mapHighlightMode */ .jm)(highlight.name);
            }
            return (typeof mode !== 'undefined') ? mode : _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfHighlightMode */ .iu.invert;
        },
        /**
         * Sets the highlight mode of the field.
         *
    ...
    PdfButtonField.prototype._assignText = function (fieldDictionary, value) {
        ...
        if (fieldDictionary && fieldDictionary.has('MK')) {
            ...
            dictionary = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
    ...
    PdfButtonField.prototype._initialize = function (page, name, bounds) {
        ...
        this._crossReference._cacheMap.set(this._ref, this._dictionary);
        this._dictionary.objId = this._ref.toString();
        this._dictionary.update('FT', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get('Btn'));
        this._dictionary.update('T', name);
        this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.pushButton;
        this._initializeFont(this._defaultFont);
        this._createItem(bounds);
    };
    PdfButtonField.prototype._createItem = function (bounds) {
        var widget = new _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfWidgetAnnotation */ .Qf();
        widget._create(this._page, bounds, this);
        widget.textAlignment = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.center;
        this._stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(widget.textAlignment, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
        widget._dictionary.update('MK', new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference));
        widget._mkDictionary.update('BC', [0, 0, 0]);
    ...
    PdfButtonField.prototype._postProcess = function (isFlatten, widget) {
        ...
        if ((widget !== null && typeof widget !== 'undefined' && widget._setAppearance && widget._enableGrouping) || this._form._setAppearance || this._setAppearance || (isFlatten && !source._dictionary.has('AP'))) {
            ...
            if (dictionary && dictionary.has('N')) {
                ...
                if (appearanceStream && appearanceStream instanceof _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP && source._dictionary.has('AS')) {
                    var name_5 = source._dictionary.get('AS');
                    if (name_5 && name_5 instanceof _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG && appearanceStream.has(name_5.name)) {
                        var reference_1 = appearanceStream.getRaw(name_5.name);
                        var value = appearanceStream.get(name_5.name);
                        if (reference_1 && value && value instanceof _base_stream__WEBPACK_IMPORTED_MODULE_11__/* ._PdfBaseStream */ .dS) {
    ...
    PdfButtonField.prototype._createAppearance = function (widget, isPressed) {
        ...
        if (enableGrouping) {
            ...
            stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(widget.textAlignment, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
        }
        else if (typeof this._font === 'undefined' || this._font === null) {
            this._font = this._defaultFont;
        }
        if (this._isLoaded && widget instanceof _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfWidgetAnnotation */ .Qf &&
            ...
            var font_1;
            this._stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p();
            this._stringFormat.lineAlignment = _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle;
            this._stringFormat.alignment = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.center;
            if (fontSize !== null && typeof fontSize !== 'undefined' && fontName) {
                font_1 = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._mapFont */ .BM)(fontName, fontSize, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular, widget);
            }
            ...
            if (isSizeZero && currentFont && currentFont instanceof _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p) {
                if (this._isLoaded && !widget._dictionary.has('AP')) {
                    ...
                    while (textWidth[0] < width || textWidth[1] < height) {
                        ...
                        currentFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(currentFont.fontFamily, currentFont._size + 1);
                ...
                if (parameter.rotationAngle === 90) {
                    if (parameter.pageRotationAngle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle90) {
                        ...
                        if (rectangle[2] > rectangle[3]) {
                            ...
                            var y = rectangle[0];
                            rectangle = [x, y, rectangle[3], rectangle[2]];
                            format._wordWrapType = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfWordWrapType */ .E7.none;
                        }
                        else {
                            var z = rectangle[0];
                            rectangle[0] = -(rectangle[1] + rectangle[3]);
...
var PdfCheckBoxField = /** @class */ (function (_super) {
    ...
    PdfCheckBoxField._load = function (form, dictionary, crossReference, reference) {
        ...
        if (field._dictionary.has('Kids')) {
            ...
            var item = _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfStateItem */ .RM._load(dictionary, crossReference, field);
            item._isLoaded = true;
            item._ref = reference;
    ...
    PdfCheckBoxField.prototype.itemAt = function (index) {
        ...
        if (this._parsedItems.has(index)) {
            ...
            if (index >= 0 && this._kids && this._kids.length > 0 && index < this._kids.length) {
                ...
                if (ref && ref instanceof _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfReference */ .BG) {
                    dictionary = this._crossReference._fetch(ref);
                }
                if (dictionary) {
                    item = _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfStateItem */ .RM._load(dictionary, this._crossReference, this);
                    item._isLoaded = true;
                    item._ref = ref;
                    this._parsedItems.set(index, item);
                }
    ...
    Object.defineProperty(PdfCheckBoxField.prototype, "checked", {
         ...
         */
        get: function () {
            return (this._kidsCount > 0) ? this.itemAt(this._defaultIndex).checked : (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._checkField */ .Gf)(this._dictionary);
        },
        /**
        ...
        set: function (value) {
            if (this.checked !== value) {
                ...
                if (value) {
                    if (this._isLoaded) {
                        var entry = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getItemValue */ .wo)((this._kidsCount > 0) ?
                            this.itemAt(this._defaultIndex)._dictionary : this._dictionary);
                        this._dictionary.update('V', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get(entry));
                        this._dictionary.update('AS', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get(entry));
                    }
                    else {
                        this._dictionary.update('V', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get('Yes'));
                        this._dictionary.update('AS', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get('Yes'));
                    }
                }
                else {
    ...
    PdfCheckBoxField.prototype._createItem = function (bounds) {
        var widget = new _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfStateItem */ .RM();
        widget._create(this._page, bounds, this);
        widget.textAlignment = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.center;
        this._stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(widget.textAlignment, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
        widget._dictionary.update('MK', new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference));
        widget._mkDictionary.update('BC', [0, 0, 0]);
        widget._mkDictionary.update('BG', [1, 1, 1]);
        widget.style = _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfCheckBoxStyle */ .P1.check;
    ...
    PdfCheckBoxField.prototype._doPostProcess = function (isFlatten) {
        ...
        if (!this._isLoaded) {
            for (var i = 0; i < count; i++) {
                var item = this.itemAt(i);
                if (item) {
                    var state = item.checked ? _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked : _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.unchecked;
            ...
            if (count > 0) {
                        ...
                        if (!this._checkFieldFlag(item._dictionary)) {
                            if (isFlatten) {
                                ...
                                var state = item.checked ?
                                    _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked :
                                    _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.unchecked;
                                if (this._setAppearance || this._form._setAppearance || !item._dictionary.has('AP')) {
                                    template = this._createAppearance(item, state);
                                }
                                else {
                                    template = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getStateTemplate */ .rb)(state, item);
                                }
                                this._drawTemplate(template, item._getPage(), item.bounds);
                            }
                ...
                var style = this.checked ?
                    _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked :
                    _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.unchecked;
                this._drawTemplate((0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getStateTemplate */ .rb)(style, this), this.page, this.bounds);
            }
        }
    ...
    PdfCheckBoxField.prototype._createAppearance = function (widget, state) {
        ...
        parameter.rotationAngle = widget.rotate;
        var template = new _graphics_pdf_template__WEBPACK_IMPORTED_MODULE_9__/* .PdfTemplate */ .T(parameter.bounds, this._crossReference);
        var graphics = template.graphics;
        if (widget._styleText) {
            this._drawCheckBox(graphics, parameter, widget._styleText, state);
        }
        else {
            this._drawCheckBox(graphics, parameter, (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._styleToString */ .Bd)(widget._style), state);
        }
        return template;
    };
    PdfCheckBoxField.prototype._drawAppearance = function (item, itemValue) {
        ...
        if (item._dictionary.has('AP')) {
            ...
            if (appearance) {
                if (appearance.has('N')) {
                    (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeReferences */ .yg)(appearance.get('N'), this._crossReference, 'Yes', 'Off');
                }
                if (appearance.has('D')) {
                    (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeReferences */ .yg)(appearance.get('D'), this._crossReference, 'Yes', 'Off');
                }
            }
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeDuplicateReference */ .i0)(appearance, this._crossReference, 'N');
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeDuplicateReference */ .i0)(appearance, this._crossReference, 'D');
        }
        else {
            var reference = this._crossReference._getNextReference();
            appearance = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
        ...
        var normalChecked = this._createAppearance(item, _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked);
        ...
        var normalUnchecked = this._createAppearance(item, _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.unchecked);
        ...
        var normalDictionary = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
        ...
        var pressChecked = this._createAppearance(item, _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedChecked);
        ...
        var pressUnchecked = this._createAppearance(item, _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.pressedUnchecked);
        ...
        var pressedDictionary = new _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfDictionary */ .sP(this._crossReference);
        if (itemValue !== null && typeof itemValue !== 'undefined') {
...
var PdfRadioButtonListField = /** @class */ (function (_super) {
        ...
        set: function (value) {
            if (this.selectedIndex !== value) {
                ...
                for (var i = 0; i < this._kidsCount; i++) {
                    var item = this.itemAt(i);
                    if (i === value) {
                        item._dictionary.update('AS', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get(item.value));
                        var name_6 = _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get(item.value);
                        this._dictionary.update('V', name_6);
                        this._dictionary.update('DV', name_6);
                    }
                    else {
                        item._dictionary.update('AS', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get('Off'));
                    }
                }
            }
        },
    ...
    PdfRadioButtonListField.prototype.itemAt = function (index) {
        ...
        if (this._parsedItems.has(index)) {
            ...
            if (index >= 0 && this._kids && this._kids.length > 0 && index < this._kids.length) {
                ...
                if (dictionary) {
                    item = _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfRadioButtonListItem */ .lh._load(dictionary, this._crossReference, this);
                    item._ref = ref;
                    item._index = index;
                    this._parsedItems.set(index, item);
                }
    ...
    PdfRadioButtonListField.prototype.add = function (value, bounds) {
        if (value instanceof _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfRadioButtonListItem */ .lh) {
            value._field = this;
            ...
            return new _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfRadioButtonListItem */ .lh(value, bounds, this);
        }
    };
    /**
    ...
    PdfRadioButtonListField.prototype._initialize = function (page, name) {
        ...
        this._dictionary.update('T', name);
        this._parsedItems = new Map();
        this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.radio;
    };
    ...
    PdfRadioButtonListField.prototype._obtainSelectedIndex = function () {
        ...
        for (var i = 0; i < this._kidsCount; ++i) {
            var item = this.itemAt(i);
            if (item) {
                var checkName = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getInheritableProperty */ .m8)(item._dictionary, 'V', false, true, 'Parent');
                if (checkName && item._dictionary.has('AS')) {
                    var asName = item._dictionary.get('AS');
                    if (asName && asName.name.toLowerCase() !== 'off') {
                        if (checkName instanceof _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG && checkName.name.toLowerCase() !== 'off') {
    ...
    PdfRadioButtonListField.prototype._doPostProcess = function (isFlatten) {
        ...
        if (this._isLoaded) {
            ...
            for (var i = 0; i < count; i++) {
                var item = this.itemAt(i);
                var state = this.selectedIndex === i ? _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.checked : _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._PdfCheckFieldState */ .d6.unchecked;
                if (!this._isDuplicatePage) {
                    item._dictionary.update('AS', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get(this.selectedIndex === i ? item.value : 'Off'));
                }
                if (isFlatten) {
                    var template = this._createAppearance(item, state);
                    this._drawTemplate(template, item._getPage(), item.bounds);
    ...
    PdfRadioButtonListField.prototype._createAppearance = function (widget, state) {
        ...
        if (widget._styleText) {
            ...
            this._drawRadioButton(graphics, parameter, (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._styleToString */ .Bd)(widget.style), state);
        }
        return template;
    };
    PdfRadioButtonListField.prototype._drawAppearance = function (item) {
        ...
        if (item._dictionary.has('AP')) {
            ...
            if (appearance) {
                if (appearance.has('N')) {
                    (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeReferences */ .yg)(appearance.get('N'), this._crossReference, item.value, 'Off');
                }
                if (appearance.has('D')) {
                    (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeReferences */ .yg)(appearance.get('D'), this._crossReference, item.value, 'Off');
                }
            }
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeDuplicateReference */ .i0)(appearance, this._crossReference, 'N');
            (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._removeDuplicateReference */ .i0)(appearance, this._crossReference, 'D');
...
var PdfListField = /** @class */ (function (_super) {
    ...
    Object.defineProperty(PdfListField.prototype, "multiSelect", {
        ...
        get: function () {
            if (this._isLoaded) {
                return (this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.multiSelect) !== 0;
            }
            else {
        ...
        set: function (value) {
            if (this.multiSelect !== value) {
                ...
                if (value) {
                    this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.multiSelect;
                }
                else {
                    this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.multiSelect;
                }
    ...
    Object.defineProperty(PdfListField.prototype, "editable", {
        ...
        get: function () {
            if (this._isLoaded) {
                return (this._fieldFlags & _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.edit) !== 0;
            }
            else {
        ...
        set: function (value) {
            if (this._editable !== value) {
                ...
                if (value) {
                    this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.edit;
                }
                else {
                    this._fieldFlags &= ~_enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.edit;
                }
    ...
    PdfListField.prototype.itemAt = function (index) {
        ...
        if (index < this._kidsCount) {
            if (this._parsedItems.has(index)) {
                ...
                if (dictionary) {
                    item = _annotations_annotation__WEBPACK_IMPORTED_MODULE_3__/* .PdfListFieldItem */ .eq._load(dictionary, this._crossReference, this);
                    item._index = index;
                    item._ref = reference;
    ...
    PdfListField.prototype._initialize = function (page, name, bounds) {
        ...
        this._crossReference._cacheMap.set(this._ref, this._dictionary);
        this._dictionary.objId = this._ref.toString();
        this._dictionary.update('FT', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get('Ch'));
        this._dictionary.update('T', name);
        this._parsedItems = new Map();
        this._listValues = [];
        this._kids = [];
        ...
        if (item && (item._dictionary.has('DS') || item._dictionary.has('DA'))) {
            if (item._dictionary.has('DS')) {
                ...
                if (value && value !== '' && value.indexOf('Tf') !== -1) {
                    ...
                    var height = 0.0;
                    if (fontSize === 0) {
                        var font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.helvetica, height);
                        if (font !== null) {
            ...
            if (fontFamily) {
                fontFamily = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._decodeFontFamily */ .n9)(fontFamily);
            }
            switch (fontFamily) {
                case 'Helv':
                    this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.helvetica, fontSize, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular);
                    break;
                case 'Courier':
                case 'Cour':
                    this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.courier, fontSize, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular);
                    break;
                case 'Symb':
                    this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.symbol, fontSize, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular);
                    break;
                case 'TiRo':
                    this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.timesRoman, fontSize, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular);
                    break;
                case 'ZaDb':
                    this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.zapfDingbats, fontSize, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular);
                    break;
                default:
                    this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.helvetica, fontSize, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular);
                    break;
                            ...
                            if (fonts.has(fontFamily)) {
                                ...
                                if (fontDictionary && fontFamily && fontDictionary.has('BaseFont')) {
                                    ...
                                    if (baseFont && baseFont.name !== null && typeof baseFont.name !== 'undefined') {
                                        textFontStyle = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getFontStyle */ .Qp)(baseFont.name);
                                        if (fontSubtType && fontSubtType === 'TrueType') {
                                            var fontData = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._createFontStream */ .vw)(this.form, fontDictionary);
                                            if (fontData && fontData.length > 0) {
                                                var base64String = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._encode */ .Mv)(fontData);
                                                if (base64String && base64String.length > 0) {
                                                    this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfTrueTypeFont */ .We(base64String, fontSize, textFontStyle);
                                                }
                                            }
                                        }
                                        else if (fontSubtType && fontSubtType === 'Type0') {
                                            var fontData = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._getFontFromDescriptor */ .al)(fontDictionary);
                                            if (fontData && fontData.length > 0) {
                                                var base64String = (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._encode */ .Mv)(fontData);
                                                if (base64String && base64String.length > 0) {
                                                    this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfTrueTypeFont */ .We(base64String, fontSize, textFontStyle);
...
var PdfComboBoxField = /** @class */ (function (_super) {
    ...
    function PdfComboBoxField(page, name, bounds) {
        ...
        if (page && name && bounds) {
            _this._initialize(page, name, bounds);
            _this._fieldFlags |= _enumerator__WEBPACK_IMPORTED_MODULE_2__/* ._FieldFlag */ .aA.combo;
        }
        return _this;
    }
    ...
    PdfComboBoxField.prototype._createAppearance = function (item) {
        ...
        if (item) {
            ...
            var page = item._getPage();
            if (item._isLoaded && page && typeof page.rotation !== 'undefined' && page.rotation !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle0) {
            ...
            parameter.foreBrush = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc(item.color);
            var border = item.border;
            if (item.borderColor) {
                parameter.borderPen = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj(item.borderColor, border.width);
                (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._updateDashedBorderStyle */ .xu)(border, parameter);
            }
            parameter.borderStyle = border.style;
            parameter.borderWidth = border.width;
            ...
            var alignment = typeof item.textAlignment !== 'undefined' ? item.textAlignment : _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.left;
            var verticalAlignment = this.multiSelect ? _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.top : _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle;
            parameter.stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(alignment, verticalAlignment);
        }
        else {
            ...
            if (bounds) {
                if (this._isLoaded &&
                    ...
                    this.page.rotation !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle0) {
            ...
            parameter.foreBrush = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc(this.color);
            var border = this.border;
            if (this.borderColor) {
                parameter.borderPen = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfPen */ .Qj(this.borderColor, border.width);
                (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._updateDashedBorderStyle */ .xu)(border, parameter);
            }
            parameter.borderStyle = border.style;
            parameter.borderWidth = border.width;
            ...
            var alignment = typeof this.textAlignment !== 'undefined' ? this.textAlignment : _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.left;
            var verticalAlignment = this.multiSelect ? _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.top : _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle;
            parameter.stringFormat = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(alignment, verticalAlignment);
        }
        parameter.required = this.required;
        ...
        if (this._isLoaded) {
            ...
            if (!this._font) {
                this._font = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.timesRoman, this._getFontHeight(_fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontFamily */ .Qr.helvetica));
            }
    ...
    PdfComboBoxField.prototype._drawComboBox = function (graphics, parameter, font, stringFormat) {
        ...
        if (i >= 0 && i < options.length) {
            ...
            var padding = (parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.inset || parameter.borderStyle === _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfBorderStyle */ .eE.beveled);
            if (padding) {
            ...
            graphics.setClip(rectangle, _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfFillMode */ .LA.winding);
            if (parameter.rotationAngle === 0) {
                ...
                brush = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc([153, 193, 218]);
                graphics.drawRectangle(x, location_1[1], width, rect[3], brush);
                brush = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfBrush */ .Dc([0, 0, 0]);
            }
            var value = void 0;
    ...
    PdfComboBoxField.prototype._getFontHeight = function (fontFamily) {
        ...
        if (this._isLoaded) {
            itemFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(fontFamily, 12);
            format = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(_enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.center, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
        ...
        if (values && values.length > 0) {
            if (s !== 12) {
                itemFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(fontFamily, s);
                var selectedValue = this.selectedValue; // eslint-disable-line
                ...
                if (textSize[0] > bounds.width || textSize[1] > bounds.height) {
                    ...
                    for (var i = 1; i <= bounds.height; i++) {
                        itemFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(fontFamily, i);
                        var size = itemFont.measureString(text);
                        if (size[0] > bounds.width || size[1] > h) {
                            fontSize = i;
                            do {
                                fontSize = fontSize - 0.001;
                                itemFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(fontFamily, fontSize);
...
var PdfListBoxField = /** @class */ (function (_super) {
        ...
        if (this._dictionary.has('Opt')) {
            ...
            if (options && options.length > 0) {
                ...
                for (var i = 0; i < count; i++) {
                    var item = this.itemAt(i);
                    if (item) {
                        if ((0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._isNullOrUndefined */ .i$)(index) && this._listValues !== null && typeof this._listValues !== 'undefined') {
    ...
    PdfListBoxField.prototype._getFontHeight = function (fontFamily) {
        var itemFont = new _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfStandardFont */ .p(fontFamily, 12, _fonts_pdf_standard_font__WEBPACK_IMPORTED_MODULE_0__/* .PdfFontStyle */ .xK.regular);
        var format = new _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfStringFormat */ .p(_enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfTextAlignment */ .P4.left, _fonts_pdf_string_format__WEBPACK_IMPORTED_MODULE_8__/* .PdfVerticalAlignment */ .K.middle);
        var s = 0;
        if ((0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._isNullOrUndefined */ .i$)(this._listValues) && this._listValues.length > 0) {
...
var PdfSignatureField = /** @class */ (function (_super) {
    ...
    PdfSignatureField.prototype._initialize = function (page, name, bounds) {
        ...
        this._crossReference._cacheMap.set(this._ref, this._dictionary);
        this._dictionary.objId = this._ref.toString();
        this._dictionary.update('FT', _pdf_primitives__WEBPACK_IMPORTED_MODULE_6__/* ._PdfName */ .TG.get('Sig'));
        this._dictionary.update('T', name);
        this._defaultIndex = 0;
        this._initializeFont(this._defaultFont);
        this._createItem(bounds);
            ...
            if (appearanceDictionary && appearanceDictionary.has('N')) {
                ...
                if (appearanceStream) {
                    ...
                    if (template && page) {
                        ...
                        if (page.rotation !== _enumerator__WEBPACK_IMPORTED_MODULE_2__/* .PdfRotationAngle */ .Gd.angle0) {
                            var newGraphics = new _graphics_pdf_graphics__WEBPACK_IMPORTED_MODULE_5__/* .PdfGraphics */ .gR(graphics._size, graphics._sw._stream, graphics._crossReference, page);
...
var _PdfDefaultAppearance = /** @class */ (function () {
    function _PdfDefaultAppearance(da) {
        ...
        this.color = (typeof color !== 'undefined') ? (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* ._parseColor */ .Y3)(color) : [0, 0, 0];
    }
...
//# sourceMappingURL=e22243e9-2f47e0d383981993.js.map