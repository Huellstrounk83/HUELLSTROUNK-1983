...
var Shape = /** @class */ (function () {
    ...
    Shape.prototype.shape = function (args) {
        ...
        switch (args.prop) {
            ...
            case 'applyActObj':
                ...
                break;
            case 'wireEvent':
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(parent.upperCanvas, 'dblclick', this.findTextTarget, this);
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(parent.textArea, 'mousedown', this.findTextTarget, this);
                uploader = document.getElementById(parent.element.id + '_fileUpload');
                if (uploader) {
                    _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(uploader, 'change', this.fileChanged, this);
                }
                break;
            case 'unWireEvent':
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(parent.upperCanvas, 'dblclick', this.findTextTarget);
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(parent.textArea, 'mousedown', this.findTextTarget);
                uploader = document.getElementById(parent.element.id + '_fileUpload');
                if (uploader) {
                    _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(uploader, 'change', this.fileChanged);
                }
                break;
    ...
    Shape.prototype.initShapePvtProps = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.shapeImg)) {
    ...
    Shape.prototype.drawShape = function (type, strokeWidth, strokeColor, fillColor, start, width, height, pointColl, arrowStart, arrowEnd, degree, opacity, isSelected, radius, redactType, value) {
        ...
        if (!parent.disabled && parent.isImageLoaded) {
            ...
            if (type !== 'freehanddraw' && type !== '') {
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(strokeSettings)) {
                ...
                if (type === 'line' || type === 'arrow') {
                    ...
                    if (redactType) {
                        ...
                        if (redactType === _index__WEBPACK_IMPORTED_MODULE_1__/* .RedactType */ .ER.Blur) {
                            if (value) {
    ...
    Shape.prototype.prevObjColl = function () {
        ...
        this.prevObj.objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
        this.prevObj.pointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
        this.prevObj.afterCropActions = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.afterCropActions, [], true);
        var selPointCollObj = { selPointColl: null };
        parent.notify('freehand-draw', { prop: 'getSelPointColl', onPropertyChange: false,
            value: { obj: selPointCollObj } });
        this.prevObj.selPointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], selPointCollObj['selPointColl'], [], true);
    };
    Shape.prototype.drawShapeText = function (text, fontFamily, fontSize, bold, italic, strokeColor, x, y, isSelected, degree, fillColor, outlineColor, outlineWidth, transformCollection, underline, strikethrough) {
        ...
        if (!parent.disabled && parent.isImageLoaded) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.textSettings.fontSize)) {
                parent.getFontSizes();
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(x) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(y)) {
    ...
    Shape.prototype.apply = function (shape, obj, canvas) {
        ...
        if (!parent.disabled) {
            if (parent.togglePen && !parent.currObjType.isCustomCrop) {
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.shape) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(shape)) {
                    parent.currObjType.shape = '';
                }
                else {
    ...
    Shape.prototype.updateShapeChangeEventArgs = function (shapeSettings, allowShapeOverflow) {
        ...
        if (shapeSettings.id && shapeSettings.id.split('_')[0] && shapeSettings.id.split('_')[0] === 'pen') {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(shapeSettings.degree)) {
    ...
    Shape.prototype.updateTextFromTextArea = function () {
        ...
        if (parent.activeObj.rotatedAngle !== 0) {
            ...
            parent.activeObj.activePoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, tempActiveObj.activePoint, {}, true);
        ...
        if (parent.objColl.length > 0) {
            ...
            while (objColl.length > 0) {
                ...
                for (var i = 0; i < objColl.length; i++) {
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentObj.order)) {
                        objColl.splice(i, 1);
                        i--;
                        continue;
                    }
    ...
    Shape.prototype.getSmallestIndex = function () {
        ...
        for (var i = 0, len = parent.objColl.length; i < len; i++) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(smallestIndex) || currentObj.order < smallestIndex) {
    ...
    Shape.prototype.zoomObjColl = function (preventApply) {
        ...
        if (parent.objColl.length > 0) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(preventApply)) {
                var temp = this.lowerContext.filter;
                this.lowerContext.filter = 'none';
                this.iterateObjColl();
                this.lowerContext.filter = temp;
    ...
    Shape.prototype.straightenFHD = function () {
        ...
        for (var i = 0, fLen = parent.freehandCounter; i < fLen; i++) {
            parent.points = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl[i].points, []);
    ...
    Shape.prototype.updateCurrentActiveObjPoint = function (degree) {
        ...
        if (degree === 'horizontal' || degree === 'vertical' || degree === 'Horizontal' || degree === 'Vertical' ||
            ...
            if (currActObjIndex !== undefined) {
                parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[currActObjIndex], {}, true);
            }
        }
        else if (degree === 90) {
            this.rotateObjColl();
    ...
    Shape.prototype.rotateLineArrowObj = function (obj) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj.pointColl)) {
            return;
        }
        var parent = this.parent;
        var _a = parent.img, destWidth = _a.destWidth, destHeight = _a.destHeight, destLeft = _a.destLeft, destTop = _a.destTop;
        if (obj.pointColl.length > 0) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj.pointColl[obj.pointColl.length - 2])) {
                prevPoint = { x: 0, y: 0 };
            }
            else {
    ...
    Shape.prototype.setTextBoxWidth = function (e) {
        ...
        if ((e && parseFloat(parent.textArea.style.width) < (textAreaWidth + letterWidth)) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(e)) {
            if (degree === 0) {
    ...
    Shape.prototype.stopPathDrawing = function (e, isApply) {
        ...
        if (parent.activeObj.shape === 'path') {
            ...
            if (obj['shape'] === 'path') {
                ...
                if (e && e.type !== 'touchstart' && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isApply)) {
    ...
    Shape.prototype.findTextTarget = function (e) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(x) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(y)) {
            ...
            if (parent.textArea.style.display === 'none') {
                temp = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
                for (var i = 0; i < parent.objColl.length; i++) {
    ...
    Shape.prototype.applyFontStyle = function (item) {
        ...
        var shapeChangedArgs = { action: 'font-style', currentShapeSettings: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, shapeSettings, {}, true) };
    ...
    Shape.prototype.updateFontRatio = function (obj, isTextArea) {
        ...
        var height = parent.activeObj.textSettings.fontSize;
        var degree = this.getRotDegOfShape(obj);
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isTextArea)) {
    ...
    Shape.prototype.pushActItemIntoObj = function () {
        ...
        if (parent.textArea.style.display === 'none') {
            ...
            var temp = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
            parent.notify('selection', { prop: 'setTextBoxStylesToActObj', onPropertyChange: false });
            parent.objColl.push(parent.activeObj);
            parent.activeObj = temp;
        }
        ...
        if (parent.activeObj.shape !== undefined && parent.activeObj.shape === 'text' && parent.activeObj.keyHistory === '') {
            ...
            if (parent.activeObj.shape && !isCropSelection && parent.activeObj.shape !== 'shape') {
                ...
                if (!isActObj) {
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.order)) {
                        parent.activeObj.order = this.getNewOrder();
                    }
                    this.updImgRatioForActObj();
                    var splitWords_1 = parent.activeObj.currIndex.split('_');
                    var tempObjColl = parent.objColl.splice(0, parseInt(splitWords_1[1], 10) - 1);
                    tempObjColl.push((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true));
                    for (var i = 0; i < parent.objColl.length; i++) {
    ...
    Shape.prototype.getFreehandDrawDetails = function (index) {
        ...
        shapeDetails.type = _index__WEBPACK_IMPORTED_MODULE_1__/* .ShapeType */ .IO.FreehandDraw;
        shapeDetails.points = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl[index].points);
            ...
            if (id.split('_')[0] === 'shape') {
                ...
                for (var i = 0, len = parent.objColl.length; i < len; i++) {
                    if (parent.objColl[i].currIndex === id) {
                        obj_4 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[i], {}, true);
                        break;
                    }
                }
    ...
    Shape.prototype.isPointsInRange = function (x, y, obj) {
        var inRange = false;
        var parent = this.parent;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(x) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(y) && x >= parent.img.destLeft && y >= parent.img.destTop &&
    ...
    Shape.prototype.selectShape = function (id, obj) {
        ...
        if (!parent.disabled && parent.isImageLoaded) {
            ...
            if (id.split('_')[0] === 'shape') {
                ...
                for (var i = 0, len = parent.objColl.length; i < len; i++) {
                    if (parent.objColl[i].currIndex === id) {
                        obj_5 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[i], {}, true);
                        break;
                    }
                }
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj_5)) {
                    isSelected = false;
                }
                else {
                    isSelected = true;
    ...
    Shape.prototype.getMaxText = function (isTextBox, text, obj) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(text)) {
    ...
    Shape.prototype.getLinePoints = function (x1, y1, x2, y2) {
        ...
        if (Math.floor(x1) === Math.floor(x2) || (points.length < 10 && (y2 - y1 > 10 || y1 - y2 > 10))) {
            ...
            if (points.length > 1) {
                var prev = void 0;
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(points[points.length - 2])) {
                    prev = { x: 0, y: 0 };
                }
                else {
    ...
    Shape.prototype.updateZOrder = function (obj, value) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        var object = obj;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(object.order)) {
            return;
        }
        var index;
        var prevIndex;
    ...
    Shape.prototype.updateShapeColl = function () {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        var tempPointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
        if (parent.shapeColl.length > 0 &&
                    ...
                    if (parent.shapeColl[i].currIndex &&
                        ...
                        for (var j = 0; j < tempObjColl.length; j++) {
                            if (parent.shapeColl[i].currIndex === tempObjColl[j].currIndex) {
                                parent.shapeColl[i] = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, tempObjColl[j], {}, true);
                        ...
                        for (var j = 0; j < tempPointColl.length; j++) {
                            if (parent.shapeColl[i].id === tempPointColl[j].id) {
                                parent.shapeColl[i] = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], tempPointColl[j], [], true);
        ...
        tempObjColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
        tempPointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
        parent.shapeColl = [];
        var order = 1;
        var isBreak;
        var isCrop = false;
        while (tempObjColl.length !== 0 || tempPointColl.length !== 0) {
            ...
            for (var i = 0; i < tempObjColl.length; i++) {
                if (tempObjColl[i].order === order ||
                    ...
                    parent.shapeColl.push((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, tempObjColl[i], {}, true));
            ...
            if (!isBreak) {
                for (var i = 0; i < tempPointColl.length; i++) {
                    if (tempPointColl[i].order === order) {
                        parent.shapeColl.push((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], tempPointColl[i], [], true));
    ...
    Shape.prototype.drawAnnotations = function (ctx, shape, pen, isPreventApply, x, y, panRegion) {
        ...
        //  = i_3;
                        ...
                        if (tempObjCollIndex > -1) {
                            tempObjColl[tempObjCollIndex] = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.objColl[0], {}, true);
                        }
                    }
                }
                    ...
                    parent.pointColl.push((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, tempShapeColl[i], {}, true));
                    ...
                    if (pen === 'iterate') {
                        ...
                        for (var i_4 = 0; i_4 < tempPointColl.length; i_4++) {
                            if (tempPointColl[i_4].id === parent.pointColl[0].id) {
                                tempPointColl[i_4] = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.pointColl[0], {}, true);
                                break;
                            }
                        }
                        for (var i_5 = 0, len = tempSelPointCollObj['selPointColl'].length; i_5 < len; i_5++) {
                            if (tempSelPointCollObj['selPointColl'][i_5].id === selPointCollObj['selPointColl'][i_5].id) {
                                tempSelPointCollObj['selPointColl'][i_5] = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, selPointCollObj['selPointColl'][i_5], {}, true);
                                break;
                            }
                        }
                    }
...
//# sourceMappingURL=5e32e882-6905022529bee241.js.map