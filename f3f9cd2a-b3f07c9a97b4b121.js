...
/* harmony export */   DK: () => (/* binding */ ValueChangedArgs),
/* harmony export */   Xl: () => (/* binding */ getAlphalabel),
/* harmony export */   ZN: () => (/* binding */ Calculate),
/* harmony export */   xM: () => (/* binding */ FormulaError)
/* harmony export */ });
/* unused harmony exports FormulaInfo, CalcSheetFamilyItem */
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _formulas_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(94659);
/* harmony import */ var _common_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(56270);
/* harmony import */ var _parser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(18368);
/* harmony import */ var _workbook_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(54697);
/* harmony import */ var _syncfusion_ej2_data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(28132);
...
var Calculate = /** @class */ (function (_super) {
    ...
    function Calculate(parent) {
        ...
        new _formulas_index__WEBPACK_IMPORTED_MODULE_1__/* .BasicFormulas */ .q(_this);
        _this.parentObject = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent) ? _this : parent;
        _this.grid = _this.parentObject;
        _this.parser = new _parser__WEBPACK_IMPORTED_MODULE_3__/* .Parser */ .i(_this);
        return _this;
    }
                    ...
                    var checkCircularReference_1 = function (refCell) {
                        if (formulaDependentCellMap_1.has(refCell)) {
                            ...
                            if (formalaRefCells.has(formulaCell)) {
                                throw _this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.CircularReference];
                            }
    ...
    Calculate.prototype.getSheetToken = function (cellRef) {
        ...
        throw this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.BadIndex];
    };
    /**
     * @hidden
        ...
        if (this.storedData.has(key) !== null) {
            ...
            if (fText.length > 0 && fText[0] === this.getFormulaCharacter()) {
                ...
                try {
                    ...
                    return ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.getErrorLine(ex)) ? '' : '#' + this.getErrorLine(ex) + ': ') + errorMessage;
                }
            }
            return this.storedData.get(key).getFormulaValue();
        }
    ...
    Calculate.prototype.getCellCollection = function (cellRange) {
        ...
        if (row1 >= maxRows || row2 >= maxRows || col1 >= maxCols || col2 >= maxCols) {
            return [this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Ref]];
        }
        if (row1 > row2) {
            i = row2;
            row2 = row1;
        ...
        try {
            ...
            if (parsedText !== this.emptyString && lastIndexOfq > -1) {
                ...
                var _loop_1 = function () {
                    ...
                    formulatResult = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this_1.getFunction(libFormula)) ? this_1.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Name] : this_1.getFunction(libFormula).apply(void 0, args);
                    if (nestedFormula) {
            ...
            this.trigger('onFailure', args);
            var errorMessage = (typeof args.exception === 'string') ? args.exception : args.message;
            formulatResult = ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.getErrorLine(ex)) ? '' : '#' + this.getErrorLine(ex) + ': ') + errorMessage;
        }
    ...
    Calculate.prototype.computeSumIfAndAvgIf = function (range, isAvgIf) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(range) || range[0] === this.emptyString || range.length === 0) {
            return this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
        var argArr = range;
        for (var i = 0; i < argArr.length; i++) {
            if (this.isCellReference(argArr[i]) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(argArr[i].match(/[0-9]/)) &&
                argArr[i].indexOf('!') < 0) {
        ...
        if (argArr[1] === '') {
            return isAvgIf ? this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.DivZero] : '0';
        }
        ...
        if (criteria.length > 255) {
            return this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Value];
        }
        ...
        if (sumRange[0] === '#REF!' || criteriaRange[0] === '#REF!') {
            return this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Name];
        }
    ...
    Calculate.prototype.computeLookup = function (range) {
        ...
        if (isArrayVector) {
            ...
            var lookupIndex = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(argArr[1]);
            var matchIndex = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(arrvalue);
            ...
            if (!isValidLookup || !isValidMatch) {
                return this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.NA];
            }
        }
        ...
        if (!this.isNaN(lookupVal)) {
            for (var a = 0; a < num.length; a++) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(matchupRange[a]) && checkCriteria[a] !== '' && lookupVal === this.parseFloat(checkCriteria[a])) {
            ...
            for (var j = 0; j < lookupRange.length; j++) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(matchupRange[j]) && lookupValue !== '' && checkCriteria[j] !== '') {
        ...
        if (lookupVal > maxVal && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(matchupRange[lookupRange.length - 1])) {
        ...
        if (findMaxVal.indexOf(lookupValue.split(this.tic).join('')) < 0 && lookupValue !== this.trueValue && lookupValue !== this.falseValue) {
            if (!this.isNaN(lookupVal) && !this.isNaN(maxVal) && !this.isNaN(minVal)) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(matchupRange[index]) && index >= 0) {
    ...
    Calculate.prototype.computeVHLookup = function (range, isVlookup) {
        ...
        var _a, _b;
        var argArr = range;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(argArr) || argArr.length < 3 || argArr.length > 4) {
            return this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
        if (argArr[1] === '') {
            return this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.NA];
        ...
        if (colNumIdx < 1) {
            return errorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Value];
        }
        ...
        if (this.isCellReference(rangeArr[0]) && this.isCellReference(rangeArr[1])) {
            ...
            this.parentObject.notify(_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .workbookFormulaOperation */ .yd0, sheetInfoArgs);
            if ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getSheetIndexByName */ .ovN)(this.parentObject, 'Sheet' + sheetId, sheetInfoArgs.sheetInfo) === -1) {
                this.grid = grid;
                return errorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Ref];
            }
        ...
        if (isExactMatchLookup) {
            ...
            result = matchedResult.length ? matchedResult[0] : errorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.NA];
        }
        else if (lookupValue.indexOf('*') > -1 || lookupValue.indexOf('?') > -1) {
            result = errorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.NA];
        }
        else {
            var matchVal_1;
            ...
            result = matchedResult.length ? matchedResult[matchedResult.length - 1] : errorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.NA];
        }
        this.grid = grid;
        return result;
    };
    ...
    Calculate.prototype.computeAndOrNot = function (args, op) {
            ...
            if (this.isCellReference(ranges[i])) {
                ...
                for (var j = 0; j < cells.length; j++) {
                    ...
                    if (value === this.falseValue || (value !== '' && parseVal === 0) || (isNot && value === '')) {
                        ...
                        resultant.push(this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Value]);
                    }
                }
            }
            else {
        ...
        var containsOnlyValueError = resultant.every(function (item) { return item === _this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Value]; });
    ...
    Calculate.prototype.computeValue = function (pFormula, refresh, isIfError) {
        try {
            ...
            throw new FormulaError(this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.InvalidExpression]);
        }
    };
    Calculate.prototype.getValArithmetic = function (stack, operator, isIfError) {
        ...
        if (isNaN(num) && !isIfError) {
            isErrorString = true;
            if (num1 === this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.DivZero]) {
                stack.push(this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.DivZero]);
            }
            else {
                stack.push(this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Value]);
            }
        }
        ...
        if (isNaN(num) && !isIfError) {
            isErrorString = true;
            if (num2 === this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.DivZero]) {
                stack.push(this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.DivZero]);
            }
            else {
                stack.push(this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Value]);
    ...
    Calculate.prototype.processLogical = function (stack, operator) {
        ...
        if (operator !== 'and' && operator !== 'equal') {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(val1)) {
                value1 = val1.indexOf(this.tic) > -1 ? val1 : this.parseFloat(val1);
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(val2)) {
        ...
        if (operator === 'or' && !isErrorString) {
            ...
            result = this.isNaN(this.parseFloat(result)) ? this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Value] : result;
        }
        stack.push(result);
        return result;
    };
        ...
        for (var j = 0; j < rangeLength.length; j++) {
            ...
            if (isCriteria === this.trueValue) {
                ...
                if (i) {
                    ...
                    prevCriteriaIdx = prevCriteria.indexOf('!') > -1 ? (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(prevCriteria.substring(prevCriteria.lastIndexOf('!') + 1)) : (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(prevCriteria);
                    prevStoreCellIdx = cell.indexOf('!') > -1 ? (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getCellIndexes */ .VSO)(cell.substring(cell.lastIndexOf('!') + 1)) : (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getCellIndexes */ .VSO)(cell);
                    criteriaRangeIndexes = cellRanges[i].indexOf('!') > -1 ?
                        (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(cellRanges[i].substring(cellRanges[i].lastIndexOf('!') + 1)) :
                        (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(cellRanges[i]);
                }
                ...
                if (this.isCellReference(cellRanges[i]) && cellRanges[i].indexOf(':') > -1) {
                    newCell = isCountIfs && !i ? (rangeLength[j].indexOf('!') > -1 ? rangeLength[j].substring(rangeLength[j].lastIndexOf('!') + 1) : rangeLength[j]) : (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getCellAddress */ .HVJ)(criteriaRangeIndexes[0] + (prevStoreCellIdx[0] - prevCriteriaIdx[0]), criteriaRangeIndexes[1] +
    ...
    Calculate.prototype.computeIfsFormulas = function (range, isCountIfs, isAvgIfs) {
        if (isCountIfs === this.trueValue && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(range) || range[0] === '' || range.length < 2 || range.length > 127 ||
            range.length % 2 !== 0)) {
            return this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
        var argArr = range;
        ...
        for (var k = 0; k < criterias.length; k++) {
            if (criterias[k] === '') {
                if (isAvgIfs === this.trueValue) {
                    return this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.DivZero];
                }
                return 0;
            }
        }
        ...
        if (isCountIfs === this.falseValue) {
            ...
            if (storedCellLength === 0) {
                return isAvgIfs === this.trueValue ? this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.DivZero] : 0;
            }
        }
        ...
        var sumRangeIndexes = cellRanges[0].indexOf('!') > -1 ?
            (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(cellRanges[0].substring(cellRanges[0].lastIndexOf('!') + 1)) : (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(cellRanges[0]);
        var lastCriteria = cellRanges[cellRanges.length - 1];
        var criteriaRangeIndexes = lastCriteria.indexOf('!') > -1 ?
            (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(lastCriteria.substring(lastCriteria.lastIndexOf('!') + 1)) : (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getRangeIndexes */ .isE)(lastCriteria);
        for (var j = 0; j < storedCell.length; j++) {
            ...
            if (this.isCellReference(cellRanges[0]) && cellRanges[0].indexOf(':') > -1) {
                newCell = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getCellAddress */ .HVJ)(sumRangeIndexes[0] + ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getCellIndexes */ .VSO)(cell)[0] - criteriaRangeIndexes[0]), sumRangeIndexes[1] + ((0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getCellIndexes */ .VSO)(cell)[1] - criteriaRangeIndexes[1]));
    ...
    Calculate.prototype.intToTime = function (value) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(val[1])) {
    ...
    Calculate.prototype.toOADate = function (dateTime, isTime, isTimeOnly) {
        var startDate = new Date('01/01/1900');
        var date = (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .isDateTime */ .Arh)(dateTime) ? dateTime : new Date(dateTime);
        var startDateUTC = Date.UTC(startDate.getFullYear(), startDate.getMonth(), startDate.getDate(), startDate.getHours(), startDate.getMinutes(), startDate.getSeconds(), startDate.getMilliseconds());
    ...
    Calculate.prototype.getValueFromArg = function (val, isUnique, isIfError, isSubtotal, isIFFormula) {
        ...
        if (tokenAvail || (this.isUpperChar(firstChar) && !['+', '-', '/', '*', ')', ')', '{'].some(function (opr) { return val.includes(opr); }))) {
            ...
            if (val === this.cell) {
                ...
                if (!isUnique) {
                    throw new FormulaError(this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.CircularReference]);
                }
            }
    ...
    Calculate.prototype.isValidCellReference = function (text) {
        ...
        if (cellTxt.length < 4) {
            while (j < cellTxt.length) {
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(cellTxt[j]) && cellTxt[j].charCodeAt(0) < numArr[j]) {
                    j++;
                    continue;
                }
                else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(cellTxt[j]) && j > 0) {
                    break;
                }
                else {
                    return false;
    ...
    Calculate.prototype.parseDate = function (date) {
        if (!this.isNaN(date)) {
            ...
            if (d < 0) {
                return this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Num];
            }
            if (d <= 60) {
    ...
    Calculate.prototype.getParentObjectCellValue = function (val, refresh, isUnique, isSubtotal) {
        ...
        if (tokenIdx > -1) {
            ...
            if (j === val.length) {
                return val === '' ? this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Value] : this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Name];
            }
            else {
                cellRef = val;
                var family = this.getSheetFamilyItem(grid);
        ...
        if (!(row > 0 && row <= maxRows && col > 0 && col <= maxCols)) {
            result = this.getErrorStrings()[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .CommonErrors */ .fw.Name];
        }
        else {
            var sheetId = this.getSheetId(this.grid);
    ...
    Calculate.prototype.getCellValueFn = function (grid, actCell, sheetId, updateDependentCell, refresh, isUnique, isSubtotal) {
        ...
        return function (row, col, curCell) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(val)) {
    ...
    Calculate.prototype.defineFunction = function (formulaName, functionName, formulaDescription) {
        if (typeof functionName === 'string') {
            functionName = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getValue */ ._W)(functionName, window);
        }
    ...
    Calculate.prototype.valueChanged = function (grid, changeArgs, isCalculate, usedRangeCol, refresh, sheetName, isRandomFormula, randomFormulaRefreshing, isDelete, deletedRange, refreshDependentCells, action) {
        ...
        if (changeArgs.getFormulaValue() && changeArgs.getFormulaValue()[0] === this.getFormulaCharacter()) {
            this.cell = cellTxt;
            var formula = void 0;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isCompute)) {
            ...
            if (this.getFormulaInfoTable().has(cellTxt)) {
                ...
                if (isCompute) {
                    ...
                    isComputedValueChanged = cValue !== formula.getFormulaValue() && (!this.parentObject.isEdit ||
                        cValue !== this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.CircularReference]);
                ...
                if (isCompute) {
                    var cValue = this.calculateFormula(formula.getParsedFormula(), refresh);
                    isComputedValueChanged = cValue !== this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.CircularReference];
                    formula.setFormulaValue(cValue);
                }
            }
            if (isCompute) {
    ...
    Calculate.prototype.computeMinMax = function (args, operation) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args) || args.length === 0) {
            return this.formulaErrorStrings[_common_enum__WEBPACK_IMPORTED_MODULE_2__/* .FormulasErrorsStrings */ .lO.WrongNumberArguments];
        }
            ...
            if (this.isCellReference(argArr[k])) {
                if (argArr[k].indexOf(':') > -1) {
                    ...
                    for (var i = 0; i < cellColl.length; i++) {
                        ...
                        else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(cellVal) || isNaN(this.parseFloat(cellVal)) || cellVal === '') {
                            continue;
                        }
    ...
    Calculate.prototype.registerGridAsSheet = function (refName, model, sheetFamilyID) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.modelToSheetID)) {
            this.modelToSheetID = new Map();
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.modelToSheetID.get(model))) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isUndefined */ .b0)(family.sheetNameToParentObject.get(tempRef))) {
    ...
    Calculate.prototype.isSheetMember = function () {
        var family = this.getSheetFamilyItem(this.grid);
        return (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(family) ? false : family.isSheetMember;
    };
    /**
                ...
                if (!isDelete && deletedRange && deletedRange.length === 4) {
                    ...
                    for (var sRIdx = deletedRange[0], eRIdx = deletedRange[2]; sRIdx <= eRIdx; sRIdx++) {
                        for (var sCIdx = deletedRange[1], eCIdx = deletedRange[3]; sCIdx <= eCIdx; sCIdx++) {
                            ...
                            var cell = token + (0,_workbook_index__WEBPACK_IMPORTED_MODULE_4__/* .getCellAddress */ .HVJ)(sRIdx, sCIdx);
    ...
    return Calculate;
}(_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Base */ .C6));
...
//# sourceMappingURL=f3f9cd2a-b3f07c9a97b4b121.js.map