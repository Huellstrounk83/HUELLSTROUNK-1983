"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[5890],{

/***/ 11464:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   m: () => (/* binding */ ToolbarModule)
/* harmony export */ });
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(34286);
/* harmony import */ var _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(63160);
/* harmony import */ var _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1716);
/* harmony import */ var _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14629);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(93680);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(34794);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(90158);
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(31376);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(63514);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(28696);
...
var ToolbarModule = /** @class */ (function () {
    ...
    ToolbarModule.prototype.initLocale = function () {
        ...
        this.l10n = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .L10n */ .Wo('image-editor', this.defaultLocale, this.parent.locale);
    };
    ToolbarModule.prototype.toolbar = function (args) {
        ...
        switch (args.prop) {
            ...
            case 'setToolbarHeight':
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.length > 0 && parent.toolbar.indexOf('Open') > -1)) {
    ...
    ToolbarModule.prototype.reset = function () {
        var parent = this.parent;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.length > 0) || parent.toolbarTemplate) {
    ...
    ToolbarModule.prototype.destroyTopToolbar = function () {
        ...
        if (this.isToolbar() && toolbar && toolbar.classList.contains('e-control')) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(toolbar, 'toolbar').destroy();
        }
    };
    ...
    ToolbarModule.prototype.isToolbar = function () {
        var parent = this.parent;
        return ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.length > 0)
            || !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbarTemplate));
    };
    ToolbarModule.prototype.createToolbar = function () {
        var _this = this;
        var parent = this.parent;
        var id = parent.element.id;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.length > 0)) {
            ...
            var toolbarItems = { cssClass: 'e-image-upload', align: 'Left', type: 'Input',
                tooltipText: this.l10n.getConstant('Browse'), template: new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_1__/* .Uploader */ .d9({ allowedExtensions: parent.uploadSettings.allowedExtensions, multiple: false }) };
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.defToolbarItems)) {
                this.defToolbarItems = [];
            }
            ...
            var uploadItems = [
                {
                    ...
                    template: new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_1__/* .Uploader */ .d9({
                        ...
                        selected: function () {
                            ...
                            if (!parent.disabled) {
                                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                                    ...
                                    if (bToolbar) {
                                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(bToolbar, 'toolbar').destroy();
                                    }
                                    _this.initMainToolbar(false, _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice, null);
            ...
            var toolbarObj = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__/* .Toolbar */ .M({ items: uploadItems, width: '100%',
                created: function () {
            ...
            if (toolbar_1) {
                ...
                if (parent.toolbar && parent.toolbar.length > 0 && parent.toolbar.indexOf('Open') === -1) {
                    var toolabr = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(document.getElementById(parent.element.id + '_toolbar'), 'toolbar');
                    if (toolabr) {
                        toolabr.destroy();
    ...
    ToolbarModule.prototype.createQuickAccessToolbar = function () {
        ...
        if (parent.showQuickAccessToolbar) {
            ...
            var toolbarObj = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__/* .Toolbar */ .M({ clicked: this.defToolbarClicked.bind(this) });
    ...
    ToolbarModule.prototype.initMainToolbar = function (isApplyOption, isDevice, isOkBtn, isResize, isFrame, isMainToolbar, isRedact) {
        ...
        if (this.isToolbar()) {
            ...
            if (this.defToolbarItems.length > 0) {
                var toolbarObj = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__/* .Toolbar */ .M({
                    width: '100%',
                ...
                if (this.isToolbar() && document.getElementById(id + '_toolbar')) {
                    ...
                    var toolbar_4 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
    ...
    ToolbarModule.prototype.initBottomToolbar = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.length > 0)) {
            ...
            var toolbarObj = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__/* .Toolbar */ .M({ items: items, width: '100%',
                created: function () {
                    _this.renderAnnotationBtn();
                    _this.renderCropBtn();
            ...
            if (this.defToolbarItems.length > 0 && document.getElementById(id + '_bottomToolbar')) {
                /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                var toolbar_5 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
    ...
    ToolbarModule.prototype.getLeftToolbarItem = function (isOkBtn, isResize) {
        ...
        var toolbarItems = [];
        if (!isOkBtn || isResize) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Open') > -1)) {
                toolbarItems.push({ id: id + '_upload', cssClass: 'e-image-upload', align: 'Left', type: 'Input', template: new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_1__/* .Uploader */ .d9({ allowedExtensions: parent.uploadSettings.allowedExtensions, multiple: false }) });
            ...
            else if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && (parent.toolbar && parent.toolbar.indexOf('Open') === -1)) {
                toolbarItems.push({ visible: false, id: id + '_upload', cssClass: 'e-image-upload', align: 'Left', type: 'Input', template: new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_1__/* .Uploader */ .d9({ allowedExtensions: parent.uploadSettings.allowedExtensions, multiple: false }) });
                toolbarItems.push({ visible: false, cssClass: 'e-image-position e-btn e-flat', tooltipText: this.l10n.getConstant('Browse'), align: 'Left' });
            }
        }
        if (parent.allowUndoRedo && !isResize) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Undo') > -1)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Redo') > -1)) {
        ...
        if (!this.preventZoomBtn && (parent.zoomSettings.zoomTrigger & _index__WEBPACK_IMPORTED_MODULE_3__/* .ZoomTrigger */ ._7.Toolbar) === _index__WEBPACK_IMPORTED_MODULE_3__/* .ZoomTrigger */ ._7.Toolbar && !isResize) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('ZoomOut') > -1)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('ZoomIn') > -1)) {
    ...
    ToolbarModule.prototype.getRightToolbarItem = function (isOkBtn, isMainToolbar, isRedact) {
        ...
        if ((isMainToolbar || !_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Reset') > -1))) {
        ...
        if (!isOkBtn) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Save') > -1)) {
    ...
    ToolbarModule.prototype.getMainToolbarItem = function (isApplyOption, isFrame, isRedact) {
        ...
        var toolbarItems = [];
        if (isFrame) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('None') > -1) || parent.toolbar.indexOf('Frame') > -1) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('Mat') > -1) || parent.toolbar.indexOf('Frame') > -1) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('Bevel') > -1) || parent.toolbar.indexOf('Frame') > -1) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('Line') > -1) || parent.toolbar.indexOf('Frame') > -1) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('Inset') > -1) || parent.toolbar.indexOf('Frame') > -1) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('Hook') > -1) || parent.toolbar.indexOf('Frame') > -1) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Crop') > -1)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Annotate') > -1)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Finetune') > -1)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Filter') > -1)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('Frame') > -1)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('Resize') > -1)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) && parent.toolbar.indexOf('Redact') > -1)) {
    ...
    ToolbarModule.prototype.updateContextualToolbar = function (type, cType, isSelect) {
        ...
        if (type === 'filter') {
            ...
            if (toolbar_6 && this.defToolbarItems.length > 0) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(toolbar_6, 'toolbar').destroy();
            }
            if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
            ...
            if (ctxToolbar.classList.contains('e-control')) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(ctxToolbar, 'toolbar').destroy();
            }
            this.refreshSlider();
            if (type === 'frame') {
        ...
        if (parent.toolbar) {
            for (var i = 0, len = parent.toolbar.length; i < len; i++) {
                if (typeof (parent.toolbar[i]) === 'object') {
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar[i].align)) {
                        if (position === 'left') {
    ...
    ToolbarModule.prototype.widthAspectRatio = function (e) {
        ...
        var widthNumeric = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox');
        var heightNumeric = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox');
        if (icon) {
            if (width != null && !isNaN(width)) {
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)((widthNumeric).value)) {
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)((widthNumeric).value)) {
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(heightNumeric.value) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(heightNumeric.placeholder)) {
    ...
    ToolbarModule.prototype.heightAspectRatio = function (e) {
        ...
        var heightNumeric = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox');
        var widthNumeric = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox');
        if (icon) {
            if (!isNaN(ht)) {
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)((heightNumeric).value)) {
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)((heightNumeric).value)) {
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widthNumeric.value) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widthNumeric.placeholder)) {
    ...
    ToolbarModule.prototype.getResizeToolbarItem = function () {
        ...
        toolbarItems.push({ id: id + '_resizeWidth', prefixIcon: 'e-icons e-anti-clock-wise',
            tooltipText: this.l10n.getConstant('Width'), align: 'Center', type: 'Input', template: new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_4__/* .NumericTextBox */ .u({ width: 75, htmlAttributes: { maxLength: '4' },
        ...
        toolbarItems.push({ id: id + '_resizeHeight', prefixIcon: 'e-icons e-clock-wise',
            tooltipText: this.l10n.getConstant('Height'), align: 'Center', type: 'Input', template: new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_4__/* .NumericTextBox */ .u({ width: 75, htmlAttributes: { maxLength: '4' },
    ...
    ToolbarModule.prototype.initResizeToolbar = function () {
        ...
        parent.trigger('toolbarUpdating', args);
        this.defToolbarItems = args.toolbarItems;
        var toolbar = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__/* .Toolbar */ .M({
            width: '100%',
            items: this.defToolbarItems,
            clicked: this.defToolbarClicked.bind(this),
            created: function () {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    if (_this.defToolbarItems.length > 0 && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(document.getElementById(id + '_bottomToolbar')))) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                    ...
                    if (_this.defToolbarItems.length > 0 && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(document.getElementById(id + '_toolbar')))) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        toolbar.refreshOverflow();
                    }
                }
    ...
    ToolbarModule.prototype.wireResizeBtnEvents = function () {
        ...
        var aspectRatioHeight = parent.element.querySelector('#' + id + '_resizeHeight');
        var aspectRatioWidth = parent.element.querySelector('#' + id + '_resizeWidth');
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(aspectRatioHeight)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(aspectRatioWidth)) {
    ...
    ToolbarModule.prototype.renderAnnotationBtn = function (isContextualToolbar) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Pen') > -1)) {
            items.push({ text: this.l10n.getConstant('Pen'), id: 'pen', iconCss: 'e-icons e-free-pen' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Line') > -1)) {
            items.push({ text: this.l10n.getConstant('Line'), id: 'line', iconCss: 'e-icons e-line' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Rectangle') > -1)) {
            items.push({ text: this.l10n.getConstant('Rectangle'), id: 'rectangle', iconCss: 'e-icons e-rectangle' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Ellipse') > -1)) {
            items.push({ text: this.l10n.getConstant('Ellipse'), id: 'ellipse', iconCss: 'e-icons e-circle' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Arrow') > -1)) {
            items.push({ text: this.l10n.getConstant('Arrow'), id: 'arrow', iconCss: 'e-icons e-arrow-right-up' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Path') > -1)) {
            items.push({ text: this.l10n.getConstant('Path'), id: 'path', iconCss: 'e-icons e-critical-path' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Text') > -1)) {
            items.push({ text: this.l10n.getConstant('Text'), id: 'text', iconCss: 'e-icons e-add-text' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Image') > -1)) {
        ...
        var toolbarId = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? '#' + id + '_bottomToolbar ' + '#' + id : '#' + id;
        ...
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: items, iconCss: 'e-icons ' + iconCss,
            ...
            select: function (args) {
                ...
                switch (args.item.id) {
                    case 'pen':
                        ...
                        shapeSettings.type = _index__WEBPACK_IMPORTED_MODULE_3__/* .ShapeType */ .IO.FreehandDraw;
    ...
    ToolbarModule.prototype.enableDisableCloneBtn = function (toolbarId, obj) {
        ...
        if (isDummyTextClick || (parent.activeObj.activePoint.width === 0 && parent.activeObj.activePoint.height === 0) &&
            ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.pointColl) || (parent.activeObj.pointColl
                && parent.activeObj.pointColl.length === 0)) &&
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(obj['freehandDrawSelectedId'])) {
            if (duplicateElement) {
    ...
    ToolbarModule.prototype.renderStraightenSlider = function () {
        var parent = this.parent;
        var id = parent.element.id;
        if (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Straightening') > -1)) &&
            ...
            if (sliderHandle && !_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
    ...
    ToolbarModule.prototype.renderCropBtn = function (shapeString) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('CustomSelection') > -1)) {
            items.push({ text: this.l10n.getConstant('Custom'), id: 'custom', iconCss: 'e-icons e-custom' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('CircleSelection') > -1)) {
            items.push({ text: this.l10n.getConstant('Circle'), id: 'circle', iconCss: 'e-icons e-circle' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('SquareSelection') > -1)) {
            items.push({ text: this.l10n.getConstant('Square'), id: 'square', iconCss: 'e-icons e-square' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('RatioSelection') > -1)) {
        ...
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
            open: function (args) {
                if (parent.togglePan) {
                    _this.cancelPan();
                }
            ...
            select: function (args) {
                ...
                drpDownBtn.content = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? null : parent.toPascalCase(args.item.id);
            },
            iconCss: 'e-icons ' + iconCss, cssClass: 'e-image-popup e-ie-crop-ddb-popup',
            content: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? null : parent.toPascalCase(shape.replace('crop-', ''))
        });
    ...
    ToolbarModule.prototype.renderTransformBtn = function () {
        ...
        var parent = this.parent;
        var items = [];
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('RotateLeft') > -1)) {
            items.push({ text: this.l10n.getConstant('RotateLeft'), id: 'rotateleft', iconCss: 'e-icons e-anti-clock-wise' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('RotateRight') > -1)) {
            items.push({ text: this.l10n.getConstant('RotateRight'), id: 'rotateright', iconCss: 'e-icons e-clock-wise' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('FlipHorizontal') > -1)) {
            items.push({ text: this.l10n.getConstant('HorizontalFlip'), id: 'horizontalflip', iconCss: 'e-icons e-horizontal-flip' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('FlipVertical') > -1)) {
    ...
    ToolbarModule.prototype.saveDialogPopup = function () {
        ...
        var dialog = new _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_6__/* .Dialog */ .lG({
            target: parent.element,
            header: this.l10n.getConstant('SaveAs'),
            closeOnEscape: true, content: document.getElementById(id + '_dialogContent'),
            width: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? '345px' : '570px', isModal: true, animationSettings: { effect: 'Zoom' }, beforeOpen: this.onBeforeopen(),
    ...
    ToolbarModule.prototype.updateSavePreviewImage = function () {
        ...
        if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice || !elem) {
            return;
        }
    ...
    ToolbarModule.prototype.saveDialogClosed = function (id) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(document.getElementById(id + '_saveDropdownbtn'), 'dropdownbutton')) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(document.getElementById(id + '_saveDropdownbtn'), 'dropdownbutton').destroy();
        }
        this.isSlider = false;
        ...
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(document.getElementById(id + '_saveDialog'), 'dialog').destroy();
    ...
    ToolbarModule.prototype.onBeforeopen = function () {
        ...
        var inputObj = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_7__/* .TextBox */ .f({
        ...
        var buttonIcon = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_8__/* .Button */ .$n({ iconCss: 'e-icons e-settings' });
        ...
        if (ddbElem) {
            ...
            var drpDownBtn_1 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
                items: items,
                open: function (args) {
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                ...
                select: function (args) {
                    ...
                    if (args.item.id !== 'jpeg') {
                        ...
                        if (slider) {
                            if (_this.isSlider) {
                                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(slider, 'slider').destroy();
                            }
                        ...
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)([qualityBtnGrp], 'e-hide');
                        slider.style.display = 'none';
                        imageNameLabel.style.display = 'block';
                        _this.updateImageSize((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.currentQuality) ? 1 : _this.currentQuality, obj['canvas'], _this.fileType);
    ...
    ToolbarModule.prototype.qualityBtnClickHandler = function (event) {
        ...
        if (event.currentTarget.id === id + '_qualitybuttonIcon' && !this.isSlider) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .addClass */ .iQ)([qualityBtnGrp], 'e-hide');
            qualitySlider.style.display = 'block';
            qualitySliderValueDiv.style.display = 'inline-block';
            qualityOption.style.display = 'flex';
            var sliderObj = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .Slider */ .Ap({
                tooltip: { placement: 'Before', isVisible: true, format: 'P0', showOn: 'Focus' },
                min: 0.01, max: 1, step: 0.01, value: this.currentQuality,
                type: 'MinRange',
                width: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? '80%' : '190px',
                created: function () {
            ...
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(qualitySlider, 'slider').destroy();
    ...
    ToolbarModule.prototype.updateImageSize = function (quality, tempCanvas, fileType) {
        ...
        else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fileType) && (fileType.toLowerCase() === 'png' || fileType.toLowerCase() === 'webp')) {
        ...
        else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fileType) && fileType.toLowerCase() === 'svg') {
            ctx.clearRect(0, 0, canvas.width, canvas.height);
            ctx.drawImage(tempCanvas, 0, 0);
    ...
    ToolbarModule.prototype.download = function () {
        ...
        if (this.fileType === 'JPEG' && this.isSlider) {
            var value = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(document.getElementById(id + '_qualitySlider'), 'slider').value;
    ...
    ToolbarModule.prototype.getCropTransformToolbarItem = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && (parent.toolbar.indexOf('Transform') > -1 || parent.toolbar.indexOf('RotateLeft') > -1))) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && (parent.toolbar.indexOf('Transform') > -1 || parent.toolbar.indexOf('RotateRight') > -1))) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && (parent.toolbar.indexOf('Transform') > -1 || parent.toolbar.indexOf('HorizontalFlip') > -1))) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && (parent.toolbar.indexOf('Transform') > -1 || parent.toolbar.indexOf('VerticalFlip') > -1))) {
        ...
        if (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Straightening') > -1)) && !_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
            toolbarItems.push({ align: 'Center', type: 'Separator' });
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar && parent.toolbar.indexOf('Straightening') > -1)) {
                var spanWidth = document.createElement('span');
    ...
    ToolbarModule.prototype.getShapesToolbarItem = function (items) {
        ...
        var id = parent.element.id;
        var toolbarItems = [];
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || (parent.toolbar)) {
            toolbarItems.push({ id: id + '_annotation', tooltipText: this.l10n.getConstant('Annotation'), align: 'Center',
                template: '<button id="' + id + '_annotationBtn"></button>' });
        }
    ...
    ToolbarModule.prototype.initCropTransformToolbar = function (shape, isTransform) {
        ...
        var toolbar = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__/* .Toolbar */ .M({
            ...
            created: function () {
                ...
                if (document.getElementById(id + '_cropBtn') && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isTransform)) {
                    if (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                        parent.notify('draw', { prop: 'select', onPropertyChange: false,
    ...
    ToolbarModule.prototype.createRectangleRadius = function (items) {
        ...
        if (items.indexOf('borderRadius') > -1) {
            ...
            var drpDownBtn_2 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
                open: function (args) {
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                ...
                select: function (args) {
                    ...
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                        if (document.getElementById(id + '_bottomToolbar')) {
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            var toolbar_7 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                        ...
                        if (document.getElementById(id + '_toolbar')) {
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            var toolbar_8 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
    ...
    ToolbarModule.prototype.createShapeColor = function (items) {
        ...
        if (items.indexOf('fillColor') > -1) {
            ...
            var fillColor_1 = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_10__/* .ColorPicker */ .s({
            ...
            var fillDDB_1 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
                open: function (args) {
        ...
        if (items.indexOf('strokeColor') > -1) {
            ...
            var strokeColor_1 = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_10__/* .ColorPicker */ .s({
            ...
            var strokeDDB_1 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
                open: function (args) {
                    var parenElem = args.element.parentElement;
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
    ...
    ToolbarModule.prototype.createShapeBtn = function (items) {
        ...
        if (items.indexOf('strokeWidth') > -1) {
            ...
            // Initialize the DropDownButton component.
            var drpDownBtn_3 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
                open: function (args) {
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                ...
                select: function (args) {
                    ...
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                        if (document.getElementById(id + '_bottomToolbar')) {
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            var toolbar_9 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                        ...
                        if (document.getElementById(id + '_toolbar')) {
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            var toolbar_10 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
    ...
    ToolbarModule.prototype.createZOrderBtn = function (items) {
        ...
        if (items.indexOf('z-order') > -1) {
            ...
            // Initialize the DropDownButton component.
            var drpDownBtn_4 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: zOrderItems, iconCss: 'e-icons e-layers',
                ...
                select: function (args) {
                    ...
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                        if (document.getElementById(id + '_bottomToolbar')) {
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            var toolbar_11 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                        ...
                        if (document.getElementById(id + '_toolbar')) {
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            var toolbar_12 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
    ...
    ToolbarModule.prototype.createStartBtn = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.start)) {
        ...
        // Initialize the DropDownButton component.
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
            open: function (args) {
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    args.element.parentElement.style.top = drpDownBtn.element.getBoundingClientRect().top -
                        args.element.parentElement.offsetHeight + 'px';
    ...
    ToolbarModule.prototype.createEndBtn = function () {
        ...
        var spanElem = document.createElement('span');
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.end)) {
    ...
    ToolbarModule.prototype.createTextColor = function (items) {
        ...
        if (items.indexOf('fontColor') > -1 && parent.element.querySelector('.e-template.e-text-font-color')) {
            ...
            var fontColor_1 = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_10__/* .ColorPicker */ .s({
                modeSwitcher: true, noColor: false, value: '#fff', inline: true,
            ...
            var strokeDDB_2 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
                open: function (args) {
                    var parenElem = args.element.parentElement;
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
    ...
    ToolbarModule.prototype.createBackgroundColor = function (items) {
        ...
        if (items.indexOf('fillColor') > -1 && parent.element.querySelector('.e-template.e-text-background-color')) {
            ...
            var backgroundColor_1 = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_10__/* .ColorPicker */ .s({
                modeSwitcher: true, noColor: true, value: '', inline: true,
                showButtons: false, mode: 'Palette', cssClass: 'e-text-fontt-color',
                beforeModeSwitch: function (args) {
                    _this.popupLeft = args.element.offsetParent.style.left;
            ...
            var strokeDDB_3 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
                open: function (args) {
                    var parenElem = args.element.parentElement;
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
    ...
    ToolbarModule.prototype.createStrokeTextColor = function (items) {
        ...
        if (items.indexOf('strokeColor') > -1 && parent.element.querySelector('.e-template.e-stroke-text-font-color')) {
            ...
            var fontColor_2 = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_10__/* .ColorPicker */ .s({
                modeSwitcher: true, noColor: true, value: '', inline: true,
                showButtons: false, mode: 'Palette', cssClass: 'e-text-fontt-color',
                beforeModeSwitch: function (args) {
                    _this.popupLeft = args.element.offsetParent.style.left;
            ...
            var strokeDDB_4 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
                open: function (args) {
                    var parenElem = args.element.parentElement;
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
    ...
    ToolbarModule.prototype.createTextBtn = function (items) {
        ...
        if (items.indexOf('fontFamily') > -1) {
            ...
            var fontFamilyBtn_1 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: this.getFontFamilyItems(),
                ...
                select: function (args) {
                    ...
                    var toolbar = document.getElementById(parent.element.id + '_toolbar');
                    if (toolbar && toolbar.classList.contains('e-control')) {
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(toolbar, 'toolbar').refreshOverflow();
                    }
                }
            });
        ...
        if (items.indexOf('fontSize') > -1) {
            ...
            var fontSizeBtn_1 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
    ...
    ToolbarModule.prototype.refreshToolbar = function (type, isApplyBtn, isCropping, isZooming, cType, shape, isTransform) {
        ...
        if (type !== 'filter' && type !== 'color') {
            ...
            if (cusWrapper && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(cusWrapper, 'toolbar')) && this.defToolbarItems.length > 0) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(cusWrapper, 'toolbar').destroy();
                cusWrapper.innerHTML = '';
            }
            if (toolbarElement && toolbarElement.classList.contains('e-control') && this.defToolbarItems.length > 0) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(toolbarElement, 'toolbar').destroy();
                toolbarElement.innerHTML = '';
            }
            if (toolbarElement && (this.defToolbarItems.length > 0 || parent.toolbar && parent.toolbar.length > 0 && parent.toolbar.indexOf('Open') === -1)) {
                var toolbar_13 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(toolbarElement, 'toolbar');
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(toolbar_13)) {
                    toolbar_13.destroy();
                    document.getElementById(parent.element.id + '_toolbar').innerHTML = '';
                }
            }
            if (bottomToolbar && this.defToolbarItems.length > 0) {
                if (bottomToolbar.className.indexOf('e-control') > -1) {
                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(bottomToolbar, 'toolbar').destroy();
        ...
        switch (type) {
            case 'main':
                ...
                else if (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice || isZooming) {
                    if (isZooming) {
                        this.initMainToolbar(isApplyBtn, _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice, null);
                    }
                    else {
                        this.initMainToolbar(isApplyBtn, _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice, null);
                    }
            ...
            case 'shapes':
                ...
                if (parent.activeObj.shape === 'image') {
                    var actObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
                    parent.notify('shape', { prop: 'refreshActiveObj', onPropertyChange: false });
            ...
            case 'color':
                ...
                break;
            case 'croptransform':
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isTransform)) {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && this.isToolbar()) {
            ...
            case 'redact':
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    ...
                    this.initMainToolbar(isApplyBtn, _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice, null, null, null, null, true);
                }
                this.enableDisableTbrBtn();
    ...
    ToolbarModule.prototype.updateRedactObj = function () {
        var parent = this.parent;
        var objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
        parent.objColl = [];
        var activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
        parent.notify('shape', { prop: 'refreshActiveObj', onPropertyChange: false });
        parent.notify('draw', { prop: 'render-image', value: { isMouseWheel: null, isPreventClearRect: null, isFrame: true } });
        ...
        if (panMoveObj['panMove']) {
            var currentPannedPoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.panPoint.currentPannedPoint, {}, true);
    ...
    ToolbarModule.prototype.getAdjustmentToolbarItem = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Brightness') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Contrast') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Hue') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Saturation') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Exposure') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Opacity') > -1)) {
            toolbarItems.push({ id: id + '_opacity', prefixIcon: 'e-icons e-opacity', cssClass: 'top-icon e-opacity',
                tooltipText: this.l10n.getConstant('Opacity'), align: 'Center' });
        }
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Blur') > -1)) {
    ...
    ToolbarModule.prototype.getFilterToolbarItem = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Default') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Chrome') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Cold') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Warm') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Grayscale') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Sepia') > -1)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.toolbar) || !isCustomized || (parent.toolbar && parent.toolbar.indexOf('Invert') > -1)) {
    ...
    ToolbarModule.prototype.createPenColor = function (items) {
        ...
        if (items.indexOf('strokeColor') > -1) {
            ...
            var penColor = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_10__/* .ColorPicker */ .s({
            ...
            var strokeDDB_5 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
                open: function (args) {
                    var parentElem = args.element.parentElement;
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
            ...
            parent.notify('freehand-draw', { prop: 'getFreehandSelectedIndex', onPropertyChange: false, value: { obj: indexObj } });
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(indexObj['freehandSelectedIndex']) && indexObj['freehandSelectedIndex'] > -1) {
    ...
    ToolbarModule.prototype.createPenBtn = function (items) {
        ...
        if (items.indexOf('strokeWidth') > -1) {
            ...
            var drpDownBtn_5 = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
                open: function (args) {
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                ...
                select: function (args) {
                    ...
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                        if (document.getElementById(id + '_bottomToolbar')) {
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            var toolbar_14 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                        ...
                        if (document.getElementById(id + '_toolbar')) {
                            /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                            var toolbar_15 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
    ...
    ToolbarModule.prototype.createFrameGradientColor = function () {
        ...
        var fillColor = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_10__/* .ColorPicker */ .s({
            ...
            change: function (args) {
                ...
                if (obj['frameChangeEventArgs'] && !obj['frameChangeEventArgs'].cancel) {
                    parent.notify('undo-redo', { prop: 'updateUndoRedoColl', onPropertyChange: false, value: {
                            ...
                            previousCropObj: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.cropObj, {}, true), previousText: null, currentText: null,
        ...
        var fillDDB = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({
            open: function (args) {
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    var parentElem = args.element.parentElement;
        ...
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
            ...
            select: function (args) {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    if (document.getElementById(id + '_bottomToolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_16 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                    ...
                    if (document.getElementById(id + '_toolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_17 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
        ...
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
            ...
            select: function (args) {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    if (document.getElementById(id + '_bottomToolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_18 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                    ...
                    if (document.getElementById(id + '_toolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_19 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
        ...
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
            ...
            select: function (args) {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    if (document.getElementById(id + '_bottomToolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_20 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                    ...
                    if (document.getElementById(id + '_toolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_21 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
        ...
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
            ...
            select: function (args) {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    if (document.getElementById(id + '_bottomToolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_22 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                    ...
                    if (document.getElementById(id + '_toolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_23 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
        ...
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
            ...
            select: function (args) {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    if (document.getElementById(id + '_bottomToolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_24 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                    ...
                    if (document.getElementById(id + '_toolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_25 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
        ...
        var drpDownBtn = new _syncfusion_ej2_splitbuttons__WEBPACK_IMPORTED_MODULE_5__/* .DropDownButton */ .Q({ items: strokeWidthItems,
            ...
            select: function (args) {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
                    if (document.getElementById(id + '_bottomToolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_26 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_bottomToolbar', 'toolbar');
                    ...
                    if (document.getElementById(id + '_toolbar')) {
                        /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
                        var toolbar_27 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_toolbar', 'toolbar');
    ...
    ToolbarModule.prototype.initFilterToolbarItem = function () {
        ...
        if (document.querySelector('#' + id + '_contextualToolbar').classList.contains('e-control')) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(document.getElementById(id + '_contextualToolbar'), 'toolbar').destroy();
        }
        var toolbar = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__/* .Toolbar */ .M({
            width: '100%',
            items: mainItem,
    ...
    ToolbarModule.prototype.createCanvasFilter = function () {
        var parent = this.parent;
        (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_11__/* .showSpinner */ .xc)(parent.element);
        ...
        (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_11__/* .hideSpinner */ .W$)(parent.element);
    ...
    ToolbarModule.prototype.getQuickAccessToolbarItem = function (isPenEdit) {
        ...
        var toolbarItems = [];
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPenEdit)) {
            if (parent.activeObj.shape === 'image') {
        ...
        args.toolbarItems = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], toolbarItems, null, true);
    ...
    ToolbarModule.prototype.renderQAT = function (isPenEdit) {
        ...
        if (parent.activeObj && parent.showQuickAccessToolbar) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.quickAccessToolbarTemplate)) {
                var toolbarObj = new _syncfusion_ej2_navigations__WEBPACK_IMPORTED_MODULE_2__/* .Toolbar */ .M({
                    items: items,
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPenEdit) && (parent.activeObj.activePoint.width !== 0 ||
    ...
    ToolbarModule.prototype.refreshDropDownBtn = function (isDisabled) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isDisabled)) {
            return;
        }
        var parent = this.parent;
        var id = parent.element.id;
        ...
        if (annotation) {
            ...
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(annotation, 'dropdown-btn').disabled = isDisabled;
        }
        ...
        if (transform) {
            ...
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(transform, 'dropdown-btn').disabled = isDisabled;
        }
        ...
        if (adjustment) {
            ...
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(adjustment, 'btn').disabled = isDisabled;
        }
        ...
        if (filter) {
            ...
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(filter, 'btn').disabled = isDisabled;
        }
    };
    ToolbarModule.prototype.cropSelect = function (args) {
        var parent = this.parent;
        parent.isCropTab = true;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.transform.cropZoomFactor)) {
    ...
    ToolbarModule.prototype.quickAccessToolbarClicked = function (args, isContextualToolbar) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isContextualToolbar)) {
    ...
    ToolbarModule.prototype.editText = function () {
        ...
        parent.notify('selection', { prop: 'setTempActObj', onPropertyChange: false,
            value: { obj: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true) } });
        ...
        parent.notify('draw', { prop: 'setPrevActObj', onPropertyChange: false,
            value: { prevActObj: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true) } });
        ...
        var tempActiveObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
        parent.notify('shape', { prop: 'refreshActiveObj', onPropertyChange: false });
        this.upperContext.clearRect(0, 0, parent.upperCanvas.width, parent.upperCanvas.height);
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.currIndex)) {
    ...
    ToolbarModule.prototype.duplicateShape = function (isPreventUndoRedo, isPublicMethod) {
        ...
        parent.notify('draw', { prop: 'getNewPath', value: { obj: pathObject } });
        var objColl;
        var duplicateObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
        var orderObj = { order: null };
        parent.notify('shape', { prop: 'getHighestOrder', onPropertyChange: false, value: { obj: orderObj } });
        ...
        if (duplicateObj.shape === 'image') {
            objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
        ...
        parent.activeObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, duplicateObj, {}, true);
        if (parent.activeObj.shape === 'image') {
            var activePoint = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, duplicateObj.activePoint, {}, true);
    ...
    ToolbarModule.prototype.defToolbarClicked = function (args) {
        ...
        if (!this.isFrameToolbar && parent.element.querySelector('.e-contextual-toolbar-wrapper')) {
            ...
            if (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice || (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !straightenObj['bool'])) {
        ...
        if (!parent.disabled) {
            switch (type) {
                ...
                case 'cancel':
                    ...
                    break;
                case 'ok':
                    if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && this.isFrameToolbar && parent.element.querySelector('.e-contextual-toolbar-wrapper') && !parent.element.querySelector('.e-contextual-toolbar-wrapper').classList.contains('e-hide')) {
                        parent.element.querySelector('.e-contextual-toolbar-wrapper').classList.add('e-hide');
                    }
                ...
                case 'redo':
                    ...
                    break;
                case 'aspectratio':
                    if (!parent.isCircleCrop && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.currSelectionPoint)) ||
                        (parent.currSelectionPoint && parent.currSelectionPoint.shape !== 'crop-circle')) {
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox').value) {
                            parent.aspectWidth = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox').value;
                            parent.aspectHeight = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox').value;
                            parent.notify('transform', { prop: 'resize', value: { width: parent.aspectWidth, height: null, isAspectRatio: true } });
                        }
                        else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox').value) {
                            parent.aspectWidth = parseFloat((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox').placeholder);
                            parent.aspectHeight = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox').value;
                ...
                case 'nonaspectratio':
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox').value ||
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox').value) {
                        parent.aspectWidth = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox').value ?
                            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox').value :
                            parseFloat((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioWidth, 'numerictextbox').placeholder);
                        parent.aspectHeight = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox').value ?
                            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox').value :
                            parseFloat((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(aspectRatioHeight, 'numerictextbox').placeholder);
                        parent.notify('transform', { prop: 'resize', value: { width: parent.aspectWidth, height: parent.aspectHeight, isAspectRatio: false } });
                    }
                    parent.resizeSrc = { startX: parent.img.srcLeft, startY: parent.img.srcTop, width: parent.img.srcWidth,
                        height: parent.img.srcHeight };
                ...
                case 'verticalflip':
                    ...
                    if (isRedact) {
                        ...
                        actObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.activeObj, {}, true);
                ...
                case 'redact':
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.redactBlur)) {
                        parent.activeObj.redactBlur = 20;
                    }
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.redactPixelate)) {
    ...
    ToolbarModule.prototype.frameToolbarClick = function () {
        ...
        if (!frame || !frame.classList.contains('e-overlay')) {
            ...
            parent.frameDestPoints = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.img, {}, true);
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.cxtTbarHeight)) {
                frameObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.frameObj, {}, true);
                tempFrameObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.tempFrameObj, {}, true);
    ...
    ToolbarModule.prototype.callFrameToolbar = function () {
        var parent = this.parent;
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)(parent.tempFrameObj, parent.frameObj);
    ...
    ToolbarModule.prototype.zoomInBtnClickHandler = function (e) {
        if (e) {
            ...
            if ((parent_1.zoomSettings.zoomTrigger & _index__WEBPACK_IMPORTED_MODULE_3__/* .ZoomTrigger */ ._7.Toolbar) === _index__WEBPACK_IMPORTED_MODULE_3__/* .ZoomTrigger */ ._7.Toolbar) {
                ...
                this.refreshShapeDrawing();
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && e.type === 'touchstart') {
                    if (!e.returnValue) {
                        return;
                    }
                    e.preventDefault();
                ...
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.trigger(zoomIn, 'click');
                var obj = { bool: false };
    ...
    ToolbarModule.prototype.zoomOutBtnClickHandler = function (e) {
        if (e) {
            ...
            if ((parent_2.zoomSettings.zoomTrigger & _index__WEBPACK_IMPORTED_MODULE_3__/* .ZoomTrigger */ ._7.Toolbar) === _index__WEBPACK_IMPORTED_MODULE_3__/* .ZoomTrigger */ ._7.Toolbar) {
                ...
                _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.trigger(zoomOut, 'click');
                var obj = { bool: false };
    ...
    ToolbarModule.prototype.destroyQuickAccessToolbar = function () {
        ...
        if (quickToolbar && quickToolbar.classList.contains('e-control')) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(quickToolbar, 'toolbar').destroy();
        }
    ...
    ToolbarModule.prototype.renderSlider = function (type, isSelect) {
        ...
        if (type === 'transparency') {
            labelWrapper = hdrWrapper.appendChild(parent.createElement('label', {
                ...
                styles: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? 'position: absolute; top: 31%; left: calc(50% - 150px); font-size: 15px; text-transform: capitalize; font-weight: 400;'
            ...
            labelWrapper = hdrWrapper.appendChild(parent.createElement('label', {
                id: id + '_labelWrapper',
                className: 'e-ie-finetune-slider-label',
                styles: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? ('position: absolute; top: 31%; left: calc(50% - 160px); font-size: 15px; text-transform: capitalize; font-weight: 400;')
        ...
        if (isSelect && type === 'straighten' && _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
        ...
        if (type === 'straighten' && _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
        ...
        if (type !== 'straighten') {
            hdrWrapper.appendChild(parent.createElement('label', {
                ...
                styles: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? ('position: absolute; top: 25%; margin-left: 20px; font-size: 15px; text-transform: capitalize; font-weight: 400;') :
            ...
            if (type === 'transparency' && _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
    ...
    ToolbarModule.prototype.createSlider = function (min, max, value, type) {
        ...
        return new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .Slider */ .Ap({
            value: value, type: 'MinRange', min: min, max: max,
            step: step, width: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? '180px' : (type === 'straighten' ? '200px' : '300px'),
            cssClass: 'e-slider',
            change: function (args) {
                parent.notify('selection', { prop: 'setSliderActive', onPropertyChange: false, value: { bool: true } });
                if (type === 'transparency') {
                    if (parent.activeObj.shape) {
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.imageRatio)) {
                            parent.notify('shape', { prop: 'updImgRatioForActObj', onPropertyChange: false });
                        }
                        parent.notify('shape', { prop: 'pushActItemIntoObj' });
                        var prevCropObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)({}, parent.cropObj, {}, true);
                        var object = { currObj: {} };
                        parent.notify('filter', { prop: 'getCurrentObj', onPropertyChange: false, value: { object: object } });
                        var prevObj = object['currObj'];
                        prevObj.objColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.objColl, [], true);
                        prevObj.pointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.pointColl, [], true);
                        prevObj.afterCropActions = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], parent.afterCropActions, [], true);
                        var selPointCollObj = { selPointColl: null };
                        parent.notify('freehand-draw', { prop: 'getSelPointColl', onPropertyChange: false,
                            value: { obj: selPointCollObj } });
                        prevObj.selPointColl = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .extend */ .X$)([], selPointCollObj['selPointColl'], [], true);
                        parent.objColl.pop();
    ...
    ToolbarModule.prototype.updateToolbarItems = function () {
        ...
        if (this.isToolbar()) {
            ...
            if (parent.activeObj.strokeSettings && parent.activeObj.textSettings) {
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.strokeSettings.strokeWidth)) {
                    parent.activeObj.strokeSettings.strokeWidth = 2;
                }
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parent.activeObj.strokeSettings.outlineWidth)) {
                ...
                if (selFillElem) {
                    ...
                    if (document.querySelector('#' + id + '_shape_fill')) {
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_shape_fill', 'colorpicker').value = value;
                    }
                }
                if (selStrokeElem) {
                    ...
                    if (document.querySelector('#' + id + '_shape_stroke')) {
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_shape_stroke', 'colorpicker').value = value;
                    }
                }
                if (selTextStrokeElem) {
                    ...
                    if (document.querySelector('#' + id + '_text_font')) {
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_text_font', 'colorpicker').value = value;
                    }
                }
                if (selStrokeTextColorElem) {
                    ...
                    if (document.querySelector('#' + id + '_stroke_text')) {
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_stroke_text', 'colorpicker').value = value;
                    }
                }
                if (selTextBGElem) {
                    var value = parent.activeObj.strokeSettings.fillColor;
                    ...
                    if (document.querySelector('#' + id + '_text_bgColor')) {
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_text_bgColor', 'colorpicker').value = value;
                    }
                }
                if (selPenStrokeElem) {
                    var value = parent.activeObj.strokeSettings.strokeColor;
                    ...
                    if (document.querySelector('#' + id + '_pen_stroke')) {
                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(id + '_pen_stroke', 'colorpicker').value = value;
                    }
    ...
    ToolbarModule.prototype.destroySubComponents = function () {
        ...
        for (var i = 0, len = inputElement.length; i < len; i++) {
            if (inputElement[i].classList.contains('e-color-picker')) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(inputElement[i], 'color-picker').destroy();
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Lt)('input#' + inputElement[i].id, parent.element));
            }
        }
        for (var i = 0, len = btnElement.length; i < len; i++) {
            if (btnElement[i].classList.contains('e-dropdown-btn')) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(btnElement[i], 'dropdown-btn').destroy();
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Lt)('button#' + btnElement[i].id, parent.element));
            }
            else if (btnElement[i].classList.contains('e-btn')) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getComponent */ .QQ)(btnElement[i], 'btn').destroy();
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Lt)('button#' + btnElement[i].id, parent.element));
            }
        }
    };
    ...
    ToolbarModule.prototype.redactSlider = function (type) {
        ...
        hdrWrapper.appendChild(parent.createElement('label', {
            ...
            styles: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? ('position: absolute; top: 30%; margin-left: 20px; font-size: 15px; text-transform: capitalize; font-weight: 400;') :
        ...
        var redactSlider = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_9__/* .Slider */ .Ap({
            tooltip: { placement: 'Before', isVisible: true, showOn: 'Focus' },
            min: 10, max: 100, step: 1, value: value,
            type: 'MinRange',
            width: _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice ? '130px' : '300px',
            created: function () {
...
//# sourceMappingURL=7f5c364e-f1870d5e9e9327ca.js.map