"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[3958],{

/***/ 93680:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   d9: () => (/* binding */ Uploader)
/* harmony export */ });
/* unused harmony exports FilesProp, ButtonsProps, AsyncSettings */
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68576);
...
var ButtonsProps = /** @class */ (function (_super) {
    ...
    __decorate([
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Property */ .mA)('Browse...')
    ], ButtonsProps.prototype, "browse", void 0);
    __decorate([
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Property */ .mA)('Upload')
    ], ButtonsProps.prototype, "upload", void 0);
    __decorate([
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Property */ .mA)('Clear')
...
var Uploader = /** @class */ (function (_super) {
        ...
        for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
            ...
            switch (prop) {
                ...
                case 'enableRtl':
                    ...
                    break;
                case 'buttons':
                    this.buttons.browse = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.buttons.browse) ? '' : this.buttons.browse;
                    this.buttons.clear = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.buttons.clear) ? '' : this.buttons.clear;
                    this.buttons.upload = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.buttons.upload) ? '' : this.buttons.upload;
                ...
                case 'locale':
                    ...
                    this.preLocaleObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getValue */ ._W)('currentLocale', this.l10n);
                    break;
                case 'cssClass':
    ...
    Uploader.prototype.setLocalizedTexts = function () {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.template)) {
            if (typeof (this.buttons.browse) === 'string') {
                this.browseButton.innerText = (this.buttons.browse === 'Browse...') ?
                    this.localizedTexts('Browse') : this.buttons.browse;
                this.browseButton.setAttribute('title', this.browseButton.innerText);
                if (this.uploadWrapper && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploadWrapper.querySelector('.' + DROP_AREA))) {
    ...
    Uploader.prototype.updateFileList = function () {
        ...
        if (this.fileList.length > 0 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploadWrapper.querySelector('.' + LIST_PARENT))) {
    ...
    Uploader.prototype.reRenderFileList = function () {
        if (this.listParent) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(this.listParent);
    ...
    Uploader.prototype.preRender = function () {
        ...
        this.l10n = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .L10n */ .Wo('uploader', this.localeText, this.locale);
        this.preLocaleObj = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getValue */ ._W)('currentLocale', this.l10n);
        this.formRendered();
        this.updateHTMLAttrToElement();
        this.checkHTMLAttributes(false);
        var ejInstance = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getValue */ ._W)('ej2_instances', this.element);
        /* istanbul ignore next */
        if (this.element.tagName === 'EJS-UPLOADER') {
            ...
            for (index; index < this.element.attributes.length; index++) {
                if (this.element.attributes[index].nodeName !== 'id') {
                    ...
                    inputElement.setAttribute(this.element.attributes[index].nodeName, (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getUniqueID */ .Lz)('uploader'));
                }
            ...
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .setValue */ .KY)('ej2_instances', ejInstance, this.element);
        }
        /* istanbul ignore next */
        if (ejInstance[0].isPureReactComponent) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(ejInstance[0].props.name)) {
                this.element.setAttribute('name', ejInstance[0].props.name);
            }
            else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(ejInstance[0].props.id) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(ejInstance[0].props.name)) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.element.getAttribute('name'))) {
        ...
        this.browserName = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.info.name;
        this.uploaderName = this.element.getAttribute('name');
    };
    Uploader.prototype.formRendered = function () {
        var parentEle = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(this.element, 'form');
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(parentEle)) {
    ...
    Uploader.prototype.wireActionButtonEvents = function () {
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.uploadButton, 'click', this.uploadButtonClick, this);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.clearButton, 'click', this.clearButtonClick, this);
    };
    Uploader.prototype.unwireActionButtonEvents = function () {
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.uploadButton, 'click', this.uploadButtonClick);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.clearButton, 'click', this.clearButtonClick);
    };
    Uploader.prototype.removeActionButtons = function () {
        if (this.actionButtons) {
            this.unwireActionButtonEvents();
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(this.actionButtons);
    ...
    Uploader.prototype.renderButtonTemplates = function () {
        ...
        if (this.uploadButton) {
            var uploadText = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.buttons.upload) ? 'Upload' : this.buttons.upload;
        ...
        if (this.clearButton) {
            var clearText = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.buttons.clear) ? 'Clear' : this.buttons.clear;
    ...
    Uploader.prototype.renderPreLoadFiles = function () {
        if (this.files.length) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.files[0].size)) {
                return;
            }
    ...
    Uploader.prototype.setDropArea = function () {
        ...
        if (this.dropArea) {
            this.dropZoneElement = (typeof (this.dropArea) !== 'string') ? this.dropArea :
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Lt)(this.dropArea, document);
            ...
            if (!enableDropText && dropTextArea) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .remove */ .TF)(dropTextArea);
            }
        }
        else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploaderOptions) && this.uploaderOptions.dropArea === undefined) {
            this.createDropTextHint();
    ...
    Uploader.prototype.updateHTMLAttrToElement = function () {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.htmlAttributes)) {
                ...
                if (wrapperAttr.indexOf(pro) > -1) {
                    if (pro === 'class') {
                        ...
                        if (updatedClassValues !== '') {
                            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .addClass */ .iQ)([this.uploadWrapper], updatedClassValues.split(' '));
                        }
                    }
                    else if (pro === 'style') {
                        var uploadStyle = this.uploadWrapper.getAttribute(pro);
                        uploadStyle = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(uploadStyle) ? (uploadStyle + this.htmlAttributes["" + pro]) :
    ...
    Uploader.prototype.setCSSClass = function (oldCSSClass) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(oldCSSClass)) {
            updatedOldCssClass = (oldCSSClass.replace(/\s+/g, ' ')).trim();
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(oldCSSClass) && updatedOldCssClass !== '') {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)([this.uploadWrapper], updatedOldCssClass.split(' '));
        }
        var updatedCssClassValue = this.cssClass;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.cssClass) && this.cssClass !== '') {
            updatedCssClassValue = (this.cssClass.replace(/\s+/g, ' ')).trim();
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.cssClass) && updatedCssClassValue !== '') {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .addClass */ .iQ)([this.uploadWrapper], updatedCssClassValue.split(updatedCssClassValue.indexOf(',') > -1 ? ',' : ' '));
        }
    };
    Uploader.prototype.wireEvents = function () {
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.browseButton, 'click', this.browseButtonClick, this);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.element, 'change', this.onSelectFiles, this);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(document, 'click', this.removeFocus, this);
        this.keyboardModule = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .KeyboardEvents */ .j9(this.uploadWrapper, {
            keyAction: this.keyActionHandler.bind(this),
            keyConfigs: this.keyConfigs,
            eventName: 'keydown'
        });
        if (this.isForm) {
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.formElement, 'reset', this.resetForm, this);
        }
    };
    Uploader.prototype.unWireEvents = function () {
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.browseButton, 'click', this.browseButtonClick);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.element, 'change', this.onSelectFiles);
        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(document, 'click', this.removeFocus);
        if (this.isForm) {
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.formElement, 'reset', this.resetForm);
        }
        ...
        switch (e.action) {
            case 'enter':
                if (e.target === this.clearButton) {
                    ...
                    var metaData = this.getCurrentMetaData(null, e);
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(metaData)) {
    ...
    Uploader.prototype.getCurrentMetaData = function (fileInfo, e) {
        var fileData;
        var targetMetaData;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fileInfo)) {
            var target = e.target.parentElement;
    ...
    Uploader.prototype.bindDropEvents = function () {
        if (this.dropZoneElement) {
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.dropZoneElement, 'drop', this.dropElement, this);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.dropZoneElement, 'dragover', this.dragHover, this);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.dropZoneElement, 'dragleave', this.onDragLeave, this);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.dropZoneElement, 'paste', this.onPasteFile, this);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(this.dropZoneElement, 'dragenter', this.onDragEnter, this);
        }
    };
    Uploader.prototype.unBindDropEvents = function () {
        if (this.dropZoneElement) {
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.dropZoneElement, 'drop', this.dropElement);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.dropZoneElement, 'dragover', this.dragHover);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.dropZoneElement, 'dragleave', this.onDragLeave);
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.remove(this.dropZoneElement, 'dragenter', this.onDragEnter);
        }
    };
    ...
    Uploader.prototype.onPasteFile = function (event) {
        ...
        for (var file = 0; file < item.length; file++) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pasteFile.getAsFile()) && ((pasteFile.kind === 'file') || pasteFile.type.match('^image/'))) {
    ...
    Uploader.prototype.removeFiles = function (args) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fileData)) {
            return;
        }
        if (args.target.classList.contains(ABORT_ICON) && !formUpload) {
            fileData[0].statusCode = '5';
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement)) {
                var spinnerTarget = liElement.querySelector('.' + ABORT_ICON);
                (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .createSpinner */ .GF)({ target: spinnerTarget, width: '20px' });
                (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .showSpinner */ .xc)(spinnerTarget);
            }
            if (this.sequentialUpload) {
                /* istanbul ignore next */
        ...
        else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .closest */ .kp)(args.target, '.' + SPINNER_PANE)) {
    ...
    Uploader.prototype.removeFilesData = function (file, customTemplate) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(selectedElement)) {
            return;
        }
        this.element.value = '';
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(selectedElement);
        index = this.fileList.indexOf(selectedElement);
        this.fileList.splice(index, 1);
        this.filesData.splice(index, 1);
        if (this.fileList.length === 0 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.listParent)) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(this.listParent);
            this.listParent = null;
            this.removeActionButtons();
        }
    ...
    Uploader.prototype.removeUploadedFile = function (file, eventArgs, removeDirectly, custom) {
        ...
        var ajax = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Ajax */ .dj(this.asyncSettings.removeUrl, 'POST', true, null);
    ...
    Uploader.prototype.removingEventCallback = function (eventArgs, formData, selectedFiles, file) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement) && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + DELETE_ICON)) ||
            !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + REMOVE_ICON)))) {
        ...
        if (eventArgs.postRawFile && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(selectedFiles.rawFile) && selectedFiles.rawFile !== '') {
    ...
    Uploader.prototype.removeFailed = function (e, files, customTemplate) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + DELETE_ICON))) {
            var spinnerTarget = liElement.querySelector('.' + DELETE_ICON);
            (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .hideSpinner */ .W$)(spinnerTarget);
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(liElement.querySelector('.e-spinner-pane'));
        }
    };
    /* istanbul ignore next */
    ...
    Uploader.prototype.renderSelectedFiles = function (args, targetFiles, directory, paste) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.allowedExtensions) && this.allowedExtensions.indexOf('*') > -1) {
            this.allTypes = true;
        }
        if (this.enableHtmlSanitizer) {
            for (var i = 0; i < fileData.length; i++) {
                var sanitizeFile = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.beforeSanitize();
                var sanitizeFileName = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.serializeValue(sanitizeFile, fileData[parseInt(i.toString(), 10)].name);
    ...
    Uploader.prototype.updateInitialFileDetails = function (args, targetFiles, file, i, fileData, directory, paste) {
        var fileName = directory ? targetFiles[i].path.substring(1, targetFiles[i].path.length) : paste ?
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getUniqueID */ .Lz)(file.name.substring(0, file.name.lastIndexOf('.'))) + '.' + this.getFileType(file.name) :
        ...
        var fileDetails = {
            ...
            statusCode: '1',
            id: (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getUniqueID */ .Lz)(file.name.substring(0, file.name.lastIndexOf('.'))) + '.' + this.getFileType(file.name)
        };
        /* istanbul ignore next */
        if (paste) {
    ...
    Uploader.prototype._internalRenderSelect = function (eventArgs, fileData) {
        if (!eventArgs.cancel) {
            ...
            if (this.showFileList) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(eventArgs.progressInterval) && eventArgs.progressInterval !== '') {
    ...
    Uploader.prototype.allowUpload = function () {
        ...
        if (this.isForm && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.asyncSettings.saveUrl) && this.asyncSettings.saveUrl !== '')) {
    ...
    Uploader.prototype.isFormUpload = function () {
        ...
        if (this.isForm && (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.asyncSettings.saveUrl) || this.asyncSettings.saveUrl === '')
            && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.asyncSettings.removeUrl) || this.asyncSettings.removeUrl === ''))) {
            isFormUpload = true;
        }
        return isFormUpload;
    };
    Uploader.prototype.clearData = function (singleUpload) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.listParent)) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(this.listParent);
            this.listParent = null;
        }
            ...
            for (var index = 0; index < filesData.length; index++) {
                for (var j = 0; j < this.filesData.length; j++) {
                    if (this.filesData[j].name === filesData[index].name) {
                        ...
                        _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(oldList[j].querySelector('.e-icons'), 'click', this.removeFiles, this);
    ...
    Uploader.prototype.checkExtension = function (files) {
        ...
        if (!this.isBlank(this.allowedExtensions)) {
            ...
            var extensions = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(allowedExtensions) ? this.allowedExtensions.split(',') : [''];
    ...
    Uploader.prototype.createCustomfileList = function (fileData) {
        ...
        for (var _i = 0, fileData_1 = fileData; _i < fileData_1.length; _i++) {
            ...
            if (liTempCompiler) {
                ...
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .append */ .BC)(fromElements, listElement);
            }
    ...
    Uploader.prototype.formFileList = function (fileData, files) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fileList.querySelector('.e-icons'))) {
            ...
            _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .EventHandler */ .Jm.add(iconElement, 'click', this.removeFiles, this);
    ...
    Uploader.prototype.createFormInput = function (fileData) {
        if (this.browserName !== 'safari') {
            ...
            inputElement.setAttribute('id', (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .getUniqueID */ .Lz)('hiddenUploader'));
    ...
    Uploader.prototype.formCustomFileList = function (fileData, files) {
        ...
        if (liTempCompiler) {
            var fromElements = [].slice.call(liTempCompiler);
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .append */ .BC)(fromElements, fileList);
        }
        var index = this.listParent.querySelectorAll('li').length;
        if (!fileList.classList.contains(INVALID_FILE)) {
            this.createFormInput(fileData);
    ...
    Uploader.prototype.internalCreateFileList = function (fileData) {
        this.createParentUL();
        if (this.template !== '' && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.template)) {
    ...
    Uploader.prototype.filterfileList = function (files) {
        ...
        for (var i = 0; i < files.length; i++) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li) && !li.classList.contains(UPLOAD_SUCCESS)) {
    ...
    Uploader.prototype.updateStatus = function (files, status, statusCode, updateLiStatus) {
        ...
        if (!(status === '' || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(status)) && !(statusCode === '' || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(statusCode))) {
            files.status = status;
        ...
        if (updateLiStatus) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li)) {
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li.querySelector('.' + STATUS)) && !((status === '' || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(status)))) {
    ...
    Uploader.prototype.getLiElement = function (files) {
        ...
        for (var i = 0; i < this.filesData.length; i++) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(files) && ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.filesData[i].id) &&
                !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(files.id)) ? (this.filesData[i].name === files.name &&
    ...
    Uploader.prototype.updateProgressbar = function (e, li) {
        if (!isNaN(Math.round((e.loaded / e.total) * 100)) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li.querySelector('.' + PROGRESSBAR))) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.progressInterval) && this.progressInterval !== '') {
    ...
    Uploader.prototype.uploadInProgress = function (e, files, customUI, request) {
        var li = this.getLiElement(files);
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li) && (!customUI)) {
            return;
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li)) {
            /* istanbul ignore next */
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(iconEle)) {
            ...
            this.trigger('canceling', eventArgs, function (eventArgs) {
                if (eventArgs.cancel) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li)) {
                        ...
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(spinnerTarget)) {
                            (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .hideSpinner */ .W$)(spinnerTarget);
                            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(li.querySelector('.e-spinner-pane'));
                        }
                    }
                }
                else {
                    ...
                    if (files.statusCode === '5') {
                        ...
                        var ajax_1 = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Ajax */ .dj(_this.asyncSettings.removeUrl, 'POST', true, null);
    ...
    Uploader.prototype.removecanceledFile = function (e, file) {
        var liElement = this.getLiElement(file);
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement) || liElement.querySelector('.' + RETRY_ICON) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + ABORT_ICON))) {
            return;
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement)) {
            (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .hideSpinner */ .W$)(spinnerTarget);
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.e-spinner-pane'))) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(liElement.querySelector('.e-spinner-pane'));
            }
        }
    ...
    Uploader.prototype.renderFailureState = function (e, file, liElement) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.e-file-status'))) {
            liElement.querySelector('.e-file-status').classList.add(UPLOAD_FAILED);
        }
        var deleteIcon = liElement.querySelector('.' + ABORT_ICON);
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(deleteIcon)) {
            return;
        }
    ...
    Uploader.prototype.reloadcanceledFile = function (e, file, liElement, custom) {
        ...
        if (!custom) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + STATUS))) {
                liElement.querySelector('.' + STATUS).classList.remove(UPLOAD_FAILED);
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + RETRY_ICON))) {
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(liElement.querySelector('.' + RETRY_ICON));
            }
    ...
    Uploader.prototype.uploadComplete = function (e, file, customUI) {
        ...
        if (status.readyState === 4 && status.status >= 200 && status.status <= 299) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li) && (!customUI || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(customUI)) && this.showFileList) {
                return;
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li)) {
    ...
    Uploader.prototype.raiseSuccessEvent = function (e, file) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(spinnerEle)) {
                (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .hideSpinner */ .W$)(liElement);
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(spinnerEle);
            }
        }
    ...
    Uploader.prototype.updateProgressBarClasses = function (li, className) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(progressBar)) {
    ...
    Uploader.prototype.removeProgressbar = function (li, callType) {
        var _this = this;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li.querySelector('.' + PROGRESS_WRAPPER))) {
            this.progressAnimation = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Animation */ .X5({ duration: 1250 });
    ...
    Uploader.prototype.animateProgressBar = function (li, callType) {
        if (callType === 'success') {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(li.querySelector('.' + STATUS))) {
        ...
        if (li.querySelector('.' + PROGRESS_WRAPPER)) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(li.querySelector('.' + PROGRESS_WRAPPER));
        }
    };
    Uploader.prototype.setExtensions = function (extensions) {
        if (extensions !== '' && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(extensions)) {
    ...
    Uploader.prototype.templateComplier = function (uploadTemplate) {
        if (uploadTemplate) {
            try {
                if (typeof uploadTemplate !== 'function' && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .Ub)(uploadTemplate, document).length) {
                    return (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .compile */ .wE)((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Lt)(uploadTemplate, document).innerHTML.trim());
                }
                else {
                    return (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .compile */ .wE)(uploadTemplate);
                }
            }
            catch (exception) {
                return (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .compile */ .wE)(uploadTemplate);
    ...
    Uploader.prototype.setRTL = function () {
        if (this.enableRtl) {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .addClass */ .iQ)([this.uploadWrapper], RTL);
        }
        else {
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .removeClass */ .vy)([this.uploadWrapper], RTL);
        }
    };
    ...
    Uploader.prototype.setControlStatus = function () {
        if (!this.enabled) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.clearButton)) {
                this.clearButton.setAttribute('disabled', 'disabled');
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploadButton)) {
                this.uploadButton.setAttribute('disabled', 'disabled');
            }
        }
        else {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.browseButton) && this.element.hasAttribute('disabled')) {
                this.element.removeAttribute('disabled');
                this.browseButton.removeAttribute('disabled');
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.clearButton) && this.clearButton.hasAttribute('disabled')) {
                this.clearButton.removeAttribute('disabled');
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploadButton) && this.uploadButton.hasAttribute('disabled')) {
                this.uploadButton.hasAttribute('disabled');
            }
        }
    };
    Uploader.prototype.checkHTMLAttributes = function (isDynamic) {
        var attributes = isDynamic ? (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.htmlAttributes) ? [] : Object.keys(this.htmlAttributes) :
            ['accept', 'multiple', 'disabled'];
        for (var _i = 0, attributes_1 = attributes; _i < attributes_1.length; _i++) {
            var prop = attributes_1[_i];
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.element.getAttribute(prop))) {
                switch (prop) {
                    case 'accept':
                        if (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploaderOptions) || (this.uploaderOptions['allowedExtensions'] === undefined))
                            || isDynamic) {
                        ...
                        break;
                    case 'multiple':
                        if (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploaderOptions) || (this.uploaderOptions['multiple'] === undefined)) || isDynamic) {
                        ...
                        break;
                    case 'disabled':
                        if (((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploaderOptions) || (this.uploaderOptions['enabled'] === undefined)) || isDynamic) {
    ...
    Uploader.prototype.sendRequest = function (file, metaData, custom, fileIndex) {
        ...
        var ajax = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Ajax */ .dj({ url: this.asyncSettings.saveUrl, type: 'POST', async: true, contentType: null });
        ajax.emitError = false;
        ajax.onLoad = function (e) {
    ...
    Uploader.prototype.checkChunkUpload = function () {
        return (this.asyncSettings.chunkSize <= 0 || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.asyncSettings.chunkSize)) ? false : true;
    };
    Uploader.prototype.chunkUploadComplete = function (e, metaData, custom) {
        ...
        if (response.readyState === 4 && response.status >= 200 && response.status < 300) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(custom) || !custom) {
            ...
            if (metaData.file.statusCode === '5') {
                ...
                this.trigger('canceling', eventArgs_1, function (eventArgs) {
                    ...
                    if (eventArgs.cancel) {
                        metaData.file.statusCode = '3';
                        var spinnerTarget = liElement.querySelector('.' + ABORT_ICON);
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(spinnerTarget)) {
                            (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .hideSpinner */ .W$)(spinnerTarget);
                            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(liElement.querySelector('.e-spinner-pane'));
                        }
                        ...
                        _this.updateFormData(formData, eventArgs.customFormData);
                        var ajax = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Ajax */ .dj(_this.asyncSettings.removeUrl, 'POST', true, null);
                        ajax.emitError = false;
                        ajax.onLoad = function (e) {
                ...
                if ((totalChunk - 1) === metaData.chunkIndex && totalChunk > metaData.chunkIndex) {
                    ...
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.template) && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(custom) || !custom) && liElement) {
                        if (liElement && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + PAUSE_UPLOAD))) {
                            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(liElement.querySelector('.' + PAUSE_UPLOAD));
                        }
    ...
    Uploader.prototype.removeChunkFile = function (e, metaData, custom) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.template) && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(custom) && !custom)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(deleteIcon)
                && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.e-spinner-pane'))) {
                (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .hideSpinner */ .W$)(spinnerTarget);
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(liElement.querySelector('.e-spinner-pane'));
            }
        }
    ...
    Uploader.prototype.resumeUpload = function (metaData, e, custom) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(targetElement) && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(custom) || !custom)) {
    ...
    Uploader.prototype.removeChunkProgressBar = function (metaData) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(cancelButton)) {
            ...
            if (!eventArgs.cancel) {
                if (metaData.retryCount < _this.asyncSettings.retryCount) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement)) {
                        ...
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pauseButton)) {
                        ...
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + PAUSE_UPLOAD))) {
                            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(liElement.querySelector('.' + PAUSE_UPLOAD));
                        }
                        if (metaData.start > 0) {
                            iconElement.classList.add(DELETE_ICON);
    ...
    Uploader.prototype.chunkUploadInProgress = function (e, metaData, custom) {
        ...
        var retryElement = liElement.querySelector('.' + RETRY_ICON);
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(retryElement)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement)) {
            if (!(liElement.querySelectorAll('.' + PROGRESS_WRAPPER).length > 0)) {
                ...
                var clearIcon = liElement.querySelector('.' + REMOVE_ICON) ? liElement.querySelector('.' + REMOVE_ICON) :
                    liElement.querySelector('.' + DELETE_ICON);
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(clearIcon)) {
                    clearIcon.classList.add(ABORT_ICON);
                    clearIcon.setAttribute('title', this.localizedTexts('abort'));
                    clearIcon.classList.remove(REMOVE_ICON);
                }
            }
            if (!isNaN(Math.round((e.loaded / e.total) * 100)) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.template) && metaData.file.statusCode !== '4') {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + PAUSE_UPLOAD)) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.template)
            && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement.querySelector('.' + DELETE_ICON))) {
    ...
    Uploader.prototype.destroy = function () {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.uploadWrapper)) {
            this.uploadWrapper.parentElement.appendChild(this.element);
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(this.uploadWrapper);
        }
    ...
    Uploader.prototype.uploadFiles = function (files, custom) {
        var selectedFiles = [];
        if (this.asyncSettings.saveUrl === '' || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.asyncSettings.saveUrl)) {
            return;
        }
        if (!custom || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(custom)) {
            if (!this.multiple) {
                var file = [];
                file.push(files[0]);
    ...
    Uploader.prototype.uploadFilesRequest = function (selectedFiles, i, custom) {
        ...
        var ajax = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Ajax */ .dj(this.asyncSettings.saveUrl, 'POST', true, null);
        ajax.emitError = false;
        var eventArgs = {
    ...
    Uploader.prototype.remove = function (fileData, customTemplate, removeDirectly, postRawFile, args) {
        var _this = this;
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(postRawFile)) {
            postRawFile = true;
        }
        var eventArgs = {
            event: args,
        ...
        this.trigger('beforeRemove', beforeEventArgs, function (beforeEventArgs) {
            if (!beforeEventArgs.cancel) {
                if (_this.isFormUpload()) {
                    ...
                    _this.trigger('removing', eventArgs, function (eventArgs) {
                        if (!eventArgs.cancel) {
                            ...
                            for (var _i = 0, removingFiles_1 = removingFiles; _i < removingFiles_1.length; _i++) {
                                ...
                                if (liIndex > -1) {
                                    var inputElement = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(data.input) ? data.input : null;
                                    if (inputElement) {
                                        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(inputElement);
                                    }
                                    _this.spliceFiles(liIndex);
                                    (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .detach */ .Yo)(_this.fileList[liIndex]);
                ...
                else if (_this.isForm && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.asyncSettings.removeUrl) || _this.asyncSettings.removeUrl === '')) {
                    ...
                    var removeFiles = [];
                    fileData = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fileData) ? fileData : _this.filesData;
                    ...
                    var validUrl = (removeUrl === '' || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(removeUrl)) ? false : true;
    ...
    Uploader.prototype.getFiles = function (fileData) {
        var files = [];
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fileData) && !(fileData instanceof Array)) {
            files.push(fileData);
        }
        else {
            files = fileData;
    ...
    Uploader.prototype.showHideUploadSpinner = function (files) {
        var liElement = this.getLiElement(files);
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(liElement) && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.template)) {
            var spinnerTarget = liElement.querySelector('.' + ABORT_ICON);
            (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .createSpinner */ .GF)({ target: spinnerTarget, width: '20px' });
            (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_1__/* .showSpinner */ .xc)(spinnerTarget);
        }
    ...
    __decorate([
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Complex */ .pr)({ saveUrl: '', removeUrl: '' }, AsyncSettings)
    ...
    __decorate([
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Complex */ .pr)({}, ButtonsProps)
    ...
    __decorate([
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Property */ .mA)(30000000)
    ], Uploader.prototype, "maxFileSize", void 0);
    __decorate([
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Property */ .mA)(null)
    ], Uploader.prototype, "dropArea", void 0);
    __decorate([
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Collection */ .pM)([{}], FilesProp)
...
//# sourceMappingURL=6f122b39-d1893af210ccd242.js.map