"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[5508],{

/***/ 6362:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Xj: () => (/* binding */ LayoutViewer),
/* harmony export */   _p: () => (/* binding */ PageLayoutViewer),
/* harmony export */   gf: () => (/* binding */ DocumentHelper),
/* harmony export */   nv: () => (/* binding */ WebLayoutViewer)
/* harmony export */ });
/* unused harmony export ColumnLayout */
/* harmony import */ var _base_dictionary__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(50836);
/* harmony import */ var _list_abstract_list__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(2735);
/* harmony import */ var _list_level_override__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(31611);
/* harmony import */ var _format_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74744);
/* harmony import */ var _format_index__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(26886);
/* harmony import */ var _format_index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(33077);
/* harmony import */ var _format_index__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(9690);
/* harmony import */ var _layout__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(30278);
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(32068);
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12695);
/* harmony import */ var _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74023);
/* harmony import */ var _text_helper__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(43518);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(22333);
/* harmony import */ var _zooming__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(38889);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(68576);
/* harmony import */ var _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(28696);
/* harmony import */ var _base_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(53581);
/* harmony import */ var _restrict_editing_restrict_editing_pane__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(75728);
/* harmony import */ var _dialogs_form_field_popup__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(24932);
/* harmony import */ var _dialogs_content_control_popup__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(37699);
/* harmony import */ var _track_changes_track_changes_pane__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(33361);
/* harmony import */ var _themes_themes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(20246);
/* harmony import */ var _base_index__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(36012);
...
var DocumentHelper = /** @class */ (function () {
    ...
    function DocumentHelper(owner) {
         ...
         * @private
         */
        this.authors = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        /**
         * @private
         */
        this.revisionsInternal = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        /**
         * @private
         */
         ...
         * @private
         */
        this.styles = new _format_index__WEBPACK_IMPORTED_MODULE_2__/* .WStyles */ .UF();
        /**
         * @private
         */
        this.stylesMap = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        /**
         * @private
         */
         ...
         * @private
         */
        this.mouseDownOffset = new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(0, 0);
         ...
         * @private
         */
        this.themes = new _themes_themes__WEBPACK_IMPORTED_MODULE_4__/* .Themes */ .B();
        /**
         * @private
         */
         ...
         * @private
         */
        this.footnotes = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Footnote */ .tW();
        /**
         * @private
         */
        this.endnotes = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Footnote */ .tW();
        /**
         * @private
         */
        ...
        this.compositionStart = function () {
            if (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !_this.owner.isReadOnlyMode) {
        ...
        this.compositionEnd = function (event) {
            if (_this.isComposingIME && !_this.owner.isReadOnlyMode) {
                ...
                (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .updateCSSText */ .Un)(_this.iframe, cssText);
                _this.editableDiv.innerHTML = '';
                if (_this.owner.editorHistoryModule) {
                    if (text !== '') {
        ...
        this.onImageResizer = function (args) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.imageResizerModule) &&
        ...
        this.onKeyPressInternal = function (event) {
            ...
            if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isIE && alt && ctrl) {
                ctrl = false;
            }
            // tslint:disable-next-line:max-line-length
            if (ctrl && event.key === 'v' || ctrl && event.key === 'a' || (ctrl || (_this.isControlPressed && _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isIE)) && event.key === 'p') {
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isIE) {
                    _this.isControlPressed = false;
                }
                return;
            }
            if (!_this.owner.isReadOnlyMode && _this.owner.editorModule.canEditContentControl || (_this.owner.documentHelper.protectionType === 'FormFieldsOnly' && _this.owner.editorModule.canEditContentControl && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.documentHelper.selection) && _this.owner.documentHelper.selection.checkContentControlLocked()) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection) && _this.selection.isInlineFormFillMode())) {
        ...
        this.onCopy = function (event) {
            if (_this.isCopying && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection) && !_this.selection.isEmpty) {
        ...
        this.onFocusOut = function () {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection)) {
        ...
        this.updateFocus = function () {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.currentSelectedComment) && !_this.owner.commentReviewPane.commentPane.isEditMode) {
            ...
            if (_this.selection && !(_this.isMobileDevice && _this.owner.isReadOnly)) {
                if (navigator !== undefined && !_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isIE && !navigator.userAgent.match('Edge')
                    && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.iframe)) {
                    _this.iframe.focus();
                }
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.editableDiv)) {
        ...
        this.scrollHandler = function () {
            ...
            if (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !_this.isComposingIME) {
            ...
            if (_this.owner.rulerHelper && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.rulerHelper.vRulerBottom)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner) && _this.owner.viewer instanceof PageLayoutViewer) {
                _this.owner.fireViewChange();
            }
            _this.isScrollHandler = false;
            _this.scrollTimer = setTimeout(function () {
                if (!_this.isScrollHandler && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner) && _this.owner.isSpellCheck) {
        ...
        this.onWindowResize = function () {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner) && _this.owner.isContainerResize) {
            ...
            _this.resizeTimer = setTimeout(function () {
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.element)) {
        ...
        this.onMouseDownInternal = function (event) {
            ...
            _this.owner.focusIn();
            if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(target) && target !== _this.viewerContainer) || _this.owner.isTableMarkerDragging || _this.isTouchInput ||
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection)) {
                ...
                if (_this.isLeftButtonPressed(event) && !_this.owner.isReadOnlyMode && _this.owner.enableImageResizerMode && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.imageResizerModule.selectedResizeElement)) {
                ...
                var cursorPoint = new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(event.offsetX, event.offsetY);
        ...
        this.onMouseMoveInternal = function (event) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(event.target) && event.target !== _this.viewerContainer || _this.owner.isTableMarkerDragging) {
                return;
            }
            event.preventDefault();
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection)) {
                ...
                var widget = _this.getLineWidget(touchPoint);
                if (_this.isMouseDown) {
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.currentPage)) {
                        ...
                        if (!_this.owner.isReadOnlyMode && _this.isRowOrCellResizing) {
                            ...
                            if (!(_this.isTouchInput || _this.isSelectionChangedOnMouseMoved || _this.touchDownOnSelectionMark > 0 || _this.isDragStarted)) {
                                ...
                                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.currentSelectedComment) && _this.owner.commentReviewPane
                            ...
                            if (_this.isLeftButtonPressed(event) && !_this.isDragStarted) {
                                ...
                                var touchPoint_1 = new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(xPosition, touchY);
        ...
        this.onWindowMouseMoveInternal = function (event) {
            ...
            if (_this.isMouseDown && _this.isMouseLeaved) {
                ...
                var cursorPoint_1 = new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(event.x - (pageLeft + viewerLeft), event.y - viewerTop);
        ...
        this.onDoubleTap = function (event) {
            _this.owner.focusIn();
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(event.target) && event.target !== _this.viewerContainer) {
                return;
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection)) {
                _this.isTouchInput = false;
                ...
                else if (_this.isDocumentProtected && formField && formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFormField */ .uS
                ...
                if (_this.owner.layoutType === 'Pages') {
                    if (inline instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .FootnoteElementBox */ .gP) {
                        ...
                        if (inline instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextElementBox */ .fg && (_this.selection.isinEndnote || _this.selection.isinFootnote)) {
                            _this.selection.footnoteReferenceElement(startPosition, endPosition, inline);
                        }
                    }
                }
                if (_this.selection.isEmpty && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.currentPage) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.selectionModule.start)) {
        ...
        this.onMouseUpInternal = function (event) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection)) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.editor) && _this.selection.checkContentControlLocked()) {
                    _this.owner.editorModule.insertContentControlPlaceholder();
                }
                if (_this.isMouseDown && !_this.isSelectionChangedOnMouseMoved
                    && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.currentPage) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.selectionModule.start)
                    ...
                    if (_this.touchDownOnSelectionMark === 0 && !_this.isRowOrCellResizing) {
                        ...
                        if (isShiftKeyPressed) {
                            ...
                            if (_this.owner.selectionModule.isImageSelected) {
                                ...
                                if (contentControlImage instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ContentControl */ .HM) {
                        ...
                        if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isIE && tapCount === 2) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.editorModule) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.selectionModule)) {
                    ...
                    if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(contentControl) && !contentControl.contentControlProperties.lockContents && iscontentControl && event.button === 0) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(contentControl) && !contentControl.contentControlProperties.lockContents && _this.protectionType == 'FormFieldsOnly' && event.button === 0)) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.currentPage) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.selectionModule.start)
                ...
                if (_this.isMouseDown && _this.isLeftButtonPressed(event) && _this.isDocumentProtected
                    ...
                    if (formField && formField.formFieldData && formField.formFieldData.enabled && !_this.selection.isInlineFormFillMode(formField)) {
                        ...
                        if (formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFormField */ .uS) {
                            data.value = formField.resultText;
                        }
                        else if (formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .CheckBoxFormField */ .av) {
                        ...
                        if (_this.owner.documentEditorSettings.formFieldSettings.formFillingMode === 'Popup' && _this.selection.previousSelectedFormField !== _this.selection.getCurrentFormField()) {
                            _this.owner.trigger(_base_index__WEBPACK_IMPORTED_MODULE_6__/* .beforeFormFieldFillEvent */ .VH, data);
                        }
                        else {
                            _this.owner.trigger(_base_index__WEBPACK_IMPORTED_MODULE_6__/* .beforeFormFieldFillEvent */ .VH, data);
                        }
                        if (!data.isCanceled) {
                            if (_this.owner.documentEditorSettings.formFieldSettings.formFillingMode === 'Popup' && !(formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .CheckBoxFormField */ .av)
                                || (formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFormField */ .uS && !(formField.formFieldData.type === 'Text'))
                                || formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .DropDownFormField */ .iP) {
                                ...
                                data.value = formField.formFieldData.checked;
                                data.isCanceled = false;
                                _this.owner.trigger(_base_index__WEBPACK_IMPORTED_MODULE_6__/* .afterFormFieldFillEvent */ .aS, data);
                            }
                        }
                    }
                    if (!formField && _this.isFormFillProtectedMode) {
                        ...
                        if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(contentControl) && contentControl instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ContentControl */ .HM && !contentControl.contentControlProperties.lockContentControl)) {
                    ...
                    if (_this.formFields.length > 0) {
                        ...
                        if (formField && formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFormField */ .uS) {
                            _this.selection.selectField();
                        }
                        else if (_this.isLeftButtonPressed(event) && formField && formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .DropDownFormField */ .iP) {
                ...
                if (_this.owner.enableImageResizerMode && _this.owner.imageResizerModule.isImageResizerVisible && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection.caret)) {
                    _this.selection.caret.style.display = 'none';
                }
                if (_this.isDragStarted) {
                    if (_this.selection.selectedWidgets.length === 0 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.dragStartParaInfo) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.dragEndParaInfo) && _this.dragEndParaInfo.paragraph.equals(_this.dragStartParaInfo.paragraph)) {
                        var currentInline = _this.dragStartParaInfo.paragraph.getInline(_this.dragEndParaInfo.offset, 0);
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(currentInline.element) && currentInline.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ImageElementBox */ .Rt && currentInline.element.textWrappingStyle !== "Inline") {
                            _this.isDragStarted = false;
                        }
                    }
                        ...
                        for (var i = 0; i < _this.selection.selectedWidgets.values.length; i++) {
                            ...
                            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(selectedWidgetInfo.floatingItems) && selectedWidgetInfo.floatingItems.length > 0) {
                                for (var j = 0; j < selectedWidgetInfo.floatingItems.length; j++) {
                                    if (selectedWidgetInfo.floatingItems[j] instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ImageElementBox */ .Rt && selectedWidgetInfo.floatingItems[j].textWrappingStyle !== "Inline") {
                                        _this.isDragStarted = false;
                                        break;
                                    }
                                }
        ...
        this.onTouchStartInternal = function (event) {
            if (_this.selection) {
                ...
                if (event.touches.length === 1) {
                    ...
                    if (_this.owner.enableImageResizerMode && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.imageResizerModule.selectedResizeElement)) {
                        _this.owner.imageResizerModule.isImageResizing = true;
                    }
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.contextMenuModule) && _this.owner.contextMenuModule.contextMenuInstance) {
                    _this.owner.contextMenuModule.contextMenuInstance.close();
                }
        ...
        this.onLongTouch = function (event) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.viewerContainer) || _this.isTouchMoved || event.touches.length !== 1) {
                return;
            }
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection)) {
                ...
                if (_this.isMouseDown) {
                    ...
                    if (_this.touchDownOnSelectionMark > 0 /*|| !this.useTouchSelectionMark*/) {
                        ...
                        touchPoint = new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(touchPoint.x, touchY);
                        _this.owner.selectionModule.moveTextPosition(touchPoint, textPosition);
                        _this.isSelectionChangedOnMouseMoved = true;
                    }
                    _this.selection.checkForCursorVisibility();
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection)) {
                ...
                if (event.changedTouches.length === 1) {
                    if (!_this.isTouchMoved || (_this.owner.enableImageResizerMode && _this.owner.imageResizerModule.isImageResizing)) {
                        ...
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.currentPage) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection.start)
        ...
        this.onKeyUpInternal = function (event) {
            if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && event.target === _this.editableDiv) {
        ...
        this.onKeyDownInternal = function (event) {
            var pasteElement = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection.pasteElement) ? _this.selection.pasteElement : undefined;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(event.target) && event.target !== _this.editableDiv && event.target !== pasteElement
            ...
            _this.owner.trigger(_base_index__WEBPACK_IMPORTED_MODULE_6__/* .keyDownEvent */ .mM, keyEventArgs);
            ...
            if (event.keyCode !== 8 && event.keyCode !== 46 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.editor) && _this.selection.checkContentControlLocked()) {
                _this.owner.editorModule.insertContentControlPlaceholder();
            }
            if (!isHandled && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection)) {
                _this.selection.caret.classList.remove("e-de-cursor-animation");
                _this.isSpellCheckPending = true;
                _this.selection.onKeyDownInternal(event, ctrl, shift, alt);
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.documentHelper) && _this.owner.documentHelper.contentControlCollection.length > 0) {
                //Need to work on these
                _this.clearContent();
                _this.owner.documentHelper.viewer.updateScrollBars();
            }
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.selection) && !_this.selection.caret.classList.contains("e-de-cursor-animation")) {
                _this.selection.caret.classList.add("e-de-cursor-animation");
            }
        };
        this.owner = owner;
        ...
        this.lists = [];
        this.abstractLists = [];
        this.render = new _render__WEBPACK_IMPORTED_MODULE_7__/* .Renderer */ .A(this);
        this.characterFormat = new _format_index__WEBPACK_IMPORTED_MODULE_8__/* .WCharacterFormat */ .q(this);
        this.themeFontLanguage = new _format_index__WEBPACK_IMPORTED_MODULE_8__/* .WCharacterFormat */ .q(this);
        this.paragraphFormat = new _format_index__WEBPACK_IMPORTED_MODULE_9__/* .WParagraphFormat */ .F(this);
        this.renderedLists = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        this.renderedLevelOverrides = [];
        this.headersFooters = [];
        this.styles = new _format_index__WEBPACK_IMPORTED_MODULE_2__/* .WStyles */ .UF();
        this.stylesMap = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        if (this.owner) {
            this.L10n = new _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .L10n */ .Wo('documenteditor', this.owner.defaultLocale);
            this.L10n.setLocale(this.owner.locale);
        }
        this.preDefinedStyles = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        this.initalizeStyles();
        this.bookmarks = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        this.editRanges = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        ...
        this.formFillPopup = new _dialogs_form_field_popup__WEBPACK_IMPORTED_MODULE_10__/* .FormFieldPopUp */ .b(this.owner);
        this.contentDropDown = new _dialogs_content_control_popup__WEBPACK_IMPORTED_MODULE_11__/* .ContentControlPopUp */ .B(this.owner);
        this.customXmlData = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        this.fontSubstitutionTable = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
        this.contentControlCollection = [];
        this.footnoteCollection = [];
        this.endnoteCollection = [];
        this.themes = new _themes_themes__WEBPACK_IMPORTED_MODULE_4__/* .Themes */ .B();
        this.images = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
    }
    ...
    Object.defineProperty(DocumentHelper.prototype, "containerCanvas", {
         ...
         */
        get: function () {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.containerCanvasIn)) {
                this.containerCanvasIn = document.createElement('canvas');
                this.containerCanvasIn.getContext('2d').save();
            }
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pageContainer)
    ...
    DocumentHelper.prototype.openTextFile = function (text) {
        ...
        arr = text.split('\n');
        var widget = [];
        var bodyWidget = new _page__WEBPACK_IMPORTED_MODULE_5__/* .BodyWidget */ .v$();
        bodyWidget.sectionFormat = new _format_index__WEBPACK_IMPORTED_MODULE_12__/* .WSectionFormat */ .A(bodyWidget);
        bodyWidget.childWidgets = widget;
        var paragraph1 = new _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D();
        var line1 = new _page__WEBPACK_IMPORTED_MODULE_5__/* .LineWidget */ .V9(paragraph1);
        for (var i = 0; i < arr.length; i++) {
            ...
            var paragraph = new _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D();
            var line = new _page__WEBPACK_IMPORTED_MODULE_5__/* .LineWidget */ .V9(paragraph);
            if (arr[i].length > 0) {
                ...
                if (arr[i].length > singleLineLength) {
                    ...
                    while (count < lineLength) {
                        ...
                        var textElement = new _page__WEBPACK_IMPORTED_MODULE_5__/* .TextElementBox */ .fg();
    ...
    Object.defineProperty(DocumentHelper.prototype, "selectionCanvas", {
         ...
         */
        get: function () {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.selectionCanvasIn)) {
    ...
    DocumentHelper.prototype.getAbstractListById = function (id, isNsid) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.abstractLists)) {
            return undefined;
        }
        for (var i = 0; i < this.abstractLists.length; i++) {
            var abstractList = this.abstractLists[i];
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(abstractList)) {
    ...
    DocumentHelper.getListLevelNumber = function (listLevel) {
        if (listLevel.ownerBase instanceof _list_level_override__WEBPACK_IMPORTED_MODULE_13__/* .WLevelOverride */ .c) {
            return listLevel.ownerBase.levelNumber;
        }
        else if (listLevel.ownerBase instanceof _list_abstract_list__WEBPACK_IMPORTED_MODULE_14__/* .WAbstractList */ .M && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(listLevel.ownerBase.levels)) {
    ...
    */
    DocumentHelper.prototype.getImageString = function (image) {
        ...
        var imageStr;
        if (image.isMetaFile && _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.formatClippedString(base64ImageString[0]).extension !== ".svg") {
            imageStr = base64ImageString[1];
        }
        else if (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.formatClippedString(base64ImageString[0]).extension === ".tif") {
            imageStr = base64ImageString[1];
        }
        else {
    ...
    DocumentHelper.prototype.addBase64StringInCollection = function (image) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (addToCollection) {
                    if (image.isMetaFile) {
                        base64ImageString.push(!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(image.metaFileImageString) ? image.metaFileImageString : image.imageString);
                ...
                if (image.isMetaFile && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(image.metaFileImageString)) {
    ...
    DocumentHelper.prototype.showComments = function (show) {
        if (this.owner && show && this.owner.enableComment) {
            ...
            this.owner.trigger(_base_index__WEBPACK_IMPORTED_MODULE_6__/* .beforePaneSwitchEvent */ .W_, eventArgs);
        }
    ...
    DocumentHelper.prototype.initializeComponents = function () {
        ...
        this.optionsPaneContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
        ...
        this.viewerContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.owner.containerId + '_viewerContainer' });
        ...
        this.pageContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.owner.containerId + '_pageContainer', className: 'e-de-background' });
        ...
        this.owner.readableDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', {
            attrs: {
                'aria-live': 'assertive',
                'role': 'region',
                'tabindex': "1",
        ...
        this.layout = new _layout__WEBPACK_IMPORTED_MODULE_15__/* .Layout */ .P(this);
        this.textHelper = new _text_helper__WEBPACK_IMPORTED_MODULE_16__/* .TextHelper */ .w(this);
        this.zoomModule = new _zooming__WEBPACK_IMPORTED_MODULE_17__/* .Zoom */ .G(this);
        this.initTouchEllipse();
        this.wireEvent();
        this.restrictEditingPane = new _restrict_editing_restrict_editing_pane__WEBPACK_IMPORTED_MODULE_18__/* .RestrictEditing */ .P(this);
        this.owner.commentReviewPane = new _index__WEBPACK_IMPORTED_MODULE_19__/* .CommentReviewPane */ .OS(this.owner);
        this.owner.trackChangesPane = new _track_changes_track_changes_pane__WEBPACK_IMPORTED_MODULE_20__/* .TrackChangesPane */ .V(this.owner, this.owner.commentReviewPane);
        (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_21__/* .createSpinner */ .GF)({ target: this.owner.element, cssClass: 'e-spin-overlay' });
    };
    ...
    DocumentHelper.prototype.createEditableIFrame = function () {
        this.iframe = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('iframe', {
            attrs: {
                'scrolling': 'no',
    ...
    DocumentHelper.prototype.initIframeContent = function () {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.iframe.contentDocument)) {
            ...
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .updateCSSText */ .Un)(this.iframe.contentDocument.body, cssText);
            (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .updateCSSText */ .Un)(this.editableDiv, cssText);
        }
    };
    /**
    ...
    DocumentHelper.prototype.wireEvent = function () {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.selectionModule)) {
            this.selection.initCaret();
        }
        this.wireInputEvents();
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.iframe)) {
    ...
    DocumentHelper.prototype.wireInputEvents = function () {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.editableDiv)) {
            return;
        }
        this.editableDiv.addEventListener('paste', this.onPaste);
        if (!_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice) {
            this.editableDiv.addEventListener('keypress', this.onKeyPressInternal);
            if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.info.name === 'chrome') {
    ...
    DocumentHelper.prototype.onIframeLoad = function () {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.iframe) && this.iframe.contentDocument.body.children.length === 0) {
            this.initIframeContent();
            this.wireInputEvents();
        }
    };
    ...
    DocumentHelper.prototype.getAvatar = function (userInfo, userName, comment, revision) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(author)) {
            var avatarDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-de-cmt-avatar' });
            var avatar = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-de-ff-cmt-avatar' });
            avatar.style.backgroundColor = this.owner.documentHelper.getAuthorColor(author);
            if (userinitial === '' || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(userinitial)) {
    ...
    DocumentHelper.prototype.positionEditableTarget = function () {
        ...
        var left = page.boundingRectangle.x + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.leftMargin) * this.zoomFactor);
        var top = point.y;
        ...
        iframeStyle += 'width:' + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(pageWidth) * this.zoomFactor) + 'px;';
        iframeStyle += 'height:250px;outline-style:none;position:absolute';
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .updateCSSText */ .Un)(this.iframe, iframeStyle);
        ...
        style += 'font-size:' + (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(this.selection.characterFormat.fontSize) * this.zoomFactor) + 'px;';
        style += 'font-family' + this.selection.characterFormat.fontFamily + ';';
        style += 'overflow:hidden;text-decoration:none;white-space:normal;';
        (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .updateCSSText */ .Un)(this.editableDiv, style);
    };
    DocumentHelper.prototype.initDialog = function (isRtl) {
        if (!this.dialogInternal) {
            this.dialogTarget1 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-de-dlg-target' });
            ...
            this.dialogInternal = new _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_22__/* .Dialog */ .lG({
    ...
    DocumentHelper.prototype.initDialog3 = function (isRtl) {
        if (!this.dialogInternal3) {
            this.dialogTarget3 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-de-dlg-target' });
            ...
            this.dialogInternal3 = new _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_22__/* .Dialog */ .lG({
                target: this.owner.documentEditorSettings.popupTarget, showCloseIcon: true,
                allowDragging: true, enableRtl: isRtl, visible: false,
    ...
    DocumentHelper.prototype.initDialog2 = function (isRtl) {
        if (!this.dialogInternal2) {
            this.dialogTarget2 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-de-dlg-target' });
            ...
            this.dialogInternal2 = new _syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_22__/* .Dialog */ .lG({
                target: this.owner.documentEditorSettings.popupTarget, showCloseIcon: true,
                allowDragging: true, enableRtl: isRtl, visible: false,
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        if (base64String && (_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.startsWith(base64String, 'http://') || _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.startsWith(base64String, 'https://'))) {
    ...
    DocumentHelper.prototype.onDocumentChanged = function (sections, iOps) {
        ...
        this.pages = [];
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.renderedLists)) {
            this.renderedLists.clear();
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.renderedLevelOverrides)) {
            this.renderedLevelOverrides = [];
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.editorHistoryModule)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(iOps) && this.owner.editorModule) {
        ...
        if (this.owner.enableCollaborativeEditing && this.owner.collaborativeEditingHandlerModule && this.owner.enableEditor) {
            ...
            if (iOps && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(iOps[_base_index__WEBPACK_IMPORTED_MODULE_23__/* .incrementalOps */ .nxG[0]])
                && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(iOps[_base_index__WEBPACK_IMPORTED_MODULE_23__/* .incrementalOps */ .nxG[0]].length > 0)) {
                for (var k = 0; k < iOps[_base_index__WEBPACK_IMPORTED_MODULE_23__/* .incrementalOps */ .nxG[0]].length; k++) {
                    this.owner.collaborativeEditingHandlerModule.applyRemoteAction('action', iOps[_base_index__WEBPACK_IMPORTED_MODULE_23__/* .incrementalOps */ .nxG[0]][k]);
                }
            }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.selectionModule) && this.owner.selectionModule.isViewPasteOptions) {
            this.owner.selectionModule.isViewPasteOptions = false;
            this.owner.selectionModule.showHidePasteOptions(undefined, undefined);
        }
        // setTimeout((): void => {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner) && this.owner.showRevisions) {
            this.showRevisions(true);
        }
        else {
            this.owner.trackChangesPane.changes = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
            this.owner.revisions.groupedView = new _base_dictionary__WEBPACK_IMPORTED_MODULE_1__/* .Dictionary */ .b();
            for (var i = 0; i < this.owner.revisions.changes.length; i++) {
                ...
                if (previousRevision) {
                    ...
                    var currentChangeView = new _track_changes_track_changes_pane__WEBPACK_IMPORTED_MODULE_20__/* .ChangesSingleView */ .v(this.owner, this.owner.trackChangesPane);
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner)) {
            this.owner.isUpdateTrackChanges = true;
        }
        this.owner.notify(_base_index__WEBPACK_IMPORTED_MODULE_6__/* .internalStyleCollectionChange */ .Wi, {});
        // });
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(picture_cc)) {
    ...
    DocumentHelper.prototype.initTouchEllipse = function () {
        ...
        this.touchStart = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-touch-ellipse', styles: style });
        var start = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { styles: ellipse });
        this.touchEnd = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { className: 'e-touch-ellipse', styles: style });
        this.touchStart.style.display = 'none';
        var end = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { styles: ellipse });
    ...
    DocumentHelper.prototype.updateTouchMarkPosition = function () {
        if (this.touchStart.style.display !== 'none' && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.selection)) {
    ...
    DocumentHelper.prototype.navigateToEndNote = function (inline, startPosition, endPosition) {
        ...
        while (pageIndex >= 0) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(endnotes)) {
                break;
            }
            for (var i = 0; i < endnotes.bodyWidgets.length; i++) {
                // check if the endNote reference isn't continued from the previous page
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(endnotes.bodyWidgets[i].previousSplitWidget)) {
    ...
    DocumentHelper.prototype.isSelectionInListText = function (cursorPoint) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget) && widget.children[0] instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ListTextElementBox */ .dJ) {
    ...
    DocumentHelper.prototype.isInShapeBorder = function (floatElement, cursorPoint) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(floatElement)) {
            ...
            if (this.isInsideRect(floatElement.x - floatElement.margin.left, floatElement.y - floatElement.margin.top, width, height, cursorPoint)) {
                ...
                if (floatElement instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ImageElementBox */ .Rt) {
                    return true;
                }
                else if (floatElement instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeElementBox */ .DE) {
                ...
                else if (floatElement instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .GroupShapeElementBox */ .YF) {
    ...
    DocumentHelper.prototype.getWidgetFromGroup = function (floatElement, cursorPoint) {
        ...
        for (var j = 0; j < floatElement.childWidgets.length; j++) {
            ...
            if (cursorPoint.x < childShapeElement.x + childShapeElement.margin.left + childShapeElement.width &&
                ...
                if (childShapeElement instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeElementBox */ .DE) {
                    widget = this.selection.getLineWidgetBodyWidget(childShapeElement.textFrame, cursorPoint);
                }
                else if (childShapeElement instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .GroupShapeElementBox */ .YF) {
    ...
    DocumentHelper.prototype.getLeftValue = function (widget) {
        ...
        if (this.selection.isParagraphFirstLine(widget)) {
            if (paragraphFormat.textAlignment === 'Right') {
                left -= _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(paragraphFormat.firstLineIndent);
                left -= _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(paragraphFormat.leftIndent);
            }
            else {
                left += _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(paragraphFormat.firstLineIndent);
            }
        ...
        if (element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ListTextElementBox */ .dJ) {
    ...
    DocumentHelper.prototype.updateSelectionOnTouch = function (point, touchPoint) {
        ...
        if (this.isMouseDown && !this.isSelectionChangedOnMouseMoved && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.currentPage) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.selectionModule.start)) {
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.currentSelectedComment) && this.owner.commentReviewPane
                && !this.owner.commentReviewPane.commentPane.isEditMode) {
                this.currentSelectedComment = undefined;
            }
            if (this.touchDownOnSelectionMark === 0) {
                this.updateTextPositionForSelection(new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(touchPoint.x, touchPoint.y), this.tapCount);
                if (this.tapCount === 2) {
    ...
    DocumentHelper.prototype.getTouchOffsetValue = function (event) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(touchOffsetValues)) {
        ...
        return new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(offsetX, offsetY);
    };
    /**
    ...
    DocumentHelper.prototype.removePage = function (page) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.viewer.visiblePages)) {
        ...
        if (index !== -1) {
            for (var i = index; i < this.pages.length; i++) {
                ...
                page = this.pages[i];
                page.boundingRectangle = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(page.boundingRectangle.x, top, page.boundingRectangle.width, page.boundingRectangle.height);
                top = page.boundingRectangle.bottom + 20;
                if (page.bodyWidgets.length > 0 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(page.bodyWidgets[0].firstChild) && !(page.bodyWidgets[0].firstChild instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR && page.bodyWidgets[0].firstChild.header)) {
    ...
    DocumentHelper.prototype.updateViewerSize = function () {
        ...
        if (this.owner.viewer instanceof WebLayoutViewer && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner)) && (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(element))) {
            if (this.resizerTimer) {
                clearTimeout(this.resizerTimer);
            }
            /* eslint-disable @typescript-eslint/indent */
            this.resizerTimer = setTimeout(function () {
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner)) {
                    var currentVisibleWidth = void 0;
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.visibleBounds)) {
                        currentVisibleWidth = _this.visibleBounds.width;
                    }
                    else {
                        currentVisibleWidth = 0;
                    }
                    if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.viewer.preVisibleWidth)) {
                        _this.owner.viewer.preVisibleWidth = 0;
                    }
                    if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.visibleBounds) && (currentVisibleWidth !== _this.owner.viewer.preVisibleWidth))) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.selection)) {
            this.selection.updateCaretPosition();
        }
    ...
    DocumentHelper.prototype.triggerAutoResizeInterval = function () {
        ...
        this.owner.notify(_base_index__WEBPACK_IMPORTED_MODULE_6__/* .beforeAutoResize */ .tM, args);
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(args.element)) {
            element = args.element;
        }
        element.style.visibility = 'hidden';
        (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_21__/* .showSpinner */ .xc)(element);
        var counter = 0;
        ...
        if (this.isAutoResizeCanStart) {
            timer = setInterval(function () {
                ...
                if (tempRect.width !== 0 && tempRect.height !== 0) {
                    ...
                    _this.owner.notify(_base_index__WEBPACK_IMPORTED_MODULE_6__/* .internalAutoResize */ .lB, args_1);
                    clearInterval(timer);
                    if (!args_1.cancel) {
                        _this.owner.resize();
                    }
                    (0,_syncfusion_ej2_popups__WEBPACK_IMPORTED_MODULE_21__/* .hideSpinner */ .W$)(element);
    ...
    DocumentHelper.prototype.updateViewerSizeInternal = function (element) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(element)) {
            ...
            this.visibleBoundsIn = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(0, 0, width, height);
    ...
    DocumentHelper.prototype.updateTextPositionForSelection = function (cursorPoint, tapCount) {
        ...
        if (tapCount > 1) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.currentPage) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.selectionModule.start)) {
                if (tapCount % 2 === 0) {
    ...
    DocumentHelper.prototype.getLineWidgetInternal = function (cursorPoint, isMouseDragged) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.currentPage)) {
            var childWidgets = void 0;
            if (this.owner.enableHeaderAndFooter) {
                var page = this.currentPage;
                var pageBottom = page.boundingRectangle.height;
                var headerHeight = Math.max((page.headerWidget.y + page.headerWidget.height), _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(page.bodyWidgets[0].sectionFormat.topMargin)) * this.zoomFactor;
                var footerDistance = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(page.bodyWidgets[0].sectionFormat.footerDistance);
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(childWidgets)) {
                    return undefined;
                }
                ...
                if (shapeElementInfo.isShapeSelected) {
                    ...
                    if (shapeElementInfo.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeElementBox */ .DE) {
                        widget = this.selection.getLineWidgetBodyWidget(shapeElementInfo.element.textFrame, cursorPoint);
                    }
                    else if (shapeElementInfo.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .GroupShapeElementBox */ .YF) {
                        ...
                        if (!isGroupChildShape) {
                            for (var i_1 = 0; i_1 < this.currentPage.bodyWidgets.length; i_1++) {
                                if (i_1 == this.currentPage.bodyWidgets.length - 1) {
                                    ...
                                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget) && widget.paragraph.y <= cursorPoint.y
                ...
                if (shapeInfo.isShapeSelected && !this.isEmptyShape(shapeInfo)) {
                    ...
                    if (shapeInfo.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeElementBox */ .DE) {
                        widget = this.selection.getLineWidgetBodyWidget(shapeInfo.element.textFrame, cursorPoint);
                    }
                    else if (shapeInfo.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .GroupShapeElementBox */ .YF) {
                    ...
                    if (this.selection.start.paragraph.bodyWidget.footNoteReference !== undefined && this.selection.start.paragraph.bodyWidget.containerWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .FootNoteWidget */ .tK && this.selection.start.paragraph.bodyWidget.containerWidget.footNoteType === 'Footnote') {
                        ...
                        this.selection.start.paragraph.bodyWidget.containerWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .FootNoteWidget */ .tK
                    ...
                    if (!isMouseDragged && this.currentPage.footnoteWidget && this.isInFootnoteWidget(this.currentPage.footnoteWidget, cursorPoint)) {
                        ...
                        for (var i_3 = 0; i_3 < this.currentPage.bodyWidgets.length; i_3++) {
                            ...
                            if (cursorPoint.x > bodyWidget_1.x + bodyWidget_1.width && this.layout.getNextWidgetHeight(bodyWidget_1) >= cursorPoint.y && bodyWidget_1.y <= cursorPoint.y) {
                                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bodyWidget_1.nextRenderedWidget) || !(this.layout.getNextWidgetHeight(bodyWidget_1.nextRenderedWidget) >= cursorPoint.y && bodyWidget_1.nextRenderedWidget.y <= cursorPoint.y)) {
                                    widget = this.selection.getLineWidgetBodyWidget(bodyWidget_1, cursorPoint, true);
                                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget) && widget.paragraph.y <= cursorPoint.y
                                        && (widget.paragraph.y + widget.paragraph.height) >= cursorPoint.y) {
                                        this.isFootnoteWidget = false;
                            ...
                            if (cursorPoint.x < bodyWidget_1.x && i_3 < this.currentPage.bodyWidgets.length - 1) {
                                ...
                                else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget) && i_3 === this.currentPage.bodyWidgets.length - 1) {
                                    this.isFootnoteWidget = false;
                                    break;
                                }
                            }
                    ...
                    if (inlineShapeInfo.isShapeSelected) {
                        ...
                        if (inlineShapeInfo.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeElementBox */ .DE) {
                            widget = this.selection.getLineWidgetBodyWidget(inlineShapeInfo.element.textFrame, cursorPoint);
                        }
                        else if (inlineShapeInfo.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .GroupShapeElementBox */ .YF) {
                        ...
                        if (behindShapeInfo.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeElementBox */ .DE) {
    ...
    DocumentHelper.prototype.checkInlineShapeItems = function (widget, cursorPoint, isMouseDragged) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget) && widget.children.length > 0) {
            if (isMouseDraggedInShape) {
                ...
                for (var i = 0; i < widget.children.length; i++) {
                    if (!((widget.children[i] instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeElementBox */ .DE || widget.children[i] instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .GroupShapeElementBox */ .YF) && widget.children[i].textWrappingStyle === 'Inline')) {
                        continue;
                    }
    ...
    DocumentHelper.prototype.checkPointIsInLine = function (widget, cursorPoint) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget) && widget.children.length > 0) {
            ...
            for (var i = widget.children.indexOf(widget.children[0]); i < widget.children.length; i++) {
                ...
                if (element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeBase */ .xp && element.textWrappingStyle !== 'Inline') {
                    continue;
                }
        ...
        else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget) && widget.children.length === 0) {
            var left = widget.paragraph.x;
    ...
    DocumentHelper.prototype.isInFootnoteWidget = function (footnoteWidget, point) {
        for (var i = 0; i < footnoteWidget.bodyWidgets.length; i++) {
            for (var j = 0; j < footnoteWidget.bodyWidgets[i].childWidgets.length; j++) {
                ...
                if (childWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .Widget */ .x0 && childWidget.y <= point.y
    ...
    DocumentHelper.prototype.checkFloatingItems = function (blockContainer, cursorPoint, isMouseDragged, isBehind) {
        ...
        if (blockContainer.floatingElements.length > 0) {
            ...
            blockContainer.floatingElements.sort(function (a, b) {
                if (a instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR || b instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR) {
                    return 0;
                }
                else {
            ...
            if (isMouseDraggedInShape) {
                ...
                for (var i = blockContainer.floatingElements.length - 1; i >= 0; i--) {
                    if (blockContainer.floatingElements[i] instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR
                        || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isBehind) && isBehind ? blockContainer.floatingElements[i].textWrappingStyle !== 'Behind' : blockContainer.floatingElements[i].textWrappingStyle === 'Behind')) {
                        continue;
                    }
    ...
    DocumentHelper.prototype.isBlockInHeader = function (block) {
        while (!(block.containerWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .HeaderFooterWidget */ .F3)) {
            if (!block.containerWidget) {
                return false;
            }
            block = block.containerWidget;
            if (block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFrame */ .j2) {
    ...
    DocumentHelper.prototype.removeEmptyPages = function (skipEndLayout) {
        ...
        for (var j = 0; j < this.pages.length; j++) {
            ...
            if (page.bodyWidgets.length <= 0) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(page.endnoteWidget) && page.endnoteWidget.bodyWidgets.length > 0) {
                    var endnote = page.endnoteWidget;
                    var previousPage = page.previousPage;
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(previousPage)) {
                        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(previousPage.endnoteWidget)) {
                            previousPage.endnoteWidget = new _page__WEBPACK_IMPORTED_MODULE_5__/* .FootNoteWidget */ .tK();
                ...
                if (this.pages.indexOf(page) !== -1 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pages[j])) {
                    this.removePage(this.pages[j]);
                }
                j--;
            }
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pages[pageIndex])) {
    ...
    DocumentHelper.prototype.getFieldResult = function (fieldBegin, page) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(page) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.selection) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(fieldBegin)) {
            ...
            switch (fieldCategory) {
                case 'page':
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(page.previousPage) && ((page.previousPage.bodyWidgets[0].sectionFormat.restartPageNumbering && page.previousPage.currentPageNum >= 1)
    ...
    DocumentHelper.prototype.isEmptyShape = function (shape) {
        var isEmpty = true;
        if (shape.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ImageElementBox */ .Rt) {
            return isEmpty;
        }
        if (shape.element instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .GroupShapeElementBox */ .YF) {
            ...
            if (childShape instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .GroupShapeElementBox */ .YF) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(childShape)) {
                return true;
            }
            if (shape.element.childWidgets.length === 0 || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(childShape.textFrame) || childShape.textFrame.childWidgets.length === 0) {
                return isEmpty;
            }
            else {
                return false;
    ...
    DocumentHelper.prototype.destroy = function () {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.render)) {
            this.render.destroy();
        }
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.touchStart)) {
            this.touchStart.innerHTML = '';
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.touchStart.parentElement)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.touchEnd)) {
            this.touchEnd.innerHTML = '';
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.touchEnd.parentElement)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.containerCanvasIn)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.containerCanvasIn.parentElement)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.selectionCanvasIn)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.selectionCanvasIn.parentElement)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.editableDiv)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.editableDiv.parentElement)) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pageContainer)) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pageContainer.parentElement)) {
                this.pageContainer.parentElement.removeChild(this.pageContainer);
            }
        }
        this.pageContainer = undefined;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.viewerContainer)) {
            this.viewerContainer.innerHTML = '';
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.viewerContainer.parentElement)) {
                this.viewerContainer.parentElement.removeChild(this.viewerContainer);
            }
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.iframe)) {
            this.iframe.innerHTML = '';
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.iframe.parentElement)) {
        ...
        if (this.optionsPaneContainer) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.optionsPaneContainer.parentElement)) {
    ...
    DocumentHelper.prototype.updateCursor = function (event) {
        ...
        var point = new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(event.offsetX, event.offsetY);
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget)) {
            ...
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(hyperlinkField) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(formField) && this.isDocumentProtected &&
            ...
            if (formField) {
                var isInlineFormFillMode = (formField.formFieldData instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFormField */ .uS) && formField.formFieldData.type === 'Text';
            ...
            if (this.owner.enableLockAndEdit) {
                ...
                pageWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(pageWidth) * this.zoomFactor;
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widget)) {
            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(footnoteElement) && this.owner.layoutType == 'Pages') {
                footnoteElement = this.selection.getFootNoteElementInCurrentSelection(widget, touchPoint);
                if (footnoteElement instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .FootnoteElementBox */ .gP) {
        ...
        if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(hyperlinkField) && (isCtrlkeyPressed &&
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(resizePosition) && resizePosition !== '') {
        ...
        else if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(widgetInfo) && widgetInfo.isImageSelected && left < touchPoint.x && top < touchPoint.y &&
    ...
    DocumentHelper.prototype.canRenderBorder = function (paragraph) {
        ...
        var nextBlockX = 0;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(previousBlock) && previousBlock instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D) {
            previousBlockX = this.getParagraphLeftPosition(previousBlock);
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(nextBlock) && nextBlock instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D) {
            nextBlockX = this.getParagraphLeftPosition(nextBlock);
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(previousBlock) && previousBlock instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D && paragraphX === previousBlockX) {
            ...
            if (isSameTopBorder && isSameBottomBorder && isSameLeftBorder && isSameRightBorder
                && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(previousBlock.paragraphFormat.borders.horizontal) && previousBlock.paragraphFormat.borders.horizontal.lineStyle === 'None') {
                skipTopBorder = true;
            }
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(nextBlock) && nextBlock instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D && (paragraphX === nextBlockX || (this.owner.documentHelper.layout.isInitialLoad && this.skipBottomBorder(paragraph, nextBlock)))) {
    ...
    DocumentHelper.prototype.checkEqualBorder = function (source, dest) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(source) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(dest)) {
    ...
    */
    DocumentHelper.prototype.getParagraphLeftPosition = function (paragraphWidget) {
        ...
        if (paragraphWidget.paragraphFormat.firstLineIndent < 0) {
            hangingIndent = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(Math.abs(paragraphWidget.paragraphFormat.firstLineIndent));
  ...
  */
    ...
    DocumentHelper.prototype.getFirstParagraphInCell = function (cell) {
        ...
        if (firstBlock instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D) {
            return firstBlock;
        }
        else {
    ...
    DocumentHelper.prototype.getFirstParagraphInFirstCell = function (table) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(table.childWidgets) && table.childWidgets.length > 0) {
    ...
    DocumentHelper.prototype.getFirstParagraphBlock = function (block) {
        if (block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D) {
            return block;
        }
        else if (block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR) {
    ...
    DocumentHelper.prototype.addToStylesMap = function (style) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(style)) {
            ...
            if (style.type == "Paragraph") {
                ...
                _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.writeParagraphFormat(returnStyleObject.paragraphFormat, true, style.paragraphFormat);
            }
            returnStyleObject.characterFormat = {};
            _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.writeCharacterFormat(returnStyleObject.characterFormat, true, style.characterFormat);
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(style.type)) {
                returnStyle.type = style.type;
                if (returnStyle.type == "Paragraph" && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(style.link)) {
    ...
    DocumentHelper.prototype.parseStyle = function (style) {
        ...
        var textDecoration = '';
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(styleObj.characterFormat.baselineAlignment) && styleObj.characterFormat.baselineAlignment !== 'Normal') {
            var vAlign = '';
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(styleObj.characterFormat.underline) && styleObj.characterFormat.underline !== 'None') {
            textDecoration += 'underline ';
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(styleObj.characterFormat.strikethrough) && styleObj.characterFormat.strikethrough !== 'None') {
            textDecoration += 'line-through ';
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(styleObj.characterFormat.fontSize)) {
            domStyle += 'font-size:' + styleObj.characterFormat.fontSize + 'px;';
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(styleObj.characterFormat.fontFamily)) {
            domStyle += 'font-family:' + styleObj.characterFormat.fontFamily + ';';
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(styleObj.characterFormat.bold) && styleObj.characterFormat.bold) {
            domStyle += 'font-weight:bold;';
        }
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(styleObj.characterFormat.italic) && styleObj.characterFormat.italic) {
    ...
    DocumentHelper.prototype.getNextValidElement = function (inline) {
        ...
        if (inline instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .BookmarkElementBox */ .yk && inline.bookmarkType === 1) {
            return inline;
        }
        while (inline instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .FieldElementBox */ .gQ) {
            if (inline.fieldType === 0 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(inline.fieldEnd)) {
                return (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(nextValidInline) ? inline : nextValidInline;
            }
            else if (inline.fieldType === 1 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(inline.fieldBegin)) {
    ...
    DocumentHelper.prototype.getNextValidElementForField = function (firstInline) {
        if (firstInline instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .FieldElementBox */ .gQ && firstInline.fieldType === 0
            && _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.isLinkedFieldCharacter(firstInline)) {
        ...
        var nextValidInline = undefined;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(firstInline.nextNode)) {
    ...
    DocumentHelper.prototype.combineSectionChild = function (bodyWidget, sections, destoryPage) {
        ...
        var temp = new _page__WEBPACK_IMPORTED_MODULE_5__/* .BodyWidget */ .v$();
        var emptyBody = false;
        ...
        do {
            ...
            for (var j = 0; j < previousBodyWidget.childWidgets.length; j++) {
                ...
                if (block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR) {
...
var LayoutViewer = /** @class */ (function () {
    function LayoutViewer(owner) {
         ...
         * @private
         */
        this.padding = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Padding */ .Yq(10, 10, 30, 10);
        /**
         * @private
         */
        this.textWrap = true;
    ...
    LayoutViewer.prototype.updateClientArea = function (bodyWidget, page, isReLayout) {
        ...
        if (this instanceof WebLayoutViewer) {
            ...
            this.clientArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.padding.left / this.documentHelper.zoomFactor, top_3, width, height);
            this.clientActiveArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.clientArea.x, this.clientArea.y, this.clientArea.width, this.clientArea.height);
        }
        else {
            var top_4 = 0;
            ...
            var bottomMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.bottomMargin);
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(sectionFormat)) {
                top_4 = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.topMargin);
                headerDistance = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.headerDistance);
                footerDistance = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.footerDistance);
            }
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(sectionFormat)) {
                width = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.pageWidth - sectionFormat.leftMargin - sectionFormat.rightMargin);
                height = pageHeight - top_4 - bottom;
            }
            if (width < 0) {
                width = 0;
            }
            var clientArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.leftMargin), top_4, width, pageHeight - top_4 - bottom);
    ...
    LayoutViewer.prototype.updateClientAreaForRow = function (row, beforeLayout) {
        ...
        if (beforeLayout) {
            ...
            this.clientActiveArea.x = this.clientArea.x = tableWidget.x;
            this.clientActiveArea.width = this.clientArea.width = tableWidget.width;
            this.clientArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.clientArea.x, this.clientArea.y, this.clientArea.width, this.clientArea.height);
            this.clientActiveArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.clientActiveArea.x, this.clientActiveArea.y, this.clientActiveArea.width, this.clientActiveArea.height);
        }
    };
    LayoutViewer.prototype.updateClientAreaForCell = function (cell, beforeLayout) {
        ...
        if (beforeLayout) {
            ...
            this.clientActiveArea.y = cellWidget.y - cellWidget.margin.top - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(cell.ownerTable.tableFormat.cellSpacing);
    ...
    LayoutViewer.prototype.updateClientAreaForTextBoxShape = function (textBox, beforeLayout, shiftNextWidget) {
        if (textBox.textWrappingStyle === 'Inline' && !shiftNextWidget && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textBox.containerShape)) {
            textBox.y = this.clientActiveArea.y;
            textBox.x = this.clientActiveArea.x;
        }
        if (beforeLayout) {
            var marginLeft = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(textBox.textFrame.marginLeft);
            var marginRight = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(textBox.textFrame.marginRight);
            var marginTop = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(textBox.textFrame.marginTop);
            var marginBottom = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(textBox.textFrame.marginBottom);
            var width = textBox.width;
            var height = Number.POSITIVE_INFINITY;
            this.clientArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(textBox.x + marginLeft, textBox.y + marginTop, width - marginLeft - marginRight, height - marginTop - marginBottom);
            this.clientActiveArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.clientArea.x, this.clientArea.y, this.clientArea.width, this.clientArea.height);
        }
    };
    ...
    LayoutViewer.prototype.updateClientAreaForTextWrap = function (area) {
        this.clientActiveArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(area.x, area.y, area.width, area.height);
    };
    ...
    LayoutViewer.prototype.updateClientAreaForBlock = function (block, beforeLayout, tableCollection, updateYPosition, updateXPosition) {
        var leftIndent = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(block.leftIndent);
        var rightIndent = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(block.rightIndent);
        var bidi = block.bidi;
        var width = 0;
        if (beforeLayout) {
            if (block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR && tableCollection) {
                ...
                if (block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(block.tableFormat)) {
                    ...
                    if (tableAlignment !== 'Left') {
                        ...
                        tableWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(block.tableHolder.getTotalWidth(0));
                        ...
                        if (this.owner.editorModule && this.owner.editorModule.tableResize.currentResizingTable === block
                            ...
                            tableWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(block.tableHolder.tableWidth);
                        }
                        ...
                        if (bidi) {
                            leftIndent = leftIndent - _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(block.leftIndent);
                ...
                width = this.clientArea.width - (leftIndent + _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(block.rightIndent));
                ...
                if (updateYPosition) {
                    this.updateParagraphYPositionBasedonTextWrap(block, new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.clientActiveArea.x, this.clientActiveArea.y, this.clientActiveArea.width, this.clientActiveArea.height));
                }
                if (updateXPosition) {
                    if (block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D) {
    ...
    LayoutViewer.prototype.updateParagraphYPositionBasedonTextWrap = function (block, rect) {
        ...
        if (bodyWidget && bodyWidget.floatingElements.length > 0 && block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D && !(block.containerWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFrame */ .j2)
            && !block.isInsideTable && !(block.containerWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .FootNoteWidget */ .tK)) {
            ...
            if (((!paragraph.isInHeaderFooter || paragraph.isInsideTable)
                ...
                if (previousItem && (previousItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR) && previousItem.wrapTextAround
                ...
                for (var i = 0; i < bodyWidget.floatingElements.length; i++) {
                    ...
                    if (floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ShapeBase */ .xp) {
                        isInsideHeaderFooter = floatingItem.paragraph.isInHeaderFooter;
                    }
                    else {
                        isInsideHeaderFooter = floatingItem.bodyWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .HeaderFooterWidget */ .F3 ? true : false;
                    }
                    if (paragraph.isInsideTable) {
                        if (floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR && !floatingItem.isInsideTable) {
                            continue;
                        }
                    }
                    var textWrappingBounds = this.getTextWrappingBound(floatingItem);
                    var textWrappingStyle = floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR ? 'Square' : floatingItem.textWrappingStyle;
                    var textWrappingType = floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR ? 'Both' : floatingItem.textWrappingType;
                    ...
                    if (!(clientLayoutArea.x > (textWrappingBounds.right + minimumWidthRequired) || clientLayoutArea.right < textWrappingBounds.x - minimumWidthRequired)) {
                        if ((((rect.y + (floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR && !isEmptyPara && paragraph.floatingElements.length === 0 ? paragraphHeight : paragraph.height) > textWrappingBounds.y
                            ...
                            var rightIndent = 0;
                            var paragarphRightIndent = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(paragraph.paragraphFormat.rightIndent);
                            ...
                            if (rect.x < textWrappingBounds.x && rect.x > textWrappingBounds.x && textWrappingType !== 'Left') {
                                ...
                                if (rect.width < minimumWidthRequired) {
                                    ...
                                    if (isWord2013 || !((floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR) && previousItem === floatingItem)) {
                                ...
                                if (rect.width < minimumWidthRequired || isFirstItemBottomPositionUpdated) {
                                    ...
                                    if (rect.width < minimumWidthRequired || isFirstItemBottomPositionUpdated) {
                                        ...
                                        if (this.clientActiveArea.x + minimumWidthRequired < textWrappingBounds.x) {
                                            ...
                                            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(tempBounds) && tempBounds.bottom <= textWrappingBounds.bottom) {
                                        ...
                                        if ((isWord2013) && !isPositionsUpdated) {
                                            if (floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR && previousItem === floatingItem) {
                            ...
                            if (isWord2013 || !((floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR) && previousItem === floatingItem)) {
                                ...
                                if (this.documentHelper.compatibilityMode === 'Word2007' && isEmptyPara && !paragraph.bidi &&
                                    !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(paragraph.paragraphFormat) && paragraph.paragraphFormat.textAlignment !== 'Left'
    ...
    LayoutViewer.prototype.updateParagraphXPositionBasedOnTextWrap = function (block) {
        ...
        //     isFirstItem = true;
        // }
        if (this instanceof PageLayoutViewer && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bodyWidget) && block instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bodyWidget.page) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bodyWidget.page.headerWidget)) {
            var floatingItems = bodyWidget.page.headerWidget.floatingElements;
            if (floatingItems.length > 0 &&
                (!block.isInHeaderFooter || block.isInsideTable ||
                    isWord2013) &&
                !(block.containerWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .FootNoteWidget */ .tK) && !(block.bodyWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFrame */ .j2)) {
                ...
                for (var i = 0; i < floatingItems.length; i++) {
                    ...
                    if (!paragraph.isInsideTable &&
                        ...
                        if (floatingItems.length > 0 &&
                            ...
                            textWrappingStyle !== "Behind") {
                            var rightIndent = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(paragraph.paragraphFormat.rightIndent);
    ...
    LayoutViewer.prototype.updateTableXPositionBasedOnTextWrap = function (block) {
        ...
        var firstRowWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(block.childWidgets[0].getFirstRowWidth());
        var bodyWidget = block.bodyWidget;
        if (this instanceof PageLayoutViewer && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bodyWidget) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bodyWidget.page) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(bodyWidget.page.headerWidget)) {
            var floatingItems = bodyWidget.page.headerWidget.floatingElements;
            // textwrap
            ...
            if (floatingItems.length > 0 && (!block.isInHeaderFooter || !block.isInsideTable || this.documentHelper.compatibilityMode === 'Word2013')
                && !(block.containerWidget instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TextFrame */ .j2)) {
                ...
                for (var i = 0; i < floatingItems.length; i++) {
                    ...
                    var textWrappingBounds = this.getTextWrappingBound(floatingItem);
                    var textWrappingStyle = floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR ? 'Square' : floatingItem.textWrappingStyle;
                    var allowOverlap = floatingItem instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR ? floatingItem.positioning.allowOverlap : floatingItem.allowOverlap;
                    ...
                    var rowHeight = block.childWidgets[0] instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableRowWidget */ .np ? block.childWidgets[0].height : 0;
                    if (rowHeight > height) {
                        height = rowHeight;
                    }
                    var width = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(block.getTableClientWidth(block.getContainerWidth()));
    ...
    LayoutViewer.prototype.getIntersectingItemBounds = function (floatingElements, intersectedfloatingItem, yPosition) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(floatingItem)) {
    ...
    LayoutViewer.prototype.getTextWrappingBound = function (floatingItem) {
        ...
        var textWrappingBounds = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(floatingItem.x - distanceLeft, floatingItem.y - distanceTop, width + distanceLeft + distanceRight, floatingItem.height + distanceTop + distanceBottom);
    ...
    LayoutViewer.prototype.findFocusedPage = function (currentPoint, updateCurrentPage, updateHeaderFooterPage) {
        var point = new _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .Point */ .bR(currentPoint.x, currentPoint.y);
    ...
    LayoutViewer.prototype.renderVisiblePages = function () {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.visiblePages) || this.visiblePages.length < 1) {
            return;
        }
    ...
    LayoutViewer.prototype.handleZoom = function () {
        ...
        if (this.documentHelper.selection && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.documentHelper.zoomX && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.documentHelper.zoomY))) {
            var x = 0;
            var y = 0;
        ...
        if (height > 0) {
            ...
            if (this.visiblePages.length > 0) {
                ...
                if (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX) {
        ...
        if (horWidth > 0) {
            ...
            if (this.visiblePages.length > 0) {
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(zoomX)) {
...
var PageLayoutViewer = /** @class */ (function (_super) {
    ...
    PageLayoutViewer.prototype.createNewPage = function (section, index) {
        ...
        var page = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Page */ .YW(this.documentHelper);
    ...
    PageLayoutViewer.prototype.updatePageBoundingRectangle = function (section, page, yPosition) {
        //page.viewer = this;
        var pageWidth = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(section.sectionFormat) ? _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(section.sectionFormat.pageWidth) : 816;
        var pageHeight = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(section.sectionFormat) ? _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(section.sectionFormat.pageHeight) : 1056;
        var xPos = (this.documentHelper.visibleBounds.width - pageWidth * this.documentHelper.zoomFactor) / 2;
        if (xPos < this.pageLeft) {
            xPos = this.pageLeft;
        }
        page.boundingRectangle = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(xPos, yPosition, pageWidth, pageHeight);
    };
    PageLayoutViewer.prototype.onPageFitTypeChanged = function (pageFitType) {
        ...
        var pageWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(section.sectionFormat.pageWidth);
            ...
            case 'FitOnePage':
                if (height > 0 && pageHeight > 0) {
                    ...
                    if (zoomFactor === this.documentHelper.zoomFactor) {
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.selectionModule) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.selectionModule.start) &&
                            !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.selectionModule.end)) {
    ...
    PageLayoutViewer.prototype.getHeaderFooterType = function (section, isHeader) {
        ...
        if (section.sectionFormat.differentFirstPage && ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(page.previousPage) || (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(page.previousPage) && page.sectionIndex !== page.previousPage.sectionIndex && page.previousPage.bodyWidgets[page.previousPage.bodyWidgets.length - 1].sectionIndex !== page.bodyWidgets[0].sectionIndex))) {
    ...
    PageLayoutViewer.prototype.createHeaderFooterWidget = function (type) {
        var headerFooter = new _page__WEBPACK_IMPORTED_MODULE_5__/* .HeaderFooterWidget */ .F3(type);
        var paragraph = new _page__WEBPACK_IMPORTED_MODULE_5__/* .ParagraphWidget */ .$D();
        paragraph.childWidgets.push(new _page__WEBPACK_IMPORTED_MODULE_5__/* .LineWidget */ .V9(paragraph));
        var style;
    ...
    PageLayoutViewer.prototype.updateHFClientArea = function (sectionFormat, isHeader) {
        var width = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.pageWidth - sectionFormat.leftMargin - sectionFormat.rightMargin);
        if (width < 0) {
            width = 0;
        }
        if (isHeader) {
            this.clientArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.leftMargin), _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.headerDistance), width, Number.POSITIVE_INFINITY);
        }
        else {
            this.clientArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.leftMargin), _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.pageHeight - sectionFormat.footerDistance), width, Number.POSITIVE_INFINITY);
        }
        this.clientActiveArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.clientArea.x, this.clientArea.y, this.clientArea.width, this.clientArea.height);
    };
    ...
    PageLayoutViewer.prototype.updateFootnoteClientArea = function (sectionFormat, footnote, footNoteType, para) {
        var width = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.pageWidth - sectionFormat.leftMargin - sectionFormat.rightMargin);
        var left = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.leftMargin);
        var bottomMargin = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.bottomMargin);
        ...
        var top = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.pageHeight) - Math.max(footerDistance + footnote.page.footerWidget.height, bottomMargin);
        this.clientArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(left, top, width, Number.POSITIVE_INFINITY);
        this.clientActiveArea = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.clientArea.x, this.clientArea.y, this.clientArea.width, Number.POSITIVE_INFINITY);
    };
    ...
    PageLayoutViewer.prototype.updateScrollBars = function () {
        ...
        for (var i = 0; i < this.documentHelper.pages.length; i++) {
            ...
            if (left > this.pageLeft) {
                this.documentHelper.pages[i].boundingRectangle = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(left, this.documentHelper.pages[i].boundingRectangle.y, this.documentHelper.pages[i].boundingRectangle.width, this.documentHelper.pages[i].boundingRectangle.height);
            }
            else {
                this.documentHelper.pages[i].boundingRectangle = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(this.pageLeft, this.documentHelper.pages[i].boundingRectangle.y, this.documentHelper.pages[i].boundingRectangle.width, this.documentHelper.pages[i].boundingRectangle.height);
            }
        }
    ...
    PageLayoutViewer.prototype.addVisiblePage = function (page, x, y) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pictureElement) && pictureElement.style.display !== 'none') {
        ...
        if (this.documentHelper.owner.isSpellCheck && this.documentHelper.owner.spellCheckerModule.enableOptimizedSpellCheck && (this.owner.documentHelper.triggerElementsOnLoading || this.owner.documentHelper.isScrollHandler) && (this.documentHelper.cachedPages.indexOf(page.index) < 0 || this.owner.editorModule.isPasteContentCheck)) {
            ...
            if (this.owner.editorModule.isPasteContentCheck) {
                content = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.editorModule.copiedTextContent) ? this.owner.editorModule.copiedTextContent : '';
            }
            else {
            ...
            if (content.trim().length > 0) {
                ...
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.spellCheckerModule)) {
                    this.owner.spellCheckerModule.updateUniqueWords(_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.getSpellCheckData(content));
                }
                /* eslint-disable @typescript-eslint/no-explicit-any */
                this.owner.spellCheckerModule.callSpellChecker(this.owner.spellCheckerModule.languageID, content, true, false, false, true).then(function (data) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner)) {
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.spellCheckerModule)) {
                        ...
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.documentHelper)) {
...
var WebLayoutViewer = /** @class */ (function (_super) {
    ...
    WebLayoutViewer.prototype.createNewPage = function (section, index) {
        ...
        page = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Page */ .YW(this.documentHelper);
        if (this.documentHelper.pages.length === 0) {
            page.boundingRectangle = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(x, yPos, this.documentHelper.visibleBounds.width, this.documentHelper.visibleBounds.height);
        }
        else {
            page.boundingRectangle = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(x, yPos - 20, this.documentHelper.visibleBounds.width, this.documentHelper.visibleBounds.height);
        }
        this.documentHelper.pages.push(page);
    ...
    WebLayoutViewer.prototype.getContentWidth = function () {
        ...
        for (var i = 0; i < this.documentHelper.pages.length; i++) {
            ...
            for (var j = 0; j < page.bodyWidgets[0].childWidgets.length; j++) {
                if (page.bodyWidgets[0].childWidgets[j] instanceof _page__WEBPACK_IMPORTED_MODULE_5__/* .TableWidget */ .ZR) {
                    var tableWidget = page.bodyWidgets[0].childWidgets[j];
                    var tableWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(tableWidget.getTableWidth()) *
    ...
    WebLayoutViewer.prototype.addVisiblePage = function (page, x, y) {
        ...
        if (this.documentHelper.owner.isSpellCheck && this.documentHelper.owner.spellCheckerModule.enableOptimizedSpellCheck && (this.owner.documentHelper.triggerElementsOnLoading || this.owner.documentHelper.isScrollHandler) && (this.documentHelper.cachedPages.indexOf(page.index) < 0 || this.owner.editorModule.isPasteContentCheck)) {
            ...
            if (this.owner.editorModule.isPasteContentCheck) {
                contentlen = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.editorModule.copiedTextContent) ? this.owner.editorModule.copiedTextContent : '';
            }
            else {
            ...
            if (contentlen.trim().length > 0) {
                page.allowNextPageRendering = false;
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.owner.spellCheckerModule)) {
                    this.owner.spellCheckerModule.updateUniqueWords(_editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.getSpellCheckData(contentlen));
                }
                /* eslint-disable @typescript-eslint/no-explicit-any */
                this.owner.spellCheckerModule.callSpellChecker(this.owner.spellCheckerModule.languageID, contentlen, true, false, false, true).then(function (data) {
                    ...
                    if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner)) {
                        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(_this.owner.spellCheckerModule)) {
...
var ColumnLayout = /** @class */ (function () {
    ...
    Object.defineProperty(ColumnLayout.prototype, "columnCount", {
        get: function () {
            var colCount;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.columnIn)) {
    ...
    ColumnLayout.prototype.setColumns = function (sectionFormat) {
        this.pageWidth = _editor_editor_helper__WEBPACK_IMPORTED_MODULE_3__/* .HelperMethods */ .LD.convertPointToPixel(sectionFormat.pageWidth - sectionFormat.leftMargin - sectionFormat.rightMargin);
        this.numberOfColumnsIn = sectionFormat.numberOfColumns;
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(sectionFormat.columns)) {
            var columns = sectionFormat.columns;
            var columnList = [];
            for (var i = 0; i < sectionFormat.numberOfColumns; i++) {
                var space = this.defaultSpaceIn;
                var width = 0;
                if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(columns) && columns.length > 0) {
    ...
    ColumnLayout.prototype.getColumnByIndex = function (index) {
        if (index >= 0 && index < this.columnCount && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.columnIn) && this.columnIn.length > 0) {
    ...
    ColumnLayout.prototype.getColumnObj = function (colWidth, colSpace, noOfCols, isEqualWidth) {
        ...
        var colObj = new _format_index__WEBPACK_IMPORTED_MODULE_12__/* .WColumnFormat */ .f();
        if ((isEqualWidth || colWidth === 0) && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pageWidth)) {
    ...
    ColumnLayout.prototype.getColumnBoundsByIndex = function (colIndex, clientArea) {
        var colRect = new _page__WEBPACK_IMPORTED_MODULE_5__/* .Rect */ .rw(clientArea.x, clientArea.y, clientArea.width, clientArea.height);
        if (colIndex >= 0 && this.columnIn.length > 0) {
            var curColumn = void 0;
            var prevColumn = void 0;
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.columnIn[colIndex])) {
...
//# sourceMappingURL=a12f2e73-c6917f7ea0c9b86d.js.map