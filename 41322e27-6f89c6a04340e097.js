...
/* harmony export */   i: () => (/* binding */ TextSearch)
/* harmony export */ });
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6841);
/* harmony import */ var _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(57266);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(39854);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(50474);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15050);
/* harmony import */ var _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(75443);
/* harmony import */ var _syncfusion_ej2_dropdowns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32177);
...
var TextSearch = /** @class */ (function () {
    ...
    TextSearch.prototype.createTextSearchBox = function () {
        var _this = this;
        this.searchBox = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + '_search_box', className: 'e-pv-text-search-bar' });
        var toolbarElement;
        ...
        var searchElementsContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + '_search_box_elements', className: 'e-pv-text-search-bar-elements' });
        this.searchInputContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + '_search_input_container', className: 'e-input-group e-pv-text-search-input' });
        this.searchInput = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { id: this.pdfViewer.element.id + '_search_input', className: 'e-input e-pv-search-input-ele' });
        var tempData = {
            matches: [
                { 'SearchString': '', 'Count': '' }
            ]
        ...
        var isFirst = false;
        this.searchAutocompleteObj = new _syncfusion_ej2_dropdowns__WEBPACK_IMPORTED_MODULE_1__/* .AutoComplete */ .j({
        ...
        this.searchBtn = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { id: this.pdfViewer.element.id + '_search_box-icon', className: 'e-input-group-icon e-input-search-group-icon e-pv-search-icon' });
        ...
        this.searchCountEle = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { id: this.pdfViewer.element.id + '_search_count', className: 'e-pv-search-count', innerHTML: '' });
        ...
        var matchCaseContainer = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + '_match_case_container', className: 'e-pv-textsearch-match-case-container' });
        var matchCaseInput = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { id: this.pdfViewer.element.id + '_match_case' });
        ...
        var matchAnyWordInput = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('input', { id: this.pdfViewer.element.id + '_match_any_word' });
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isBlazor */ .Z4)()) {
            var matchCaseText_1 = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { id: this.pdfViewer.element.id + '_search_box_text', styles: 'position: absolute; padding-top: 3px; padding-left: 8px; padding-right: 8px; font-size: 13px' });
            ...
            var checkBox = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_2__/* .CheckBox */ .o({ cssClass: 'e-pv-match-case', label: this.pdfViewer.localeObj.getConstant('Match case'), htmlAttributes: { 'tabindex': '0' }, change: this.checkBoxOnChange.bind(this) });
            checkBox.appendTo(matchCaseInput);
            this.matchAnyWordCheckBox = new _syncfusion_ej2_buttons__WEBPACK_IMPORTED_MODULE_2__/* .CheckBox */ .o({
        ...
        var waitingPopup = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + '_textSearchLoadingIndicator' });
        ...
        (0,_index__WEBPACK_IMPORTED_MODULE_3__/* .createSpinner */ .GF)({ target: waitingPopup, cssClass: 'e-spin-center' });
    ...
    TextSearch.prototype.showLoadingIndicator = function (isShow) {
        ...
        if (waitingPopup) {
            if (isShow) {
                (0,_index__WEBPACK_IMPORTED_MODULE_3__/* .showSpinner */ .xc)(waitingPopup);
            }
            else {
                (0,_index__WEBPACK_IMPORTED_MODULE_3__/* .hideSpinner */ .W$)(waitingPopup);
            }
        }
    };
    TextSearch.prototype.textSearchWhileLoading = function (searchWord, isMatchCase, startIndex, endIndex, isFirstResult, isCompleted) {
        ...
        if (this.pdfViewerBase.clientSideRendering) {
            this.pdfViewerBase.pdfViewerRunner.addTask({
                ...
                isRequestsend: !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isFirstResult) ? isFirstResult : false
            }, _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_5__/* .TaskPriorityLevel */ .sA.Medium);
        }
    };
    /**
    ...
    TextSearch.prototype.hightlightSearchedTexts = function (pageNumber, isPageChange, isSearchCompleted) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pageNumber)) {
                ...
                for (var boundsKey in value.Bounds) {
                    if (Object.prototype.hasOwnProperty.call(value.Bounds, boundsKey)) {
                        ...
                        for (var i = 0; i < bounds.length; i++) {
                            ...
                            var pageIndex = null;
                            if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isSearchCompleted)) {
                            ...
                            if ((this.searchIndex === idSearchIndexCount) && pageIndex === Number(key)) {
                                ...
                                if ((!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPageChange) && !isPageChange) || (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(isPageChange)) {
    ...
    TextSearch.prototype.showSearchBox = function (isShow) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.searchBox)) {
            if (isShow) {
    ...
    TextSearch.prototype.calculateSearchCount = function (inputString, documentTextCollection) {
        ...
        for (var i = 0; i < documentTextCollection.length; i++) {
            ...
            if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(words)) {
    ...
    TextSearch.prototype.initiateTextSearch = function (inputString, isMobileSearch) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.documentTextCollection) && this.documentTextCollection.length !== this.pdfViewerBase.pageCount) {
        ...
        if (this.pdfViewer.enableHtmlSanitizer && typeof inputString === 'string') {
            inputString = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(inputString);
        }
    ...
    TextSearch.prototype.handleSearchAfterTextCollectionReady = function (inputString, isMobileSearch) {
        ...
        if (inputString !== '' && !this.isMultiSearch && this.isSingleSearch && this.searchCount > 0) {
            ...
            else if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.searchMatches[this.searchPageIndex]) && inputString === this.searchString) {
                this.initSearch(this.searchPageIndex, false);
            }
            else {
    ...
    TextSearch.prototype.initiateSearch = function (inputString, isMobileSearch) {
        ...
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.intervalId)) {
    ...
    TextSearch.prototype.isScrollPages = function (childEle) {
        ...
        var toolbarHeight = (this.pdfViewer.enableToolbar && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.pdfViewer.toolbarModule))
    ...
    TextSearch.prototype.initSearch = function (pageIndex, isSinglePageSearch, isCount) {
        ...
        if (isCount) {
            ...
            if (storedData) {
                ...
                if (!isSinglePageSearch && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pageIndex)) {
        ...
        if (this.searchMatches && this.searchMatches[parseInt(pageIndex.toString(), 10)] &&
            ...
            if (!isSinglePageSearch) {
                ...
                if (this.searchedPages.indexOf(this.searchPageIndex) === -1 && this.searchedPages.length !== this.pdfViewerBase.pageCount) {
                    ...
                    if (this.searchMatches && (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.searchMatches[this.searchPageIndex]) &&
                        this.searchedPages.length === this.pdfViewerBase.pageCount) {
                        if (!this.isMessagePopupOpened) {
                            this.onMessageBoxOpen();
                        }
    ...
    TextSearch.prototype.highlightSearchedTexts = function (pageIndex, isSinglePageSearch, ArrayReturns) {
        ...
        if (characterBounds && matches !== undefined) {
            for (var i = 0; i < matches.length; i++) {
                ...
                if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(matches[parseInt(i.toString(), 10)].length)) {
    ...
    TextSearch.prototype.addDivForSearch = function (index, pageIndex, characterBounds, queryLength, className, nestedIndex) {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(textLayer) && className === 'e-pv-search-text-highlight') {
    ...
    TextSearch.prototype.createSearchTextDiv = function (index, pageIndex, height, width, top, left, className, isContinuation, divCount, nestedIndex, charRotation) {
        ...
        if (nestedIndex !== undefined && this.pdfViewerBase.getElement(idString) && !nestedElement[parseInt(nestedIndex.toString(), 10)]) {
            var textDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + idString + '_' + nestedIndex });
        ...
        if (!this.pdfViewerBase.getElement(idString)) {
            var textDiv = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('div', { id: this.pdfViewer.element.id + idString });
            var pageDetails = this.pdfViewerBase.pageSize[parseInt(pageIndex.toString(), 10)];
    ...
    TextSearch.prototype.createRequestForSearch = function (pageIndex) {
        ...
        var _loop_1 = function (x) {
            var _loop_2 = function (y) {
                ...
                this_1.searchRequestHandler = new _index__WEBPACK_IMPORTED_MODULE_4__/* .AjaxHandler */ .$(this_1.pdfViewer);
                ...
                if (this_1.pdfViewerBase.clientSideRendering) {
                    ...
                    var cropBoxRect = new _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__/* .Rect */ .r(0, 0, 0, 0);
                    var mediaBoxRect = new _syncfusion_ej2_drawings__WEBPACK_IMPORTED_MODULE_6__/* .Rect */ .r(0, 0, 0, 0);
    ...
    TextSearch.prototype.searchRequestOnSuccess = function (data, proxy, viewPortWidth, pageWidth, isTileRendering, pageIndex, x, y, noTileX, noTileY) {
        if (!(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(data.pageText) && data.uniqueId === proxy.pdfViewerBase.documentId) {
            this.getSearchCountText();
    ...
    TextSearch.prototype.createRequestForGetPdfTexts = function (startIndex, endIndex) {
        ...
        this.searchRequestHandler = new _index__WEBPACK_IMPORTED_MODULE_4__/* .AjaxHandler */ .$(this.pdfViewer);
    ...
    TextSearch.prototype.createSearchBoxButtons = function (id, className) {
        var button = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('button', { id: this.pdfViewer.element.id + '_' + id, className: 'e-btn e-icon-btn e-pv-text-search-btn ' + className });
        button.setAttribute('type', 'button');
        var iconSpan = (0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .createElement */ .n)('span', { id: this.pdfViewer.element.id + '_' + id + 'Icon', className: 'e-pv-icon-search ' + className + '-icon' });
    ...
    TextSearch.prototype.updateSearchInputIcon = function (isEnable) {
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isBlazor */ .Z4)()) {
            if (this.searchBtn && (_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .Browser */ .Pw.isDevice && !this.pdfViewer.enableDesktopMode)) {
    ...
    TextSearch.prototype.onMessageBoxOpen = function () {
        ...
        if ((0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(this.searchPageIndex)) {
    ...
    TextSearch.prototype.searchText = function (searchText, isMatchCase) {
        ...
        if (this.isDocumentTextCollectionReady) {
            ...
            if (this.pdfViewer.enableHtmlSanitizer && searchText) {
                searchText = _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .SanitizeHtmlHelper */ .r4.sanitize(searchText);
            }
    ...
    TextSearch.prototype.findText = function (searchText, isMatchCase, pageIndex) {
        ...
        var searchResults = {};
        var startIndex = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pageIndex) ? pageIndex : 0;
        var endIndex = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pageIndex) ? pageIndex + 1 : this.documentTextCollection.length;
        ...
        var findTextResult = [];
        if (documentTextCollection && documentTextCollection.TextData.length > 0 && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pageIndex)) {
    ...
    TextSearch.prototype.findTextAsync = function (searchText, isMatchCase, pageIndex) {
        ...
        var endIndex = !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(pageIndex) ? pageIndex + 1 : this.pdfViewerBase.pageCount;
        var jsonObject = { pageStartIndex: startIndex, pageEndIndex: endIndex, documentId: proxy.pdfViewerBase.getDocumentId(), hashId: proxy.pdfViewerBase.hashId, action: 'RenderPdfTexts', elementId: proxy.pdfViewer.element.id, uniqueId: proxy.pdfViewerBase.documentId };
        if (this.pdfViewerBase.jsonDocumentId) {
            jsonObject.documentId = this.pdfViewerBase.jsonDocumentId;
        }
        var requestType = 'pdfTextSearchRequest';
        if (this.pdfViewer.extractTextOption === _index__WEBPACK_IMPORTED_MODULE_7__/* .ExtractTextOption */ .EH.None ||
            this.pdfViewer.extractTextOption === _index__WEBPACK_IMPORTED_MODULE_7__/* .ExtractTextOption */ .EH.TextOnly) {
            return new Promise(function (resolve, reject) {
                ...
                var msg = 'extractText_' + _base_pdfviewer_utlis__WEBPACK_IMPORTED_MODULE_5__/* .PdfViewerUtils */ .A9.createGUID();
    ...
    TextSearch.prototype.calculateTextBounds = function (searchText, matchIndex, characterBounds, pageIndex) {
        ...
        for (var i = 0; i < matchIndex.length; i++) {
            ...
            for (var k = 0; k < textLength; k++) {
                var index = matchIndex && !(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_0__/* .isNullOrUndefined */ .hX)(matchIndex.length) && matchIndex.length > 1 ?
...
//# sourceMappingURL=41322e27-6f89c6a04340e097.js.map