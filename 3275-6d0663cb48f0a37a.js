"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[3275],{
...
/* harmony export */ });
/* harmony import */ var _focusManager_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(56195);
/* harmony import */ var _notifyManager_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(74268);
/* harmony import */ var _query_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(31668);
/* harmony import */ var _subscribable_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38445);
/* harmony import */ var _thenable_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(83515);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34049);
...
var QueryObserver = class extends _subscribable_js__WEBPACK_IMPORTED_MODULE_0__/* .Subscribable */ .Q {
  constructor(client, options) {
    ...
    this.#currentThenable = (0,_thenable_js__WEBPACK_IMPORTED_MODULE_1__/* .pendingThenable */ .T)();
    this.bindMethods();
  ...
  setOptions(options) {
    ...
    if (this.options.enabled !== void 0 && typeof this.options.enabled !== "boolean" && typeof this.options.enabled !== "function" && typeof (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(this.options.enabled, this.#currentQuery) !== "boolean") {
      throw new Error(
    ...
    if (prevOptions._defaulted && !(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .shallowEqualObjects */ .f8)(this.options, prevOptions)) {
    ...
    this.updateResult();
    if (mounted && (this.#currentQuery !== prevQuery || (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(this.options.enabled, this.#currentQuery) !== (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(prevOptions.enabled, this.#currentQuery) || (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveStaleTime */ .d2)(this.options.staleTime, this.#currentQuery) !== (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveStaleTime */ .d2)(prevOptions.staleTime, this.#currentQuery))) {
      this.#updateStaleTimeout();
    }
    const nextRefetchInterval = this.#computeRefetchInterval();
    if (mounted && (this.#currentQuery !== prevQuery || (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(this.options.enabled, this.#currentQuery) !== (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(prevOptions.enabled, this.#currentQuery) || nextRefetchInterval !== this.#currentRefetchInterval)) {
  ...
  #executeFetch(fetchOptions) {
    ...
    if (!fetchOptions?.throwOnError) {
      promise = promise.catch(_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .noop */ .lQ);
    }
    return promise;
  }
  #updateStaleTimeout() {
    this.#clearStaleTimeout();
    const staleTime = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveStaleTime */ .d2)(
      this.options.staleTime,
      this.#currentQuery
    );
    if (_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .isServer */ .S$ || this.#currentResult.isStale || !(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .isValidTimeout */ .gn)(staleTime)) {
      return;
    }
    const time = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .timeUntilStale */ .j3)(this.#currentResult.dataUpdatedAt, staleTime);
  ...
  #updateRefetchInterval(nextInterval) {
    ...
    if (_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .isServer */ .S$ || (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(this.options.enabled, this.#currentQuery) === false || !(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .isValidTimeout */ .gn)(this.#currentRefetchInterval) || this.#currentRefetchInterval === 0) {
      return;
    }
    this.#refetchIntervalId = setInterval(() => {
      if (this.options.refetchIntervalInBackground || _focusManager_js__WEBPACK_IMPORTED_MODULE_3__/* .focusManager */ .m.isFocused()) {
        this.#executeFetch();
      }
  ...
  createResult(query, options) {
    ...
    if (options._optimisticResults) {
      ...
      if (fetchOnMount || fetchOptionally) {
        newState = {
          ...newState,
          ...(0,_query_js__WEBPACK_IMPORTED_MODULE_4__/* .fetchState */ .k)(state.data, query.options)
        };
      }
    ...
    if (options.placeholderData !== void 0 && data === void 0 && status === "pending") {
      ...
      if (placeholderData !== void 0) {
        status = "success";
        data = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .replaceData */ .pl)(
          prevResult?.data,
          placeholderData,
          options
        );
    ...
    if (options.select && data !== void 0 && !skipSelect) {
      if (prevResult && data === prevResultState?.data && options.select === this.#selectFn) {
        ...
        try {
          ...
          data = (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .replaceData */ .pl)(prevResult?.data, data, options);
    ...
    const result = {
      ...
      isEnabled: (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(options.enabled, query) !== false
    };
    ...
    if (this.options.experimental_prefetchInRender) {
      ...
      const recreateThenable = () => {
        const pending = this.#currentThenable = nextResult.promise = (0,_thenable_js__WEBPACK_IMPORTED_MODULE_1__/* .pendingThenable */ .T)();
  ...
  updateResult() {
    ...
    if ((0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .shallowEqualObjects */ .f8)(nextResult, prevResult)) {
      return;
    }
...
function shouldLoadOnMount(query, options) {
  return (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(options.enabled, query) !== false && query.state.data === void 0 && !(query.state.status === "error" && options.retryOnMount === false);
}
function shouldFetchOnMount(query, options) {
  return shouldLoadOnMount(query, options) || query.state.data !== void 0 && shouldFetchOn(query, options, options.refetchOnMount);
}
function shouldFetchOn(query, options, field) {
  if ((0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(options.enabled, query) !== false && (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveStaleTime */ .d2)(options.staleTime, query) !== "static") {
...
function shouldFetchOptionally(query, prevQuery, options, prevOptions) {
  return (query !== prevQuery || (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(prevOptions.enabled, query) === false) && (!options.suspense || query.state.status !== "error") && isStale(query, options);
}
function isStale(query, options) {
  return (0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveEnabled */ .Eh)(options.enabled, query) !== false && query.isStaleByTime((0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveStaleTime */ .d2)(options.staleTime, query));
}
function shouldAssignObserverCurrentProperties(observer, optimisticResult) {
  if (!(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__/* .shallowEqualObjects */ .f8)(observer.getCurrentResult(), optimisticResult)) {
    return true;
  }
  return false;
}
...
/* harmony export */ });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(34049);
/* harmony import */ var _notifyManager_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74268);
/* harmony import */ var _retryer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93049);
...
var Query = class extends _removable_js__WEBPACK_IMPORTED_MODULE_0__/* .Removable */ .k {
  ...
  isActive() {
    return this.observers.some(
      (observer) => (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .resolveEnabled */ .Eh)(observer.options.enabled, this) !== false
    );
  }
  isDisabled() {
    ...
    return this.options.queryFn === _utils_js__WEBPACK_IMPORTED_MODULE_1__/* .skipToken */ .hT || this.state.dataUpdateCount + this.state.errorUpdateCount === 0;
  }
  isStatic() {
    if (this.getObserversCount() > 0) {
      return this.observers.some(
        (observer) => (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .resolveStaleTime */ .d2)(observer.options.staleTime, this) === "static"
      );
    }
    return false;
  }
  ...
  isStaleByTime(staleTime = 0) {
    ...
    return !(0,_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .timeUntilStale */ .j3)(this.state.dataUpdatedAt, staleTime);
  }
  onFocus() {
  ...
  async fetch(options, fetchOptions) {
    ...
    const fetchFn = () => {
      const queryFn = (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__/* .ensureQueryFn */ .ZM)(this.options, fetchOptions);
  ...
  #dispatch(action) {
    ...
    _notifyManager_js__WEBPACK_IMPORTED_MODULE_3__/* .notifyManager */ .jG.batch(() => {
...
/* harmony export */ });
/* harmony import */ var _tanstack_query_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2954);
/* harmony import */ var _useBaseQuery_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(94774);
...
/* harmony export */ });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34049);
// src/removable.ts
...
/* harmony export */   b: () => (/* binding */ tryResolveSync)
/* harmony export */ });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34049);
// src/thenable.ts
...
function tryResolveSync(promise) {
  ...
  promise.then((result) => {
    data = result;
    return result;
  }, _utils_js__WEBPACK_IMPORTED_MODULE_0__/* .noop */ .lQ)?.catch(_utils_js__WEBPACK_IMPORTED_MODULE_0__/* .noop */ .lQ);
  if (data !== void 0) {
    return { data };
  }
  return void 0;
...
/* harmony import */ var _focusManager_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(56195);
/* harmony import */ var _onlineManager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63122);
/* harmony import */ var _thenable_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(83515);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34049);
// src/retryer.ts
...
function createRetryer(config) {
  ...
  let failureCount = 0;
  let continueFn;
  const thenable = (0,_thenable_js__WEBPACK_IMPORTED_MODULE_1__/* .pendingThenable */ .T)();
  ...
  const canContinue = () => _focusManager_js__WEBPACK_IMPORTED_MODULE_2__/* .focusManager */ .m.isFocused() && (config.networkMode === "always" || _onlineManager_js__WEBPACK_IMPORTED_MODULE_0__/* .onlineManager */ .t.isOnline()) && config.canRun();
...
var getHasError = (param)=>{
    ...
    return result.isError && !errorResetBoundary.isReset() && !result.isFetching && query && (suspense && result.data === void 0 || (0,utils/* shouldThrowError */.GU)(throwOnError, [
        result.error,
        query
    ]));
};
...
function useBaseQuery(options, Observer, queryClient) {
    ...
    if (defaultedOptions.experimental_prefetchInRender && !utils/* isServer */.S$ && willFetch(result, isRestoring)) {
        ...
        fetchOptimistic(defaultedOptions, observer, errorResetBoundary) : (_client_getQueryCache_get = client.getQueryCache().get(defaultedOptions.queryHash)) === null || _client_getQueryCache_get === void 0 ? void 0 : _client_getQueryCache_get.promise;
        promise === null || promise === void 0 ? void 0 : promise.catch(utils/* noop */.lQ).finally(()=>{
            observer.updateResult();
        });
    }
...
//# sourceMappingURL=3275-6d0663cb48f0a37a.js.map